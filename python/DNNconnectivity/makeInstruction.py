...
#                             00100010000000000010001110000   000000001010____000'
#0a005000049                  00001010000000000101000000000___000000001001____001
...
print  '// Cons Jump'
print  hex(int(a[1].replace('_',''),2)).split('x')[1]
