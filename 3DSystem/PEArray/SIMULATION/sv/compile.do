...
vlog +define+TESTING     +incdir+../../HDL/common +incdir+../../SIMULATION/common                                                                              ../../HDL/run_s/common/code/generic_fifo.v       2>&1   | tee -a $1  
vlog +define+TESTING     +incdir+../../HDL/common +incdir+../../SIMULATION/common                                                                              ../../HDL/run_s/pe/code/sram.v                   2>&1   | tee -a $1  
vlog +define+TESTING     +incdir+../../HDL/common +incdir+../../SIMULATION/common                                                                              ../../HDL/run_s/pe/code/mem_acc_cont.v           2>&1   | tee -a $1  
...
vlog +define+TESTING -sv +incdir+../../HDL/common +incdir+../../SIMULATION/common +incdir+../../MEMORY/65nm/FIFOs/compout/views/sasslnpky2p32x35cm4sw0bk1ltlc1 ../../HDL/run_s/pe/code/streamingOps_cntl.v      2>&1   | tee -a $1                            
vlog +define+TESTING -sv +incdir+../../HDL/common +incdir+../../SIMULATION/common                                                                              ../../HDL/run_s/pe_array.v                       2>&1   | tee -a $1  
...
vlog +define+TESTING -sv +incdir+../../HDL/common +incdir+../../SIMULATION/common base_operation.sv                                                                              2>&1   | tee -a $1  
vlog +define+TESTING -sv +incdir+../../HDL/common +incdir+../../SIMULATION/common driver.sv                                                                                      2>&1   | tee -a $1  
vlog +define+TESTING -sv +incdir+../../HDL/common +incdir+../../SIMULATION/common oob_driver.sv                                                                                  2>&1   | tee -a $1  
...
vlog +define+TESTING -sv +incdir+../../HDL/common +incdir+../../SIMULATION/common testbench.sv                                                                                   2>&1   | tee -a $1  
vlog +define+TESTING -sv +incdir+../../HDL/common +incdir+../../SIMULATION/common top.sv                                                                                         2>&1   | tee -a $1  
