...
if __name__ == "__main__":
  ...
  pLine = pLine + '\n            // Operation'
  for pe in range (0, numOfPe):
      pLine = pLine + '\n            force pe_array_inst.pe_inst[{0}].pe.rs0[31:1] = `STREAMING_OP_CNTL_OPERATION_NOP_FROM_TWO_EXT_TO_MEM ;'.format(pe)
  pLine = pLine + '\n'
...
if __name__ == "__main__":
  ...
  pLine = pLine + '\n            // Operation'
  for pe in range (0, numOfPe):
      pLine = pLine + '\n            force pe_array_inst.pe_inst[{0}].pe.rs0[31:1] = `STREAMING_OP_CNTL_OPERATION_STD_STD_FP_MAC_TO_MEM ;'.format(pe)
  pLine = pLine + '\n'
  pLine = pLine + '\n            repeat(50) @(negedge clk);'
