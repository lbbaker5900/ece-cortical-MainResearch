...
report_timing \
	-delay max \
	-nworst 30 \
	> ${modname}_${type}_timing_initial_tt_max.rpt

report_timing \
	-delay min \
	-nworst 30 \
	> ${modname}_${type}_timing_initial_tt_min.rpt
...
if ($fullrun == "True") {
  ...
  report_power > ${modname}_${type}_power_netlist_ff_max_initial.rpt
  ...
  report_power > ${modname}_${type}_power_netlist_ss_max_initial.rpt
  ...
  report_power > ${modname}_${type}_power_netlist_tt_max_initial.rpt
