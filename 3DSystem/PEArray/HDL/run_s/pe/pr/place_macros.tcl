...
get_cells -hier -filter "full_name =~ mem_acc_cont/bank_mem*gmemory/genblk*_mem1p*"
get_cells -hier -regexp -filter "full_name =~ mem_acc_cont.*bank_mem_\[0-9\]\[0-9\]__.*gmemory/genblk.*_mem1p.*"
...
set llx [expr $x]
set lly [expr $y]
change_selection [get_cells -hier -regexp -filter "full_name =~ mem_acc_cont.*bank_mem_\[0-7\]__.*gmemory/genblk.*_mem1p.*"]
