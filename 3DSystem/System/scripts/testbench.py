...
if __name__ == "__main__":
  ...
  for mgr in range (0, numOfMgr):
    ...
    for intf in range (2):
        if intf == 0:
          ...
          src = "MCNTL"
        pLine = pLine + '\nadd wave -noupdate -group MGR{0} -group MWC -group FROM_{2}_FIFO -radix hexadecimal  {{/top/system_inst/manager_array_inst/mgr_inst[{0}]/manager/mwc_cntl/input_intf_fifo[{1}]/pipe_cntl}}'.format(mgr,intf,src)
        pLine = pLine + '\nadd wave -noupdate -group MGR{0} -group MWC -group FROM_{2}_FIFO -radix hexadecimal  {{/top/system_inst/manager_array_inst/mgr_inst[{0}]/manager/mwc_cntl/input_intf_fifo[{1}]/pipe_data}}'.format(mgr,intf,src)
        pLine = pLine + '\nadd wave -noupdate -group MGR{0} -group MWC -group FROM_{2}_FIFO -radix hexadecimal  {{/top/system_inst/manager_array_inst/mgr_inst[{0}]/manager/mwc_cntl/input_intf_fifo[{1}]/pipe_eom}}'.format(mgr,intf,src)
        pLine = pLine + '\nadd wave -noupdate -group MGR{0} -group MWC -group FROM_{2}_FIFO -radix hexadecimal  {{/top/system_inst/manager_array_inst/mgr_inst[{0}]/manager/mwc_cntl/input_intf_fifo[{1}]/pipe_mem_data}}'.format(mgr,intf,src)
        pLine = pLine + '\nadd wave -noupdate -group MGR{0} -group MWC -group FROM_{2}_FIFO -radix hexadecimal  {{/top/system_inst/manager_array_inst/mgr_inst[{0}]/manager/mwc_cntl/input_intf_fifo[{1}]/pipe_ptype}}'.format(mgr,intf,src)
        pLine = pLine + '\nadd wave -noupdate -group MGR{0} -group MWC -group FROM_{2}_FIFO -radix hexadecimal  {{/top/system_inst/manager_array_inst/mgr_inst[{0}]/manager/mwc_cntl/input_intf_fifo[{1}]/pipe_pvalid}}'.format(mgr,intf,src)
        pLine = pLine + '\nadd wave -noupdate -group MGR{0} -group MWC -group FROM_{2}_FIFO -radix hexadecimal  {{/top/system_inst/manager_array_inst/mgr_inst[{0}]/manager/mwc_cntl/input_intf_fifo[{1}]/pipe_read}}'.format(mgr,intf,src)
        pLine = pLine + '\nadd wave -noupdate -group MGR{0} -group MWC -group FROM_{2}_FIFO -radix hexadecimal  {{/top/system_inst/manager_array_inst/mgr_inst[{0}]/manager/mwc_cntl/input_intf_fifo[{1}]/pipe_som}}'.format(mgr,intf,src)
        pLine = pLine + '\nadd wave -noupdate -group MGR{0} -group MWC -group FROM_{2}_FIFO -radix hexadecimal  {{/top/system_inst/manager_array_inst/mgr_inst[{0}]/manager/mwc_cntl/input_intf_fifo[{1}]/pipe_valid}}'.format(mgr,intf,src)
        pLine = pLine + '\nadd wave -noupdate -group MGR{0} -group MWC -group FROM_{2}_FIFO -radix hexadecimal  {{/top/system_inst/manager_array_inst/mgr_inst[{0}]/manager/mwc_cntl/input_intf_fifo[{1}]/write}}'.format(mgr,intf,src)
        pLine = pLine + '\nadd wave -noupdate -group MGR{0} -group MWC -group FROM_{2}_FIFO -radix hexadecimal  {{/top/system_inst/manager_array_inst/mgr_inst[{0}]/manager/mwc_cntl/input_intf_fifo[{1}]/write_data}}'.format(mgr,intf,src)
  ...
  for mgr in range (0, numOfMgr):
    ...
    #
    pLine = pLine + '\nadd wave -noupdate -group MGR{0} -group MGR_CNTL -group TO_WUF -radix hexadecimal  {{/top/system_inst/manager_array_inst/mgr_inst[{0}]/manager/mgr_cntl/xxx__wuf__stall}}'.format(mgr)
    #
