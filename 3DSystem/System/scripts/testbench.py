...
if __name__ == "__main__":
  ...
  for mgr in range (0, numOfMgr):
    for chan in range (0, numOfChannels):
        pLine = pLine + '\nadd wave -noupdate -group MGR0 -group SEL_FSM -group CHAN{1} -radix hexadecimal {{/top/system_inst/manager_array_inst/mgr_inst[{0}]/manager/main_mem_cntl/channel_strm_select_fsm[{1}]/mmc_cntl_strm_sel_state}}       '.format(mgr,chan)
        pLine = pLine + '\nadd wave -noupdate -group MGR0 -group SEL_FSM -group CHAN{1} -radix hexadecimal {{/top/system_inst/manager_array_inst/mgr_inst[{0}]/manager/main_mem_cntl/channel_strm_select_fsm[{1}]/mmc_cntl_strm_sel_state_next}}  '.format(mgr,chan)
        pLine = pLine + '\nadd wave -noupdate -group MGR0 -group SEL_FSM -group CHAN{1} -radix hexadecimal {{/top/system_inst/manager_array_inst/mgr_inst[{0}]/manager/main_mem_cntl/channel_strm_select_fsm[{1}]/strm_ena[0]/strm}}              '.format(mgr,chan)
        pLine = pLine + '\nadd wave -noupdate -group MGR0 -group SEL_FSM -group CHAN{1} -radix hexadecimal {{/top/system_inst/manager_array_inst/mgr_inst[{0}]/manager/main_mem_cntl/channel_strm_select_fsm[{1}]/strm_ena[1]/strm}}              '.format(mgr,chan)
        pLine = pLine + '\nadd wave -noupdate -group MGR0 -group SEL_FSM -group CHAN{1} -radix hexadecimal {{/top/system_inst/manager_array_inst/mgr_inst[{0}]/manager/main_mem_cntl/channel_strm_select_fsm[{1}]/strm_ena[2]/strm}}              '.format(mgr,chan)
