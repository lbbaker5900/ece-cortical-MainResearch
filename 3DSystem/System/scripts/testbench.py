...
if __name__ == "__main__":
  ...
  for mgr in range (0, numOfMgr):
    for strm in range (0, numOfStrms):
      for lane in [0,7,15,23,31] :
        pLine = pLine + '\nadd wave -noupdate -group MGR{0} -group LANE{2} -group STRM01 -radix hexadecimal {{/top/system_inst/pe_array_inst/pe_inst[{0}]/pe/stOp_lane[{2}]/streamingOps_datapath/sti__stOp__strm{1}_data_valid}}'.format(mgr,strm,lane)
        pLine = pLine + '\nadd wave -noupdate -group MGR{0} -group LANE{2} -group STRM01 -radix hexadecimal {{/top/system_inst/pe_array_inst/pe_inst[{0}]/pe/stOp_lane[{2}]/streamingOps_datapath/sti__stOp__strm{1}_cntl}}'.format(mgr,strm,lane)
        pLine = pLine + '\nadd wave -noupdate -group MGR{0} -group LANE{2} -group STRM01 -radix hexadecimal {{/top/system_inst/pe_array_inst/pe_inst[{0}]/pe/stOp_lane[{2}]/streamingOps_datapath/sti__stOp__strm{1}_data}}'.format(mgr,strm,lane)
        pLine = pLine + '\nadd wave -noupdate -group MGR{0} -group LANE{2} -group STRM01 -radix hexadecimal {{/top/system_inst/pe_array_inst/pe_inst[{0}]/pe/stOp_lane[{2}]/streamingOps_datapath/stOp__sti__strm{1}_ready}}'.format(mgr,strm,lane)
        #
  ...
  for mgr in range (0, numOfMgr):
    for strm in range (0, numOfStrms):
       pLine = pLine + '\nadd wave -noupdate -group MGR{0} -group STRM{1} -group SDP -radix hexadecimal {{/top/system_inst/manager_array_inst/mgr_inst[{0}]/manager/mrc_cntl_strm_inst[{1}]/mrc_cntl/sdp_cntl/clk}}'.format(mgr,strm)
       pLine = pLine + '\nadd wave -noupdate -group MGR{0} -group STRM{1} -group SDP -radix hexadecimal {{/top/system_inst/manager_array_inst/mgr_inst[{0}]/manager/mrc_cntl_strm_inst[{1}]/mrc_cntl/sdp_cntl/reset_poweron}}'.format(mgr,strm)
       pLine = pLine + '\nadd wave -noupdate -group MGR{0} -group STRM{1} -group SDP -radix hexadecimal {{/top/system_inst/manager_array_inst/mgr_inst[{0}]/manager/mrc_cntl_strm_inst[{1}]/mrc_cntl/sdp_cntl/sdp__xxx__get_next_line}}'.format(mgr,strm)
       pLine = pLine + '\nadd wave -noupdate -group MGR{0} -group STRM{1} -group SDP -radix hexadecimal {{/top/system_inst/manager_array_inst/mgr_inst[{0}]/manager/mrc_cntl_strm_inst[{1}]/mrc_cntl/sdp_cntl/sdp__xxx__lane_channel_ptr}}'.format(mgr,strm)
       pLine = pLine + '\nadd wave -noupdate -group MGR{0} -group STRM{1} -group SDP -radix hexadecimal {{/top/system_inst/manager_array_inst/mgr_inst[{0}]/manager/mrc_cntl_strm_inst[{1}]/mrc_cntl/sdp_cntl/sdp__xxx__lane_cntl}}'.format(mgr,strm)
       pLine = pLine + '\nadd wave -noupdate -group MGR{0} -group STRM{1} -group SDP -radix hexadecimal {{/top/system_inst/manager_array_inst/mgr_inst[{0}]/manager/mrc_cntl_strm_inst[{1}]/mrc_cntl/sdp_cntl/sdp__xxx__lane_enable}}'.format(mgr,strm)
       pLine = pLine + '\nadd wave -noupdate -group MGR{0} -group STRM{1} -group SDP -radix hexadecimal {{/top/system_inst/manager_array_inst/mgr_inst[{0}]/manager/mrc_cntl_strm_inst[{1}]/mrc_cntl/sdp_cntl/sdp__xxx__lane_valid}}'.format(mgr,strm)
       pLine = pLine + '\nadd wave -noupdate -group MGR{0} -group STRM{1} -group SDP -radix hexadecimal {{/top/system_inst/manager_array_inst/mgr_inst[{0}]/manager/mrc_cntl_strm_inst[{1}]/mrc_cntl/sdp_cntl/sdp__xxx__lane_word_ptr}}'.format(mgr,strm)
       pLine = pLine + '\nadd wave -noupdate -group MGR{0} -group STRM{1} -group SDP -radix hexadecimal {{/top/system_inst/manager_array_inst/mgr_inst[{0}]/manager/mrc_cntl_strm_inst[{1}]/mrc_cntl/sdp_cntl/sdp__xxx__mem_request_bank}}'.format(mgr,strm)
       pLine = pLine + '\nadd wave -noupdate -group MGR{0} -group STRM{1} -group SDP -radix hexadecimal {{/top/system_inst/manager_array_inst/mgr_inst[{0}]/manager/mrc_cntl_strm_inst[{1}]/mrc_cntl/sdp_cntl/sdp__xxx__mem_request_channel}}'.format(mgr,strm)
       pLine = pLine + '\nadd wave -noupdate -group MGR{0} -group STRM{1} -group SDP -radix hexadecimal {{/top/system_inst/manager_array_inst/mgr_inst[{0}]/manager/mrc_cntl_strm_inst[{1}]/mrc_cntl/sdp_cntl/sdp__xxx__mem_request_cntl}}'.format(mgr,strm)
       pLine = pLine + '\nadd wave -noupdate -group MGR{0} -group STRM{1} -group SDP -radix hexadecimal {{/top/system_inst/manager_array_inst/mgr_inst[{0}]/manager/mrc_cntl_strm_inst[{1}]/mrc_cntl/sdp_cntl/sdp__xxx__mem_request_page}}'.format(mgr,strm)
       pLine = pLine + '\nadd wave -noupdate -group MGR{0} -group STRM{1} -group SDP -radix hexadecimal {{/top/system_inst/manager_array_inst/mgr_inst[{0}]/manager/mrc_cntl_strm_inst[{1}]/mrc_cntl/sdp_cntl/sdp__xxx__mem_request_valid}}'.format(mgr,strm)
       pLine = pLine + '\nadd wave -noupdate -group MGR{0} -group STRM{1} -group SDP -radix hexadecimal {{/top/system_inst/manager_array_inst/mgr_inst[{0}]/manager/mrc_cntl_strm_inst[{1}]/mrc_cntl/sdp_cntl/sdp__xxx__mem_request_word}}'.format(mgr,strm)
       pLine = pLine + '\nadd wave -noupdate -group MGR{0} -group STRM{1} -group SDP -radix hexadecimal {{/top/system_inst/manager_array_inst/mgr_inst[{0}]/manager/mrc_cntl_strm_inst[{1}]/mrc_cntl/sdp_cntl/sdp__xxx__storage_desc_processing_complete}}'.format(mgr,strm)
       pLine = pLine + '\nadd wave -noupdate -group MGR{0} -group STRM{1} -group SDP -radix hexadecimal {{/top/system_inst/manager_array_inst/mgr_inst[{0}]/manager/mrc_cntl_strm_inst[{1}]/mrc_cntl/sdp_cntl/sdpr__sdps__cfg_accessOrder}}'.format(mgr,strm)
       pLine = pLine + '\nadd wave -noupdate -group MGR{0} -group STRM{1} -group SDP -radix hexadecimal {{/top/system_inst/manager_array_inst/mgr_inst[{0}]/manager/mrc_cntl_strm_inst[{1}]/mrc_cntl/sdp_cntl/sdpr__sdps__cfg_addr}}'.format(mgr,strm)
       pLine = pLine + '\nadd wave -noupdate -group MGR{0} -group STRM{1} -group SDP -radix hexadecimal {{/top/system_inst/manager_array_inst/mgr_inst[{0}]/manager/mrc_cntl_strm_inst[{1}]/mrc_cntl/sdp_cntl/sdpr__sdps__cfg_valid}}'.format(mgr,strm)
       pLine = pLine + '\nadd wave -noupdate -group MGR{0} -group STRM{1} -group SDP -radix hexadecimal {{/top/system_inst/manager_array_inst/mgr_inst[{0}]/manager/mrc_cntl_strm_inst[{1}]/mrc_cntl/sdp_cntl/sdpr__sdps__complete}}'.format(mgr,strm)
       pLine = pLine + '\nadd wave -noupdate -group MGR{0} -group STRM{1} -group SDP -radix hexadecimal {{/top/system_inst/manager_array_inst/mgr_inst[{0}]/manager/mrc_cntl_strm_inst[{1}]/mrc_cntl/sdp_cntl/sdpr__sdps__consJump_cntl}}'.format(mgr,strm)
       pLine = pLine + '\nadd wave -noupdate -group MGR{0} -group STRM{1} -group SDP -radix hexadecimal {{/top/system_inst/manager_array_inst/mgr_inst[{0}]/manager/mrc_cntl_strm_inst[{1}]/mrc_cntl/sdp_cntl/sdpr__sdps__consJump_valid}}'.format(mgr,strm)
       pLine = pLine + '\nadd wave -noupdate -group MGR{0} -group STRM{1} -group SDP -radix hexadecimal {{/top/system_inst/manager_array_inst/mgr_inst[{0}]/manager/mrc_cntl_strm_inst[{1}]/mrc_cntl/sdp_cntl/sdpr__sdps__consJump_value}}'.format(mgr,strm)
       pLine = pLine + '\nadd wave -noupdate -group MGR{0} -group STRM{1} -group SDP -radix hexadecimal {{/top/system_inst/manager_array_inst/mgr_inst[{0}]/manager/mrc_cntl_strm_inst[{1}]/mrc_cntl/sdp_cntl/sdpr__sdps__response_id_bank}}'.format(mgr,strm)
       pLine = pLine + '\nadd wave -noupdate -group MGR{0} -group STRM{1} -group SDP -radix hexadecimal {{/top/system_inst/manager_array_inst/mgr_inst[{0}]/manager/mrc_cntl_strm_inst[{1}]/mrc_cntl/sdp_cntl/sdpr__sdps__response_id_channel}}'.format(mgr,strm)
       pLine = pLine + '\nadd wave -noupdate -group MGR{0} -group STRM{1} -group SDP -radix hexadecimal {{/top/system_inst/manager_array_inst/mgr_inst[{0}]/manager/mrc_cntl_strm_inst[{1}]/mrc_cntl/sdp_cntl/sdpr__sdps__response_id_cntl}}'.format(mgr,strm)
       pLine = pLine + '\nadd wave -noupdate -group MGR{0} -group STRM{1} -group SDP -radix hexadecimal {{/top/system_inst/manager_array_inst/mgr_inst[{0}]/manager/mrc_cntl_strm_inst[{1}]/mrc_cntl/sdp_cntl/sdpr__sdps__response_id_line}}'.format(mgr,strm)
       pLine = pLine + '\nadd wave -noupdate -group MGR{0} -group STRM{1} -group SDP -radix hexadecimal {{/top/system_inst/manager_array_inst/mgr_inst[{0}]/manager/mrc_cntl_strm_inst[{1}]/mrc_cntl/sdp_cntl/sdpr__sdps__response_id_page}}'.format(mgr,strm)
       pLine = pLine + '\nadd wave -noupdate -group MGR{0} -group STRM{1} -group SDP -radix hexadecimal {{/top/system_inst/manager_array_inst/mgr_inst[{0}]/manager/mrc_cntl_strm_inst[{1}]/mrc_cntl/sdp_cntl/sdpr__sdps__response_id_valid}}'.format(mgr,strm)
       pLine = pLine + '\nadd wave -noupdate -group MGR{0} -group STRM{1} -group SDP -radix hexadecimal {{/top/system_inst/manager_array_inst/mgr_inst[{0}]/manager/mrc_cntl_strm_inst[{1}]/mrc_cntl/sdp_cntl/sdps__sdpr__cfg_ready}}'.format(mgr,strm)
       pLine = pLine + '\nadd wave -noupdate -group MGR{0} -group STRM{1} -group SDP -radix hexadecimal {{/top/system_inst/manager_array_inst/mgr_inst[{0}]/manager/mrc_cntl_strm_inst[{1}]/mrc_cntl/sdp_cntl/sdps__sdpr__complete}}'.format(mgr,strm)
       pLine = pLine + '\nadd wave -noupdate -group MGR{0} -group STRM{1} -group SDP -radix hexadecimal {{/top/system_inst/manager_array_inst/mgr_inst[{0}]/manager/mrc_cntl_strm_inst[{1}]/mrc_cntl/sdp_cntl/sdps__sdpr__consJump_ready}}'.format(mgr,strm)
       pLine = pLine + '\nadd wave -noupdate -group MGR{0} -group STRM{1} -group SDP -radix hexadecimal {{/top/system_inst/manager_array_inst/mgr_inst[{0}]/manager/mrc_cntl_strm_inst[{1}]/mrc_cntl/sdp_cntl/sdps__sdpr__response_id_ready}}'.format(mgr,strm)
       pLine = pLine + '\nadd wave -noupdate -group MGR{0} -group STRM{1} -group SDP -radix hexadecimal {{/top/system_inst/manager_array_inst/mgr_inst[{0}]/manager/mrc_cntl_strm_inst[{1}]/mrc_cntl/sdp_cntl/sys__mgr__mgrId}}'.format(mgr,strm)
       pLine = pLine + '\nadd wave -noupdate -group MGR{0} -group STRM{1} -group SDP -radix hexadecimal {{/top/system_inst/manager_array_inst/mgr_inst[{0}]/manager/mrc_cntl_strm_inst[{1}]/mrc_cntl/sdp_cntl/xxx__sdp__lane_enable}}'.format(mgr,strm)
       pLine = pLine + '\nadd wave -noupdate -group MGR{0} -group STRM{1} -group SDP -radix hexadecimal {{/top/system_inst/manager_array_inst/mgr_inst[{0}]/manager/mrc_cntl_strm_inst[{1}]/mrc_cntl/sdp_cntl/xxx__sdp__lane_ready}}'.format(mgr,strm)
       pLine = pLine + '\nadd wave -noupdate -group MGR{0} -group STRM{1} -group SDP -radix hexadecimal {{/top/system_inst/manager_array_inst/mgr_inst[{0}]/manager/mrc_cntl_strm_inst[{1}]/mrc_cntl/sdp_cntl/xxx__sdp__mem_request_channel_data_valid}}'.format(mgr,strm)
       pLine = pLine + '\nadd wave -noupdate -group MGR{0} -group STRM{1} -group SDP -radix hexadecimal {{/top/system_inst/manager_array_inst/mgr_inst[{0}]/manager/mrc_cntl_strm_inst[{1}]/mrc_cntl/sdp_cntl/xxx__sdp__mem_request_ready}}'.format(mgr,strm)
       pLine = pLine + '\nadd wave -noupdate -group MGR{0} -group STRM{1} -group SDP -radix hexadecimal {{/top/system_inst/manager_array_inst/mgr_inst[{0}]/manager/mrc_cntl_strm_inst[{1}]/mrc_cntl/sdp_cntl/xxx__sdp__num_lanes}}'.format(mgr,strm)
       pLine = pLine + '\nadd wave -noupdate -group MGR{0} -group STRM{1} -group SDP -radix hexadecimal {{/top/system_inst/manager_array_inst/mgr_inst[{0}]/manager/mrc_cntl_strm_inst[{1}]/mrc_cntl/sdp_cntl/xxx__sdp__num_lanes_m1}}'.format(mgr,strm)
       pLine = pLine + '\nadd wave -noupdate -group MGR{0} -group STRM{1} -group SDP -radix hexadecimal {{/top/system_inst/manager_array_inst/mgr_inst[{0}]/manager/mrc_cntl_strm_inst[{1}]/mrc_cntl/sdp_cntl/xxx__sdp__storage_desc_processing_enable}}'.format(mgr,strm)
       pLine = pLine + '\nadd wave -noupdate -group MGR{0} -group STRM{1} -group SDP -radix hexadecimal {{/top/system_inst/manager_array_inst/mgr_inst[{0}]/manager/mrc_cntl_strm_inst[{1}]/mrc_cntl/sdp_cntl/xxx__sdp__storage_desc_ptr}}'.format(mgr,strm)
  ...
  for mgr in range (0, numOfMgr):
    for strm in range (0, numOfStrms):
      pLine = pLine + '\nadd wave -noupdate -group MGR{0} -group STRM{1} -group SDPR -radix hexadecimal {{/top/system_inst/manager_array_inst/mgr_inst[{0}]/manager/mrc_cntl_strm_inst[{1}]/mrc_cntl/sdp_cntl/sdp_request_cntl/cj_address}}'.format(mgr,strm,lane,chan)
      pLine = pLine + '\nadd wave -noupdate -group MGR{0} -group STRM{1} -group SDPR -radix hexadecimal {{/top/system_inst/manager_array_inst/mgr_inst[{0}]/manager/mrc_cntl_strm_inst[{1}]/mrc_cntl/sdp_cntl/sdp_request_cntl/cj_bank}}'.format(mgr,strm,lane,chan)
      pLine = pLine + '\nadd wave -noupdate -group MGR{0} -group STRM{1} -group SDPR -radix hexadecimal {{/top/system_inst/manager_array_inst/mgr_inst[{0}]/manager/mrc_cntl_strm_inst[{1}]/mrc_cntl/sdp_cntl/sdp_request_cntl/cj_channel}}'.format(mgr,strm,lane,chan)
      pLine = pLine + '\nadd wave -noupdate -group MGR{0} -group STRM{1} -group SDPR -radix hexadecimal {{/top/system_inst/manager_array_inst/mgr_inst[{0}]/manager/mrc_cntl_strm_inst[{1}]/mrc_cntl/sdp_cntl/sdp_request_cntl/cj_ms_lane_address}}'.format(mgr,strm,lane,chan)
      pLine = pLine + '\nadd wave -noupdate -group MGR{0} -group STRM{1} -group SDPR -radix hexadecimal {{/top/system_inst/manager_array_inst/mgr_inst[{0}]/manager/mrc_cntl_strm_inst[{1}]/mrc_cntl/sdp_cntl/sdp_request_cntl/cj_ms_lane_bank}}'.format(mgr,strm,lane,chan)
      pLine = pLine + '\nadd wave -noupdate -group MGR{0} -group STRM{1} -group SDPR -radix hexadecimal {{/top/system_inst/manager_array_inst/mgr_inst[{0}]/manager/mrc_cntl_strm_inst[{1}]/mrc_cntl/sdp_cntl/sdp_request_cntl/cj_ms_lane_channel}}'.format(mgr,strm,lane,chan)
      pLine = pLine + '\nadd wave -noupdate -group MGR{0} -group STRM{1} -group SDPR -radix hexadecimal {{/top/system_inst/manager_array_inst/mgr_inst[{0}]/manager/mrc_cntl_strm_inst[{1}]/mrc_cntl/sdp_cntl/sdp_request_cntl/cj_ms_lane_page}}'.format(mgr,strm,lane,chan)
      pLine = pLine + '\nadd wave -noupdate -group MGR{0} -group STRM{1} -group SDPR -radix hexadecimal {{/top/system_inst/manager_array_inst/mgr_inst[{0}]/manager/mrc_cntl_strm_inst[{1}]/mrc_cntl/sdp_cntl/sdp_request_cntl/cj_ms_lane_word}}'.format(mgr,strm,lane,chan)
      pLine = pLine + '\nadd wave -noupdate -group MGR{0} -group STRM{1} -group SDPR -radix hexadecimal {{/top/system_inst/manager_array_inst/mgr_inst[{0}]/manager/mrc_cntl_strm_inst[{1}]/mrc_cntl/sdp_cntl/sdp_request_cntl/cj_page}}'.format(mgr,strm,lane,chan)
      pLine = pLine + '\nadd wave -noupdate -group MGR{0} -group STRM{1} -group SDPR -radix hexadecimal {{/top/system_inst/manager_array_inst/mgr_inst[{0}]/manager/mrc_cntl_strm_inst[{1}]/mrc_cntl/sdp_cntl/sdp_request_cntl/cj_word}}'.format(mgr,strm,lane,chan)
      pLine = pLine + '\nadd wave -noupdate -group MGR{0} -group STRM{1} -group SDPR -radix hexadecimal {{/top/system_inst/manager_array_inst/mgr_inst[{0}]/manager/mrc_cntl_strm_inst[{1}]/mrc_cntl/sdp_cntl/sdp_request_cntl/clk}}'.format(mgr,strm,lane,chan)
      pLine = pLine + '\nadd wave -noupdate -group MGR{0} -group STRM{1} -group SDPR -radix hexadecimal {{/top/system_inst/manager_array_inst/mgr_inst[{0}]/manager/mrc_cntl_strm_inst[{1}]/mrc_cntl/sdp_cntl/sdp_request_cntl/completed_streaming}}'.format(mgr,strm,lane,chan)
      pLine = pLine + '\nadd wave -noupdate -group MGR{0} -group STRM{1} -group SDPR -radix hexadecimal {{/top/system_inst/manager_array_inst/mgr_inst[{0}]/manager/mrc_cntl_strm_inst[{1}]/mrc_cntl/sdp_cntl/sdp_request_cntl/consJumpMemory_cntl}}'.format(mgr,strm,lane,chan)
      pLine = pLine + '\nadd wave -noupdate -group MGR{0} -group STRM{1} -group SDPR -radix hexadecimal {{/top/system_inst/manager_array_inst/mgr_inst[{0}]/manager/mrc_cntl_strm_inst[{1}]/mrc_cntl/sdp_cntl/sdp_request_cntl/consJumpMemory_eom}}'.format(mgr,strm,lane,chan)
      pLine = pLine + '\nadd wave -noupdate -group MGR{0} -group STRM{1} -group SDPR -radix hexadecimal {{/top/system_inst/manager_array_inst/mgr_inst[{0}]/manager/mrc_cntl_strm_inst[{1}]/mrc_cntl/sdp_cntl/sdp_request_cntl/consJumpMemory_som}}'.format(mgr,strm,lane,chan)
      pLine = pLine + '\nadd wave -noupdate -group MGR{0} -group STRM{1} -group SDPR -radix hexadecimal {{/top/system_inst/manager_array_inst/mgr_inst[{0}]/manager/mrc_cntl_strm_inst[{1}]/mrc_cntl/sdp_cntl/sdp_request_cntl/consJumpMemory_som_eom}}'.format(mgr,strm,lane,chan)
      pLine = pLine + '\nadd wave -noupdate -group MGR{0} -group STRM{1} -group SDPR -radix hexadecimal {{/top/system_inst/manager_array_inst/mgr_inst[{0}]/manager/mrc_cntl_strm_inst[{1}]/mrc_cntl/sdp_cntl/sdp_request_cntl/consJumpMemory_value}}'.format(mgr,strm,lane,chan)
      pLine = pLine + '\nadd wave -noupdate -group MGR{0} -group STRM{1} -group SDPR -radix hexadecimal {{/top/system_inst/manager_array_inst/mgr_inst[{0}]/manager/mrc_cntl_strm_inst[{1}]/mrc_cntl/sdp_cntl/sdp_request_cntl/consJumpPtr}}'.format(mgr,strm,lane,chan)
      pLine = pLine + '\nadd wave -noupdate -group MGR{0} -group STRM{1} -group SDPR -radix hexadecimal {{/top/system_inst/manager_array_inst/mgr_inst[{0}]/manager/mrc_cntl_strm_inst[{1}]/mrc_cntl/sdp_cntl/sdp_request_cntl/create_response_id}}'.format(mgr,strm,lane,chan)
      pLine = pLine + '\nadd wave -noupdate -group MGR{0} -group STRM{1} -group SDPR -radix hexadecimal {{/top/system_inst/manager_array_inst/mgr_inst[{0}]/manager/mrc_cntl_strm_inst[{1}]/mrc_cntl/sdp_cntl/sdp_request_cntl/desc_processor_strm_ack}}'.format(mgr,strm,lane,chan)
      pLine = pLine + '\nadd wave -noupdate -group MGR{0} -group STRM{1} -group SDPR -radix hexadecimal {{/top/system_inst/manager_array_inst/mgr_inst[{0}]/manager/mrc_cntl_strm_inst[{1}]/mrc_cntl/sdp_cntl/sdp_request_cntl/first_time_thru}}'.format(mgr,strm,lane,chan)
      pLine = pLine + '\nadd wave -noupdate -group MGR{0} -group STRM{1} -group SDPR -radix hexadecimal {{/top/system_inst/manager_array_inst/mgr_inst[{0}]/manager/mrc_cntl_strm_inst[{1}]/mrc_cntl/sdp_cntl/sdp_request_cntl/inc_consJumpPtr}}'.format(mgr,strm,lane,chan)
      pLine = pLine + '\nadd wave -noupdate -group MGR{0} -group STRM{1} -group SDPR -radix hexadecimal {{/top/system_inst/manager_array_inst/mgr_inst[{0}]/manager/mrc_cntl_strm_inst[{1}]/mrc_cntl/sdp_cntl/sdp_request_cntl/local_storage_desc_ptr}}'.format(mgr,strm,lane,chan)
      pLine = pLine + '\nadd wave -noupdate -group MGR{0} -group STRM{1} -group SDPR -radix hexadecimal {{/top/system_inst/manager_array_inst/mgr_inst[{0}]/manager/mrc_cntl_strm_inst[{1}]/mrc_cntl/sdp_cntl/sdp_request_cntl/mem_ms_lane_start_address}}'.format(mgr,strm,lane,chan)
      pLine = pLine + '\nadd wave -noupdate -group MGR{0} -group STRM{1} -group SDPR -radix hexadecimal {{/top/system_inst/manager_array_inst/mgr_inst[{0}]/manager/mrc_cntl_strm_inst[{1}]/mrc_cntl/sdp_cntl/sdp_request_cntl/mem_start_address}}'.format(mgr,strm,lane,chan)
      pLine = pLine + '\nadd wave -noupdate -group MGR{0} -group STRM{1} -group SDPR -radix hexadecimal {{/top/system_inst/manager_array_inst/mgr_inst[{0}]/manager/mrc_cntl_strm_inst[{1}]/mrc_cntl/sdp_cntl/sdp_request_cntl/mem_start_bank}}'.format(mgr,strm,lane,chan)
      pLine = pLine + '\nadd wave -noupdate -group MGR{0} -group STRM{1} -group SDPR -radix hexadecimal {{/top/system_inst/manager_array_inst/mgr_inst[{0}]/manager/mrc_cntl_strm_inst[{1}]/mrc_cntl/sdp_cntl/sdp_request_cntl/mem_start_channel}}'.format(mgr,strm,lane,chan)
      pLine = pLine + '\nadd wave -noupdate -group MGR{0} -group STRM{1} -group SDPR -radix hexadecimal {{/top/system_inst/manager_array_inst/mgr_inst[{0}]/manager/mrc_cntl_strm_inst[{1}]/mrc_cntl/sdp_cntl/sdp_request_cntl/mem_start_line}}'.format(mgr,strm,lane,chan)
      pLine = pLine + '\nadd wave -noupdate -group MGR{0} -group STRM{1} -group SDPR -radix hexadecimal {{/top/system_inst/manager_array_inst/mgr_inst[{0}]/manager/mrc_cntl_strm_inst[{1}]/mrc_cntl/sdp_cntl/sdp_request_cntl/mem_start_page}}'.format(mgr,strm,lane,chan)
      pLine = pLine + '\nadd wave -noupdate -group MGR{0} -group STRM{1} -group SDPR -radix hexadecimal {{/top/system_inst/manager_array_inst/mgr_inst[{0}]/manager/mrc_cntl_strm_inst[{1}]/mrc_cntl/sdp_cntl/sdp_request_cntl/mem_start_word}}'.format(mgr,strm,lane,chan)
      pLine = pLine + '\nadd wave -noupdate -group MGR{0} -group STRM{1} -group SDPR -radix hexadecimal {{/top/system_inst/manager_array_inst/mgr_inst[{0}]/manager/mrc_cntl_strm_inst[{1}]/mrc_cntl/sdp_cntl/sdp_request_cntl/force_cons_chan01_request}}'.format(mgr,strm,lane,chan)
      pLine = pLine + '\nadd wave -noupdate -group MGR{0} -group STRM{1} -group SDPR -radix hexadecimal {{/top/system_inst/manager_array_inst/mgr_inst[{0}]/manager/mrc_cntl_strm_inst[{1}]/mrc_cntl/sdp_cntl/sdp_request_cntl/force_cons_chan0_request}}'.format(mgr,strm,lane,chan)
      pLine = pLine + '\nadd wave -noupdate -group MGR{0} -group STRM{1} -group SDPR -radix hexadecimal {{/top/system_inst/manager_array_inst/mgr_inst[{0}]/manager/mrc_cntl_strm_inst[{1}]/mrc_cntl/sdp_cntl/sdp_request_cntl/force_cons_chan10_request}}'.format(mgr,strm,lane,chan)
      pLine = pLine + '\nadd wave -noupdate -group MGR{0} -group STRM{1} -group SDPR -radix hexadecimal {{/top/system_inst/manager_array_inst/mgr_inst[{0}]/manager/mrc_cntl_strm_inst[{1}]/mrc_cntl/sdp_cntl/sdp_request_cntl/force_cons_chan1_request}}'.format(mgr,strm,lane,chan)
      pLine = pLine + '\nadd wave -noupdate -group MGR{0} -group STRM{1} -group SDPR -radix hexadecimal {{/top/system_inst/manager_array_inst/mgr_inst[{0}]/manager/mrc_cntl_strm_inst[{1}]/mrc_cntl/sdp_cntl/sdp_request_cntl/force_cons_request}}'.format(mgr,strm,lane,chan)
      pLine = pLine + '\nadd wave -noupdate -group MGR{0} -group STRM{1} -group SDPR -radix hexadecimal {{/top/system_inst/manager_array_inst/mgr_inst[{0}]/manager/mrc_cntl_strm_inst[{1}]/mrc_cntl/sdp_cntl/sdp_request_cntl/force_disable_request}}'.format(mgr,strm,lane,chan)
      pLine = pLine + '\nadd wave -noupdate -group MGR{0} -group STRM{1} -group SDPR -radix hexadecimal {{/top/system_inst/manager_array_inst/mgr_inst[{0}]/manager/mrc_cntl_strm_inst[{1}]/mrc_cntl/sdp_cntl/sdp_request_cntl/generate_requests}}'.format(mgr,strm,lane,chan)
      pLine = pLine + '\nadd wave -noupdate -group MGR{0} -group STRM{1} -group SDPR -radix hexadecimal {{/top/system_inst/manager_array_inst/mgr_inst[{0}]/manager/mrc_cntl_strm_inst[{1}]/mrc_cntl/sdp_cntl/sdp_request_cntl/create_mem_request}}'.format(mgr,strm,lane,chan)
      pLine = pLine + '\nadd wave -noupdate -group MGR{0} -group STRM{1} -group SDPR -radix hexadecimal {{/top/system_inst/manager_array_inst/mgr_inst[{0}]/manager/mrc_cntl_strm_inst[{1}]/mrc_cntl/sdp_cntl/sdp_request_cntl/sdp_cntl_proc_storage_desc_state}}'.format(mgr,strm,lane,chan)
      pLine = pLine + '\nadd wave -noupdate -group MGR{0} -group STRM{1} -group SDPR -radix hexadecimal {{/top/system_inst/manager_array_inst/mgr_inst[{0}]/manager/mrc_cntl_strm_inst[{1}]/mrc_cntl/sdp_cntl/sdp_request_cntl/sdp_cntl_proc_storage_desc_state_next}}'.format(mgr,strm,lane,chan)
      pLine = pLine + '\nadd wave -noupdate -group MGR{0} -group STRM{1} -group SDPR -radix hexadecimal {{/top/system_inst/manager_array_inst/mgr_inst[{0}]/manager/mrc_cntl_strm_inst[{1}]/mrc_cntl/sdp_cntl/sdp_request_cntl/channel_change}}'.format(mgr,strm,lane,chan)
      pLine = pLine + '\nadd wave -noupdate -group MGR{0} -group STRM{1} -group SDPR -radix hexadecimal {{/top/system_inst/manager_array_inst/mgr_inst[{0}]/manager/mrc_cntl_strm_inst[{1}]/mrc_cntl/sdp_cntl/sdp_request_cntl/bank_change}}'.format(mgr,strm,lane,chan)
      pLine = pLine + '\nadd wave -noupdate -group MGR{0} -group STRM{1} -group SDPR -radix hexadecimal {{/top/system_inst/manager_array_inst/mgr_inst[{0}]/manager/mrc_cntl_strm_inst[{1}]/mrc_cntl/sdp_cntl/sdp_request_cntl/page_change}}'.format(mgr,strm,lane,chan)
      pLine = pLine + '\nadd wave -noupdate -group MGR{0} -group STRM{1} -group SDPR -radix hexadecimal {{/top/system_inst/manager_array_inst/mgr_inst[{0}]/manager/mrc_cntl_strm_inst[{1}]/mrc_cntl/sdp_cntl/sdp_request_cntl/pbc_last_end_addr}}'.format(mgr,strm,lane,chan)
      pLine = pLine + '\nadd wave -noupdate -group MGR{0} -group STRM{1} -group SDPR -radix hexadecimal {{/top/system_inst/manager_array_inst/mgr_inst[{0}]/manager/mrc_cntl_strm_inst[{1}]/mrc_cntl/sdp_cntl/sdp_request_cntl/pbc_last_end_addr_chan}}'.format(mgr,strm,lane,chan)
      pLine = pLine + '\nadd wave -noupdate -group MGR{0} -group STRM{1} -group SDPR -radix hexadecimal {{/top/system_inst/manager_array_inst/mgr_inst[{0}]/manager/mrc_cntl_strm_inst[{1}]/mrc_cntl/sdp_cntl/sdp_request_cntl/pbc_last_end_addr_bank}}'.format(mgr,strm,lane,chan)
      pLine = pLine + '\nadd wave -noupdate -group MGR{0} -group STRM{1} -group SDPR -radix hexadecimal {{/top/system_inst/manager_array_inst/mgr_inst[{0}]/manager/mrc_cntl_strm_inst[{1}]/mrc_cntl/sdp_cntl/sdp_request_cntl/pbc_last_end_addr_page}}'.format(mgr,strm,lane,chan)
      pLine = pLine + '\nadd wave -noupdate -group MGR{0} -group STRM{1} -group SDPR -radix hexadecimal {{/top/system_inst/manager_array_inst/mgr_inst[{0}]/manager/mrc_cntl_strm_inst[{1}]/mrc_cntl/sdp_cntl/sdp_request_cntl/pbc_end_addr}}'.format(mgr,strm,lane,chan)
      pLine = pLine + '\nadd wave -noupdate -group MGR{0} -group STRM{1} -group SDPR -radix hexadecimal {{/top/system_inst/manager_array_inst/mgr_inst[{0}]/manager/mrc_cntl_strm_inst[{1}]/mrc_cntl/sdp_cntl/sdp_request_cntl/pbc_end_addr_chan}}'.format(mgr,strm,lane,chan)
      pLine = pLine + '\nadd wave -noupdate -group MGR{0} -group STRM{1} -group SDPR -radix hexadecimal {{/top/system_inst/manager_array_inst/mgr_inst[{0}]/manager/mrc_cntl_strm_inst[{1}]/mrc_cntl/sdp_cntl/sdp_request_cntl/pbc_end_addr_bank}}'.format(mgr,strm,lane,chan)
      pLine = pLine + '\nadd wave -noupdate -group MGR{0} -group STRM{1} -group SDPR -radix hexadecimal {{/top/system_inst/manager_array_inst/mgr_inst[{0}]/manager/mrc_cntl_strm_inst[{1}]/mrc_cntl/sdp_cntl/sdp_request_cntl/pbc_end_addr_page}}'.format(mgr,strm,lane,chan)
      pLine = pLine + '\nadd wave -noupdate -group MGR{0} -group STRM{1} -group SDPR -radix hexadecimal {{/top/system_inst/manager_array_inst/mgr_inst[{0}]/manager/mrc_cntl_strm_inst[{1}]/mrc_cntl/sdp_cntl/sdp_request_cntl/pbc_inc_addr}}'.format(mgr,strm,lane,chan)
      pLine = pLine + '\nadd wave -noupdate -group MGR{0} -group STRM{1} -group SDPR -radix hexadecimal {{/top/system_inst/manager_array_inst/mgr_inst[{0}]/manager/mrc_cntl_strm_inst[{1}]/mrc_cntl/sdp_cntl/sdp_request_cntl/pbc_inc_addr_chan}}'.format(mgr,strm,lane,chan)
      pLine = pLine + '\nadd wave -noupdate -group MGR{0} -group STRM{1} -group SDPR -radix hexadecimal {{/top/system_inst/manager_array_inst/mgr_inst[{0}]/manager/mrc_cntl_strm_inst[{1}]/mrc_cntl/sdp_cntl/sdp_request_cntl/pbc_inc_addr_bank}}'.format(mgr,strm,lane,chan)
      pLine = pLine + '\nadd wave -noupdate -group MGR{0} -group STRM{1} -group SDPR -radix hexadecimal {{/top/system_inst/manager_array_inst/mgr_inst[{0}]/manager/mrc_cntl_strm_inst[{1}]/mrc_cntl/sdp_cntl/sdp_request_cntl/pbc_inc_addr_page}}'.format(mgr,strm,lane,chan)
      pLine = pLine + '\nadd wave -noupdate -group MGR{0} -group STRM{1} -group SDPR -radix hexadecimal {{/top/system_inst/manager_array_inst/mgr_inst[{0}]/manager/mrc_cntl_strm_inst[{1}]/mrc_cntl/sdp_cntl/sdp_request_cntl/pbc_last_end_is_cons_tm1_end}}'.format(mgr,strm,lane,chan)
      pLine = pLine + '\nadd wave -noupdate -group MGR{0} -group STRM{1} -group SDPR -radix hexadecimal {{/top/system_inst/manager_array_inst/mgr_inst[{0}]/manager/mrc_cntl_strm_inst[{1}]/mrc_cntl/sdp_cntl/sdp_request_cntl/pbc_last_requested_valid}}'.format(mgr,strm,lane,chan)
      pLine = pLine + '\nadd wave -noupdate -group MGR{0} -group STRM{1} -group SDPR -radix hexadecimal {{/top/system_inst/manager_array_inst/mgr_inst[{0}]/manager/mrc_cntl_strm_inst[{1}]/mrc_cntl/sdp_cntl/sdp_request_cntl/pbc_bank_last_requested}}'.format(mgr,strm,lane,chan)
      pLine = pLine + '\nadd wave -noupdate -group MGR{0} -group STRM{1} -group SDPR -radix hexadecimal {{/top/system_inst/manager_array_inst/mgr_inst[{0}]/manager/mrc_cntl_strm_inst[{1}]/mrc_cntl/sdp_cntl/sdp_request_cntl/pbc_page_last_requested}}'.format(mgr,strm,lane,chan)
      pLine = pLine + '\nadd wave -noupdate -group MGR{0} -group STRM{1} -group SDPR -radix hexadecimal {{/top/system_inst/manager_array_inst/mgr_inst[{0}]/manager/mrc_cntl_strm_inst[{1}]/mrc_cntl/sdp_cntl/sdp_request_cntl/requests_complete}}'.format(mgr,strm,lane,chan)
      pLine = pLine + '\nadd wave -noupdate -group MGR{0} -group STRM{1} -group SDPR -radix hexadecimal {{/top/system_inst/manager_array_inst/mgr_inst[{0}]/manager/mrc_cntl_strm_inst[{1}]/mrc_cntl/sdp_cntl/sdp_request_cntl/reset_poweron}}'.format(mgr,strm,lane,chan)
      pLine = pLine + '\nadd wave -noupdate -group MGR{0} -group STRM{1} -group SDPR -radix hexadecimal {{/top/system_inst/manager_array_inst/mgr_inst[{0}]/manager/mrc_cntl_strm_inst[{1}]/mrc_cntl/sdp_cntl/sdp_request_cntl/sdmem_AccessOrder}}'.format(mgr,strm,lane,chan)
      pLine = pLine + '\nadd wave -noupdate -group MGR{0} -group STRM{1} -group SDPR -radix hexadecimal {{/top/system_inst/manager_array_inst/mgr_inst[{0}]/manager/mrc_cntl_strm_inst[{1}]/mrc_cntl/sdp_cntl/sdp_request_cntl/sdmem_Address}}'.format(mgr,strm,lane,chan)
      pLine = pLine + '\nadd wave -noupdate -group MGR{0} -group STRM{1} -group SDPR -radix hexadecimal {{/top/system_inst/manager_array_inst/mgr_inst[{0}]/manager/mrc_cntl_strm_inst[{1}]/mrc_cntl/sdp_cntl/sdp_request_cntl/sdmem_consJump}}'.format(mgr,strm,lane,chan)
      pLine = pLine + '\nadd wave -noupdate -group MGR{0} -group STRM{1} -group SDPR -radix hexadecimal {{/top/system_inst/manager_array_inst/mgr_inst[{0}]/manager/mrc_cntl_strm_inst[{1}]/mrc_cntl/sdp_cntl/sdp_request_cntl/sdmem_consJumpCntl}}'.format(mgr,strm,lane,chan)
      pLine = pLine + '\nadd wave -noupdate -group MGR{0} -group STRM{1} -group SDPR -radix hexadecimal {{/top/system_inst/manager_array_inst/mgr_inst[{0}]/manager/mrc_cntl_strm_inst[{1}]/mrc_cntl/sdp_cntl/sdp_request_cntl/sdmem_consJumpPtr}}'.format(mgr,strm,lane,chan)
      pLine = pLine + '\nadd wave -noupdate -group MGR{0} -group STRM{1} -group SDPR -radix hexadecimal {{/top/system_inst/manager_array_inst/mgr_inst[{0}]/manager/mrc_cntl_strm_inst[{1}]/mrc_cntl/sdp_cntl/sdp_request_cntl/sdp__xxx__mem_request_bank}}'.format(mgr,strm,lane,chan)
      pLine = pLine + '\nadd wave -noupdate -group MGR{0} -group STRM{1} -group SDPR -radix hexadecimal {{/top/system_inst/manager_array_inst/mgr_inst[{0}]/manager/mrc_cntl_strm_inst[{1}]/mrc_cntl/sdp_cntl/sdp_request_cntl/sdp__xxx__mem_request_channel}}'.format(mgr,strm,lane,chan)
      pLine = pLine + '\nadd wave -noupdate -group MGR{0} -group STRM{1} -group SDPR -radix hexadecimal {{/top/system_inst/manager_array_inst/mgr_inst[{0}]/manager/mrc_cntl_strm_inst[{1}]/mrc_cntl/sdp_cntl/sdp_request_cntl/sdp__xxx__mem_request_cntl}}'.format(mgr,strm,lane,chan)
      pLine = pLine + '\nadd wave -noupdate -group MGR{0} -group STRM{1} -group SDPR -radix hexadecimal {{/top/system_inst/manager_array_inst/mgr_inst[{0}]/manager/mrc_cntl_strm_inst[{1}]/mrc_cntl/sdp_cntl/sdp_request_cntl/sdp__xxx__mem_request_page}}'.format(mgr,strm,lane,chan)
      pLine = pLine + '\nadd wave -noupdate -group MGR{0} -group STRM{1} -group SDPR -radix hexadecimal {{/top/system_inst/manager_array_inst/mgr_inst[{0}]/manager/mrc_cntl_strm_inst[{1}]/mrc_cntl/sdp_cntl/sdp_request_cntl/sdp__xxx__mem_request_valid}}'.format(mgr,strm,lane,chan)
      pLine = pLine + '\nadd wave -noupdate -group MGR{0} -group STRM{1} -group SDPR -radix hexadecimal {{/top/system_inst/manager_array_inst/mgr_inst[{0}]/manager/mrc_cntl_strm_inst[{1}]/mrc_cntl/sdp_cntl/sdp_request_cntl/sdp__xxx__mem_request_word}}'.format(mgr,strm,lane,chan)
      pLine = pLine + '\nadd wave -noupdate -group MGR{0} -group STRM{1} -group SDPR -radix hexadecimal {{/top/system_inst/manager_array_inst/mgr_inst[{0}]/manager/mrc_cntl_strm_inst[{1}]/mrc_cntl/sdp_cntl/sdp_request_cntl/sdp__xxx__storage_desc_processing_complete}}'.format(mgr,strm,lane,chan)
      pLine = pLine + '\nadd wave -noupdate -group MGR{0} -group STRM{1} -group SDPR -radix hexadecimal {{/top/system_inst/manager_array_inst/mgr_inst[{0}]/manager/mrc_cntl_strm_inst[{1}]/mrc_cntl/sdp_cntl/sdp_request_cntl/sdp_cntl_proc_storage_desc_state}}'.format(mgr,strm,lane,chan)
      pLine = pLine + '\nadd wave -noupdate -group MGR{0} -group STRM{1} -group SDPR -radix hexadecimal {{/top/system_inst/manager_array_inst/mgr_inst[{0}]/manager/mrc_cntl_strm_inst[{1}]/mrc_cntl/sdp_cntl/sdp_request_cntl/sdp_cntl_proc_storage_desc_state_next}}'.format(mgr,strm,lane,chan)
      pLine = pLine + '\nadd wave -noupdate -group MGR{0} -group STRM{1} -group SDPR -radix hexadecimal {{/top/system_inst/manager_array_inst/mgr_inst[{0}]/manager/mrc_cntl_strm_inst[{1}]/mrc_cntl/sdp_cntl/sdp_request_cntl/sdpr__sdps__cfg_accessOrder}}'.format(mgr,strm,lane,chan)
      pLine = pLine + '\nadd wave -noupdate -group MGR{0} -group STRM{1} -group SDPR -radix hexadecimal {{/top/system_inst/manager_array_inst/mgr_inst[{0}]/manager/mrc_cntl_strm_inst[{1}]/mrc_cntl/sdp_cntl/sdp_request_cntl/sdpr__sdps__cfg_addr}}'.format(mgr,strm,lane,chan)
      pLine = pLine + '\nadd wave -noupdate -group MGR{0} -group STRM{1} -group SDPR -radix hexadecimal {{/top/system_inst/manager_array_inst/mgr_inst[{0}]/manager/mrc_cntl_strm_inst[{1}]/mrc_cntl/sdp_cntl/sdp_request_cntl/sdpr__sdps__cfg_valid}}'.format(mgr,strm,lane,chan)
      pLine = pLine + '\nadd wave -noupdate -group MGR{0} -group STRM{1} -group SDPR -radix hexadecimal {{/top/system_inst/manager_array_inst/mgr_inst[{0}]/manager/mrc_cntl_strm_inst[{1}]/mrc_cntl/sdp_cntl/sdp_request_cntl/sdpr__sdps__complete}}'.format(mgr,strm,lane,chan)
      pLine = pLine + '\nadd wave -noupdate -group MGR{0} -group STRM{1} -group SDPR -radix hexadecimal {{/top/system_inst/manager_array_inst/mgr_inst[{0}]/manager/mrc_cntl_strm_inst[{1}]/mrc_cntl/sdp_cntl/sdp_request_cntl/sdpr__sdps__consJump_cntl}}'.format(mgr,strm,lane,chan)
      pLine = pLine + '\nadd wave -noupdate -group MGR{0} -group STRM{1} -group SDPR -radix hexadecimal {{/top/system_inst/manager_array_inst/mgr_inst[{0}]/manager/mrc_cntl_strm_inst[{1}]/mrc_cntl/sdp_cntl/sdp_request_cntl/sdpr__sdps__consJump_valid}}'.format(mgr,strm,lane,chan)
      pLine = pLine + '\nadd wave -noupdate -group MGR{0} -group STRM{1} -group SDPR -radix hexadecimal {{/top/system_inst/manager_array_inst/mgr_inst[{0}]/manager/mrc_cntl_strm_inst[{1}]/mrc_cntl/sdp_cntl/sdp_request_cntl/sdpr__sdps__consJump_value}}'.format(mgr,strm,lane,chan)
      pLine = pLine + '\nadd wave -noupdate -group MGR{0} -group STRM{1} -group SDPR -radix hexadecimal {{/top/system_inst/manager_array_inst/mgr_inst[{0}]/manager/mrc_cntl_strm_inst[{1}]/mrc_cntl/sdp_cntl/sdp_request_cntl/sdpr__sdps__response_id_bank}}'.format(mgr,strm,lane,chan)
      pLine = pLine + '\nadd wave -noupdate -group MGR{0} -group STRM{1} -group SDPR -radix hexadecimal {{/top/system_inst/manager_array_inst/mgr_inst[{0}]/manager/mrc_cntl_strm_inst[{1}]/mrc_cntl/sdp_cntl/sdp_request_cntl/sdpr__sdps__response_id_bank_e1}}'.format(mgr,strm,lane,chan)
      pLine = pLine + '\nadd wave -noupdate -group MGR{0} -group STRM{1} -group SDPR -radix hexadecimal {{/top/system_inst/manager_array_inst/mgr_inst[{0}]/manager/mrc_cntl_strm_inst[{1}]/mrc_cntl/sdp_cntl/sdp_request_cntl/sdpr__sdps__response_id_channel}}'.format(mgr,strm,lane,chan)
      pLine = pLine + '\nadd wave -noupdate -group MGR{0} -group STRM{1} -group SDPR -radix hexadecimal {{/top/system_inst/manager_array_inst/mgr_inst[{0}]/manager/mrc_cntl_strm_inst[{1}]/mrc_cntl/sdp_cntl/sdp_request_cntl/sdpr__sdps__response_id_channel_e1}}'.format(mgr,strm,lane,chan)
      pLine = pLine + '\nadd wave -noupdate -group MGR{0} -group STRM{1} -group SDPR -radix hexadecimal {{/top/system_inst/manager_array_inst/mgr_inst[{0}]/manager/mrc_cntl_strm_inst[{1}]/mrc_cntl/sdp_cntl/sdp_request_cntl/sdpr__sdps__response_id_cntl}}'.format(mgr,strm,lane,chan)
      pLine = pLine + '\nadd wave -noupdate -group MGR{0} -group STRM{1} -group SDPR -radix hexadecimal {{/top/system_inst/manager_array_inst/mgr_inst[{0}]/manager/mrc_cntl_strm_inst[{1}]/mrc_cntl/sdp_cntl/sdp_request_cntl/sdpr__sdps__response_id_cntl_e1}}'.format(mgr,strm,lane,chan)
      pLine = pLine + '\nadd wave -noupdate -group MGR{0} -group STRM{1} -group SDPR -radix hexadecimal {{/top/system_inst/manager_array_inst/mgr_inst[{0}]/manager/mrc_cntl_strm_inst[{1}]/mrc_cntl/sdp_cntl/sdp_request_cntl/sdpr__sdps__response_id_line}}'.format(mgr,strm,lane,chan)
      pLine = pLine + '\nadd wave -noupdate -group MGR{0} -group STRM{1} -group SDPR -radix hexadecimal {{/top/system_inst/manager_array_inst/mgr_inst[{0}]/manager/mrc_cntl_strm_inst[{1}]/mrc_cntl/sdp_cntl/sdp_request_cntl/sdpr__sdps__response_id_line_e1}}'.format(mgr,strm,lane,chan)
      pLine = pLine + '\nadd wave -noupdate -group MGR{0} -group STRM{1} -group SDPR -radix hexadecimal {{/top/system_inst/manager_array_inst/mgr_inst[{0}]/manager/mrc_cntl_strm_inst[{1}]/mrc_cntl/sdp_cntl/sdp_request_cntl/sdpr__sdps__response_id_page}}'.format(mgr,strm,lane,chan)
      pLine = pLine + '\nadd wave -noupdate -group MGR{0} -group STRM{1} -group SDPR -radix hexadecimal {{/top/system_inst/manager_array_inst/mgr_inst[{0}]/manager/mrc_cntl_strm_inst[{1}]/mrc_cntl/sdp_cntl/sdp_request_cntl/sdpr__sdps__response_id_page_e1}}'.format(mgr,strm,lane,chan)
      pLine = pLine + '\nadd wave -noupdate -group MGR{0} -group STRM{1} -group SDPR -radix hexadecimal {{/top/system_inst/manager_array_inst/mgr_inst[{0}]/manager/mrc_cntl_strm_inst[{1}]/mrc_cntl/sdp_cntl/sdp_request_cntl/sdpr__sdps__response_id_valid}}'.format(mgr,strm,lane,chan)
      pLine = pLine + '\nadd wave -noupdate -group MGR{0} -group STRM{1} -group SDPR -radix hexadecimal {{/top/system_inst/manager_array_inst/mgr_inst[{0}]/manager/mrc_cntl_strm_inst[{1}]/mrc_cntl/sdp_cntl/sdp_request_cntl/sdpr__sdps__response_id_valid_e1}}'.format(mgr,strm,lane,chan)
      pLine = pLine + '\nadd wave -noupdate -group MGR{0} -group STRM{1} -group SDPR -radix hexadecimal {{/top/system_inst/manager_array_inst/mgr_inst[{0}]/manager/mrc_cntl_strm_inst[{1}]/mrc_cntl/sdp_cntl/sdp_request_cntl/sdps__sdpr__cfg_ready}}'.format(mgr,strm,lane,chan)
      pLine = pLine + '\nadd wave -noupdate -group MGR{0} -group STRM{1} -group SDPR -radix hexadecimal {{/top/system_inst/manager_array_inst/mgr_inst[{0}]/manager/mrc_cntl_strm_inst[{1}]/mrc_cntl/sdp_cntl/sdp_request_cntl/sdps__sdpr__complete}}'.format(mgr,strm,lane,chan)
      pLine = pLine + '\nadd wave -noupdate -group MGR{0} -group STRM{1} -group SDPR -radix hexadecimal {{/top/system_inst/manager_array_inst/mgr_inst[{0}]/manager/mrc_cntl_strm_inst[{1}]/mrc_cntl/sdp_cntl/sdp_request_cntl/sdps__sdpr__consJump_ready}}'.format(mgr,strm,lane,chan)
      pLine = pLine + '\nadd wave -noupdate -group MGR{0} -group STRM{1} -group SDPR -radix hexadecimal {{/top/system_inst/manager_array_inst/mgr_inst[{0}]/manager/mrc_cntl_strm_inst[{1}]/mrc_cntl/sdp_cntl/sdp_request_cntl/sdps__sdpr__response_id_ready}}'.format(mgr,strm,lane,chan)
      pLine = pLine + '\nadd wave -noupdate -group MGR{0} -group STRM{1} -group SDPR -radix hexadecimal {{/top/system_inst/manager_array_inst/mgr_inst[{0}]/manager/mrc_cntl_strm_inst[{1}]/mrc_cntl/sdp_cntl/sdp_request_cntl/sdps__sdpr__response_id_ready_d1}}'.format(mgr,strm,lane,chan)
      pLine = pLine + '\nadd wave -noupdate -group MGR{0} -group STRM{1} -group SDPR -radix hexadecimal {{/top/system_inst/manager_array_inst/mgr_inst[{0}]/manager/mrc_cntl_strm_inst[{1}]/mrc_cntl/sdp_cntl/sdp_request_cntl/storage_desc_accessOrder}}'.format(mgr,strm,lane,chan)
      pLine = pLine + '\nadd wave -noupdate -group MGR{0} -group STRM{1} -group SDPR -radix hexadecimal {{/top/system_inst/manager_array_inst/mgr_inst[{0}]/manager/mrc_cntl_strm_inst[{1}]/mrc_cntl/sdp_cntl/sdp_request_cntl/storage_desc_address}}'.format(mgr,strm,lane,chan)
      pLine = pLine + '\nadd wave -noupdate -group MGR{0} -group STRM{1} -group SDPR -radix hexadecimal {{/top/system_inst/manager_array_inst/mgr_inst[{0}]/manager/mrc_cntl_strm_inst[{1}]/mrc_cntl/sdp_cntl/sdp_request_cntl/storage_desc_bank}}'.format(mgr,strm,lane,chan)
      pLine = pLine + '\nadd wave -noupdate -group MGR{0} -group STRM{1} -group SDPR -radix hexadecimal {{/top/system_inst/manager_array_inst/mgr_inst[{0}]/manager/mrc_cntl_strm_inst[{1}]/mrc_cntl/sdp_cntl/sdp_request_cntl/storage_desc_bank_lsb}}'.format(mgr,strm,lane,chan)
      pLine = pLine + '\nadd wave -noupdate -group MGR{0} -group STRM{1} -group SDPR -radix hexadecimal {{/top/system_inst/manager_array_inst/mgr_inst[{0}]/manager/mrc_cntl_strm_inst[{1}]/mrc_cntl/sdp_cntl/sdp_request_cntl/storage_desc_channel}}'.format(mgr,strm,lane,chan)
      pLine = pLine + '\nadd wave -noupdate -group MGR{0} -group STRM{1} -group SDPR -radix hexadecimal {{/top/system_inst/manager_array_inst/mgr_inst[{0}]/manager/mrc_cntl_strm_inst[{1}]/mrc_cntl/sdp_cntl/sdp_request_cntl/storage_desc_cline}}'.format(mgr,strm,lane,chan)
      pLine = pLine + '\nadd wave -noupdate -group MGR{0} -group STRM{1} -group SDPR -radix hexadecimal {{/top/system_inst/manager_array_inst/mgr_inst[{0}]/manager/mrc_cntl_strm_inst[{1}]/mrc_cntl/sdp_cntl/sdp_request_cntl/storage_desc_consJumpPtr}}'.format(mgr,strm,lane,chan)
      pLine = pLine + '\nadd wave -noupdate -group MGR{0} -group STRM{1} -group SDPR -radix hexadecimal {{/top/system_inst/manager_array_inst/mgr_inst[{0}]/manager/mrc_cntl_strm_inst[{1}]/mrc_cntl/sdp_cntl/sdp_request_cntl/storage_desc_local_address}}'.format(mgr,strm,lane,chan)
      pLine = pLine + '\nadd wave -noupdate -group MGR{0} -group STRM{1} -group SDPR -radix hexadecimal {{/top/system_inst/manager_array_inst/mgr_inst[{0}]/manager/mrc_cntl_strm_inst[{1}]/mrc_cntl/sdp_cntl/sdp_request_cntl/storage_desc_mgr}}'.format(mgr,strm,lane,chan)
      pLine = pLine + '\nadd wave -noupdate -group MGR{0} -group STRM{1} -group SDPR -radix hexadecimal {{/top/system_inst/manager_array_inst/mgr_inst[{0}]/manager/mrc_cntl_strm_inst[{1}]/mrc_cntl/sdp_cntl/sdp_request_cntl/storage_desc_page}}'.format(mgr,strm,lane,chan)
      pLine = pLine + '\nadd wave -noupdate -group MGR{0} -group STRM{1} -group SDPR -radix hexadecimal {{/top/system_inst/manager_array_inst/mgr_inst[{0}]/manager/mrc_cntl_strm_inst[{1}]/mrc_cntl/sdp_cntl/sdp_request_cntl/storage_desc_word}}'.format(mgr,strm,lane,chan)
      pLine = pLine + '\nadd wave -noupdate -group MGR{0} -group STRM{1} -group SDPR -radix hexadecimal {{/top/system_inst/manager_array_inst/mgr_inst[{0}]/manager/mrc_cntl_strm_inst[{1}]/mrc_cntl/sdp_cntl/sdp_request_cntl/strm_transfer_type}}'.format(mgr,strm,lane,chan)
      pLine = pLine + '\nadd wave -noupdate -group MGR{0} -group STRM{1} -group SDPR -radix hexadecimal {{/top/system_inst/manager_array_inst/mgr_inst[{0}]/manager/mrc_cntl_strm_inst[{1}]/mrc_cntl/sdp_cntl/sdp_request_cntl/sys__mgr__mgrId}}'.format(mgr,strm,lane,chan)
      pLine = pLine + '\nadd wave -noupdate -group MGR{0} -group STRM{1} -group SDPR -radix hexadecimal {{/top/system_inst/manager_array_inst/mgr_inst[{0}]/manager/mrc_cntl_strm_inst[{1}]/mrc_cntl/sdp_cntl/sdp_request_cntl/to_strm_fsm_fifo_ready}}'.format(mgr,strm,lane,chan)
      pLine = pLine + '\nadd wave -noupdate -group MGR{0} -group STRM{1} -group SDPR -radix hexadecimal {{/top/system_inst/manager_array_inst/mgr_inst[{0}]/manager/mrc_cntl_strm_inst[{1}]/mrc_cntl/sdp_cntl/sdp_request_cntl/xxx__sdp__lane_enable}}'.format(mgr,strm,lane,chan)
      pLine = pLine + '\nadd wave -noupdate -group MGR{0} -group STRM{1} -group SDPR -radix hexadecimal {{/top/system_inst/manager_array_inst/mgr_inst[{0}]/manager/mrc_cntl_strm_inst[{1}]/mrc_cntl/sdp_cntl/sdp_request_cntl/xxx__sdp__mem_request_ready}}'.format(mgr,strm,lane,chan)
      pLine = pLine + '\nadd wave -noupdate -group MGR{0} -group STRM{1} -group SDPR -radix hexadecimal {{/top/system_inst/manager_array_inst/mgr_inst[{0}]/manager/mrc_cntl_strm_inst[{1}]/mrc_cntl/sdp_cntl/sdp_request_cntl/xxx__sdp__mem_request_ready_d1}}'.format(mgr,strm,lane,chan)
      pLine = pLine + '\nadd wave -noupdate -group MGR{0} -group STRM{1} -group SDPR -radix hexadecimal {{/top/system_inst/manager_array_inst/mgr_inst[{0}]/manager/mrc_cntl_strm_inst[{1}]/mrc_cntl/sdp_cntl/sdp_request_cntl/xxx__sdp__num_lanes}}'.format(mgr,strm,lane,chan)
      pLine = pLine + '\nadd wave -noupdate -group MGR{0} -group STRM{1} -group SDPR -radix hexadecimal {{/top/system_inst/manager_array_inst/mgr_inst[{0}]/manager/mrc_cntl_strm_inst[{1}]/mrc_cntl/sdp_cntl/sdp_request_cntl/xxx__sdp__num_lanes_m1}}'.format(mgr,strm,lane,chan)
      pLine = pLine + '\nadd wave -noupdate -group MGR{0} -group STRM{1} -group SDPR -radix hexadecimal {{/top/system_inst/manager_array_inst/mgr_inst[{0}]/manager/mrc_cntl_strm_inst[{1}]/mrc_cntl/sdp_cntl/sdp_request_cntl/xxx__sdp__storage_desc_processing_enable}}'.format(mgr,strm,lane,chan)
      pLine = pLine + '\nadd wave -noupdate -group MGR{0} -group STRM{1} -group SDPR -radix hexadecimal {{/top/system_inst/manager_array_inst/mgr_inst[{0}]/manager/mrc_cntl_strm_inst[{1}]/mrc_cntl/sdp_cntl/sdp_request_cntl/xxx__sdp__storage_desc_ptr}}'.format(mgr,strm,lane,chan)
      pLine = pLine + '\nadd wave -noupdate -group MGR{0} -group STRM{1} -group SDPR -radix hexadecimal {{/top/system_inst/manager_array_inst/mgr_inst[{0}]/manager/mrc_cntl_strm_inst[{1}]/mrc_cntl/sdp_cntl/sdp_request_cntl/xxx__sdp__txfer_type}}'.format(mgr,strm,lane,chan)
  ...
  for mgr in range (0, numOfMgr):
    for strm in range (0, numOfStrms):
      for lane in [0,7,15,23,31] :
        pLine = pLine + '\nadd wave -noupdate -group MGR{0} -group SDPS -group LANE{2} -group STRM01 -radix hexadecimal {{/top/system_inst/pe_array_inst/pe_inst[{0}]/pe/stOp_lane[{2}]/streamingOps_datapath/sti__stOp__strm{1}_data_valid}}'.format(mgr,strm,lane)
        pLine = pLine + '\nadd wave -noupdate -group MGR{0} -group SDPS -group LANE{2} -group STRM01 -radix hexadecimal {{/top/system_inst/pe_array_inst/pe_inst[{0}]/pe/stOp_lane[{2}]/streamingOps_datapath/sti__stOp__strm{1}_cntl}}'.format(mgr,strm,lane)
        pLine = pLine + '\nadd wave -noupdate -group MGR{0} -group SDPS -group LANE{2} -group STRM01 -radix hexadecimal {{/top/system_inst/pe_array_inst/pe_inst[{0}]/pe/stOp_lane[{2}]/streamingOps_datapath/sti__stOp__strm{1}_data}}'.format(mgr,strm,lane)
        pLine = pLine + '\nadd wave -noupdate -group MGR{0} -group SDPS -group LANE{2} -group STRM01 -radix hexadecimal {{/top/system_inst/pe_array_inst/pe_inst[{0}]/pe/stOp_lane[{2}]/streamingOps_datapath/stOp__sti__strm{1}_ready}}'.format(mgr,strm,lane)
      #
      pLine = pLine + '\nadd wave -noupdate -group MGR{0} -group STRM{1} -group SDPS -radix hexadecimal {{/top/system_inst/manager_array_inst/mgr_inst[{0}]/manager/mrc_cntl_strm_inst[{1}]/mrc_cntl/sdp_cntl/sdp_stream_cntl/xxx__sdp__lane_ready}}'.format(mgr,strm,lane)
      pLine = pLine + '\nadd wave -noupdate -group MGR{0} -group STRM{1} -group SDPS -radix hexadecimal {{/top/system_inst/manager_array_inst/mgr_inst[{0}]/manager/mrc_cntl_strm_inst[{1}]/mrc_cntl/sdp_cntl/sdp_stream_cntl/sdp_cntl_stream_cntl_state}}'.format(mgr,strm,lane)
      pLine = pLine + '\nadd wave -noupdate -group MGR{0} -group STRM{1} -group SDPS -radix hexadecimal {{/top/system_inst/manager_array_inst/mgr_inst[{0}]/manager/mrc_cntl_strm_inst[{1}]/mrc_cntl/sdp_cntl/sdp_stream_cntl/sdp_cntl_stream_cntl_state_next}}'.format(mgr,strm,lane)
      pLine = pLine + '\nadd wave -noupdate -group MGR{0} -group STRM{1} -group SDPS -radix hexadecimal {{/top/system_inst/manager_array_inst/mgr_inst[{0}]/manager/mrc_cntl_strm_inst[{1}]/mrc_cntl/sdp_cntl/sdp_stream_cntl/all_lanes_complete}}'.format(mgr,strm,lane)
      pLine = pLine + '\nadd wave -noupdate -group MGR{0} -group STRM{1} -group SDPS -radix hexadecimal {{/top/system_inst/manager_array_inst/mgr_inst[{0}]/manager/mrc_cntl_strm_inst[{1}]/mrc_cntl/sdp_cntl/sdp_stream_cntl/running}}'.format(mgr,strm,lane)
      pLine = pLine + '\nadd wave -noupdate -group MGR{0} -group STRM{1} -group SDPS -radix hexadecimal {{/top/system_inst/manager_array_inst/mgr_inst[{0}]/manager/mrc_cntl_strm_inst[{1}]/mrc_cntl/sdp_cntl/sdp_stream_cntl/flush_complete}}'.format(mgr,strm,lane)
      pLine = pLine + '\nadd wave -noupdate -group MGR{0} -group STRM{1} -group SDPS -radix hexadecimal {{/top/system_inst/manager_array_inst/mgr_inst[{0}]/manager/mrc_cntl_strm_inst[{1}]/mrc_cntl/sdp_cntl/sdp_stream_cntl/force_flush}}'.format(mgr,strm,lane)
      pLine = pLine + '\nadd wave -noupdate -group MGR{0} -group STRM{1} -group SDPS -radix hexadecimal {{/top/system_inst/manager_array_inst/mgr_inst[{0}]/manager/mrc_cntl_strm_inst[{1}]/mrc_cntl/sdp_cntl/sdp_stream_cntl/request_read_diff}}'.format(mgr,strm,lane)
      pLine = pLine + '\nadd wave -noupdate -group MGR{0} -group STRM{1} -group SDPS -radix hexadecimal {{/top/system_inst/manager_array_inst/mgr_inst[{0}]/manager/mrc_cntl_strm_inst[{1}]/mrc_cntl/sdp_cntl/sdp_stream_cntl/request_read_diff_eq0}}'.format(mgr,strm,lane)
      pLine = pLine + '\nadd wave -noupdate -group MGR{0} -group STRM{1} -group SDPS -radix hexadecimal {{/top/system_inst/manager_array_inst/mgr_inst[{0}]/manager/mrc_cntl_strm_inst[{1}]/mrc_cntl/sdp_cntl/sdp_stream_cntl/request_read_diff_gt0}}'.format(mgr,strm,lane)
      pLine = pLine + '\nadd wave -noupdate -group MGR{0} -group STRM{1} -group SDPS -radix hexadecimal {{/top/system_inst/manager_array_inst/mgr_inst[{0}]/manager/mrc_cntl_strm_inst[{1}]/mrc_cntl/sdp_cntl/sdp_stream_cntl/request_read_diff_lt0}}'.format(mgr,strm,lane)
      pLine = pLine + '\nadd wave -noupdate -group MGR{0} -group STRM{1} -group SDPS -group FROM_MMC -radix hexadecimal {{/top/system_inst/manager_array_inst/mgr_inst[{0}]/manager/mrc_cntl_strm_inst[{1}]/mrc_cntl/from_mmc_fifo[0]/write}}'.format(mgr,strm,lane)
      pLine = pLine + '\nadd wave -noupdate -group MGR{0} -group STRM{1} -group SDPS -group FROM_MMC -radix hexadecimal {{/top/system_inst/manager_array_inst/mgr_inst[{0}]/manager/mrc_cntl_strm_inst[{1}]/mrc_cntl/from_mmc_fifo[0]/pipe_valid}}'.format(mgr,strm,lane)
      pLine = pLine + '\nadd wave -noupdate -group MGR{0} -group STRM{1} -group SDPS -group FROM_MMC -radix hexadecimal {{/top/system_inst/manager_array_inst/mgr_inst[{0}]/manager/mrc_cntl_strm_inst[{1}]/mrc_cntl/from_mmc_fifo[0]/pipe_data}}'.format(mgr,strm,lane)
      pLine = pLine + '\nadd wave -noupdate -group MGR{0} -group STRM{1} -group SDPS -group FROM_MMC -radix hexadecimal {{/top/system_inst/manager_array_inst/mgr_inst[{0}]/manager/mrc_cntl_strm_inst[{1}]/mrc_cntl/from_mmc_fifo[0]/pipe_read}}'.format(mgr,strm,lane)
      pLine = pLine + '\nadd wave -noupdate -group MGR{0} -group STRM{1} -group SDPS -group FROM_MMC -radix hexadecimal {{/top/system_inst/manager_array_inst/mgr_inst[{0}]/manager/mrc_cntl_strm_inst[{1}]/mrc_cntl/from_mmc_fifo[1]/write}}'.format(mgr,strm,lane)
      pLine = pLine + '\nadd wave -noupdate -group MGR{0} -group STRM{1} -group SDPS -group FROM_MMC -radix hexadecimal {{/top/system_inst/manager_array_inst/mgr_inst[{0}]/manager/mrc_cntl_strm_inst[{1}]/mrc_cntl/from_mmc_fifo[1]/pipe_valid}}'.format(mgr,strm,lane)
      pLine = pLine + '\nadd wave -noupdate -group MGR{0} -group STRM{1} -group SDPS -group FROM_MMC -radix hexadecimal {{/top/system_inst/manager_array_inst/mgr_inst[{0}]/manager/mrc_cntl_strm_inst[{1}]/mrc_cntl/from_mmc_fifo[1]/pipe_data}}'.format(mgr,strm,lane)
      pLine = pLine + '\nadd wave -noupdate -group MGR{0} -group STRM{1} -group SDPS -group FROM_MMC -radix hexadecimal {{/top/system_inst/manager_array_inst/mgr_inst[{0}]/manager/mrc_cntl_strm_inst[{1}]/mrc_cntl/from_mmc_fifo[1]/pipe_read}}'.format(mgr,strm,lane)
      pLine = pLine + '\nadd wave -noupdate -group MGR{0} -group STRM{1} -group SDPS -group RESPONSE_ID -radix hexadecimal {{/top/system_inst/manager_array_inst/mgr_inst[{0}]/manager/mrc_cntl_strm_inst[{1}]/mrc_cntl/sdp_cntl/sdp_stream_cntl/response_id_fifo[0]/write}}'.format(mgr,strm,lane)
      pLine = pLine + '\nadd wave -noupdate -group MGR{0} -group STRM{1} -group SDPS -group RESPONSE_ID -radix hexadecimal {{/top/system_inst/manager_array_inst/mgr_inst[{0}]/manager/mrc_cntl_strm_inst[{1}]/mrc_cntl/sdp_cntl/sdp_stream_cntl/response_id_fifo[0]/pipe_valid}}'.format(mgr,strm,lane)
      pLine = pLine + '\nadd wave -noupdate -group MGR{0} -group STRM{1} -group SDPS -group RESPONSE_ID -radix hexadecimal {{/top/system_inst/manager_array_inst/mgr_inst[{0}]/manager/mrc_cntl_strm_inst[{1}]/mrc_cntl/sdp_cntl/sdp_stream_cntl/response_id_fifo[0]/pipe_cntl}}'.format(mgr,strm,lane)
      pLine = pLine + '\nadd wave -noupdate -group MGR{0} -group STRM{1} -group SDPS -group RESPONSE_ID -radix hexadecimal {{/top/system_inst/manager_array_inst/mgr_inst[{0}]/manager/mrc_cntl_strm_inst[{1}]/mrc_cntl/sdp_cntl/sdp_stream_cntl/response_id_fifo[0]/pipe_bank}}'.format(mgr,strm,lane)
      pLine = pLine + '\nadd wave -noupdate -group MGR{0} -group STRM{1} -group SDPS -group RESPONSE_ID -radix hexadecimal {{/top/system_inst/manager_array_inst/mgr_inst[{0}]/manager/mrc_cntl_strm_inst[{1}]/mrc_cntl/sdp_cntl/sdp_stream_cntl/response_id_fifo[0]/pipe_page}}'.format(mgr,strm,lane)
      pLine = pLine + '\nadd wave -noupdate -group MGR{0} -group STRM{1} -group SDPS -group RESPONSE_ID -radix hexadecimal {{/top/system_inst/manager_array_inst/mgr_inst[{0}]/manager/mrc_cntl_strm_inst[{1}]/mrc_cntl/sdp_cntl/sdp_stream_cntl/response_id_fifo[0]/pipe_line}}'.format(mgr,strm,lane)
      pLine = pLine + '\nadd wave -noupdate -group MGR{0} -group STRM{1} -group SDPS -group RESPONSE_ID -radix hexadecimal {{/top/system_inst/manager_array_inst/mgr_inst[{0}]/manager/mrc_cntl_strm_inst[{1}]/mrc_cntl/sdp_cntl/sdp_stream_cntl/response_id_fifo[0]/pipe_som}}'.format(mgr,strm,lane)
      pLine = pLine + '\nadd wave -noupdate -group MGR{0} -group STRM{1} -group SDPS -group RESPONSE_ID -radix hexadecimal {{/top/system_inst/manager_array_inst/mgr_inst[{0}]/manager/mrc_cntl_strm_inst[{1}]/mrc_cntl/sdp_cntl/sdp_stream_cntl/response_id_fifo[0]/pipe_mom}}'.format(mgr,strm,lane)
      pLine = pLine + '\nadd wave -noupdate -group MGR{0} -group STRM{1} -group SDPS -group RESPONSE_ID -radix hexadecimal {{/top/system_inst/manager_array_inst/mgr_inst[{0}]/manager/mrc_cntl_strm_inst[{1}]/mrc_cntl/sdp_cntl/sdp_stream_cntl/response_id_fifo[0]/pipe_eom}}'.format(mgr,strm,lane)
      pLine = pLine + '\nadd wave -noupdate -group MGR{0} -group STRM{1} -group SDPS -group RESPONSE_ID -radix hexadecimal {{/top/system_inst/manager_array_inst/mgr_inst[{0}]/manager/mrc_cntl_strm_inst[{1}]/mrc_cntl/sdp_cntl/sdp_stream_cntl/response_id_fifo[0]/response_id_in_progress}}'.format(mgr,strm,lane)
      pLine = pLine + '\nadd wave -noupdate -group MGR{0} -group STRM{1} -group SDPS -group RESPONSE_ID -radix hexadecimal {{/top/system_inst/manager_array_inst/mgr_inst[{0}]/manager/mrc_cntl_strm_inst[{1}]/mrc_cntl/sdp_cntl/sdp_stream_cntl/response_id_fifo[0]/pipe_read}}'.format(mgr,strm,lane)
      pLine = pLine + '\nadd wave -noupdate -group MGR{0} -group STRM{1} -group SDPS -group RESPONSE_ID -radix hexadecimal {{/top/system_inst/manager_array_inst/mgr_inst[{0}]/manager/mrc_cntl_strm_inst[{1}]/mrc_cntl/sdp_cntl/sdp_stream_cntl/response_id_fifo[1]/write}}'.format(mgr,strm,lane)
      pLine = pLine + '\nadd wave -noupdate -group MGR{0} -group STRM{1} -group SDPS -group RESPONSE_ID -radix hexadecimal {{/top/system_inst/manager_array_inst/mgr_inst[{0}]/manager/mrc_cntl_strm_inst[{1}]/mrc_cntl/sdp_cntl/sdp_stream_cntl/response_id_fifo[1]/pipe_valid}}'.format(mgr,strm,lane)
      pLine = pLine + '\nadd wave -noupdate -group MGR{0} -group STRM{1} -group SDPS -group RESPONSE_ID -radix hexadecimal {{/top/system_inst/manager_array_inst/mgr_inst[{0}]/manager/mrc_cntl_strm_inst[{1}]/mrc_cntl/sdp_cntl/sdp_stream_cntl/response_id_fifo[1]/pipe_cntl}}'.format(mgr,strm,lane)
      pLine = pLine + '\nadd wave -noupdate -group MGR{0} -group STRM{1} -group SDPS -group RESPONSE_ID -radix hexadecimal {{/top/system_inst/manager_array_inst/mgr_inst[{0}]/manager/mrc_cntl_strm_inst[{1}]/mrc_cntl/sdp_cntl/sdp_stream_cntl/response_id_fifo[1]/pipe_bank}}'.format(mgr,strm,lane)
      pLine = pLine + '\nadd wave -noupdate -group MGR{0} -group STRM{1} -group SDPS -group RESPONSE_ID -radix hexadecimal {{/top/system_inst/manager_array_inst/mgr_inst[{0}]/manager/mrc_cntl_strm_inst[{1}]/mrc_cntl/sdp_cntl/sdp_stream_cntl/response_id_fifo[1]/pipe_page}}'.format(mgr,strm,lane)
      pLine = pLine + '\nadd wave -noupdate -group MGR{0} -group STRM{1} -group SDPS -group RESPONSE_ID -radix hexadecimal {{/top/system_inst/manager_array_inst/mgr_inst[{0}]/manager/mrc_cntl_strm_inst[{1}]/mrc_cntl/sdp_cntl/sdp_stream_cntl/response_id_fifo[1]/pipe_line}}'.format(mgr,strm,lane)
      pLine = pLine + '\nadd wave -noupdate -group MGR{0} -group STRM{1} -group SDPS -group RESPONSE_ID -radix hexadecimal {{/top/system_inst/manager_array_inst/mgr_inst[{0}]/manager/mrc_cntl_strm_inst[{1}]/mrc_cntl/sdp_cntl/sdp_stream_cntl/response_id_fifo[1]/pipe_som}}'.format(mgr,strm,lane)
      pLine = pLine + '\nadd wave -noupdate -group MGR{0} -group STRM{1} -group SDPS -group RESPONSE_ID -radix hexadecimal {{/top/system_inst/manager_array_inst/mgr_inst[{0}]/manager/mrc_cntl_strm_inst[{1}]/mrc_cntl/sdp_cntl/sdp_stream_cntl/response_id_fifo[1]/pipe_mom}}'.format(mgr,strm,lane)
      pLine = pLine + '\nadd wave -noupdate -group MGR{0} -group STRM{1} -group SDPS -group RESPONSE_ID -radix hexadecimal {{/top/system_inst/manager_array_inst/mgr_inst[{0}]/manager/mrc_cntl_strm_inst[{1}]/mrc_cntl/sdp_cntl/sdp_stream_cntl/response_id_fifo[1]/pipe_eom}}'.format(mgr,strm,lane)
      pLine = pLine + '\nadd wave -noupdate -group MGR{0} -group STRM{1} -group SDPS -group RESPONSE_ID -radix hexadecimal {{/top/system_inst/manager_array_inst/mgr_inst[{0}]/manager/mrc_cntl_strm_inst[{1}]/mrc_cntl/sdp_cntl/sdp_stream_cntl/response_id_fifo[1]/response_id_in_progress}}'.format(mgr,strm,lane)
      pLine = pLine + '\nadd wave -noupdate -group MGR{0} -group STRM{1} -group SDPS -group RESPONSE_ID -radix hexadecimal {{/top/system_inst/manager_array_inst/mgr_inst[{0}]/manager/mrc_cntl_strm_inst[{1}]/mrc_cntl/sdp_cntl/sdp_stream_cntl/response_id_fifo[1]/pipe_read}}'.format(mgr,strm,lane)
      pLine = pLine + '\nadd wave -noupdate -group MGR{0} -group STRM{1} -group SDPS -radix hexadecimal {{/top/system_inst/manager_array_inst/mgr_inst[{0}]/manager/mrc_cntl_strm_inst[{1}]/mrc_cntl/sdp_cntl/sdp_stream_cntl/block_request[0]}}'.format(mgr,strm,lane)
      pLine = pLine + '\nadd wave -noupdate -group MGR{0} -group STRM{1} -group SDPS -radix hexadecimal {{/top/system_inst/manager_array_inst/mgr_inst[{0}]/manager/mrc_cntl_strm_inst[{1}]/mrc_cntl/sdp_cntl/sdp_stream_cntl/block_request[1]}}'.format(mgr,strm,lane)
      #                                                                                  
      pLine = pLine + '\nadd wave -noupdate -group MGR{0} -group STRM{1} -group SDPS -radix hexadecimal {{/top/system_inst/manager_array_inst/mgr_inst[{0}]/manager/mrc_cntl_strm_inst[{1}]/mrc_cntl/sdp_cntl/sdp_stream_cntl/get_next_line[0]}}'.format(mgr,strm,lane)
      pLine = pLine + '\nadd wave -noupdate -group MGR{0} -group STRM{1} -group SDPS -radix hexadecimal {{/top/system_inst/manager_array_inst/mgr_inst[{0}]/manager/mrc_cntl_strm_inst[{1}]/mrc_cntl/sdp_cntl/sdp_stream_cntl/get_next_line[1]}}'.format(mgr,strm,lane)
      #                                                                                  
      pLine = pLine + '\nadd wave -noupdate -group MGR{0} -group STRM{1} -group SDPS -radix hexadecimal {{/top/system_inst/manager_array_inst/mgr_inst[{0}]/manager/mrc_cntl_strm_inst[{1}]/mrc_cntl/sdp_cntl/sdp_stream_cntl/sdp__xxx__get_next_line[0]}} '.format(mgr,strm,lane)
      pLine = pLine + '\nadd wave -noupdate -group MGR{0} -group STRM{1} -group SDPS -radix hexadecimal {{/top/system_inst/manager_array_inst/mgr_inst[{0}]/manager/mrc_cntl_strm_inst[{1}]/mrc_cntl/sdp_cntl/sdp_stream_cntl/all_lanes_complete}}'.format(mgr,strm,lane)
      #                                                                                  
      pLine = pLine + '\nadd wave -noupdate -group MGR{0} -group STRM{1} -group SDPS -radix hexadecimal {{/top/system_inst/manager_array_inst/mgr_inst[{0}]/manager/mrc_cntl_strm_inst[{1}]/mrc_cntl/sdp_cntl/sdp_stream_cntl/lanes_req_next_line[0][{2}]}}'.format(mgr,strm,lane)
      pLine = pLine + '\nadd wave -noupdate -group MGR{0} -group STRM{1} -group SDPS -radix hexadecimal {{/top/system_inst/manager_array_inst/mgr_inst[{0}]/manager/mrc_cntl_strm_inst[{1}]/mrc_cntl/sdp_cntl/sdp_stream_cntl/lanes_req_next_line[1][{2}]}}'.format(mgr,strm,lane)
      pLine = pLine + '\nadd wave -noupdate -group MGR{0} -group STRM{1} -group SDPS -radix hexadecimal {{/top/system_inst/manager_array_inst/mgr_inst[{0}]/manager/mrc_cntl_strm_inst[{1}]/mrc_cntl/sdp_cntl/sdp_stream_cntl/lanes_force_req_next_line[0][{2}]}}'.format(mgr,strm,lane)
      pLine = pLine + '\nadd wave -noupdate -group MGR{0} -group STRM{1} -group SDPS -radix hexadecimal {{/top/system_inst/manager_array_inst/mgr_inst[{0}]/manager/mrc_cntl_strm_inst[{1}]/mrc_cntl/sdp_cntl/sdp_stream_cntl/lanes_force_req_next_line[1][{2}]}}'.format(mgr,strm,lane)
      pLine = pLine + '\nadd wave -noupdate -group MGR{0} -group STRM{1} -group SDPS -radix hexadecimal {{/top/system_inst/manager_array_inst/mgr_inst[{0}]/manager/mrc_cntl_strm_inst[{1}]/mrc_cntl/sdp_cntl/sdp_stream_cntl/lanes_force_req_next_line}}'.format(mgr,strm,lane)
      pLine = pLine + '\nadd wave -noupdate -group MGR{0} -group STRM{1} -group SDPS -radix hexadecimal {{/top/system_inst/manager_array_inst/mgr_inst[{0}]/manager/mrc_cntl_strm_inst[{1}]/mrc_cntl/sdp_cntl/sdp_stream_cntl/neither_match[0][{2}]}}'.format(mgr,strm,lane)
      pLine = pLine + '\nadd wave -noupdate -group MGR{0} -group STRM{1} -group SDPS -radix hexadecimal {{/top/system_inst/manager_array_inst/mgr_inst[{0}]/manager/mrc_cntl_strm_inst[{1}]/mrc_cntl/sdp_cntl/sdp_stream_cntl/neither_match[1][{2}]}}'.format(mgr,strm,lane)
      pLine = pLine + '\nadd wave -noupdate -group MGR{0} -group STRM{1} -group SDPS -radix hexadecimal {{/top/system_inst/manager_array_inst/mgr_inst[{0}]/manager/mrc_cntl_strm_inst[{1}]/mrc_cntl/sdp_cntl/sdp_stream_cntl/sdp__xxx__get_next_line[0]}} '.format(mgr,strm,lane)
      pLine = pLine + '\nadd wave -noupdate -group MGR{0} -group STRM{1} -group SDPS -radix hexadecimal {{/top/system_inst/manager_array_inst/mgr_inst[{0}]/manager/mrc_cntl_strm_inst[{1}]/mrc_cntl/sdp_cntl/sdp_stream_cntl/sdp__xxx__get_next_line[1]}} '.format(mgr,strm,lane)
      #                                                                                  
      pLine = pLine + '\nadd wave -noupdate -group MGR{0} -group STRM{1} -group SDPS -radix hexadecimal {{/top/system_inst/manager_array_inst/mgr_inst[{0}]/manager/mrc_cntl_strm_inst[{1}]/mrc_cntl/sdp_cntl/sdp_stream_cntl/consJump_to_strm_fsm_fifo[0]/pipe_consJumpCntl}}'.format(mgr,strm,lane)
      pLine = pLine + '\nadd wave -noupdate -group MGR{0} -group STRM{1} -group SDPS -radix hexadecimal {{/top/system_inst/manager_array_inst/mgr_inst[{0}]/manager/mrc_cntl_strm_inst[{1}]/mrc_cntl/sdp_cntl/sdp_stream_cntl/consJump_to_strm_fsm_fifo[0]/pipe_consJumpValue}}'.format(mgr,strm,lane)
      #                                                                                  
      pLine = pLine + '\nadd wave -noupdate -group MGR{0} -group STRM{1} -group SDPS -radix hexadecimal {{/top/system_inst/manager_array_inst/mgr_inst[{0}]/manager/mrc_cntl_strm_inst[{1}]/mrc_cntl/sdp_cntl/sdp_stream_cntl/all_lanes_loaded_consequtive}}'.format(mgr,strm,lane)
      pLine = pLine + '\nadd wave -noupdate -group MGR{0} -group STRM{1} -group SDPS -radix hexadecimal {{/top/system_inst/manager_array_inst/mgr_inst[{0}]/manager/mrc_cntl_strm_inst[{1}]/mrc_cntl/sdp_cntl/sdp_stream_cntl/all_lanes_loaded_jump}}'.format(mgr,strm,lane)
      #                                                                                  
      pLine = pLine + '\nadd wave -noupdate -group MGR{0} -group STRM{1} -group SDPS -radix hexadecimal {{/top/system_inst/manager_array_inst/mgr_inst[{0}]/manager/mrc_cntl_strm_inst[{1}]/mrc_cntl/sdp_cntl/sdp_stream_cntl/lanes_loaded_consequtive}}'.format(mgr,strm,lane)
      pLine = pLine + '\nadd wave -noupdate -group MGR{0} -group STRM{1} -group SDPS -radix hexadecimal {{/top/system_inst/manager_array_inst/mgr_inst[{0}]/manager/mrc_cntl_strm_inst[{1}]/mrc_cntl/sdp_cntl/sdp_stream_cntl/lanes_loaded_jump}}'.format(mgr,strm,lane)
      pLine = pLine + '\nadd wave -noupdate -group MGR{0} -group STRM{1} -group SDPS -radix hexadecimal {{/top/system_inst/manager_array_inst/mgr_inst[{0}]/manager/mrc_cntl_strm_inst[{1}]/mrc_cntl/sdp_cntl/sdp_stream_cntl/lanes_loading_consequtive}}'.format(mgr,strm,lane)
      pLine = pLine + '\nadd wave -noupdate -group MGR{0} -group STRM{1} -group SDPS -radix hexadecimal {{/top/system_inst/manager_array_inst/mgr_inst[{0}]/manager/mrc_cntl_strm_inst[{1}]/mrc_cntl/sdp_cntl/sdp_stream_cntl/lanes_loading_jump}}'.format(mgr,strm,lane)
      #                                                                                  
      #                                                                                  
      pLine = pLine + '\nadd wave -noupdate -group MGR{0} -group STRM{1} -group SDPS -radix hexadecimal {{/top/system_inst/manager_array_inst/mgr_inst[{0}]/manager/mrc_cntl_strm_inst[{1}]/mrc_cntl/sdp_cntl/sdp_stream_cntl/addr_to_strm_fsm_fifo[0]/write}}'.format(mgr,strm,lane)
      pLine = pLine + '\nadd wave -noupdate -group MGR{0} -group STRM{1} -group SDPS -radix hexadecimal {{/top/system_inst/manager_array_inst/mgr_inst[{0}]/manager/mrc_cntl_strm_inst[{1}]/mrc_cntl/sdp_cntl/sdp_stream_cntl/addr_to_strm_fsm_fifo[0]/pipe_addr}}'.format(mgr,strm,lane)
      pLine = pLine + '\nadd wave -noupdate -group MGR{0} -group STRM{1} -group SDPS -radix hexadecimal {{/top/system_inst/manager_array_inst/mgr_inst[{0}]/manager/mrc_cntl_strm_inst[{1}]/mrc_cntl/sdp_cntl/sdp_stream_cntl/addr_to_strm_fsm_fifo[0]/pipe_num_lanes}}'.format(mgr,strm,lane)
      pLine = pLine + '\nadd wave -noupdate -group MGR{0} -group STRM{1} -group SDPS -radix hexadecimal {{/top/system_inst/manager_array_inst/mgr_inst[{0}]/manager/mrc_cntl_strm_inst[{1}]/mrc_cntl/sdp_cntl/sdp_stream_cntl/addr_to_strm_fsm_fifo[0]/pipe_num_lanes_m1}}'.format(mgr,strm,lane)
      pLine = pLine + '\nadd wave -noupdate -group MGR{0} -group STRM{1} -group SDPS -radix hexadecimal {{/top/system_inst/manager_array_inst/mgr_inst[{0}]/manager/mrc_cntl_strm_inst[{1}]/mrc_cntl/sdp_cntl/sdp_stream_cntl/addr_to_strm_fsm_fifo[0]/pipe_order}}'.format(mgr,strm,lane)
      pLine = pLine + '\nadd wave -noupdate -group MGR{0} -group STRM{1} -group SDPS -radix hexadecimal {{/top/system_inst/manager_array_inst/mgr_inst[{0}]/manager/mrc_cntl_strm_inst[{1}]/mrc_cntl/sdp_cntl/sdp_stream_cntl/addr_to_strm_fsm_fifo[0]/pipe_read}}'.format(mgr,strm,lane)
      pLine = pLine + '\nadd wave -noupdate -group MGR{0} -group STRM{1} -group SDPS -radix hexadecimal {{/top/system_inst/manager_array_inst/mgr_inst[{0}]/manager/mrc_cntl_strm_inst[{1}]/mrc_cntl/sdp_cntl/sdp_stream_cntl/addr_to_strm_fsm_fifo[0]/pipe_tgt}}'.format(mgr,strm,lane)
      pLine = pLine + '\nadd wave -noupdate -group MGR{0} -group STRM{1} -group SDPS -radix hexadecimal {{/top/system_inst/manager_array_inst/mgr_inst[{0}]/manager/mrc_cntl_strm_inst[{1}]/mrc_cntl/sdp_cntl/sdp_stream_cntl/addr_to_strm_fsm_fifo[0]/pipe_transfer_type}}'.format(mgr,strm,lane)
      pLine = pLine + '\nadd wave -noupdate -group MGR{0} -group STRM{1} -group SDPS -radix hexadecimal {{/top/system_inst/manager_array_inst/mgr_inst[{0}]/manager/mrc_cntl_strm_inst[{1}]/mrc_cntl/sdp_cntl/sdp_stream_cntl/addr_to_strm_fsm_fifo[0]/pipe_valid}}'.format(mgr,strm,lane)
      pLine = pLine + '\nadd wave -noupdate -group MGR{0} -group STRM{1} -group SDPS -radix hexadecimal {{/top/system_inst/manager_array_inst/mgr_inst[{0}]/manager/mrc_cntl_strm_inst[{1}]/mrc_cntl/sdp_cntl/sdp_stream_cntl/consJump_to_strm_fsm_fifo[0]/pipe_consJumpCntl}}'.format(mgr,strm,lane)
      pLine = pLine + '\nadd wave -noupdate -group MGR{0} -group STRM{1} -group SDPS -radix hexadecimal {{/top/system_inst/manager_array_inst/mgr_inst[{0}]/manager/mrc_cntl_strm_inst[{1}]/mrc_cntl/sdp_cntl/sdp_stream_cntl/consJump_to_strm_fsm_fifo[0]/pipe_consJumpValue}}'.format(mgr,strm,lane)
      pLine = pLine + '\nadd wave -noupdate -group MGR{0} -group STRM{1} -group SDPS -radix hexadecimal {{/top/system_inst/manager_array_inst/mgr_inst[{0}]/manager/mrc_cntl_strm_inst[{1}]/mrc_cntl/sdp_cntl/sdp_stream_cntl/consJump_to_strm_fsm_fifo[0]/pipe_eom}}'.format(mgr,strm,lane)
      pLine = pLine + '\nadd wave -noupdate -group MGR{0} -group STRM{1} -group SDPS -radix hexadecimal {{/top/system_inst/manager_array_inst/mgr_inst[{0}]/manager/mrc_cntl_strm_inst[{1}]/mrc_cntl/sdp_cntl/sdp_stream_cntl/consJump_to_strm_fsm_fifo[0]/pipe_read}}'.format(mgr,strm,lane)
      pLine = pLine + '\nadd wave -noupdate -group MGR{0} -group STRM{1} -group SDPS -radix hexadecimal {{/top/system_inst/manager_array_inst/mgr_inst[{0}]/manager/mrc_cntl_strm_inst[{1}]/mrc_cntl/sdp_cntl/sdp_stream_cntl/consJump_to_strm_fsm_fifo[0]/pipe_som}}'.format(mgr,strm,lane)
      pLine = pLine + '\nadd wave -noupdate -group MGR{0} -group STRM{1} -group SDPS -radix hexadecimal {{/top/system_inst/manager_array_inst/mgr_inst[{0}]/manager/mrc_cntl_strm_inst[{1}]/mrc_cntl/sdp_cntl/sdp_stream_cntl/consJump_to_strm_fsm_fifo[0]/pipe_valid}}'.format(mgr,strm,lane)
      pLine = pLine + '\nadd wave -noupdate -group MGR{0} -group STRM{1} -group SDPS -radix hexadecimal {{/top/system_inst/manager_array_inst/mgr_inst[{0}]/manager/mrc_cntl_strm_inst[{1}]/mrc_cntl/sdp_cntl/sdp_stream_cntl/consJump_to_strm_fsm_fifo[0]/write}}'.format(mgr,strm,lane)
      pLine = pLine + '\nadd wave -noupdate -group MGR{0} -group STRM{1} -group SDPS -radix hexadecimal {{/top/system_inst/manager_array_inst/mgr_inst[{0}]/manager/mrc_cntl_strm_inst[{1}]/mrc_cntl/sdp_cntl/sdp_stream_cntl/exec_lane_enable}}'.format(mgr,strm,lane)
      #
      #
      for lane in [0,7,15,23,31] :
        #
        pLine = pLine + '\nadd wave -noupdate -group MGR{0} -group STRM{1} -group SDPS -group LANE{2} -radix hexadecimal {{/top/system_inst/manager_array_inst/mgr_inst[{0}]/manager/mrc_cntl_strm_inst[{1}]/mrc_cntl/sdp_cntl/sdp_stream_cntl/lane_fsm[{2}]/sdp_cntl_stream_data_state}}'.format(mgr,strm,lane)
        pLine = pLine + '\nadd wave -noupdate -group MGR{0} -group STRM{1} -group SDPS -group LANE{2} -radix hexadecimal {{/top/system_inst/manager_array_inst/mgr_inst[{0}]/manager/mrc_cntl_strm_inst[{1}]/mrc_cntl/sdp_cntl/sdp_stream_cntl/lane_fsm[{2}]/req_next_line[0]}} '.format(mgr,strm,lane)
        pLine = pLine + '\nadd wave -noupdate -group MGR{0} -group STRM{1} -group SDPS -group LANE{2} -radix hexadecimal {{/top/system_inst/manager_array_inst/mgr_inst[{0}]/manager/mrc_cntl_strm_inst[{1}]/mrc_cntl/sdp_cntl/sdp_stream_cntl/lane_fsm[{2}]/force_req_next_line[0]}} '.format(mgr,strm,lane)
        pLine = pLine + '\nadd wave -noupdate -group MGR{0} -group STRM{1} -group SDPS -group LANE{2} -radix hexadecimal {{/top/system_inst/manager_array_inst/mgr_inst[{0}]/manager/mrc_cntl_strm_inst[{1}]/mrc_cntl/sdp_cntl/sdp_stream_cntl/lane_fsm[{2}]/lane_address_match[0]}} '.format(mgr,strm,lane)
        pLine = pLine + '\nadd wave -noupdate -group MGR{0} -group STRM{1} -group SDPS -group LANE{2} -radix hexadecimal {{/top/system_inst/manager_array_inst/mgr_inst[{0}]/manager/mrc_cntl_strm_inst[{1}]/mrc_cntl/sdp_cntl/sdp_stream_cntl/lane_fsm[{2}]/lane_address_next_match[0]}} '.format(mgr,strm,lane)
        pLine = pLine + '\nadd wave -noupdate -group MGR{0} -group STRM{1} -group SDPS -group LANE{2} -radix hexadecimal {{/top/system_inst/manager_array_inst/mgr_inst[{0}]/manager/mrc_cntl_strm_inst[{1}]/mrc_cntl/sdp_cntl/sdp_stream_cntl/lane_fsm[{2}]/req_next_line[1]}} '.format(mgr,strm,lane)
        pLine = pLine + '\nadd wave -noupdate -group MGR{0} -group STRM{1} -group SDPS -group LANE{2} -radix hexadecimal {{/top/system_inst/manager_array_inst/mgr_inst[{0}]/manager/mrc_cntl_strm_inst[{1}]/mrc_cntl/sdp_cntl/sdp_stream_cntl/lane_fsm[{2}]/force_req_next_line[1]}} '.format(mgr,strm,lane)
        pLine = pLine + '\nadd wave -noupdate -group MGR{0} -group STRM{1} -group SDPS -group LANE{2} -radix hexadecimal {{/top/system_inst/manager_array_inst/mgr_inst[{0}]/manager/mrc_cntl_strm_inst[{1}]/mrc_cntl/sdp_cntl/sdp_stream_cntl/lane_fsm[{2}]/lane_address_match[1]}} '.format(mgr,strm,lane)
        pLine = pLine + '\nadd wave -noupdate -group MGR{0} -group STRM{1} -group SDPS -group LANE{2} -radix hexadecimal {{/top/system_inst/manager_array_inst/mgr_inst[{0}]/manager/mrc_cntl_strm_inst[{1}]/mrc_cntl/sdp_cntl/sdp_stream_cntl/lane_fsm[{2}]/lane_address_next_match[1]}} '.format(mgr,strm,lane)
        #                                                                                  
        pLine = pLine + '\nadd wave -noupdate -group MGR{0} -group STRM{1} -group SDPS -group LANE{2} -radix hexadecimal {{/top/system_inst/manager_array_inst/mgr_inst[{0}]/manager/mrc_cntl_strm_inst[{1}]/mrc_cntl/sdp_cntl/sdp_stream_cntl/lane_fsm[{2}]/sdp_cntl_stream_data_state}}'.format(mgr,strm,lane)
        pLine = pLine + '\nadd wave -noupdate -group MGR{0} -group STRM{1} -group SDPS -group LANE{2} -radix hexadecimal {{/top/system_inst/manager_array_inst/mgr_inst[{0}]/manager/mrc_cntl_strm_inst[{1}]/mrc_cntl/sdp_cntl/sdp_stream_cntl/lane_fsm[{2}]/lane_channel_ptr}}'.format(mgr,strm,lane)
        pLine = pLine + '\nadd wave -noupdate -group MGR{0} -group STRM{1} -group SDPS -group LANE{2} -radix hexadecimal {{/top/system_inst/manager_array_inst/mgr_inst[{0}]/manager/mrc_cntl_strm_inst[{1}]/mrc_cntl/sdp_cntl/sdp_stream_cntl/lane_fsm[{2}]/lane_bank_ptr}}'.format(mgr,strm,lane)
        pLine = pLine + '\nadd wave -noupdate -group MGR{0} -group STRM{1} -group SDPS -group LANE{2} -radix hexadecimal {{/top/system_inst/manager_array_inst/mgr_inst[{0}]/manager/mrc_cntl_strm_inst[{1}]/mrc_cntl/sdp_cntl/sdp_stream_cntl/lane_fsm[{2}]/lane_line_ptr}}'.format(mgr,strm,lane)
        pLine = pLine + '\nadd wave -noupdate -group MGR{0} -group STRM{1} -group SDPS -group LANE{2} -radix hexadecimal {{/top/system_inst/manager_array_inst/mgr_inst[{0}]/manager/mrc_cntl_strm_inst[{1}]/mrc_cntl/sdp_cntl/sdp_stream_cntl/lane_fsm[{2}]/lane_word_ptr}}'.format(mgr,strm,lane)
        pLine = pLine + '\nadd wave -noupdate -group MGR{0} -group STRM{1} -group SDPS -group LANE{2} -radix hexadecimal {{/top/system_inst/manager_array_inst/mgr_inst[{0}]/manager/mrc_cntl_strm_inst[{1}]/mrc_cntl/sdp_cntl/sdp_stream_cntl/lane_fsm[{2}]/lane_channel_ptr_e1}}'.format(mgr,strm,lane)
        pLine = pLine + '\nadd wave -noupdate -group MGR{0} -group STRM{1} -group SDPS -group LANE{2} -radix hexadecimal {{/top/system_inst/manager_array_inst/mgr_inst[{0}]/manager/mrc_cntl_strm_inst[{1}]/mrc_cntl/sdp_cntl/sdp_stream_cntl/lane_fsm[{2}]/lane_bank_ptr_e1}}'.format(mgr,strm,lane)
        pLine = pLine + '\nadd wave -noupdate -group MGR{0} -group STRM{1} -group SDPS -group LANE{2} -radix hexadecimal {{/top/system_inst/manager_array_inst/mgr_inst[{0}]/manager/mrc_cntl_strm_inst[{1}]/mrc_cntl/sdp_cntl/sdp_stream_cntl/lane_fsm[{2}]/lane_line_ptr_e1}}'.format(mgr,strm,lane)
        pLine = pLine + '\nadd wave -noupdate -group MGR{0} -group STRM{1} -group SDPS -group LANE{2} -radix hexadecimal {{/top/system_inst/manager_array_inst/mgr_inst[{0}]/manager/mrc_cntl_strm_inst[{1}]/mrc_cntl/sdp_cntl/sdp_stream_cntl/lane_fsm[{2}]/lane_word_ptr_e1}}'.format(mgr,strm,lane)
        pLine = pLine + '\nadd wave -noupdate -group MGR{0} -group STRM{1} -group SDPS -group LANE{2} -radix hexadecimal {{/top/system_inst/manager_array_inst/mgr_inst[{0}]/manager/mrc_cntl_strm_inst[{1}]/mrc_cntl/sdp_cntl/sdp_stream_cntl/lane_fsm[{2}]/consequtive_counter_le0}}'.format(mgr,strm,lane)
        pLine = pLine + '\nadd wave -noupdate -group MGR{0} -group STRM{1} -group SDPS -group LANE{2} -radix hexadecimal {{/top/system_inst/manager_array_inst/mgr_inst[{0}]/manager/mrc_cntl_strm_inst[{1}]/mrc_cntl/sdp_cntl/sdp_stream_cntl/lane_fsm[{2}]/lane_data_available}}'.format(mgr,strm,lane)
        pLine = pLine + '\nadd wave -noupdate -group MGR{0} -group STRM{1} -group SDPS -group LANE{2} -radix hexadecimal {{/top/system_inst/manager_array_inst/mgr_inst[{0}]/manager/mrc_cntl_strm_inst[{1}]/mrc_cntl/sdp_cntl/sdp_stream_cntl/lane_fsm[{2}]/sent_data_without_increment}}'.format(mgr,strm,lane)
        pLine = pLine + '\nadd wave -noupdate -group MGR{0} -group STRM{1} -group SDPS -group LANE{2} -radix hexadecimal {{/top/system_inst/manager_array_inst/mgr_inst[{0}]/manager/mrc_cntl_strm_inst[{1}]/mrc_cntl/sdp_cntl/sdp_stream_cntl/lane_fsm[{2}]/destination_ready}}'.format(mgr,strm,lane)
        pLine = pLine + '\nadd wave -noupdate -group MGR{0} -group STRM{1} -group SDPS -group LANE{2} -radix hexadecimal {{/top/system_inst/manager_array_inst/mgr_inst[{0}]/manager/mrc_cntl_strm_inst[{1}]/mrc_cntl/sdp_cntl/sdp_stream_cntl/lane_fsm[{2}]/consequtive_counter}}'.format(mgr,strm,lane)
        pLine = pLine + '\nadd wave -noupdate -group MGR{0} -group STRM{1} -group SDPS -group LANE{2} -radix hexadecimal {{/top/system_inst/manager_array_inst/mgr_inst[{0}]/manager/mrc_cntl_strm_inst[{1}]/mrc_cntl/sdp_cntl/sdp_stream_cntl/lane_fsm[{2}]/lane_next_inc_cons_start_address}}'.format(mgr,strm,lane)
        pLine = pLine + '\nadd wave -noupdate -group MGR{0} -group STRM{1} -group SDPS -group LANE{2} -radix hexadecimal {{/top/system_inst/manager_array_inst/mgr_inst[{0}]/manager/mrc_cntl_strm_inst[{1}]/mrc_cntl/sdp_cntl/sdp_stream_cntl/lane_fsm[{2}]/last_consequtive}}'.format(mgr,strm,lane)
        pLine = pLine + '\nadd wave -noupdate -group MGR{0} -group STRM{1} -group SDPS -group LANE{2} -radix hexadecimal {{/top/system_inst/manager_array_inst/mgr_inst[{0}]/manager/mrc_cntl_strm_inst[{1}]/mrc_cntl/sdp_cntl/sdp_stream_cntl/lane_fsm[{2}]/sdp_cntl_stream_data_state}}'.format(mgr,strm,lane)
        pLine = pLine + '\nadd wave -noupdate -group MGR{0} -group STRM{1} -group SDPS -group LANE{2} -radix hexadecimal {{/top/system_inst/manager_array_inst/mgr_inst[{0}]/manager/mrc_cntl_strm_inst[{1}]/mrc_cntl/sdp_cntl/sdp_stream_cntl/lane_fsm[{2}]/lane_address_match[0]}}'.format(mgr,strm,lane) 
        pLine = pLine + '\nadd wave -noupdate -group MGR{0} -group STRM{1} -group SDPS -group LANE{2} -radix hexadecimal {{/top/system_inst/manager_array_inst/mgr_inst[{0}]/manager/mrc_cntl_strm_inst[{1}]/mrc_cntl/sdp_cntl/sdp_stream_cntl/lane_fsm[{2}]/lane_address_match[1]}}'.format(mgr,strm,lane) 
        #                                                                                  
        pLine = pLine + '\nadd wave -noupdate -group MGR{0} -group STRM{1} -group SDPS -group LANE{2} -radix hexadecimal {{/top/system_inst/manager_array_inst/mgr_inst[{0}]/manager/mrc_cntl_strm_inst[{1}]/mrc_cntl/sdp_cntl/sdp_stream_cntl/lanes_req_next_line[0][{2}]}}'.format(mgr,strm,lane)
        pLine = pLine + '\nadd wave -noupdate -group MGR{0} -group STRM{1} -group SDPS -group LANE{2} -radix hexadecimal {{/top/system_inst/manager_array_inst/mgr_inst[{0}]/manager/mrc_cntl_strm_inst[{1}]/mrc_cntl/sdp_cntl/sdp_stream_cntl/lanes_req_next_line[1][{2}]}}'.format(mgr,strm,lane)
        pLine = pLine + '\nadd wave -noupdate -group MGR{0} -group STRM{1} -group SDPS -group LANE{2} -radix hexadecimal {{/top/system_inst/manager_array_inst/mgr_inst[{0}]/manager/mrc_cntl_strm_inst[{1}]/mrc_cntl/sdp_cntl/sdp_stream_cntl/lane_fsm[{2}]/req_next_line_but_not_accepted}}'.format(mgr,strm,lane)
        pLine = pLine + '\nadd wave -noupdate -group MGR{0} -group STRM{1} -group SDPS -group LANE{2} -radix hexadecimal {{/top/system_inst/manager_array_inst/mgr_inst[{0}]/manager/mrc_cntl_strm_inst[{1}]/mrc_cntl/sdp_cntl/sdp_stream_cntl/lane_fsm[{2}]/send_data}}'.format(mgr,strm,lane)
        pLine = pLine + '\nadd wave -noupdate -group MGR{0} -group STRM{1} -group SDPS -group LANE{2} -radix hexadecimal {{/top/system_inst/manager_array_inst/mgr_inst[{0}]/manager/mrc_cntl_strm_inst[{1}]/mrc_cntl/sdp_cntl/sdp_stream_cntl/lane_fsm[{2}]/lane_running}}'.format(mgr,strm,lane)
        pLine = pLine + '\nadd wave -noupdate -group MGR{0} -group STRM{1} -group SDPS -group LANE{2} -radix hexadecimal {{/top/system_inst/manager_array_inst/mgr_inst[{0}]/manager/mrc_cntl_strm_inst[{1}]/mrc_cntl/sdp_cntl/sdp_stream_cntl/lane_fsm[{2}]/lane_data_available}}'.format(mgr,strm,lane)
        pLine = pLine + '\nadd wave -noupdate -group MGR{0} -group STRM{1} -group SDPS -group LANE{2} -radix hexadecimal {{/top/system_inst/manager_array_inst/mgr_inst[{0}]/manager/mrc_cntl_strm_inst[{1}]/mrc_cntl/sdp_cntl/sdp_stream_cntl/lane_fsm[{2}]/destination_ready}}'.format(mgr,strm,lane)
        pLine = pLine + '\nadd wave -noupdate -group MGR{0} -group STRM{1} -group SDPS -group LANE{2} -radix hexadecimal {{/top/system_inst/manager_array_inst/mgr_inst[{0}]/manager/mrc_cntl_strm_inst[{1}]/mrc_cntl/sdp_cntl/sdp_stream_cntl/lane_fsm[{2}]/sdp_cntl_stream_data_state}}'.format(mgr,strm,lane)
        pLine = pLine + '\nadd wave -noupdate -group MGR{0} -group STRM{1} -group SDPS -group LANE{2} -radix hexadecimal {{/top/system_inst/manager_array_inst/mgr_inst[{0}]/manager/mrc_cntl_strm_inst[{1}]/mrc_cntl/sdp_cntl/sdp_stream_cntl/lane_fsm[{2}]/loaded_consequtive}}'.format(mgr,strm,lane)
        pLine = pLine + '\nadd wave -noupdate -group MGR{0} -group STRM{1} -group SDPS -group LANE{2} -radix hexadecimal {{/top/system_inst/manager_array_inst/mgr_inst[{0}]/manager/mrc_cntl_strm_inst[{1}]/mrc_cntl/sdp_cntl/sdp_stream_cntl/lane_fsm[{2}]/loaded_jump}}'.format(mgr,strm,lane)
        pLine = pLine + '\nadd wave -noupdate -group MGR{0} -group STRM{1} -group SDPS -group LANE{2} -radix hexadecimal {{/top/system_inst/manager_array_inst/mgr_inst[{0}]/manager/mrc_cntl_strm_inst[{1}]/mrc_cntl/sdp_cntl/sdp_stream_cntl/lane_fsm[{2}]/loading_consequtive}}'.format(mgr,strm,lane)
        pLine = pLine + '\nadd wave -noupdate -group MGR{0} -group STRM{1} -group SDPS -group LANE{2} -radix hexadecimal {{/top/system_inst/manager_array_inst/mgr_inst[{0}]/manager/mrc_cntl_strm_inst[{1}]/mrc_cntl/sdp_cntl/sdp_stream_cntl/lane_fsm[{2}]/loading_jump}}'.format(mgr,strm,lane)
  ...
  for mgr in range (0, numOfMgr):
    #                                                              
    pLine = pLine + '\nadd wave -noupdate -group MGR{0} -group WUD -radix hexadecimal {{/top/system_inst/manager_array_inst/mgr_inst[{0}]/manager/wu_decode/wum__wud__valid}}'.format(mgr,strm)
    pLine = pLine + '\nadd wave -noupdate -group MGR{0} -group WUD -radix hexadecimal {{/top/system_inst/manager_array_inst/mgr_inst[{0}]/manager/wu_decode/wum__wud__icntl}}'.format(mgr,strm)
    pLine = pLine + '\nadd wave -noupdate -group MGR{0} -group WUD -radix hexadecimal {{/top/system_inst/manager_array_inst/mgr_inst[{0}]/manager/wu_decode/wum__wud__dcntl}}'.format(mgr,strm)
    pLine = pLine + '\nadd wave -noupdate -group MGR{0} -group WUD -radix hexadecimal {{/top/system_inst/manager_array_inst/mgr_inst[{0}]/manager/wu_decode/wum__wud__op}}'.format(mgr,strm)
    pLine = pLine + '\nadd wave -noupdate -group MGR{0} -group WUD -radix hexadecimal {{/top/system_inst/manager_array_inst/mgr_inst[{0}]/manager/wu_decode/wum__wud__option_type}}'.format(mgr,strm)
    pLine = pLine + '\nadd wave -noupdate -group MGR{0} -group WUD -radix hexadecimal {{/top/system_inst/manager_array_inst/mgr_inst[{0}]/manager/wu_decode/wum__wud__option_value}}'.format(mgr,strm)
    pLine = pLine + '\nadd wave -noupdate -group MGR{0} -group WUD -radix hexadecimal {{/top/system_inst/manager_array_inst/mgr_inst[{0}]/manager/wu_decode/wud__wum__ready}}'.format(mgr,strm)
    #
    pLine = pLine + '\nadd wave -noupdate -group MGR{0} -group WUD -radix hexadecimal {{/top/system_inst/manager_array_inst/mgr_inst[{0}]/manager/wu_decode/wud__odc__valid}}'.format(mgr,strm)
    pLine = pLine + '\nadd wave -noupdate -group MGR{0} -group WUD -radix hexadecimal {{/top/system_inst/manager_array_inst/mgr_inst[{0}]/manager/wu_decode/wud__odc__cntl}}'.format(mgr,strm)
    pLine = pLine + '\nadd wave -noupdate -group MGR{0} -group WUD -radix hexadecimal {{/top/system_inst/manager_array_inst/mgr_inst[{0}]/manager/wu_decode/wud__odc__num_lanes}}'.format(mgr,strm)
    pLine = pLine + '\nadd wave -noupdate -group MGR{0} -group WUD -radix hexadecimal {{/top/system_inst/manager_array_inst/mgr_inst[{0}]/manager/wu_decode/wud__odc__simd_cmd}}'.format(mgr,strm)
    pLine = pLine + '\nadd wave -noupdate -group MGR{0} -group WUD -radix hexadecimal {{/top/system_inst/manager_array_inst/mgr_inst[{0}]/manager/wu_decode/wud__odc__stOp_cmd}}'.format(mgr,strm)
    pLine = pLine + '\nadd wave -noupdate -group MGR{0} -group WUD -radix hexadecimal {{/top/system_inst/manager_array_inst/mgr_inst[{0}]/manager/wu_decode/odc__wud__ready}}'.format(mgr,strm)
    #
    for strm in range (0, numOfStrms):
      #
      pLine = pLine + '\nadd wave -noupdate -group MGR{0} -group WUD -group STRM{1} -radix hexadecimal {{/top/system_inst/manager_array_inst/mgr_inst[{0}]/manager/wu_decode/wud__mrc{1}__valid}}'.format(mgr,strm)
      pLine = pLine + '\nadd wave -noupdate -group MGR{0} -group WUD -group STRM{1} -radix hexadecimal {{/top/system_inst/manager_array_inst/mgr_inst[{0}]/manager/wu_decode/wud__mrc{1}__cntl}}'.format(mgr,strm)
      pLine = pLine + '\nadd wave -noupdate -group MGR{0} -group WUD -group STRM{1} -radix hexadecimal {{/top/system_inst/manager_array_inst/mgr_inst[{0}]/manager/wu_decode/wud__mrc{1}__option_type}}'.format(mgr,strm)
      pLine = pLine + '\nadd wave -noupdate -group MGR{0} -group WUD -group STRM{1} -radix hexadecimal {{/top/system_inst/manager_array_inst/mgr_inst[{0}]/manager/wu_decode/wud__mrc{1}__option_value}}'.format(mgr,strm)
      pLine = pLine + '\nadd wave -noupdate -group MGR{0} -group WUD -group STRM{1} -radix hexadecimal {{/top/system_inst/manager_array_inst/mgr_inst[{0}]/manager/wu_decode/mrc{1}__wud__ready}}'.format(mgr,strm)
    #                                                              
    pLine = pLine + '\nadd wave -noupdate -group MGR{0} -group WUD -radix hexadecimal {{/top/system_inst/manager_array_inst/mgr_inst[{0}]/manager/wu_decode/wud__rdp__valid}}'.format(mgr,strm)
    pLine = pLine + '\nadd wave -noupdate -group MGR{0} -group WUD -radix hexadecimal {{/top/system_inst/manager_array_inst/mgr_inst[{0}]/manager/wu_decode/wud__rdp__dcntl}}'.format(mgr,strm)
    pLine = pLine + '\nadd wave -noupdate -group MGR{0} -group WUD -radix hexadecimal {{/top/system_inst/manager_array_inst/mgr_inst[{0}]/manager/wu_decode/wud__rdp__option_type}}'.format(mgr,strm)
    pLine = pLine + '\nadd wave -noupdate -group MGR{0} -group WUD -radix hexadecimal {{/top/system_inst/manager_array_inst/mgr_inst[{0}]/manager/wu_decode/wud__rdp__option_value}}'.format(mgr,strm)
    pLine = pLine + '\nadd wave -noupdate -group MGR{0} -group WUD -radix hexadecimal {{/top/system_inst/manager_array_inst/mgr_inst[{0}]/manager/wu_decode/wud__rdp__tag}}'.format(mgr,strm)
    pLine = pLine + '\nadd wave -noupdate -group MGR{0} -group WUD -radix hexadecimal {{/top/system_inst/manager_array_inst/mgr_inst[{0}]/manager/wu_decode/rdp__wud__ready}}'.format(mgr,strm)
