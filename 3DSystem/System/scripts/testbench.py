...
if __name__ == "__main__":
  ...
  for mgr in range (0, numOfMgr):
    for strm in range (0, numOfStrms):
      for lane in [0,7,15,23,31] :
        pLine = pLine + '\nadd wave -noupdate -group MGR{0} -group SDP -group LANE{2} -group STRM01 -radix hexadecimal {{/top/system_inst/pe_array_inst/pe_inst[{0}]/pe/stOp_lane[{2}]/streamingOps_datapath/sti__stOp__strm{1}_data_valid}}'.format(mgr,strm,lane)
        pLine = pLine + '\nadd wave -noupdate -group MGR{0} -group SDP -group LANE{2} -group STRM01 -radix hexadecimal {{/top/system_inst/pe_array_inst/pe_inst[{0}]/pe/stOp_lane[{2}]/streamingOps_datapath/sti__stOp__strm{1}_cntl}}'.format(mgr,strm,lane)
        pLine = pLine + '\nadd wave -noupdate -group MGR{0} -group SDP -group LANE{2} -group STRM01 -radix hexadecimal {{/top/system_inst/pe_array_inst/pe_inst[{0}]/pe/stOp_lane[{2}]/streamingOps_datapath/sti__stOp__strm{1}_data}}'.format(mgr,strm,lane)
        pLine = pLine + '\nadd wave -noupdate -group MGR{0} -group SDP -group LANE{2} -group STRM01 -radix hexadecimal {{/top/system_inst/pe_array_inst/pe_inst[{0}]/pe/stOp_lane[{2}]/streamingOps_datapath/stOp__sti__strm{1}_ready}}'.format(mgr,strm,lane)
        #
  ...
  for mgr in range (0, numOfMgr):
    for strm in range (0, numOfStrms):
       pLine = pLine + '\nadd wave -noupdate -group MGR{0} -group SDP -group STRM{1} -group SDP -radix hexadecimal {{/top/system_inst/manager_array_inst/mgr_inst[{0}]/manager/mrc_cntl_strm_inst[{1}]/mrc_cntl/sdp_cntl/clk}}'.format(mgr,strm)
       pLine = pLine + '\nadd wave -noupdate -group MGR{0} -group SDP -group STRM{1} -group SDP -radix hexadecimal {{/top/system_inst/manager_array_inst/mgr_inst[{0}]/manager/mrc_cntl_strm_inst[{1}]/mrc_cntl/sdp_cntl/reset_poweron}}'.format(mgr,strm)
       pLine = pLine + '\nadd wave -noupdate -group MGR{0} -group SDP -group STRM{1} -group SDP -radix hexadecimal {{/top/system_inst/manager_array_inst/mgr_inst[{0}]/manager/mrc_cntl_strm_inst[{1}]/mrc_cntl/sdp_cntl/sdp__xxx__get_next_line}}'.format(mgr,strm)
       pLine = pLine + '\nadd wave -noupdate -group MGR{0} -group SDP -group STRM{1} -group SDP -radix hexadecimal {{/top/system_inst/manager_array_inst/mgr_inst[{0}]/manager/mrc_cntl_strm_inst[{1}]/mrc_cntl/sdp_cntl/sdp__xxx__lane_channel_ptr}}'.format(mgr,strm)
       pLine = pLine + '\nadd wave -noupdate -group MGR{0} -group SDP -group STRM{1} -group SDP -radix hexadecimal {{/top/system_inst/manager_array_inst/mgr_inst[{0}]/manager/mrc_cntl_strm_inst[{1}]/mrc_cntl/sdp_cntl/sdp__xxx__lane_cntl}}'.format(mgr,strm)
       pLine = pLine + '\nadd wave -noupdate -group MGR{0} -group SDP -group STRM{1} -group SDP -radix hexadecimal {{/top/system_inst/manager_array_inst/mgr_inst[{0}]/manager/mrc_cntl_strm_inst[{1}]/mrc_cntl/sdp_cntl/sdp__xxx__lane_enable}}'.format(mgr,strm)
       pLine = pLine + '\nadd wave -noupdate -group MGR{0} -group SDP -group STRM{1} -group SDP -radix hexadecimal {{/top/system_inst/manager_array_inst/mgr_inst[{0}]/manager/mrc_cntl_strm_inst[{1}]/mrc_cntl/sdp_cntl/sdp__xxx__lane_valid}}'.format(mgr,strm)
       pLine = pLine + '\nadd wave -noupdate -group MGR{0} -group SDP -group STRM{1} -group SDP -radix hexadecimal {{/top/system_inst/manager_array_inst/mgr_inst[{0}]/manager/mrc_cntl_strm_inst[{1}]/mrc_cntl/sdp_cntl/sdp__xxx__lane_word_ptr}}'.format(mgr,strm)
       pLine = pLine + '\nadd wave -noupdate -group MGR{0} -group SDP -group STRM{1} -group SDP -radix hexadecimal {{/top/system_inst/manager_array_inst/mgr_inst[{0}]/manager/mrc_cntl_strm_inst[{1}]/mrc_cntl/sdp_cntl/sdp__xxx__mem_request_bank}}'.format(mgr,strm)
       pLine = pLine + '\nadd wave -noupdate -group MGR{0} -group SDP -group STRM{1} -group SDP -radix hexadecimal {{/top/system_inst/manager_array_inst/mgr_inst[{0}]/manager/mrc_cntl_strm_inst[{1}]/mrc_cntl/sdp_cntl/sdp__xxx__mem_request_channel}}'.format(mgr,strm)
       pLine = pLine + '\nadd wave -noupdate -group MGR{0} -group SDP -group STRM{1} -group SDP -radix hexadecimal {{/top/system_inst/manager_array_inst/mgr_inst[{0}]/manager/mrc_cntl_strm_inst[{1}]/mrc_cntl/sdp_cntl/sdp__xxx__mem_request_cntl}}'.format(mgr,strm)
       pLine = pLine + '\nadd wave -noupdate -group MGR{0} -group SDP -group STRM{1} -group SDP -radix hexadecimal {{/top/system_inst/manager_array_inst/mgr_inst[{0}]/manager/mrc_cntl_strm_inst[{1}]/mrc_cntl/sdp_cntl/sdp__xxx__mem_request_page}}'.format(mgr,strm)
       pLine = pLine + '\nadd wave -noupdate -group MGR{0} -group SDP -group STRM{1} -group SDP -radix hexadecimal {{/top/system_inst/manager_array_inst/mgr_inst[{0}]/manager/mrc_cntl_strm_inst[{1}]/mrc_cntl/sdp_cntl/sdp__xxx__mem_request_valid}}'.format(mgr,strm)
       pLine = pLine + '\nadd wave -noupdate -group MGR{0} -group SDP -group STRM{1} -group SDP -radix hexadecimal {{/top/system_inst/manager_array_inst/mgr_inst[{0}]/manager/mrc_cntl_strm_inst[{1}]/mrc_cntl/sdp_cntl/sdp__xxx__mem_request_word}}'.format(mgr,strm)
       pLine = pLine + '\nadd wave -noupdate -group MGR{0} -group SDP -group STRM{1} -group SDP -radix hexadecimal {{/top/system_inst/manager_array_inst/mgr_inst[{0}]/manager/mrc_cntl_strm_inst[{1}]/mrc_cntl/sdp_cntl/sdp__xxx__storage_desc_processing_complete}}'.format(mgr,strm)
       pLine = pLine + '\nadd wave -noupdate -group MGR{0} -group SDP -group STRM{1} -group SDP -radix hexadecimal {{/top/system_inst/manager_array_inst/mgr_inst[{0}]/manager/mrc_cntl_strm_inst[{1}]/mrc_cntl/sdp_cntl/sdpr__sdps__cfg_accessOrder}}'.format(mgr,strm)
       pLine = pLine + '\nadd wave -noupdate -group MGR{0} -group SDP -group STRM{1} -group SDP -radix hexadecimal {{/top/system_inst/manager_array_inst/mgr_inst[{0}]/manager/mrc_cntl_strm_inst[{1}]/mrc_cntl/sdp_cntl/sdpr__sdps__cfg_addr}}'.format(mgr,strm)
       pLine = pLine + '\nadd wave -noupdate -group MGR{0} -group SDP -group STRM{1} -group SDP -radix hexadecimal {{/top/system_inst/manager_array_inst/mgr_inst[{0}]/manager/mrc_cntl_strm_inst[{1}]/mrc_cntl/sdp_cntl/sdpr__sdps__cfg_valid}}'.format(mgr,strm)
       pLine = pLine + '\nadd wave -noupdate -group MGR{0} -group SDP -group STRM{1} -group SDP -radix hexadecimal {{/top/system_inst/manager_array_inst/mgr_inst[{0}]/manager/mrc_cntl_strm_inst[{1}]/mrc_cntl/sdp_cntl/sdpr__sdps__complete}}'.format(mgr,strm)
       pLine = pLine + '\nadd wave -noupdate -group MGR{0} -group SDP -group STRM{1} -group SDP -radix hexadecimal {{/top/system_inst/manager_array_inst/mgr_inst[{0}]/manager/mrc_cntl_strm_inst[{1}]/mrc_cntl/sdp_cntl/sdpr__sdps__consJump_cntl}}'.format(mgr,strm)
       pLine = pLine + '\nadd wave -noupdate -group MGR{0} -group SDP -group STRM{1} -group SDP -radix hexadecimal {{/top/system_inst/manager_array_inst/mgr_inst[{0}]/manager/mrc_cntl_strm_inst[{1}]/mrc_cntl/sdp_cntl/sdpr__sdps__consJump_valid}}'.format(mgr,strm)
       pLine = pLine + '\nadd wave -noupdate -group MGR{0} -group SDP -group STRM{1} -group SDP -radix hexadecimal {{/top/system_inst/manager_array_inst/mgr_inst[{0}]/manager/mrc_cntl_strm_inst[{1}]/mrc_cntl/sdp_cntl/sdpr__sdps__consJump_value}}'.format(mgr,strm)
       pLine = pLine + '\nadd wave -noupdate -group MGR{0} -group SDP -group STRM{1} -group SDP -radix hexadecimal {{/top/system_inst/manager_array_inst/mgr_inst[{0}]/manager/mrc_cntl_strm_inst[{1}]/mrc_cntl/sdp_cntl/sdpr__sdps__response_id_bank}}'.format(mgr,strm)
       pLine = pLine + '\nadd wave -noupdate -group MGR{0} -group SDP -group STRM{1} -group SDP -radix hexadecimal {{/top/system_inst/manager_array_inst/mgr_inst[{0}]/manager/mrc_cntl_strm_inst[{1}]/mrc_cntl/sdp_cntl/sdpr__sdps__response_id_channel}}'.format(mgr,strm)
       pLine = pLine + '\nadd wave -noupdate -group MGR{0} -group SDP -group STRM{1} -group SDP -radix hexadecimal {{/top/system_inst/manager_array_inst/mgr_inst[{0}]/manager/mrc_cntl_strm_inst[{1}]/mrc_cntl/sdp_cntl/sdpr__sdps__response_id_cntl}}'.format(mgr,strm)
       pLine = pLine + '\nadd wave -noupdate -group MGR{0} -group SDP -group STRM{1} -group SDP -radix hexadecimal {{/top/system_inst/manager_array_inst/mgr_inst[{0}]/manager/mrc_cntl_strm_inst[{1}]/mrc_cntl/sdp_cntl/sdpr__sdps__response_id_line}}'.format(mgr,strm)
       pLine = pLine + '\nadd wave -noupdate -group MGR{0} -group SDP -group STRM{1} -group SDP -radix hexadecimal {{/top/system_inst/manager_array_inst/mgr_inst[{0}]/manager/mrc_cntl_strm_inst[{1}]/mrc_cntl/sdp_cntl/sdpr__sdps__response_id_page}}'.format(mgr,strm)
       pLine = pLine + '\nadd wave -noupdate -group MGR{0} -group SDP -group STRM{1} -group SDP -radix hexadecimal {{/top/system_inst/manager_array_inst/mgr_inst[{0}]/manager/mrc_cntl_strm_inst[{1}]/mrc_cntl/sdp_cntl/sdpr__sdps__response_id_valid}}'.format(mgr,strm)
       pLine = pLine + '\nadd wave -noupdate -group MGR{0} -group SDP -group STRM{1} -group SDP -radix hexadecimal {{/top/system_inst/manager_array_inst/mgr_inst[{0}]/manager/mrc_cntl_strm_inst[{1}]/mrc_cntl/sdp_cntl/sdps__sdpr__cfg_ready}}'.format(mgr,strm)
       pLine = pLine + '\nadd wave -noupdate -group MGR{0} -group SDP -group STRM{1} -group SDP -radix hexadecimal {{/top/system_inst/manager_array_inst/mgr_inst[{0}]/manager/mrc_cntl_strm_inst[{1}]/mrc_cntl/sdp_cntl/sdps__sdpr__complete}}'.format(mgr,strm)
       pLine = pLine + '\nadd wave -noupdate -group MGR{0} -group SDP -group STRM{1} -group SDP -radix hexadecimal {{/top/system_inst/manager_array_inst/mgr_inst[{0}]/manager/mrc_cntl_strm_inst[{1}]/mrc_cntl/sdp_cntl/sdps__sdpr__consJump_ready}}'.format(mgr,strm)
       pLine = pLine + '\nadd wave -noupdate -group MGR{0} -group SDP -group STRM{1} -group SDP -radix hexadecimal {{/top/system_inst/manager_array_inst/mgr_inst[{0}]/manager/mrc_cntl_strm_inst[{1}]/mrc_cntl/sdp_cntl/sdps__sdpr__response_id_ready}}'.format(mgr,strm)
       pLine = pLine + '\nadd wave -noupdate -group MGR{0} -group SDP -group STRM{1} -group SDP -radix hexadecimal {{/top/system_inst/manager_array_inst/mgr_inst[{0}]/manager/mrc_cntl_strm_inst[{1}]/mrc_cntl/sdp_cntl/sys__mgr__mgrId}}'.format(mgr,strm)
       pLine = pLine + '\nadd wave -noupdate -group MGR{0} -group SDP -group STRM{1} -group SDP -radix hexadecimal {{/top/system_inst/manager_array_inst/mgr_inst[{0}]/manager/mrc_cntl_strm_inst[{1}]/mrc_cntl/sdp_cntl/xxx__sdp__lane_enable}}'.format(mgr,strm)
       pLine = pLine + '\nadd wave -noupdate -group MGR{0} -group SDP -group STRM{1} -group SDP -radix hexadecimal {{/top/system_inst/manager_array_inst/mgr_inst[{0}]/manager/mrc_cntl_strm_inst[{1}]/mrc_cntl/sdp_cntl/xxx__sdp__lane_ready}}'.format(mgr,strm)
       pLine = pLine + '\nadd wave -noupdate -group MGR{0} -group SDP -group STRM{1} -group SDP -radix hexadecimal {{/top/system_inst/manager_array_inst/mgr_inst[{0}]/manager/mrc_cntl_strm_inst[{1}]/mrc_cntl/sdp_cntl/xxx__sdp__mem_request_channel_data_valid}}'.format(mgr,strm)
       pLine = pLine + '\nadd wave -noupdate -group MGR{0} -group SDP -group STRM{1} -group SDP -radix hexadecimal {{/top/system_inst/manager_array_inst/mgr_inst[{0}]/manager/mrc_cntl_strm_inst[{1}]/mrc_cntl/sdp_cntl/xxx__sdp__mem_request_ready}}'.format(mgr,strm)
       pLine = pLine + '\nadd wave -noupdate -group MGR{0} -group SDP -group STRM{1} -group SDP -radix hexadecimal {{/top/system_inst/manager_array_inst/mgr_inst[{0}]/manager/mrc_cntl_strm_inst[{1}]/mrc_cntl/sdp_cntl/xxx__sdp__num_lanes}}'.format(mgr,strm)
       pLine = pLine + '\nadd wave -noupdate -group MGR{0} -group SDP -group STRM{1} -group SDP -radix hexadecimal {{/top/system_inst/manager_array_inst/mgr_inst[{0}]/manager/mrc_cntl_strm_inst[{1}]/mrc_cntl/sdp_cntl/xxx__sdp__num_lanes_m1}}'.format(mgr,strm)
       pLine = pLine + '\nadd wave -noupdate -group MGR{0} -group SDP -group STRM{1} -group SDP -radix hexadecimal {{/top/system_inst/manager_array_inst/mgr_inst[{0}]/manager/mrc_cntl_strm_inst[{1}]/mrc_cntl/sdp_cntl/xxx__sdp__storage_desc_processing_enable}}'.format(mgr,strm)
       pLine = pLine + '\nadd wave -noupdate -group MGR{0} -group SDP -group STRM{1} -group SDP -radix hexadecimal {{/top/system_inst/manager_array_inst/mgr_inst[{0}]/manager/mrc_cntl_strm_inst[{1}]/mrc_cntl/sdp_cntl/xxx__sdp__storage_desc_ptr}}'.format(mgr,strm)
  ...
  for mgr in range (0, numOfMgr):
    for strm in range (0, numOfStrms):
      ...
      pLine = pLine + '\nadd wave -noupdate -group MGR{0} -group SDP -group STRM{1} -group SDPR -radix hexadecimal {{/top/system_inst/manager_array_inst/mgr_inst[{0}]/manager/mrc_cntl_strm_inst[{1}]/mrc_cntl/sdp_cntl/sdp_request_cntl/clk}}'.format(mgr,strm,lane,chan)
      ...
      pLine = pLine + '\nadd wave -noupdate -group MGR{0} -group SDP -group STRM{1} -group SDPR -radix hexadecimal {{/top/system_inst/manager_array_inst/mgr_inst[{0}]/manager/mrc_cntl_strm_inst[{1}]/mrc_cntl/sdp_cntl/sdp_request_cntl/reset_poweron}}'.format(mgr,strm,lane,chan)
      ...
      pLine = pLine + '\nadd wave -noupdate -group MGR{0} -group SDP -group STRM{1} -group SDPR -radix hexadecimal {{/top/system_inst/manager_array_inst/mgr_inst[{0}]/manager/mrc_cntl_strm_inst[{1}]/mrc_cntl/sdp_cntl/sdp_request_cntl/to_strm_fsm_fifo_ready}}'.format(mgr,strm,lane,chan)
  ...
  for mgr in range (0, numOfMgr):
    ...
    pLine = pLine + '\nadd wave -noupdate -group MGR{0} -group DFI -radix hexadecimal {{/top/system_inst/manager_array_inst/mgr_inst[{0}]/manager/dfi/clk}}'.format(mgr)
    pLine = pLine + '\nadd wave -noupdate -group MGR{0} -group DFI -radix hexadecimal {{/top/system_inst/manager_array_inst/mgr_inst[{0}]/manager/dfi/clk_diram}}'.format(mgr)
    pLine = pLine + '\nadd wave -noupdate -group MGR{0} -group DFI -radix hexadecimal {{/top/system_inst/manager_array_inst/mgr_inst[{0}]/manager/dfi/clk_diram2x}}'.format(mgr)
    pLine = pLine + '\nadd wave -noupdate -group MGR{0} -group DFI -radix hexadecimal {{/top/system_inst/manager_array_inst/mgr_inst[{0}]/manager/dfi/clk_diram_cq}}'.format(mgr)
    pLine = pLine + '\nadd wave -noupdate -group MGR{0} -group DFI -radix hexadecimal {{/top/system_inst/manager_array_inst/mgr_inst[{0}]/manager/dfi/mmc__dfi__addr}}'.format(mgr)
    pLine = pLine + '\nadd wave -noupdate -group MGR{0} -group DFI -radix hexadecimal {{/top/system_inst/manager_array_inst/mgr_inst[{0}]/manager/dfi/mmc__dfi__bank}}'.format(mgr)
    pLine = pLine + '\nadd wave -noupdate -group MGR{0} -group DFI -radix hexadecimal {{/top/system_inst/manager_array_inst/mgr_inst[{0}]/manager/dfi/mmc__dfi__cmd0}}'.format(mgr)
    pLine = pLine + '\nadd wave -noupdate -group MGR{0} -group DFI -radix hexadecimal {{/top/system_inst/manager_array_inst/mgr_inst[{0}]/manager/dfi/mmc__dfi__cmd1}}'.format(mgr)
    pLine = pLine + '\nadd wave -noupdate -group MGR{0} -group DFI -radix hexadecimal {{/top/system_inst/manager_array_inst/mgr_inst[{0}]/manager/dfi/mmc__dfi__cs}}'.format(mgr)
    pLine = pLine + '\nadd wave -noupdate -group MGR{0} -group DFI -radix hexadecimal {{/top/system_inst/manager_array_inst/mgr_inst[{0}]/manager/dfi/mmc__dfi__data}}'.format(mgr)
    pLine = pLine + '\nadd wave -noupdate -group MGR{0} -group DFI -radix hexadecimal {{/top/system_inst/manager_array_inst/mgr_inst[{0}]/manager/dfi/mmc__dfi__data_mask}}'.format(mgr)
    pLine = pLine + '\nadd wave -noupdate -group MGR{0} -group DFI -radix hexadecimal {{/top/system_inst/manager_array_inst/mgr_inst[{0}]/manager/dfi/phy__dfi__data}}'.format(mgr)
    pLine = pLine + '\nadd wave -noupdate -group MGR{0} -group DFI -radix hexadecimal {{/top/system_inst/manager_array_inst/mgr_inst[{0}]/manager/dfi/phy__dfi__valid}}'.format(mgr)
    pLine = pLine + '\nadd wave -noupdate -group MGR{0} -group DFI -radix hexadecimal {{/top/system_inst/manager_array_inst/mgr_inst[{0}]/manager/dfi/reset_poweron}}'.format(mgr)
    pLine = pLine + '\nadd wave -noupdate -group MGR{0} -group DFI -radix hexadecimal {{/top/system_inst/manager_array_inst/mgr_inst[{0}]/manager/dfi/clk_diram_cntl_ck}}'.format(mgr)
    pLine = pLine + '\nadd wave -noupdate -group MGR{0} -group DFI -radix hexadecimal {{/top/system_inst/manager_array_inst/mgr_inst[{0}]/manager/dfi/clk_diram_data_ck}}'.format(mgr)
    pLine = pLine + '\nadd wave -noupdate -group MGR{0} -group DFI -radix hexadecimal {{/top/system_inst/manager_array_inst/mgr_inst[{0}]/manager/dfi/dfi__mmc__cntl}}'.format(mgr)
    pLine = pLine + '\nadd wave -noupdate -group MGR{0} -group DFI -radix hexadecimal {{/top/system_inst/manager_array_inst/mgr_inst[{0}]/manager/dfi/dfi__mmc__data}}'.format(mgr)
    pLine = pLine + '\nadd wave -noupdate -group MGR{0} -group DFI -radix hexadecimal {{/top/system_inst/manager_array_inst/mgr_inst[{0}]/manager/dfi/dfi__mmc__init_done}}'.format(mgr)
    pLine = pLine + '\nadd wave -noupdate -group MGR{0} -group DFI -radix hexadecimal {{/top/system_inst/manager_array_inst/mgr_inst[{0}]/manager/dfi/dfi__mmc__valid}}'.format(mgr)
    pLine = pLine + '\nadd wave -noupdate -group MGR{0} -group DFI -radix hexadecimal {{/top/system_inst/manager_array_inst/mgr_inst[{0}]/manager/dfi/dfi__phy__addr}}'.format(mgr)
    pLine = pLine + '\nadd wave -noupdate -group MGR{0} -group DFI -radix hexadecimal {{/top/system_inst/manager_array_inst/mgr_inst[{0}]/manager/dfi/dfi__phy__bank}}'.format(mgr)
    pLine = pLine + '\nadd wave -noupdate -group MGR{0} -group DFI -radix hexadecimal {{/top/system_inst/manager_array_inst/mgr_inst[{0}]/manager/dfi/dfi__phy__cmd0}}'.format(mgr)
    pLine = pLine + '\nadd wave -noupdate -group MGR{0} -group DFI -radix hexadecimal {{/top/system_inst/manager_array_inst/mgr_inst[{0}]/manager/dfi/dfi__phy__cmd1}}'.format(mgr)
    pLine = pLine + '\nadd wave -noupdate -group MGR{0} -group DFI -radix hexadecimal {{/top/system_inst/manager_array_inst/mgr_inst[{0}]/manager/dfi/dfi__phy__cs}}'.format(mgr)
    pLine = pLine + '\nadd wave -noupdate -group MGR{0} -group DFI -radix hexadecimal {{/top/system_inst/manager_array_inst/mgr_inst[{0}]/manager/dfi/dfi__phy__data}}'.format(mgr)
    pLine = pLine + '\nadd wave -noupdate -group MGR{0} -group DFI -radix hexadecimal {{/top/system_inst/manager_array_inst/mgr_inst[{0}]/manager/dfi/dfi__phy__data_mask}}'.format(mgr)
    pLine = pLine + '\nadd wave -noupdate -group MGR{0} -group DFI -radix hexadecimal {{/top/system_inst/manager_array_inst/mgr_inst[{0}]/manager/dfi/burst_count}}'.format(mgr)
    pLine = pLine + '\nadd wave -noupdate -group MGR{0} -group DFI -radix hexadecimal {{/top/system_inst/manager_array_inst/mgr_inst[{0}]/manager/dfi/clk_diram2x_dly}}'.format(mgr)
    pLine = pLine + '\nadd wave -noupdate -group MGR{0} -group DFI -radix hexadecimal {{/top/system_inst/manager_array_inst/mgr_inst[{0}]/manager/dfi/dfi__mmc__cntl_e3}}'.format(mgr)
    pLine = pLine + '\nadd wave -noupdate -group MGR{0} -group DFI -radix hexadecimal {{/top/system_inst/manager_array_inst/mgr_inst[{0}]/manager/dfi/dfi__mmc__data_e1}}'.format(mgr)
    pLine = pLine + '\nadd wave -noupdate -group MGR{0} -group DFI -radix hexadecimal {{/top/system_inst/manager_array_inst/mgr_inst[{0}]/manager/dfi/dfi__mmc__data_e2}}'.format(mgr)
    pLine = pLine + '\nadd wave -noupdate -group MGR{0} -group DFI -radix hexadecimal {{/top/system_inst/manager_array_inst/mgr_inst[{0}]/manager/dfi/dfi__mmc__data_e3}}'.format(mgr)
    pLine = pLine + '\nadd wave -noupdate -group MGR{0} -group DFI -radix hexadecimal {{/top/system_inst/manager_array_inst/mgr_inst[{0}]/manager/dfi/dfi__mmc__valid_e1}}'.format(mgr)
    pLine = pLine + '\nadd wave -noupdate -group MGR{0} -group DFI -radix hexadecimal {{/top/system_inst/manager_array_inst/mgr_inst[{0}]/manager/dfi/dfi__mmc__valid_e2}}'.format(mgr)
    pLine = pLine + '\nadd wave -noupdate -group MGR{0} -group DFI -radix hexadecimal {{/top/system_inst/manager_array_inst/mgr_inst[{0}]/manager/dfi/dfi__mmc__valid_e3}}'.format(mgr)
    pLine = pLine + '\nadd wave -noupdate -group MGR{0} -group DFI -radix hexadecimal {{/top/system_inst/manager_array_inst/mgr_inst[{0}]/manager/dfi/dfi__phy__addr_e1}}'.format(mgr)
    pLine = pLine + '\nadd wave -noupdate -group MGR{0} -group DFI -radix hexadecimal {{/top/system_inst/manager_array_inst/mgr_inst[{0}]/manager/dfi/dfi__phy__bank_e1}}'.format(mgr)
    pLine = pLine + '\nadd wave -noupdate -group MGR{0} -group DFI -radix hexadecimal {{/top/system_inst/manager_array_inst/mgr_inst[{0}]/manager/dfi/dfi__phy__cmd0_e1}}'.format(mgr)
    pLine = pLine + '\nadd wave -noupdate -group MGR{0} -group DFI -radix hexadecimal {{/top/system_inst/manager_array_inst/mgr_inst[{0}]/manager/dfi/dfi__phy__cmd1_e1}}'.format(mgr)
    pLine = pLine + '\nadd wave -noupdate -group MGR{0} -group DFI -radix hexadecimal {{/top/system_inst/manager_array_inst/mgr_inst[{0}]/manager/dfi/dfi__phy__cs_e1}}'.format(mgr)
    pLine = pLine + '\nadd wave -noupdate -group MGR{0} -group DFI -radix hexadecimal {{/top/system_inst/manager_array_inst/mgr_inst[{0}]/manager/dfi/dfi__phy__data_e1}}'.format(mgr)
    pLine = pLine + '\nadd wave -noupdate -group MGR{0} -group DFI -radix hexadecimal {{/top/system_inst/manager_array_inst/mgr_inst[{0}]/manager/dfi/dfi__phy__data_mask_e1}}'.format(mgr)
    pLine = pLine + '\nadd wave -noupdate -group MGR{0} -group DFI -radix hexadecimal {{/top/system_inst/manager_array_inst/mgr_inst[{0}]/manager/dfi/dram_chan_mode}}'.format(mgr)
    pLine = pLine + '\nadd wave -noupdate -group MGR{0} -group DFI -radix hexadecimal {{/top/system_inst/manager_array_inst/mgr_inst[{0}]/manager/dfi/init_done}}'.format(mgr)
    pLine = pLine + '\nadd wave -noupdate -group MGR{0} -group DFI -radix hexadecimal {{/top/system_inst/manager_array_inst/mgr_inst[{0}]/manager/dfi/init_done_d1}}'.format(mgr)
