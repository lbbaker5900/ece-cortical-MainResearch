...
if __name__ == "__main__":
  ...
  for mgr in range (0, numOfMgr):
        ...
        for port in range (0, numOfPorts):
              pLine = pLine + '\nadd wave -noupdate -group MGR{0} -radix hexadecimal {{/top/system_inst/manager_array_inst/mgr_inst[{0}]/manager/mgr_noc_cntl/mgr__noc__port_valid    [{1}]  }}'.format(mgr,port)
              pLine = pLine + '\nadd wave -noupdate -group MGR{0} -radix hexadecimal {{/top/system_inst/manager_array_inst/mgr_inst[{0}]/manager/mgr_noc_cntl/mgr__noc__port_cntl     [{1}]  }}'.format(mgr,port)
              pLine = pLine + '\nadd wave -noupdate -group MGR{0} -radix hexadecimal {{/top/system_inst/manager_array_inst/mgr_inst[{0}]/manager/mgr_noc_cntl/mgr__noc__port_data     [{1}]  }}'.format(mgr,port)
              pLine = pLine + '\nadd wave -noupdate -group MGR{0} -radix hexadecimal {{/top/system_inst/manager_array_inst/mgr_inst[{0}]/manager/mgr_noc_cntl/mgr__noc__port_fc       [{1}]  }}'.format(mgr,port)
              pLine = pLine + '\nadd wave -noupdate -group MGR{0} -radix hexadecimal {{/top/system_inst/manager_array_inst/mgr_inst[{0}]/manager/mgr_noc_cntl/noc__mgr__port_valid    [{1}]  }}'.format(mgr,port)
              pLine = pLine + '\nadd wave -noupdate -group MGR{0} -radix hexadecimal {{/top/system_inst/manager_array_inst/mgr_inst[{0}]/manager/mgr_noc_cntl/noc__mgr__port_cntl     [{1}]  }}'.format(mgr,port)
              pLine = pLine + '\nadd wave -noupdate -group MGR{0} -radix hexadecimal {{/top/system_inst/manager_array_inst/mgr_inst[{0}]/manager/mgr_noc_cntl/noc__mgr__port_data     [{1}]  }}'.format(mgr,port)
              pLine = pLine + '\nadd wave -noupdate -group MGR{0} -radix hexadecimal {{/top/system_inst/manager_array_inst/mgr_inst[{0}]/manager/mgr_noc_cntl/noc__mgr__port_fc       [{1}]  }}'.format(mgr,port)
  ...
  pLine = ""
  for mgr in range (0, numOfMgr):
    pLine = pLine + '\nadd wave -noupdate -group MGR{0} -group STU -radix hexadecimal {{/top/system_inst/stu__mgr__valid    [{0}]          }}'.format(mgr)
    pLine = pLine + '\nadd wave -noupdate -group MGR{0} -group STU -radix hexadecimal {{/top/system_inst/stu__mgr__cntl     [{0}]          }}'.format(mgr)
    pLine = pLine + '\nadd wave -noupdate -group MGR{0} -group STU -radix hexadecimal {{/top/system_inst/mgr__stu__ready    [{0}]          }}'.format(mgr)
    pLine = pLine + '\nadd wave -noupdate -group MGR{0} -group STU -radix hexadecimal {{/top/system_inst/stu__mgr__type     [{0}]          }}'.format(mgr)
    pLine = pLine + '\nadd wave -noupdate -group MGR{0} -group STU -radix hexadecimal {{/top/system_inst/stu__mgr__data     [{0}]          }}'.format(mgr)
    pLine = pLine + '\nadd wave -noupdate -group MGR{0} -group STU -radix hexadecimal {{/top/system_inst/stu__mgr__oob_data [{0}]          }}'.format(mgr)
    pLine = pLine + '\nadd wave -noupdate -group MGR{0} -group STU -radix float32     {{/top/system_inst/stu__mgr__data     [{0}] [127:96] }}'.format(mgr)
    pLine = pLine + '\nadd wave -noupdate -group MGR{0} -group STU -radix float32     {{/top/system_inst/stu__mgr__data     [{0}] [ 95: 64]}}'.format(mgr)
    pLine = pLine + '\nadd wave -noupdate -group MGR{0} -group STU -radix float32     {{/top/system_inst/stu__mgr__data     [{0}] [ 63: 32]}}'.format(mgr)
    pLine = pLine + '\nadd wave -noupdate -group MGR{0} -group STU -radix float32     {{/top/system_inst/stu__mgr__data     [{0}] [ 31:  0]}}'.format(mgr)
  ...
  for mgr in range (0, numOfMgr):
    for lane in [0,7,15,23,31] :
      for strm in range (0, numOfStrms):
          pLine = pLine + '\nadd wave -noupdate -group MGR{0} -group STD -radix hexadecimal {{/top/system_inst/mgr__std__lane_strm_data_valid[{0}][{1}][{2}]}}'.format(mgr,lane,strm)
          pLine = pLine + '\nadd wave -noupdate -group MGR{0} -group STD -radix hexadecimal {{/top/system_inst/mgr__std__lane_strm_cntl      [{0}][{1}][{2}]}}'.format(mgr,lane,strm)
          pLine = pLine + '\nadd wave -noupdate -group MGR{0} -group STD -radix float32     {{/top/system_inst/mgr__std__lane_strm_data      [{0}][{1}][{2}]}}'.format(mgr,lane,strm)
          pLine = pLine + '\nadd wave -noupdate -group MGR{0} -group STD -radix hexadecimal {{/top/system_inst/std__mgr__lane_strm_ready     [{0}][{1}][{2}]}}'.format(mgr,lane,strm)


  f.write(pLine)
  f.close()

  f = open("../SIMULATION/sv/mrc_cntl.do", "w")
  ...
  for mgr in range (0, numOfMgr):
    for strm in range (0, numOfStrms):
       pLine = pLine + '\nadd wave -noupdate -group MGR{0} -group MRC{1} -group SDP -group GEN -radix hexadecimal {{/top/system_inst/manager_array_inst/mgr_inst[{0}]/manager/mrc_cntl_strm_inst[{1}]/mrc_cntl/sdp_cntl/clk}}'.format(mgr,strm)
       pLine = pLine + '\nadd wave -noupdate -group MGR{0} -group MRC{1} -group SDP -group GEN -radix hexadecimal {{/top/system_inst/manager_array_inst/mgr_inst[{0}]/manager/mrc_cntl_strm_inst[{1}]/mrc_cntl/sdp_cntl/reset_poweron}}'.format(mgr,strm)
       pLine = pLine + '\nadd wave -noupdate -group MGR{0} -group MRC{1} -group SDP -group GEN -radix hexadecimal {{/top/system_inst/manager_array_inst/mgr_inst[{0}]/manager/mrc_cntl_strm_inst[{1}]/mrc_cntl/sdp_cntl/sdp__xxx__get_next_line}}'.format(mgr,strm)
       pLine = pLine + '\nadd wave -noupdate -group MGR{0} -group MRC{1} -group SDP -group GEN -radix hexadecimal {{/top/system_inst/manager_array_inst/mgr_inst[{0}]/manager/mrc_cntl_strm_inst[{1}]/mrc_cntl/sdp_cntl/sdp__xxx__lane_channel_ptr}}'.format(mgr,strm)
       pLine = pLine + '\nadd wave -noupdate -group MGR{0} -group MRC{1} -group SDP -group GEN -radix hexadecimal {{/top/system_inst/manager_array_inst/mgr_inst[{0}]/manager/mrc_cntl_strm_inst[{1}]/mrc_cntl/sdp_cntl/sdp__xxx__lane_cntl}}'.format(mgr,strm)
       pLine = pLine + '\nadd wave -noupdate -group MGR{0} -group MRC{1} -group SDP -group GEN -radix hexadecimal {{/top/system_inst/manager_array_inst/mgr_inst[{0}]/manager/mrc_cntl_strm_inst[{1}]/mrc_cntl/sdp_cntl/sdp__xxx__lane_enable}}'.format(mgr,strm)
       pLine = pLine + '\nadd wave -noupdate -group MGR{0} -group MRC{1} -group SDP -group GEN -radix hexadecimal {{/top/system_inst/manager_array_inst/mgr_inst[{0}]/manager/mrc_cntl_strm_inst[{1}]/mrc_cntl/sdp_cntl/sdp__xxx__lane_valid}}'.format(mgr,strm)
       pLine = pLine + '\nadd wave -noupdate -group MGR{0} -group MRC{1} -group SDP -group GEN -radix hexadecimal {{/top/system_inst/manager_array_inst/mgr_inst[{0}]/manager/mrc_cntl_strm_inst[{1}]/mrc_cntl/sdp_cntl/sdp__xxx__lane_word_ptr}}'.format(mgr,strm)
       pLine = pLine + '\nadd wave -noupdate -group MGR{0} -group MRC{1} -group SDP -group GEN -radix hexadecimal {{/top/system_inst/manager_array_inst/mgr_inst[{0}]/manager/mrc_cntl_strm_inst[{1}]/mrc_cntl/sdp_cntl/sdp__xxx__lane_target}}'.format(mgr,strm)
       pLine = pLine + '\nadd wave -noupdate -group MGR{0} -group MRC{1} -group SDP -group GEN -radix hexadecimal {{/top/system_inst/manager_array_inst/mgr_inst[{0}]/manager/mrc_cntl_strm_inst[{1}]/mrc_cntl/sdp_cntl/xxx__sdp__lane_ready}}'.format(mgr,strm)
       pLine = pLine + '\nadd wave -noupdate -group MGR{0} -group MRC{1} -group SDP -group GEN -radix hexadecimal {{/top/system_inst/manager_array_inst/mgr_inst[{0}]/manager/mrc_cntl_strm_inst[{1}]/mrc_cntl/sdp_cntl/sdp__xxx__mem_request_valid}}'.format(mgr,strm)
       pLine = pLine + '\nadd wave -noupdate -group MGR{0} -group MRC{1} -group SDP -group GEN -radix hexadecimal {{/top/system_inst/manager_array_inst/mgr_inst[{0}]/manager/mrc_cntl_strm_inst[{1}]/mrc_cntl/sdp_cntl/sdp__xxx__mem_request_cntl}}'.format(mgr,strm)
       pLine = pLine + '\nadd wave -noupdate -group MGR{0} -group MRC{1} -group SDP -group GEN -radix hexadecimal {{/top/system_inst/manager_array_inst/mgr_inst[{0}]/manager/mrc_cntl_strm_inst[{1}]/mrc_cntl/sdp_cntl/sdp__xxx__mem_request_channel}}'.format(mgr,strm)
       pLine = pLine + '\nadd wave -noupdate -group MGR{0} -group MRC{1} -group SDP -group GEN -radix hexadecimal {{/top/system_inst/manager_array_inst/mgr_inst[{0}]/manager/mrc_cntl_strm_inst[{1}]/mrc_cntl/sdp_cntl/sdp__xxx__mem_request_bank}}'.format(mgr,strm)
       pLine = pLine + '\nadd wave -noupdate -group MGR{0} -group MRC{1} -group SDP -group GEN -radix hexadecimal {{/top/system_inst/manager_array_inst/mgr_inst[{0}]/manager/mrc_cntl_strm_inst[{1}]/mrc_cntl/sdp_cntl/sdp__xxx__mem_request_page}}'.format(mgr,strm)
       pLine = pLine + '\nadd wave -noupdate -group MGR{0} -group MRC{1} -group SDP -group GEN -radix hexadecimal {{/top/system_inst/manager_array_inst/mgr_inst[{0}]/manager/mrc_cntl_strm_inst[{1}]/mrc_cntl/sdp_cntl/sdp__xxx__mem_request_word}}'.format(mgr,strm)
       pLine = pLine + '\nadd wave -noupdate -group MGR{0} -group MRC{1} -group SDP -group GEN -radix hexadecimal {{/top/system_inst/manager_array_inst/mgr_inst[{0}]/manager/mrc_cntl_strm_inst[{1}]/mrc_cntl/sdp_cntl/xxx__sdp__mem_request_ready}}'.format(mgr,strm)
       pLine = pLine + '\nadd wave -noupdate -group MGR{0} -group MRC{1} -group SDP -group GEN -radix hexadecimal {{/top/system_inst/manager_array_inst/mgr_inst[{0}]/manager/mrc_cntl_strm_inst[{1}]/mrc_cntl/sdp_cntl/xxx__sdp__mem_request_channel_data_valid}}'.format(mgr,strm)
       pLine = pLine + '\nadd wave -noupdate -group MGR{0} -group MRC{1} -group SDP -group GEN -radix hexadecimal {{/top/system_inst/manager_array_inst/mgr_inst[{0}]/manager/mrc_cntl_strm_inst[{1}]/mrc_cntl/sdp_cntl/sdp__xxx__storage_desc_processing_complete}}'.format(mgr,strm)
       pLine = pLine + '\nadd wave -noupdate -group MGR{0} -group MRC{1} -group SDP -group GEN -radix hexadecimal {{/top/system_inst/manager_array_inst/mgr_inst[{0}]/manager/mrc_cntl_strm_inst[{1}]/mrc_cntl/sdp_cntl/sdpr__sdps__cfg_lane_enable}}'.format(mgr,strm)
       pLine = pLine + '\nadd wave -noupdate -group MGR{0} -group MRC{1} -group SDP -group GEN -radix hexadecimal {{/top/system_inst/manager_array_inst/mgr_inst[{0}]/manager/mrc_cntl_strm_inst[{1}]/mrc_cntl/sdp_cntl/sdpr__sdps__cfg_accessOrder}}'.format(mgr,strm)
       pLine = pLine + '\nadd wave -noupdate -group MGR{0} -group MRC{1} -group SDP -group GEN -radix hexadecimal {{/top/system_inst/manager_array_inst/mgr_inst[{0}]/manager/mrc_cntl_strm_inst[{1}]/mrc_cntl/sdp_cntl/sdpr__sdps__cfg_addr}}'.format(mgr,strm)
       pLine = pLine + '\nadd wave -noupdate -group MGR{0} -group MRC{1} -group SDP -group GEN -radix hexadecimal {{/top/system_inst/manager_array_inst/mgr_inst[{0}]/manager/mrc_cntl_strm_inst[{1}]/mrc_cntl/sdp_cntl/sdpr__sdps__cfg_valid}}'.format(mgr,strm)
       pLine = pLine + '\nadd wave -noupdate -group MGR{0} -group MRC{1} -group SDP -group GEN -radix hexadecimal {{/top/system_inst/manager_array_inst/mgr_inst[{0}]/manager/mrc_cntl_strm_inst[{1}]/mrc_cntl/sdp_cntl/sdpr__sdps__complete}}'.format(mgr,strm)
       pLine = pLine + '\nadd wave -noupdate -group MGR{0} -group MRC{1} -group SDP -group GEN -radix hexadecimal {{/top/system_inst/manager_array_inst/mgr_inst[{0}]/manager/mrc_cntl_strm_inst[{1}]/mrc_cntl/sdp_cntl/sdpr__sdps__consJump_cntl}}'.format(mgr,strm)
       pLine = pLine + '\nadd wave -noupdate -group MGR{0} -group MRC{1} -group SDP -group GEN -radix hexadecimal {{/top/system_inst/manager_array_inst/mgr_inst[{0}]/manager/mrc_cntl_strm_inst[{1}]/mrc_cntl/sdp_cntl/sdpr__sdps__consJump_valid}}'.format(mgr,strm)
       pLine = pLine + '\nadd wave -noupdate -group MGR{0} -group MRC{1} -group SDP -group GEN -radix hexadecimal {{/top/system_inst/manager_array_inst/mgr_inst[{0}]/manager/mrc_cntl_strm_inst[{1}]/mrc_cntl/sdp_cntl/sdpr__sdps__consJump_value}}'.format(mgr,strm)
       pLine = pLine + '\nadd wave -noupdate -group MGR{0} -group MRC{1} -group SDP -group GEN -radix hexadecimal {{/top/system_inst/manager_array_inst/mgr_inst[{0}]/manager/mrc_cntl_strm_inst[{1}]/mrc_cntl/sdp_cntl/sdpr__sdps__response_id_bank}}'.format(mgr,strm)
       pLine = pLine + '\nadd wave -noupdate -group MGR{0} -group MRC{1} -group SDP -group GEN -radix hexadecimal {{/top/system_inst/manager_array_inst/mgr_inst[{0}]/manager/mrc_cntl_strm_inst[{1}]/mrc_cntl/sdp_cntl/sdpr__sdps__response_id_channel}}'.format(mgr,strm)
       pLine = pLine + '\nadd wave -noupdate -group MGR{0} -group MRC{1} -group SDP -group GEN -radix hexadecimal {{/top/system_inst/manager_array_inst/mgr_inst[{0}]/manager/mrc_cntl_strm_inst[{1}]/mrc_cntl/sdp_cntl/sdpr__sdps__response_id_cntl}}'.format(mgr,strm)
       pLine = pLine + '\nadd wave -noupdate -group MGR{0} -group MRC{1} -group SDP -group GEN -radix hexadecimal {{/top/system_inst/manager_array_inst/mgr_inst[{0}]/manager/mrc_cntl_strm_inst[{1}]/mrc_cntl/sdp_cntl/sdpr__sdps__response_id_line}}'.format(mgr,strm)
       pLine = pLine + '\nadd wave -noupdate -group MGR{0} -group MRC{1} -group SDP -group GEN -radix hexadecimal {{/top/system_inst/manager_array_inst/mgr_inst[{0}]/manager/mrc_cntl_strm_inst[{1}]/mrc_cntl/sdp_cntl/sdpr__sdps__response_id_page}}'.format(mgr,strm)
       pLine = pLine + '\nadd wave -noupdate -group MGR{0} -group MRC{1} -group SDP -group GEN -radix hexadecimal {{/top/system_inst/manager_array_inst/mgr_inst[{0}]/manager/mrc_cntl_strm_inst[{1}]/mrc_cntl/sdp_cntl/sdpr__sdps__response_id_valid}}'.format(mgr,strm)
       pLine = pLine + '\nadd wave -noupdate -group MGR{0} -group MRC{1} -group SDP -group GEN -radix hexadecimal {{/top/system_inst/manager_array_inst/mgr_inst[{0}]/manager/mrc_cntl_strm_inst[{1}]/mrc_cntl/sdp_cntl/sdps__sdpr__cfg_ready}}'.format(mgr,strm)
       pLine = pLine + '\nadd wave -noupdate -group MGR{0} -group MRC{1} -group SDP -group GEN -radix hexadecimal {{/top/system_inst/manager_array_inst/mgr_inst[{0}]/manager/mrc_cntl_strm_inst[{1}]/mrc_cntl/sdp_cntl/sdps__sdpr__complete}}'.format(mgr,strm)
       pLine = pLine + '\nadd wave -noupdate -group MGR{0} -group MRC{1} -group SDP -group GEN -radix hexadecimal {{/top/system_inst/manager_array_inst/mgr_inst[{0}]/manager/mrc_cntl_strm_inst[{1}]/mrc_cntl/sdp_cntl/sdps__sdpr__consJump_ready}}'.format(mgr,strm)
       pLine = pLine + '\nadd wave -noupdate -group MGR{0} -group MRC{1} -group SDP -group GEN -radix hexadecimal {{/top/system_inst/manager_array_inst/mgr_inst[{0}]/manager/mrc_cntl_strm_inst[{1}]/mrc_cntl/sdp_cntl/sdps__sdpr__response_id_ready}}'.format(mgr,strm)
       pLine = pLine + '\nadd wave -noupdate -group MGR{0} -group MRC{1} -group SDP -group GEN -radix hexadecimal {{/top/system_inst/manager_array_inst/mgr_inst[{0}]/manager/mrc_cntl_strm_inst[{1}]/mrc_cntl/sdp_cntl/sys__mgr__mgrId}}'.format(mgr,strm)
       pLine = pLine + '\nadd wave -noupdate -group MGR{0} -group MRC{1} -group SDP -group GEN -radix hexadecimal {{/top/system_inst/manager_array_inst/mgr_inst[{0}]/manager/mrc_cntl_strm_inst[{1}]/mrc_cntl/sdp_cntl/xxx__sdp__lane_enable}}'.format(mgr,strm)
       pLine = pLine + '\nadd wave -noupdate -group MGR{0} -group MRC{1} -group SDP -group GEN -radix hexadecimal {{/top/system_inst/manager_array_inst/mgr_inst[{0}]/manager/mrc_cntl_strm_inst[{1}]/mrc_cntl/sdp_cntl/xxx__sdp__target}}'.format(mgr,strm)
       pLine = pLine + '\nadd wave -noupdate -group MGR{0} -group MRC{1} -group SDP -group GEN -radix hexadecimal {{/top/system_inst/manager_array_inst/mgr_inst[{0}]/manager/mrc_cntl_strm_inst[{1}]/mrc_cntl/sdp_cntl/xxx__sdp__num_lanes}}'.format(mgr,strm)
       pLine = pLine + '\nadd wave -noupdate -group MGR{0} -group MRC{1} -group SDP -group GEN -radix hexadecimal {{/top/system_inst/manager_array_inst/mgr_inst[{0}]/manager/mrc_cntl_strm_inst[{1}]/mrc_cntl/sdp_cntl/xxx__sdp__num_lanes_m1}}'.format(mgr,strm)
       pLine = pLine + '\nadd wave -noupdate -group MGR{0} -group MRC{1} -group SDP -group GEN -radix hexadecimal {{/top/system_inst/manager_array_inst/mgr_inst[{0}]/manager/mrc_cntl_strm_inst[{1}]/mrc_cntl/sdp_cntl/xxx__sdp__storage_desc_processing_enable}}'.format(mgr,strm)
       pLine = pLine + '\nadd wave -noupdate -group MGR{0} -group MRC{1} -group SDP -group GEN -radix hexadecimal {{/top/system_inst/manager_array_inst/mgr_inst[{0}]/manager/mrc_cntl_strm_inst[{1}]/mrc_cntl/sdp_cntl/xxx__sdp__storage_desc_ptr}}'.format(mgr,strm)
  ...
  for mgr in range (0, numOfMgr):
    for strm in range (0, numOfStrms):
      pLine = pLine + '\nadd wave -noupdate -group MGR{0} -group MRC{1} -group SDP -group SDPR -radix hexadecimal {{/top/system_inst/manager_array_inst/mgr_inst[{0}]/manager/mrc_cntl_strm_inst[{1}]/mrc_cntl/sdp_cntl/sdp_request_cntl/sdp_cntl_proc_storage_desc_state}}'.format(mgr,strm,lane,chan)
      pLine = pLine + '\nadd wave -noupdate -group MGR{0} -group MRC{1} -group SDP -group SDPR -radix hexadecimal {{/top/system_inst/manager_array_inst/mgr_inst[{0}]/manager/mrc_cntl_strm_inst[{1}]/mrc_cntl/sdp_cntl/sdp_request_cntl/sdp_cntl_proc_storage_desc_state_next}}'.format(mgr,strm,lane,chan)
      pLine = pLine + '\nadd wave -noupdate -group MGR{0} -group MRC{1} -group SDP -group SDPR -radix hexadecimal {{/top/system_inst/manager_array_inst/mgr_inst[{0}]/manager/mrc_cntl_strm_inst[{1}]/mrc_cntl/sdp_cntl/sdp_request_cntl/sdp__xxx__mem_request_valid}}'.format(mgr,strm,lane,chan)
      pLine = pLine + '\nadd wave -noupdate -group MGR{0} -group MRC{1} -group SDP -group SDPR -radix hexadecimal {{/top/system_inst/manager_array_inst/mgr_inst[{0}]/manager/mrc_cntl_strm_inst[{1}]/mrc_cntl/sdp_cntl/sdp_request_cntl/sdp__xxx__mem_request_cntl}}'.format(mgr,strm,lane,chan)
      pLine = pLine + '\nadd wave -noupdate -group MGR{0} -group MRC{1} -group SDP -group SDPR -radix hexadecimal {{/top/system_inst/manager_array_inst/mgr_inst[{0}]/manager/mrc_cntl_strm_inst[{1}]/mrc_cntl/sdp_cntl/sdp_request_cntl/sdp__xxx__mem_request_channel}}'.format(mgr,strm,lane,chan)
      pLine = pLine + '\nadd wave -noupdate -group MGR{0} -group MRC{1} -group SDP -group SDPR -radix hexadecimal {{/top/system_inst/manager_array_inst/mgr_inst[{0}]/manager/mrc_cntl_strm_inst[{1}]/mrc_cntl/sdp_cntl/sdp_request_cntl/sdp__xxx__mem_request_bank}}'.format(mgr,strm,lane,chan)
      pLine = pLine + '\nadd wave -noupdate -group MGR{0} -group MRC{1} -group SDP -group SDPR -radix hexadecimal {{/top/system_inst/manager_array_inst/mgr_inst[{0}]/manager/mrc_cntl_strm_inst[{1}]/mrc_cntl/sdp_cntl/sdp_request_cntl/sdp__xxx__mem_request_page}}'.format(mgr,strm,lane,chan)
      pLine = pLine + '\nadd wave -noupdate -group MGR{0} -group MRC{1} -group SDP -group SDPR -radix hexadecimal {{/top/system_inst/manager_array_inst/mgr_inst[{0}]/manager/mrc_cntl_strm_inst[{1}]/mrc_cntl/sdp_cntl/sdp_request_cntl/sdp__xxx__mem_request_word}}'.format(mgr,strm,lane,chan)
      pLine = pLine + '\nadd wave -noupdate -group MGR{0} -group MRC{1} -group SDP -group SDPR -radix hexadecimal {{/top/system_inst/manager_array_inst/mgr_inst[{0}]/manager/mrc_cntl_strm_inst[{1}]/mrc_cntl/sdp_cntl/sdp_request_cntl/xxx__sdp__mem_request_ready}}'.format(mgr,strm,lane,chan)
      pLine = pLine + '\nadd wave -noupdate -group MGR{0} -group MRC{1} -group SDP -group SDPR -radix hexadecimal {{/top/system_inst/manager_array_inst/mgr_inst[{0}]/manager/mrc_cntl_strm_inst[{1}]/mrc_cntl/sdp_cntl/sdp_request_cntl/sdpr__sdps__response_id_valid}}'.format(mgr,strm,lane,chan)
      pLine = pLine + '\nadd wave -noupdate -group MGR{0} -group MRC{1} -group SDP -group SDPR -radix hexadecimal {{/top/system_inst/manager_array_inst/mgr_inst[{0}]/manager/mrc_cntl_strm_inst[{1}]/mrc_cntl/sdp_cntl/sdp_request_cntl/sdpr__sdps__response_id_cntl}}'.format(mgr,strm,lane,chan)
      pLine = pLine + '\nadd wave -noupdate -group MGR{0} -group MRC{1} -group SDP -group SDPR -radix hexadecimal {{/top/system_inst/manager_array_inst/mgr_inst[{0}]/manager/mrc_cntl_strm_inst[{1}]/mrc_cntl/sdp_cntl/sdp_request_cntl/sdpr__sdps__response_id_channel}}'.format(mgr,strm,lane,chan)
      pLine = pLine + '\nadd wave -noupdate -group MGR{0} -group MRC{1} -group SDP -group SDPR -radix hexadecimal {{/top/system_inst/manager_array_inst/mgr_inst[{0}]/manager/mrc_cntl_strm_inst[{1}]/mrc_cntl/sdp_cntl/sdp_request_cntl/sdpr__sdps__response_id_bank}}'.format(mgr,strm,lane,chan)
      pLine = pLine + '\nadd wave -noupdate -group MGR{0} -group MRC{1} -group SDP -group SDPR -radix hexadecimal {{/top/system_inst/manager_array_inst/mgr_inst[{0}]/manager/mrc_cntl_strm_inst[{1}]/mrc_cntl/sdp_cntl/sdp_request_cntl/sdpr__sdps__response_id_page}}'.format(mgr,strm,lane,chan)
      pLine = pLine + '\nadd wave -noupdate -group MGR{0} -group MRC{1} -group SDP -group SDPR -radix hexadecimal {{/top/system_inst/manager_array_inst/mgr_inst[{0}]/manager/mrc_cntl_strm_inst[{1}]/mrc_cntl/sdp_cntl/sdp_request_cntl/sdpr__sdps__response_id_line}}'.format(mgr,strm,lane,chan)
      pLine = pLine + '\nadd wave -noupdate -group MGR{0} -group MRC{1} -group SDP -group SDPR -radix hexadecimal {{/top/system_inst/manager_array_inst/mgr_inst[{0}]/manager/mrc_cntl_strm_inst[{1}]/mrc_cntl/sdp_cntl/sdp_request_cntl/sdps__sdpr__response_id_ready}}'.format(mgr,strm,lane,chan)
      pLine = pLine + '\nadd wave -noupdate -group MGR{0} -group MRC{1} -group SDP -group SDPR -radix hexadecimal {{/top/system_inst/manager_array_inst/mgr_inst[{0}]/manager/mrc_cntl_strm_inst[{1}]/mrc_cntl/sdp_cntl/sdp_request_cntl/sdpr__sdps__response_id_valid_e1}}'.format(mgr,strm,lane,chan)
      pLine = pLine + '\nadd wave -noupdate -group MGR{0} -group MRC{1} -group SDP -group SDPR -radix hexadecimal {{/top/system_inst/manager_array_inst/mgr_inst[{0}]/manager/mrc_cntl_strm_inst[{1}]/mrc_cntl/sdp_cntl/sdp_request_cntl/sdpr__sdps__response_id_cntl_e1}}'.format(mgr,strm,lane,chan)
      pLine = pLine + '\nadd wave -noupdate -group MGR{0} -group MRC{1} -group SDP -group SDPR -radix hexadecimal {{/top/system_inst/manager_array_inst/mgr_inst[{0}]/manager/mrc_cntl_strm_inst[{1}]/mrc_cntl/sdp_cntl/sdp_request_cntl/sdpr__sdps__response_id_channel_e1}}'.format(mgr,strm,lane,chan)
      pLine = pLine + '\nadd wave -noupdate -group MGR{0} -group MRC{1} -group SDP -group SDPR -radix hexadecimal {{/top/system_inst/manager_array_inst/mgr_inst[{0}]/manager/mrc_cntl_strm_inst[{1}]/mrc_cntl/sdp_cntl/sdp_request_cntl/sdpr__sdps__response_id_bank_e1}}'.format(mgr,strm,lane,chan)
      pLine = pLine + '\nadd wave -noupdate -group MGR{0} -group MRC{1} -group SDP -group SDPR -radix hexadecimal {{/top/system_inst/manager_array_inst/mgr_inst[{0}]/manager/mrc_cntl_strm_inst[{1}]/mrc_cntl/sdp_cntl/sdp_request_cntl/sdpr__sdps__response_id_page_e1}}'.format(mgr,strm,lane,chan)
      pLine = pLine + '\nadd wave -noupdate -group MGR{0} -group MRC{1} -group SDP -group SDPR -radix hexadecimal {{/top/system_inst/manager_array_inst/mgr_inst[{0}]/manager/mrc_cntl_strm_inst[{1}]/mrc_cntl/sdp_cntl/sdp_request_cntl/sdpr__sdps__response_id_line_e1}}'.format(mgr,strm,lane,chan)
      pLine = pLine + '\nadd wave -noupdate -group MGR{0} -group MRC{1} -group SDP -group SDPR -radix hexadecimal {{/top/system_inst/manager_array_inst/mgr_inst[{0}]/manager/mrc_cntl_strm_inst[{1}]/mrc_cntl/sdp_cntl/sdp_request_cntl/sdps__sdpr__response_id_ready_d1}}'.format(mgr,strm,lane,chan)
      pLine = pLine + '\nadd wave -noupdate -group MGR{0} -group MRC{1} -group SDP -group SDPR -radix hexadecimal {{/top/system_inst/manager_array_inst/mgr_inst[{0}]/manager/mrc_cntl_strm_inst[{1}]/mrc_cntl/sdp_cntl/sdp_request_cntl/cj_address}}'.format(mgr,strm,lane,chan)
      pLine = pLine + '\nadd wave -noupdate -group MGR{0} -group MRC{1} -group SDP -group SDPR -radix hexadecimal {{/top/system_inst/manager_array_inst/mgr_inst[{0}]/manager/mrc_cntl_strm_inst[{1}]/mrc_cntl/sdp_cntl/sdp_request_cntl/cj_bank}}'.format(mgr,strm,lane,chan)
      pLine = pLine + '\nadd wave -noupdate -group MGR{0} -group MRC{1} -group SDP -group SDPR -radix hexadecimal {{/top/system_inst/manager_array_inst/mgr_inst[{0}]/manager/mrc_cntl_strm_inst[{1}]/mrc_cntl/sdp_cntl/sdp_request_cntl/cj_channel}}'.format(mgr,strm,lane,chan)
      pLine = pLine + '\nadd wave -noupdate -group MGR{0} -group MRC{1} -group SDP -group SDPR -radix hexadecimal {{/top/system_inst/manager_array_inst/mgr_inst[{0}]/manager/mrc_cntl_strm_inst[{1}]/mrc_cntl/sdp_cntl/sdp_request_cntl/cj_ms_lane_address}}'.format(mgr,strm,lane,chan)
      pLine = pLine + '\nadd wave -noupdate -group MGR{0} -group MRC{1} -group SDP -group SDPR -radix hexadecimal {{/top/system_inst/manager_array_inst/mgr_inst[{0}]/manager/mrc_cntl_strm_inst[{1}]/mrc_cntl/sdp_cntl/sdp_request_cntl/cj_ms_lane_bank}}'.format(mgr,strm,lane,chan)
      pLine = pLine + '\nadd wave -noupdate -group MGR{0} -group MRC{1} -group SDP -group SDPR -radix hexadecimal {{/top/system_inst/manager_array_inst/mgr_inst[{0}]/manager/mrc_cntl_strm_inst[{1}]/mrc_cntl/sdp_cntl/sdp_request_cntl/cj_ms_lane_channel}}'.format(mgr,strm,lane,chan)
      pLine = pLine + '\nadd wave -noupdate -group MGR{0} -group MRC{1} -group SDP -group SDPR -radix hexadecimal {{/top/system_inst/manager_array_inst/mgr_inst[{0}]/manager/mrc_cntl_strm_inst[{1}]/mrc_cntl/sdp_cntl/sdp_request_cntl/cj_ms_lane_page}}'.format(mgr,strm,lane,chan)
      pLine = pLine + '\nadd wave -noupdate -group MGR{0} -group MRC{1} -group SDP -group SDPR -radix hexadecimal {{/top/system_inst/manager_array_inst/mgr_inst[{0}]/manager/mrc_cntl_strm_inst[{1}]/mrc_cntl/sdp_cntl/sdp_request_cntl/cj_ms_lane_word}}'.format(mgr,strm,lane,chan)
      pLine = pLine + '\nadd wave -noupdate -group MGR{0} -group MRC{1} -group SDP -group SDPR -radix hexadecimal {{/top/system_inst/manager_array_inst/mgr_inst[{0}]/manager/mrc_cntl_strm_inst[{1}]/mrc_cntl/sdp_cntl/sdp_request_cntl/cj_page}}'.format(mgr,strm,lane,chan)
      pLine = pLine + '\nadd wave -noupdate -group MGR{0} -group MRC{1} -group SDP -group SDPR -radix hexadecimal {{/top/system_inst/manager_array_inst/mgr_inst[{0}]/manager/mrc_cntl_strm_inst[{1}]/mrc_cntl/sdp_cntl/sdp_request_cntl/cj_word}}'.format(mgr,strm,lane,chan)
      pLine = pLine + '\nadd wave -noupdate -group MGR{0} -group MRC{1} -group SDP -group SDPR -radix hexadecimal {{/top/system_inst/manager_array_inst/mgr_inst[{0}]/manager/mrc_cntl_strm_inst[{1}]/mrc_cntl/sdp_cntl/sdp_request_cntl/pbc_last_end_is_cons_tm1_end}}'.format(mgr,strm,lane,chan)
      pLine = pLine + '\nadd wave -noupdate -group MGR{0} -group MRC{1} -group SDP -group SDPR -radix hexadecimal {{/top/system_inst/manager_array_inst/mgr_inst[{0}]/manager/mrc_cntl_strm_inst[{1}]/mrc_cntl/sdp_cntl/sdp_request_cntl/pbc_last_requested_valid}}'.format(mgr,strm,lane,chan)
      pLine = pLine + '\nadd wave -noupdate -group MGR{0} -group MRC{1} -group SDP -group SDPR -radix hexadecimal {{/top/system_inst/manager_array_inst/mgr_inst[{0}]/manager/mrc_cntl_strm_inst[{1}]/mrc_cntl/sdp_cntl/sdp_request_cntl/pbc_last_requested_mismatch}}'.format(mgr,strm,lane,chan)
      pLine = pLine + '\nadd wave -noupdate -group MGR{0} -group MRC{1} -group SDP -group SDPR -radix hexadecimal {{/top/system_inst/manager_array_inst/mgr_inst[{0}]/manager/mrc_cntl_strm_inst[{1}]/mrc_cntl/sdp_cntl/sdp_request_cntl/pbc_bank_last_requested}}'.format(mgr,strm,lane,chan)
      pLine = pLine + '\nadd wave -noupdate -group MGR{0} -group MRC{1} -group SDP -group SDPR -radix hexadecimal {{/top/system_inst/manager_array_inst/mgr_inst[{0}]/manager/mrc_cntl_strm_inst[{1}]/mrc_cntl/sdp_cntl/sdp_request_cntl/pbc_page_last_requested}}'.format(mgr,strm,lane,chan)
      pLine = pLine + '\nadd wave -noupdate -group MGR{0} -group MRC{1} -group SDP -group SDPR -radix hexadecimal {{/top/system_inst/manager_array_inst/mgr_inst[{0}]/manager/mrc_cntl_strm_inst[{1}]/mrc_cntl/sdp_cntl/sdp_request_cntl/completed_streaming}}'.format(mgr,strm,lane,chan)
      pLine = pLine + '\nadd wave -noupdate -group MGR{0} -group MRC{1} -group SDP -group SDPR -radix hexadecimal {{/top/system_inst/manager_array_inst/mgr_inst[{0}]/manager/mrc_cntl_strm_inst[{1}]/mrc_cntl/sdp_cntl/sdp_request_cntl/consJumpMemory_cntl}}'.format(mgr,strm,lane,chan)
      pLine = pLine + '\nadd wave -noupdate -group MGR{0} -group MRC{1} -group SDP -group SDPR -radix hexadecimal {{/top/system_inst/manager_array_inst/mgr_inst[{0}]/manager/mrc_cntl_strm_inst[{1}]/mrc_cntl/sdp_cntl/sdp_request_cntl/consJumpMemory_eom}}'.format(mgr,strm,lane,chan)
      pLine = pLine + '\nadd wave -noupdate -group MGR{0} -group MRC{1} -group SDP -group SDPR -radix hexadecimal {{/top/system_inst/manager_array_inst/mgr_inst[{0}]/manager/mrc_cntl_strm_inst[{1}]/mrc_cntl/sdp_cntl/sdp_request_cntl/consJumpMemory_som}}'.format(mgr,strm,lane,chan)
      pLine = pLine + '\nadd wave -noupdate -group MGR{0} -group MRC{1} -group SDP -group SDPR -radix hexadecimal {{/top/system_inst/manager_array_inst/mgr_inst[{0}]/manager/mrc_cntl_strm_inst[{1}]/mrc_cntl/sdp_cntl/sdp_request_cntl/consJumpMemory_som_eom}}'.format(mgr,strm,lane,chan)
      pLine = pLine + '\nadd wave -noupdate -group MGR{0} -group MRC{1} -group SDP -group SDPR -radix hexadecimal {{/top/system_inst/manager_array_inst/mgr_inst[{0}]/manager/mrc_cntl_strm_inst[{1}]/mrc_cntl/sdp_cntl/sdp_request_cntl/consJumpMemory_value}}'.format(mgr,strm,lane,chan)
      pLine = pLine + '\nadd wave -noupdate -group MGR{0} -group MRC{1} -group SDP -group SDPR -radix hexadecimal {{/top/system_inst/manager_array_inst/mgr_inst[{0}]/manager/mrc_cntl_strm_inst[{1}]/mrc_cntl/sdp_cntl/sdp_request_cntl/consJumpPtr}}'.format(mgr,strm,lane,chan)
      pLine = pLine + '\nadd wave -noupdate -group MGR{0} -group MRC{1} -group SDP -group SDPR -radix hexadecimal {{/top/system_inst/manager_array_inst/mgr_inst[{0}]/manager/mrc_cntl_strm_inst[{1}]/mrc_cntl/sdp_cntl/sdp_request_cntl/create_response_id}}'.format(mgr,strm,lane,chan)
      pLine = pLine + '\nadd wave -noupdate -group MGR{0} -group MRC{1} -group SDP -group SDPR -radix hexadecimal {{/top/system_inst/manager_array_inst/mgr_inst[{0}]/manager/mrc_cntl_strm_inst[{1}]/mrc_cntl/sdp_cntl/sdp_request_cntl/desc_processor_strm_ack}}'.format(mgr,strm,lane,chan)
      pLine = pLine + '\nadd wave -noupdate -group MGR{0} -group MRC{1} -group SDP -group SDPR -radix hexadecimal {{/top/system_inst/manager_array_inst/mgr_inst[{0}]/manager/mrc_cntl_strm_inst[{1}]/mrc_cntl/sdp_cntl/sdp_request_cntl/inc_consJumpPtr}}'.format(mgr,strm,lane,chan)
      pLine = pLine + '\nadd wave -noupdate -group MGR{0} -group MRC{1} -group SDP -group SDPR -radix hexadecimal {{/top/system_inst/manager_array_inst/mgr_inst[{0}]/manager/mrc_cntl_strm_inst[{1}]/mrc_cntl/sdp_cntl/sdp_request_cntl/local_storage_desc_ptr}}'.format(mgr,strm,lane,chan)
      pLine = pLine + '\nadd wave -noupdate -group MGR{0} -group MRC{1} -group SDP -group SDPR -radix hexadecimal {{/top/system_inst/manager_array_inst/mgr_inst[{0}]/manager/mrc_cntl_strm_inst[{1}]/mrc_cntl/sdp_cntl/sdp_request_cntl/mem_ms_lane_start_address}}'.format(mgr,strm,lane,chan)
      pLine = pLine + '\nadd wave -noupdate -group MGR{0} -group MRC{1} -group SDP -group SDPR -radix hexadecimal {{/top/system_inst/manager_array_inst/mgr_inst[{0}]/manager/mrc_cntl_strm_inst[{1}]/mrc_cntl/sdp_cntl/sdp_request_cntl/mem_start_address}}'.format(mgr,strm,lane,chan)
      pLine = pLine + '\nadd wave -noupdate -group MGR{0} -group MRC{1} -group SDP -group SDPR -radix hexadecimal {{/top/system_inst/manager_array_inst/mgr_inst[{0}]/manager/mrc_cntl_strm_inst[{1}]/mrc_cntl/sdp_cntl/sdp_request_cntl/mem_start_bank}}'.format(mgr,strm,lane,chan)
      pLine = pLine + '\nadd wave -noupdate -group MGR{0} -group MRC{1} -group SDP -group SDPR -radix hexadecimal {{/top/system_inst/manager_array_inst/mgr_inst[{0}]/manager/mrc_cntl_strm_inst[{1}]/mrc_cntl/sdp_cntl/sdp_request_cntl/mem_start_channel}}'.format(mgr,strm,lane,chan)
      pLine = pLine + '\nadd wave -noupdate -group MGR{0} -group MRC{1} -group SDP -group SDPR -radix hexadecimal {{/top/system_inst/manager_array_inst/mgr_inst[{0}]/manager/mrc_cntl_strm_inst[{1}]/mrc_cntl/sdp_cntl/sdp_request_cntl/mem_start_line}}'.format(mgr,strm,lane,chan)
      pLine = pLine + '\nadd wave -noupdate -group MGR{0} -group MRC{1} -group SDP -group SDPR -radix hexadecimal {{/top/system_inst/manager_array_inst/mgr_inst[{0}]/manager/mrc_cntl_strm_inst[{1}]/mrc_cntl/sdp_cntl/sdp_request_cntl/mem_start_page}}'.format(mgr,strm,lane,chan)
      pLine = pLine + '\nadd wave -noupdate -group MGR{0} -group MRC{1} -group SDP -group SDPR -radix hexadecimal {{/top/system_inst/manager_array_inst/mgr_inst[{0}]/manager/mrc_cntl_strm_inst[{1}]/mrc_cntl/sdp_cntl/sdp_request_cntl/mem_start_word}}'.format(mgr,strm,lane,chan)
      pLine = pLine + '\nadd wave -noupdate -group MGR{0} -group MRC{1} -group SDP -group SDPR -radix hexadecimal {{/top/system_inst/manager_array_inst/mgr_inst[{0}]/manager/mrc_cntl_strm_inst[{1}]/mrc_cntl/sdp_cntl/sdp_request_cntl/first_time_thru}}'.format(mgr,strm,lane,chan)
      pLine = pLine + '\nadd wave -noupdate -group MGR{0} -group MRC{1} -group SDP -group SDPR -radix hexadecimal {{/top/system_inst/manager_array_inst/mgr_inst[{0}]/manager/mrc_cntl_strm_inst[{1}]/mrc_cntl/sdp_cntl/sdp_request_cntl/force_cons_chan01_request}}'.format(mgr,strm,lane,chan)
      pLine = pLine + '\nadd wave -noupdate -group MGR{0} -group MRC{1} -group SDP -group SDPR -radix hexadecimal {{/top/system_inst/manager_array_inst/mgr_inst[{0}]/manager/mrc_cntl_strm_inst[{1}]/mrc_cntl/sdp_cntl/sdp_request_cntl/force_cons_chan0_request}}'.format(mgr,strm,lane,chan)
      pLine = pLine + '\nadd wave -noupdate -group MGR{0} -group MRC{1} -group SDP -group SDPR -radix hexadecimal {{/top/system_inst/manager_array_inst/mgr_inst[{0}]/manager/mrc_cntl_strm_inst[{1}]/mrc_cntl/sdp_cntl/sdp_request_cntl/force_cons_chan10_request}}'.format(mgr,strm,lane,chan)
      pLine = pLine + '\nadd wave -noupdate -group MGR{0} -group MRC{1} -group SDP -group SDPR -radix hexadecimal {{/top/system_inst/manager_array_inst/mgr_inst[{0}]/manager/mrc_cntl_strm_inst[{1}]/mrc_cntl/sdp_cntl/sdp_request_cntl/force_cons_chan1_request}}'.format(mgr,strm,lane,chan)
      pLine = pLine + '\nadd wave -noupdate -group MGR{0} -group MRC{1} -group SDP -group SDPR -radix hexadecimal {{/top/system_inst/manager_array_inst/mgr_inst[{0}]/manager/mrc_cntl_strm_inst[{1}]/mrc_cntl/sdp_cntl/sdp_request_cntl/force_cons_request}}'.format(mgr,strm,lane,chan)
      pLine = pLine + '\nadd wave -noupdate -group MGR{0} -group MRC{1} -group SDP -group SDPR -radix hexadecimal {{/top/system_inst/manager_array_inst/mgr_inst[{0}]/manager/mrc_cntl_strm_inst[{1}]/mrc_cntl/sdp_cntl/sdp_request_cntl/force_disable_request}}'.format(mgr,strm,lane,chan)
      pLine = pLine + '\nadd wave -noupdate -group MGR{0} -group MRC{1} -group SDP -group SDPR -radix hexadecimal {{/top/system_inst/manager_array_inst/mgr_inst[{0}]/manager/mrc_cntl_strm_inst[{1}]/mrc_cntl/sdp_cntl/sdp_request_cntl/generate_requests}}'.format(mgr,strm,lane,chan)
      pLine = pLine + '\nadd wave -noupdate -group MGR{0} -group MRC{1} -group SDP -group SDPR -radix hexadecimal {{/top/system_inst/manager_array_inst/mgr_inst[{0}]/manager/mrc_cntl_strm_inst[{1}]/mrc_cntl/sdp_cntl/sdp_request_cntl/create_mem_request}}'.format(mgr,strm,lane,chan)
      pLine = pLine + '\nadd wave -noupdate -group MGR{0} -group MRC{1} -group SDP -group SDPR -radix hexadecimal {{/top/system_inst/manager_array_inst/mgr_inst[{0}]/manager/mrc_cntl_strm_inst[{1}]/mrc_cntl/sdp_cntl/sdp_request_cntl/requests_complete}}'.format(mgr,strm,lane,chan)
      pLine = pLine + '\nadd wave -noupdate -group MGR{0} -group MRC{1} -group SDP -group SDPR -radix hexadecimal {{/top/system_inst/manager_array_inst/mgr_inst[{0}]/manager/mrc_cntl_strm_inst[{1}]/mrc_cntl/sdp_cntl/sdp_request_cntl/sdp_cntl_proc_storage_desc_state}}'.format(mgr,strm,lane,chan)
      pLine = pLine + '\nadd wave -noupdate -group MGR{0} -group MRC{1} -group SDP -group SDPR -radix hexadecimal {{/top/system_inst/manager_array_inst/mgr_inst[{0}]/manager/mrc_cntl_strm_inst[{1}]/mrc_cntl/sdp_cntl/sdp_request_cntl/sdp_cntl_proc_storage_desc_state_next}}'.format(mgr,strm,lane,chan)
      pLine = pLine + '\nadd wave -noupdate -group MGR{0} -group MRC{1} -group SDP -group SDPR -radix hexadecimal {{/top/system_inst/manager_array_inst/mgr_inst[{0}]/manager/mrc_cntl_strm_inst[{1}]/mrc_cntl/sdp_cntl/sdp_request_cntl/channel_change}}'.format(mgr,strm,lane,chan)
      pLine = pLine + '\nadd wave -noupdate -group MGR{0} -group MRC{1} -group SDP -group SDPR -radix hexadecimal {{/top/system_inst/manager_array_inst/mgr_inst[{0}]/manager/mrc_cntl_strm_inst[{1}]/mrc_cntl/sdp_cntl/sdp_request_cntl/bank_change}}'.format(mgr,strm,lane,chan)
      pLine = pLine + '\nadd wave -noupdate -group MGR{0} -group MRC{1} -group SDP -group SDPR -radix hexadecimal {{/top/system_inst/manager_array_inst/mgr_inst[{0}]/manager/mrc_cntl_strm_inst[{1}]/mrc_cntl/sdp_cntl/sdp_request_cntl/page_change}}'.format(mgr,strm,lane,chan)
      pLine = pLine + '\nadd wave -noupdate -group MGR{0} -group MRC{1} -group SDP -group SDPR -radix hexadecimal {{/top/system_inst/manager_array_inst/mgr_inst[{0}]/manager/mrc_cntl_strm_inst[{1}]/mrc_cntl/sdp_cntl/sdp_request_cntl/pbc_last_end_addr}}'.format(mgr,strm,lane,chan)
      pLine = pLine + '\nadd wave -noupdate -group MGR{0} -group MRC{1} -group SDP -group SDPR -radix hexadecimal {{/top/system_inst/manager_array_inst/mgr_inst[{0}]/manager/mrc_cntl_strm_inst[{1}]/mrc_cntl/sdp_cntl/sdp_request_cntl/pbc_last_end_addr_chan}}'.format(mgr,strm,lane,chan)
      pLine = pLine + '\nadd wave -noupdate -group MGR{0} -group MRC{1} -group SDP -group SDPR -radix hexadecimal {{/top/system_inst/manager_array_inst/mgr_inst[{0}]/manager/mrc_cntl_strm_inst[{1}]/mrc_cntl/sdp_cntl/sdp_request_cntl/pbc_last_end_addr_bank}}'.format(mgr,strm,lane,chan)
      pLine = pLine + '\nadd wave -noupdate -group MGR{0} -group MRC{1} -group SDP -group SDPR -radix hexadecimal {{/top/system_inst/manager_array_inst/mgr_inst[{0}]/manager/mrc_cntl_strm_inst[{1}]/mrc_cntl/sdp_cntl/sdp_request_cntl/pbc_last_end_addr_page}}'.format(mgr,strm,lane,chan)
      pLine = pLine + '\nadd wave -noupdate -group MGR{0} -group MRC{1} -group SDP -group SDPR -radix hexadecimal {{/top/system_inst/manager_array_inst/mgr_inst[{0}]/manager/mrc_cntl_strm_inst[{1}]/mrc_cntl/sdp_cntl/sdp_request_cntl/pbc_end_addr}}'.format(mgr,strm,lane,chan)
      pLine = pLine + '\nadd wave -noupdate -group MGR{0} -group MRC{1} -group SDP -group SDPR -radix hexadecimal {{/top/system_inst/manager_array_inst/mgr_inst[{0}]/manager/mrc_cntl_strm_inst[{1}]/mrc_cntl/sdp_cntl/sdp_request_cntl/pbc_end_addr_chan}}'.format(mgr,strm,lane,chan)
      pLine = pLine + '\nadd wave -noupdate -group MGR{0} -group MRC{1} -group SDP -group SDPR -radix hexadecimal {{/top/system_inst/manager_array_inst/mgr_inst[{0}]/manager/mrc_cntl_strm_inst[{1}]/mrc_cntl/sdp_cntl/sdp_request_cntl/pbc_end_addr_bank}}'.format(mgr,strm,lane,chan)
      pLine = pLine + '\nadd wave -noupdate -group MGR{0} -group MRC{1} -group SDP -group SDPR -radix hexadecimal {{/top/system_inst/manager_array_inst/mgr_inst[{0}]/manager/mrc_cntl_strm_inst[{1}]/mrc_cntl/sdp_cntl/sdp_request_cntl/pbc_end_addr_page}}'.format(mgr,strm,lane,chan)
      pLine = pLine + '\nadd wave -noupdate -group MGR{0} -group MRC{1} -group SDP -group SDPR -radix hexadecimal {{/top/system_inst/manager_array_inst/mgr_inst[{0}]/manager/mrc_cntl_strm_inst[{1}]/mrc_cntl/sdp_cntl/sdp_request_cntl/pbc_inc_addr}}'.format(mgr,strm,lane,chan)
      pLine = pLine + '\nadd wave -noupdate -group MGR{0} -group MRC{1} -group SDP -group SDPR -radix hexadecimal {{/top/system_inst/manager_array_inst/mgr_inst[{0}]/manager/mrc_cntl_strm_inst[{1}]/mrc_cntl/sdp_cntl/sdp_request_cntl/pbc_inc_addr_chan}}'.format(mgr,strm,lane,chan)
      pLine = pLine + '\nadd wave -noupdate -group MGR{0} -group MRC{1} -group SDP -group SDPR -radix hexadecimal {{/top/system_inst/manager_array_inst/mgr_inst[{0}]/manager/mrc_cntl_strm_inst[{1}]/mrc_cntl/sdp_cntl/sdp_request_cntl/pbc_inc_addr_bank}}'.format(mgr,strm,lane,chan)
      pLine = pLine + '\nadd wave -noupdate -group MGR{0} -group MRC{1} -group SDP -group SDPR -radix hexadecimal {{/top/system_inst/manager_array_inst/mgr_inst[{0}]/manager/mrc_cntl_strm_inst[{1}]/mrc_cntl/sdp_cntl/sdp_request_cntl/pbc_inc_addr_page}}'.format(mgr,strm,lane,chan)
      pLine = pLine + '\nadd wave -noupdate -group MGR{0} -group MRC{1} -group SDP -group SDPR -radix hexadecimal {{/top/system_inst/manager_array_inst/mgr_inst[{0}]/manager/mrc_cntl_strm_inst[{1}]/mrc_cntl/sdp_cntl/sdp_request_cntl/sdmem_AccessOrder}}'.format(mgr,strm,lane,chan)
      pLine = pLine + '\nadd wave -noupdate -group MGR{0} -group MRC{1} -group SDP -group SDPR -radix hexadecimal {{/top/system_inst/manager_array_inst/mgr_inst[{0}]/manager/mrc_cntl_strm_inst[{1}]/mrc_cntl/sdp_cntl/sdp_request_cntl/sdmem_Address}}'.format(mgr,strm,lane,chan)
      pLine = pLine + '\nadd wave -noupdate -group MGR{0} -group MRC{1} -group SDP -group SDPR -radix hexadecimal {{/top/system_inst/manager_array_inst/mgr_inst[{0}]/manager/mrc_cntl_strm_inst[{1}]/mrc_cntl/sdp_cntl/sdp_request_cntl/sdmem_consJump}}'.format(mgr,strm,lane,chan)
      pLine = pLine + '\nadd wave -noupdate -group MGR{0} -group MRC{1} -group SDP -group SDPR -radix hexadecimal {{/top/system_inst/manager_array_inst/mgr_inst[{0}]/manager/mrc_cntl_strm_inst[{1}]/mrc_cntl/sdp_cntl/sdp_request_cntl/sdmem_consJumpCntl}}'.format(mgr,strm,lane,chan)
      pLine = pLine + '\nadd wave -noupdate -group MGR{0} -group MRC{1} -group SDP -group SDPR -radix hexadecimal {{/top/system_inst/manager_array_inst/mgr_inst[{0}]/manager/mrc_cntl_strm_inst[{1}]/mrc_cntl/sdp_cntl/sdp_request_cntl/sdmem_consJumpPtr}}'.format(mgr,strm,lane,chan)
      pLine = pLine + '\nadd wave -noupdate -group MGR{0} -group MRC{1} -group SDP -group SDPR -radix hexadecimal {{/top/system_inst/manager_array_inst/mgr_inst[{0}]/manager/mrc_cntl_strm_inst[{1}]/mrc_cntl/sdp_cntl/sdp_request_cntl/sdp__xxx__storage_desc_processing_complete}}'.format(mgr,strm,lane,chan)
      pLine = pLine + '\nadd wave -noupdate -group MGR{0} -group MRC{1} -group SDP -group SDPR -radix hexadecimal {{/top/system_inst/manager_array_inst/mgr_inst[{0}]/manager/mrc_cntl_strm_inst[{1}]/mrc_cntl/sdp_cntl/sdp_request_cntl/sdp_cntl_proc_storage_desc_state}}'.format(mgr,strm,lane,chan)
      pLine = pLine + '\nadd wave -noupdate -group MGR{0} -group MRC{1} -group SDP -group SDPR -radix hexadecimal {{/top/system_inst/manager_array_inst/mgr_inst[{0}]/manager/mrc_cntl_strm_inst[{1}]/mrc_cntl/sdp_cntl/sdp_request_cntl/sdp_cntl_proc_storage_desc_state_next}}'.format(mgr,strm,lane,chan)
      pLine = pLine + '\nadd wave -noupdate -group MGR{0} -group MRC{1} -group SDP -group SDPR -radix hexadecimal {{/top/system_inst/manager_array_inst/mgr_inst[{0}]/manager/mrc_cntl_strm_inst[{1}]/mrc_cntl/sdp_cntl/sdp_request_cntl/sdpr__sdps__cfg_accessOrder}}'.format(mgr,strm,lane,chan)
      pLine = pLine + '\nadd wave -noupdate -group MGR{0} -group MRC{1} -group SDP -group SDPR -radix hexadecimal {{/top/system_inst/manager_array_inst/mgr_inst[{0}]/manager/mrc_cntl_strm_inst[{1}]/mrc_cntl/sdp_cntl/sdp_request_cntl/sdpr__sdps__cfg_addr}}'.format(mgr,strm,lane,chan)
      pLine = pLine + '\nadd wave -noupdate -group MGR{0} -group MRC{1} -group SDP -group SDPR -radix hexadecimal {{/top/system_inst/manager_array_inst/mgr_inst[{0}]/manager/mrc_cntl_strm_inst[{1}]/mrc_cntl/sdp_cntl/sdp_request_cntl/sdpr__sdps__cfg_valid}}'.format(mgr,strm,lane,chan)
      pLine = pLine + '\nadd wave -noupdate -group MGR{0} -group MRC{1} -group SDP -group SDPR -radix hexadecimal {{/top/system_inst/manager_array_inst/mgr_inst[{0}]/manager/mrc_cntl_strm_inst[{1}]/mrc_cntl/sdp_cntl/sdp_request_cntl/sdpr__sdps__complete}}'.format(mgr,strm,lane,chan)
      pLine = pLine + '\nadd wave -noupdate -group MGR{0} -group MRC{1} -group SDP -group SDPR -radix hexadecimal {{/top/system_inst/manager_array_inst/mgr_inst[{0}]/manager/mrc_cntl_strm_inst[{1}]/mrc_cntl/sdp_cntl/sdp_request_cntl/sdpr__sdps__consJump_cntl}}'.format(mgr,strm,lane,chan)
      pLine = pLine + '\nadd wave -noupdate -group MGR{0} -group MRC{1} -group SDP -group SDPR -radix hexadecimal {{/top/system_inst/manager_array_inst/mgr_inst[{0}]/manager/mrc_cntl_strm_inst[{1}]/mrc_cntl/sdp_cntl/sdp_request_cntl/sdpr__sdps__consJump_valid}}'.format(mgr,strm,lane,chan)
      pLine = pLine + '\nadd wave -noupdate -group MGR{0} -group MRC{1} -group SDP -group SDPR -radix hexadecimal {{/top/system_inst/manager_array_inst/mgr_inst[{0}]/manager/mrc_cntl_strm_inst[{1}]/mrc_cntl/sdp_cntl/sdp_request_cntl/sdpr__sdps__consJump_value}}'.format(mgr,strm,lane,chan)
      pLine = pLine + '\nadd wave -noupdate -group MGR{0} -group MRC{1} -group SDP -group SDPR -radix hexadecimal {{/top/system_inst/manager_array_inst/mgr_inst[{0}]/manager/mrc_cntl_strm_inst[{1}]/mrc_cntl/sdp_cntl/sdp_request_cntl/sdps__sdpr__cfg_ready}}'.format(mgr,strm,lane,chan)
      pLine = pLine + '\nadd wave -noupdate -group MGR{0} -group MRC{1} -group SDP -group SDPR -radix hexadecimal {{/top/system_inst/manager_array_inst/mgr_inst[{0}]/manager/mrc_cntl_strm_inst[{1}]/mrc_cntl/sdp_cntl/sdp_request_cntl/sdps__sdpr__complete}}'.format(mgr,strm,lane,chan)
      pLine = pLine + '\nadd wave -noupdate -group MGR{0} -group MRC{1} -group SDP -group SDPR -radix hexadecimal {{/top/system_inst/manager_array_inst/mgr_inst[{0}]/manager/mrc_cntl_strm_inst[{1}]/mrc_cntl/sdp_cntl/sdp_request_cntl/sdps__sdpr__consJump_ready}}'.format(mgr,strm,lane,chan)
      pLine = pLine + '\nadd wave -noupdate -group MGR{0} -group MRC{1} -group SDP -group SDPR -radix hexadecimal {{/top/system_inst/manager_array_inst/mgr_inst[{0}]/manager/mrc_cntl_strm_inst[{1}]/mrc_cntl/sdp_cntl/sdp_request_cntl/storage_desc_accessOrder}}'.format(mgr,strm,lane,chan)
      pLine = pLine + '\nadd wave -noupdate -group MGR{0} -group MRC{1} -group SDP -group SDPR -radix hexadecimal {{/top/system_inst/manager_array_inst/mgr_inst[{0}]/manager/mrc_cntl_strm_inst[{1}]/mrc_cntl/sdp_cntl/sdp_request_cntl/storage_desc_address}}'.format(mgr,strm,lane,chan)
      pLine = pLine + '\nadd wave -noupdate -group MGR{0} -group MRC{1} -group SDP -group SDPR -radix hexadecimal {{/top/system_inst/manager_array_inst/mgr_inst[{0}]/manager/mrc_cntl_strm_inst[{1}]/mrc_cntl/sdp_cntl/sdp_request_cntl/storage_desc_bank}}'.format(mgr,strm,lane,chan)
      pLine = pLine + '\nadd wave -noupdate -group MGR{0} -group MRC{1} -group SDP -group SDPR -radix hexadecimal {{/top/system_inst/manager_array_inst/mgr_inst[{0}]/manager/mrc_cntl_strm_inst[{1}]/mrc_cntl/sdp_cntl/sdp_request_cntl/storage_desc_bank_lsb}}'.format(mgr,strm,lane,chan)
      pLine = pLine + '\nadd wave -noupdate -group MGR{0} -group MRC{1} -group SDP -group SDPR -radix hexadecimal {{/top/system_inst/manager_array_inst/mgr_inst[{0}]/manager/mrc_cntl_strm_inst[{1}]/mrc_cntl/sdp_cntl/sdp_request_cntl/storage_desc_channel}}'.format(mgr,strm,lane,chan)
      pLine = pLine + '\nadd wave -noupdate -group MGR{0} -group MRC{1} -group SDP -group SDPR -radix hexadecimal {{/top/system_inst/manager_array_inst/mgr_inst[{0}]/manager/mrc_cntl_strm_inst[{1}]/mrc_cntl/sdp_cntl/sdp_request_cntl/storage_desc_cline}}'.format(mgr,strm,lane,chan)
      pLine = pLine + '\nadd wave -noupdate -group MGR{0} -group MRC{1} -group SDP -group SDPR -radix hexadecimal {{/top/system_inst/manager_array_inst/mgr_inst[{0}]/manager/mrc_cntl_strm_inst[{1}]/mrc_cntl/sdp_cntl/sdp_request_cntl/storage_desc_consJumpPtr}}'.format(mgr,strm,lane,chan)
      pLine = pLine + '\nadd wave -noupdate -group MGR{0} -group MRC{1} -group SDP -group SDPR -radix hexadecimal {{/top/system_inst/manager_array_inst/mgr_inst[{0}]/manager/mrc_cntl_strm_inst[{1}]/mrc_cntl/sdp_cntl/sdp_request_cntl/storage_desc_local_address}}'.format(mgr,strm,lane,chan)
      pLine = pLine + '\nadd wave -noupdate -group MGR{0} -group MRC{1} -group SDP -group SDPR -radix hexadecimal {{/top/system_inst/manager_array_inst/mgr_inst[{0}]/manager/mrc_cntl_strm_inst[{1}]/mrc_cntl/sdp_cntl/sdp_request_cntl/storage_desc_mgr}}'.format(mgr,strm,lane,chan)
      pLine = pLine + '\nadd wave -noupdate -group MGR{0} -group MRC{1} -group SDP -group SDPR -radix hexadecimal {{/top/system_inst/manager_array_inst/mgr_inst[{0}]/manager/mrc_cntl_strm_inst[{1}]/mrc_cntl/sdp_cntl/sdp_request_cntl/storage_desc_page}}'.format(mgr,strm,lane,chan)
      pLine = pLine + '\nadd wave -noupdate -group MGR{0} -group MRC{1} -group SDP -group SDPR -radix hexadecimal {{/top/system_inst/manager_array_inst/mgr_inst[{0}]/manager/mrc_cntl_strm_inst[{1}]/mrc_cntl/sdp_cntl/sdp_request_cntl/storage_desc_word}}'.format(mgr,strm,lane,chan)
      pLine = pLine + '\nadd wave -noupdate -group MGR{0} -group MRC{1} -group SDP -group SDPR -radix hexadecimal {{/top/system_inst/manager_array_inst/mgr_inst[{0}]/manager/mrc_cntl_strm_inst[{1}]/mrc_cntl/sdp_cntl/sdp_request_cntl/strm_transfer_type}}'.format(mgr,strm,lane,chan)
      pLine = pLine + '\nadd wave -noupdate -group MGR{0} -group MRC{1} -group SDP -group SDPR -radix hexadecimal {{/top/system_inst/manager_array_inst/mgr_inst[{0}]/manager/mrc_cntl_strm_inst[{1}]/mrc_cntl/sdp_cntl/sdp_request_cntl/sys__mgr__mgrId}}'.format(mgr,strm,lane,chan)
      pLine = pLine + '\nadd wave -noupdate -group MGR{0} -group MRC{1} -group SDP -group SDPR -radix hexadecimal {{/top/system_inst/manager_array_inst/mgr_inst[{0}]/manager/mrc_cntl_strm_inst[{1}]/mrc_cntl/sdp_cntl/sdp_request_cntl/stream_proc_ready}}'.format(mgr,strm,lane,chan)
      pLine = pLine + '\nadd wave -noupdate -group MGR{0} -group MRC{1} -group SDP -group SDPR -radix hexadecimal {{/top/system_inst/manager_array_inst/mgr_inst[{0}]/manager/mrc_cntl_strm_inst[{1}]/mrc_cntl/sdp_cntl/sdp_request_cntl/xxx__sdp__lane_enable}}'.format(mgr,strm,lane,chan)
      pLine = pLine + '\nadd wave -noupdate -group MGR{0} -group MRC{1} -group SDP -group SDPR -radix hexadecimal {{/top/system_inst/manager_array_inst/mgr_inst[{0}]/manager/mrc_cntl_strm_inst[{1}]/mrc_cntl/sdp_cntl/sdp_request_cntl/xxx__sdp__mem_request_ready}}'.format(mgr,strm,lane,chan)
      pLine = pLine + '\nadd wave -noupdate -group MGR{0} -group MRC{1} -group SDP -group SDPR -radix hexadecimal {{/top/system_inst/manager_array_inst/mgr_inst[{0}]/manager/mrc_cntl_strm_inst[{1}]/mrc_cntl/sdp_cntl/sdp_request_cntl/xxx__sdp__mem_request_ready_d1}}'.format(mgr,strm,lane,chan)
      pLine = pLine + '\nadd wave -noupdate -group MGR{0} -group MRC{1} -group SDP -group SDPR -radix hexadecimal {{/top/system_inst/manager_array_inst/mgr_inst[{0}]/manager/mrc_cntl_strm_inst[{1}]/mrc_cntl/sdp_cntl/sdp_request_cntl/xxx__sdp__num_lanes}}'.format(mgr,strm,lane,chan)
      pLine = pLine + '\nadd wave -noupdate -group MGR{0} -group MRC{1} -group SDP -group SDPR -radix hexadecimal {{/top/system_inst/manager_array_inst/mgr_inst[{0}]/manager/mrc_cntl_strm_inst[{1}]/mrc_cntl/sdp_cntl/sdp_request_cntl/xxx__sdp__num_lanes_m1}}'.format(mgr,strm,lane,chan)
      pLine = pLine + '\nadd wave -noupdate -group MGR{0} -group MRC{1} -group SDP -group SDPR -radix hexadecimal {{/top/system_inst/manager_array_inst/mgr_inst[{0}]/manager/mrc_cntl_strm_inst[{1}]/mrc_cntl/sdp_cntl/sdp_request_cntl/xxx__sdp__storage_desc_processing_enable}}'.format(mgr,strm,lane,chan)
      pLine = pLine + '\nadd wave -noupdate -group MGR{0} -group MRC{1} -group SDP -group SDPR -radix hexadecimal {{/top/system_inst/manager_array_inst/mgr_inst[{0}]/manager/mrc_cntl_strm_inst[{1}]/mrc_cntl/sdp_cntl/sdp_request_cntl/xxx__sdp__storage_desc_ptr}}'.format(mgr,strm,lane,chan)
      pLine = pLine + '\nadd wave -noupdate -group MGR{0} -group MRC{1} -group SDP -group SDPR -radix hexadecimal {{/top/system_inst/manager_array_inst/mgr_inst[{0}]/manager/mrc_cntl_strm_inst[{1}]/mrc_cntl/sdp_cntl/sdp_request_cntl/xxx__sdp__txfer_type}}'.format(mgr,strm,lane,chan)
  ...
  for mgr in range (0, numOfMgr):
    for strm in range (0, numOfStrms):
      ...
      #
      pLine = pLine + '\nadd wave -noupdate -group MGR{0} -group MRC{1} -group SDP -group SDPS -radix hexadecimal {{/top/system_inst/manager_array_inst/mgr_inst[{0}]/manager/mrc_cntl_strm_inst[{1}]/mrc_cntl/sdp_cntl/sdp_stream_cntl/xxx__sdp__storage_desc_processing_enable}}'.format(mgr,strm,lane)
      pLine = pLine + '\nadd wave -noupdate -group MGR{0} -group MRC{1} -group SDP -group SDPS -radix hexadecimal {{/top/system_inst/manager_array_inst/mgr_inst[{0}]/manager/mrc_cntl_strm_inst[{1}]/mrc_cntl/sdp_cntl/sdp_stream_cntl/xxx__sdp__storage_desc_ptr}}'.format(mgr,strm,lane)
      pLine = pLine + '\nadd wave -noupdate -group MGR{0} -group MRC{1} -group SDP -group SDPS -radix hexadecimal {{/top/system_inst/manager_array_inst/mgr_inst[{0}]/manager/mrc_cntl_strm_inst[{1}]/mrc_cntl/sdp_cntl/sdp_stream_cntl/xxx__sdp__num_lanes}}'.format(mgr,strm,lane)
      pLine = pLine + '\nadd wave -noupdate -group MGR{0} -group MRC{1} -group SDP -group SDPS -radix hexadecimal {{/top/system_inst/manager_array_inst/mgr_inst[{0}]/manager/mrc_cntl_strm_inst[{1}]/mrc_cntl/sdp_cntl/sdp_stream_cntl/xxx__sdp__num_lanes_m1}}'.format(mgr,strm,lane)
      pLine = pLine + '\nadd wave -noupdate -group MGR{0} -group MRC{1} -group SDP -group SDPS -radix hexadecimal {{/top/system_inst/manager_array_inst/mgr_inst[{0}]/manager/mrc_cntl_strm_inst[{1}]/mrc_cntl/sdp_cntl/sdp_stream_cntl/xxx__sdp__txfer_type}}'.format(mgr,strm,lane)
      pLine = pLine + '\nadd wave -noupdate -group MGR{0} -group MRC{1} -group SDP -group SDPS -radix hexadecimal {{/top/system_inst/manager_array_inst/mgr_inst[{0}]/manager/mrc_cntl_strm_inst[{1}]/mrc_cntl/sdp_cntl/sdp_stream_cntl/xxx__sdp__target}}'.format(mgr,strm,lane)
      pLine = pLine + '\nadd wave -noupdate -group MGR{0} -group MRC{1} -group SDP -group SDPS -radix hexadecimal {{/top/system_inst/manager_array_inst/mgr_inst[{0}]/manager/mrc_cntl_strm_inst[{1}]/mrc_cntl/sdp_cntl/sdp_stream_cntl/xxx__sdp__lane_enable}}'.format(mgr,strm,lane)
      pLine = pLine + '\nadd wave -noupdate -group MGR{0} -group MRC{1} -group SDP -group SDPS -radix hexadecimal {{/top/system_inst/manager_array_inst/mgr_inst[{0}]/manager/mrc_cntl_strm_inst[{1}]/mrc_cntl/sdp_cntl/sdp_stream_cntl/xxx__sdp__mem_request_channel_data_valid}}'.format(mgr,strm,lane)
      #
      pLine = pLine + '\nadd wave -noupdate -group MGR{0} -group MRC{1} -group SDP -group SDPS -radix hexadecimal {{/top/system_inst/manager_array_inst/mgr_inst[{0}]/manager/mrc_cntl_strm_inst[{1}]/mrc_cntl/sdp_cntl/sdp_stream_cntl/xxx__sdp__lane_ready}}'.format(mgr,strm,lane)
      pLine = pLine + '\nadd wave -noupdate -group MGR{0} -group MRC{1} -group SDP -group SDPS -radix hexadecimal {{/top/system_inst/manager_array_inst/mgr_inst[{0}]/manager/mrc_cntl_strm_inst[{1}]/mrc_cntl/sdp_cntl/sdp_stream_cntl/sdp_cntl_stream_cntl_state}}'.format(mgr,strm,lane)
      pLine = pLine + '\nadd wave -noupdate -group MGR{0} -group MRC{1} -group SDP -group SDPS -radix hexadecimal {{/top/system_inst/manager_array_inst/mgr_inst[{0}]/manager/mrc_cntl_strm_inst[{1}]/mrc_cntl/sdp_cntl/sdp_stream_cntl/sdp_cntl_stream_cntl_state_next}}'.format(mgr,strm,lane)
      pLine = pLine + '\nadd wave -noupdate -group MGR{0} -group MRC{1} -group SDP -group SDPS -radix hexadecimal {{/top/system_inst/manager_array_inst/mgr_inst[{0}]/manager/mrc_cntl_strm_inst[{1}]/mrc_cntl/sdp_cntl/sdp_stream_cntl/all_lanes_complete}}'.format(mgr,strm,lane)
      pLine = pLine + '\nadd wave -noupdate -group MGR{0} -group MRC{1} -group SDP -group SDPS -radix hexadecimal {{/top/system_inst/manager_array_inst/mgr_inst[{0}]/manager/mrc_cntl_strm_inst[{1}]/mrc_cntl/sdp_cntl/sdp_stream_cntl/running}}'.format(mgr,strm,lane)
      pLine = pLine + '\nadd wave -noupdate -group MGR{0} -group MRC{1} -group SDP -group SDPS -radix hexadecimal {{/top/system_inst/manager_array_inst/mgr_inst[{0}]/manager/mrc_cntl_strm_inst[{1}]/mrc_cntl/sdp_cntl/sdp_stream_cntl/flush_complete}}'.format(mgr,strm,lane)
      pLine = pLine + '\nadd wave -noupdate -group MGR{0} -group MRC{1} -group SDP -group SDPS -radix hexadecimal {{/top/system_inst/manager_array_inst/mgr_inst[{0}]/manager/mrc_cntl_strm_inst[{1}]/mrc_cntl/sdp_cntl/sdp_stream_cntl/force_flush}}'.format(mgr,strm,lane)
      pLine = pLine + '\nadd wave -noupdate -group MGR{0} -group MRC{1} -group SDP -group SDPS -radix hexadecimal {{/top/system_inst/manager_array_inst/mgr_inst[{0}]/manager/mrc_cntl_strm_inst[{1}]/mrc_cntl/sdp_cntl/sdp_stream_cntl/request_read_diff}}'.format(mgr,strm,lane)
      pLine = pLine + '\nadd wave -noupdate -group MGR{0} -group MRC{1} -group SDP -group SDPS -radix hexadecimal {{/top/system_inst/manager_array_inst/mgr_inst[{0}]/manager/mrc_cntl_strm_inst[{1}]/mrc_cntl/sdp_cntl/sdp_stream_cntl/request_read_diff_eq0}}'.format(mgr,strm,lane)
      pLine = pLine + '\nadd wave -noupdate -group MGR{0} -group MRC{1} -group SDP -group SDPS -radix hexadecimal {{/top/system_inst/manager_array_inst/mgr_inst[{0}]/manager/mrc_cntl_strm_inst[{1}]/mrc_cntl/sdp_cntl/sdp_stream_cntl/request_read_diff_gt0}}'.format(mgr,strm,lane)
      pLine = pLine + '\nadd wave -noupdate -group MGR{0} -group MRC{1} -group SDP -group SDPS -radix hexadecimal {{/top/system_inst/manager_array_inst/mgr_inst[{0}]/manager/mrc_cntl_strm_inst[{1}]/mrc_cntl/sdp_cntl/sdp_stream_cntl/request_read_diff_lt0}}'.format(mgr,strm,lane)
      pLine = pLine + '\nadd wave -noupdate -group MGR{0} -group MRC{1} -group SDP -group SDPS -radix hexadecimal {{/top/system_inst/manager_array_inst/mgr_inst[{0}]/manager/mrc_cntl_strm_inst[{1}]/mrc_cntl/sdp_cntl/sdp_stream_cntl/exec_lane_enable}}'.format(mgr,strm,lane)
      pLine = pLine + '\nadd wave -noupdate -group MGR{0} -group MRC{1} -group SDP -group SDPS -radix hexadecimal {{/top/system_inst/manager_array_inst/mgr_inst[{0}]/manager/mrc_cntl_strm_inst[{1}]/mrc_cntl/sdp_cntl/sdp_stream_cntl/lanes_req_next_line}}'.format(mgr,strm,lane)
      pLine = pLine + '\nadd wave -noupdate -group MGR{0} -group MRC{1} -group SDP -group SDPS -radix hexadecimal {{/top/system_inst/manager_array_inst/mgr_inst[{0}]/manager/mrc_cntl_strm_inst[{1}]/mrc_cntl/sdp_cntl/sdp_stream_cntl/lanes_sending}}'.format(mgr,strm,lane)
      pLine = pLine + '\nadd wave -noupdate -group MGR{0} -group MRC{1} -group SDP -group SDPS -radix hexadecimal {{/top/system_inst/manager_array_inst/mgr_inst[{0}]/manager/mrc_cntl_strm_inst[{1}]/mrc_cntl/sdp_cntl/sdp_stream_cntl/lanes_address_match}}'.format(mgr,strm,lane)
      pLine = pLine + '\nadd wave -noupdate -group MGR{0} -group MRC{1} -group SDP -group SDPS -radix hexadecimal {{/top/system_inst/manager_array_inst/mgr_inst[{0}]/manager/mrc_cntl_strm_inst[{1}]/mrc_cntl/sdp_cntl/sdp_stream_cntl/all_lanes_req_next_line}}'.format(mgr,strm,lane)
      pLine = pLine + '\nadd wave -noupdate -group MGR{0} -group MRC{1} -group SDP -group SDPS -radix hexadecimal {{/top/system_inst/manager_array_inst/mgr_inst[{0}]/manager/mrc_cntl_strm_inst[{1}]/mrc_cntl/sdp_cntl/sdp_stream_cntl/at_least_one_force_req_next_line}}'.format(mgr,strm,lane)
      pLine = pLine + '\nadd wave -noupdate -group MGR{0} -group MRC{1} -group SDP -group SDPS -radix hexadecimal {{/top/system_inst/manager_array_inst/mgr_inst[{0}]/manager/mrc_cntl_strm_inst[{1}]/mrc_cntl/sdp_cntl/sdp_stream_cntl/at_least_one_req_next_line}}'.format(mgr,strm,lane)
      pLine = pLine + '\nadd wave -noupdate -group MGR{0} -group MRC{1} -group SDP -group SDPS -radix hexadecimal {{/top/system_inst/manager_array_inst/mgr_inst[{0}]/manager/mrc_cntl_strm_inst[{1}]/mrc_cntl/sdp_cntl/sdp_stream_cntl/lanes_force_req_next_line}}'.format(mgr,strm,lane)
      pLine = pLine + '\nadd wave -noupdate -group MGR{0} -group MRC{1} -group SDP -group SDPS -radix hexadecimal {{/top/system_inst/manager_array_inst/mgr_inst[{0}]/manager/mrc_cntl_strm_inst[{1}]/mrc_cntl/sdp_cntl/sdp_stream_cntl/get_next_line}}'.format(mgr,strm,lane)
      pLine = pLine + '\nadd wave -noupdate -group MGR{0} -group MRC{1} -group SDP -group SDPS -radix hexadecimal {{/top/system_inst/manager_array_inst/mgr_inst[{0}]/manager/mrc_cntl_strm_inst[{1}]/mrc_cntl/sdp_cntl/sdp_stream_cntl/lanes_running}}'.format(mgr,strm,lane)
      pLine = pLine + '\nadd wave -noupdate -group MGR{0} -group MRC{1} -group SDP -group SDPS -radix hexadecimal {{/top/system_inst/manager_array_inst/mgr_inst[{0}]/manager/mrc_cntl_strm_inst[{1}]/mrc_cntl/sdp_cntl/sdp_stream_cntl/block_request}}'.format(mgr,strm,lane)
      pLine = pLine + '\nadd wave -noupdate -group MGR{0} -group MRC{1} -group SDP -group SDPS -group FROM_MMC -radix hexadecimal {{/top/system_inst/manager_array_inst/mgr_inst[{0}]/manager/mrc_cntl_strm_inst[{1}]/mrc_cntl/from_mmc_fifo[0]/write}}'.format(mgr,strm,lane)
      pLine = pLine + '\nadd wave -noupdate -group MGR{0} -group MRC{1} -group SDP -group SDPS -group FROM_MMC -radix hexadecimal {{/top/system_inst/manager_array_inst/mgr_inst[{0}]/manager/mrc_cntl_strm_inst[{1}]/mrc_cntl/from_mmc_fifo[0]/write_data}}'.format(mgr,strm,lane)
      pLine = pLine + '\nadd wave -noupdate -group MGR{0} -group MRC{1} -group SDP -group SDPS -group FROM_MMC -radix hexadecimal {{/top/system_inst/manager_array_inst/mgr_inst[{0}]/manager/mrc_cntl_strm_inst[{1}]/mrc_cntl/from_mmc_fifo[0]/almost_full}}'.format(mgr,strm,lane)
      pLine = pLine + '\nadd wave -noupdate -group MGR{0} -group MRC{1} -group SDP -group SDPS -group FROM_MMC -radix hexadecimal {{/top/system_inst/manager_array_inst/mgr_inst[{0}]/manager/mrc_cntl_strm_inst[{1}]/mrc_cntl/from_mmc_fifo[0]/pipe_valid}}'.format(mgr,strm,lane)
      pLine = pLine + '\nadd wave -noupdate -group MGR{0} -group MRC{1} -group SDP -group SDPS -group FROM_MMC -radix hexadecimal {{/top/system_inst/manager_array_inst/mgr_inst[{0}]/manager/mrc_cntl_strm_inst[{1}]/mrc_cntl/from_mmc_fifo[0]/pipe_data}}'.format(mgr,strm,lane)
      pLine = pLine + '\nadd wave -noupdate -group MGR{0} -group MRC{1} -group SDP -group SDPS -group FROM_MMC -radix hexadecimal {{/top/system_inst/manager_array_inst/mgr_inst[{0}]/manager/mrc_cntl_strm_inst[{1}]/mrc_cntl/from_mmc_fifo[0]/pipe_read}}'.format(mgr,strm,lane)
      pLine = pLine + '\nadd wave -noupdate -group MGR{0} -group MRC{1} -group SDP -group SDPS -group FROM_MMC -radix hexadecimal {{/top/system_inst/manager_array_inst/mgr_inst[{0}]/manager/mrc_cntl_strm_inst[{1}]/mrc_cntl/from_mmc_fifo[1]/write}}'.format(mgr,strm,lane)
      pLine = pLine + '\nadd wave -noupdate -group MGR{0} -group MRC{1} -group SDP -group SDPS -group FROM_MMC -radix hexadecimal {{/top/system_inst/manager_array_inst/mgr_inst[{0}]/manager/mrc_cntl_strm_inst[{1}]/mrc_cntl/from_mmc_fifo[1]/write_data}}'.format(mgr,strm,lane)
      pLine = pLine + '\nadd wave -noupdate -group MGR{0} -group MRC{1} -group SDP -group SDPS -group FROM_MMC -radix hexadecimal {{/top/system_inst/manager_array_inst/mgr_inst[{0}]/manager/mrc_cntl_strm_inst[{1}]/mrc_cntl/from_mmc_fifo[1]/almost_full}}'.format(mgr,strm,lane)
      pLine = pLine + '\nadd wave -noupdate -group MGR{0} -group MRC{1} -group SDP -group SDPS -group FROM_MMC -radix hexadecimal {{/top/system_inst/manager_array_inst/mgr_inst[{0}]/manager/mrc_cntl_strm_inst[{1}]/mrc_cntl/from_mmc_fifo[1]/pipe_valid}}'.format(mgr,strm,lane)
      pLine = pLine + '\nadd wave -noupdate -group MGR{0} -group MRC{1} -group SDP -group SDPS -group FROM_MMC -radix hexadecimal {{/top/system_inst/manager_array_inst/mgr_inst[{0}]/manager/mrc_cntl_strm_inst[{1}]/mrc_cntl/from_mmc_fifo[1]/pipe_data}}'.format(mgr,strm,lane)
      pLine = pLine + '\nadd wave -noupdate -group MGR{0} -group MRC{1} -group SDP -group SDPS -group FROM_MMC -radix hexadecimal {{/top/system_inst/manager_array_inst/mgr_inst[{0}]/manager/mrc_cntl_strm_inst[{1}]/mrc_cntl/from_mmc_fifo[1]/pipe_read}}'.format(mgr,strm,lane)
      pLine = pLine + '\nadd wave -noupdate -group MGR{0} -group MRC{1} -group SDP -group SDPS -group RESPONSE_ID -radix hexadecimal {{/top/system_inst/manager_array_inst/mgr_inst[{0}]/manager/mrc_cntl_strm_inst[{1}]/mrc_cntl/sdp_cntl/sdp_stream_cntl/response_id_fifo[0]/write}}'.format(mgr,strm,lane)
      pLine = pLine + '\nadd wave -noupdate -group MGR{0} -group MRC{1} -group SDP -group SDPS -group RESPONSE_ID -radix hexadecimal {{/top/system_inst/manager_array_inst/mgr_inst[{0}]/manager/mrc_cntl_strm_inst[{1}]/mrc_cntl/sdp_cntl/sdp_stream_cntl/response_id_fifo[0]/pipe_valid}}'.format(mgr,strm,lane)
      pLine = pLine + '\nadd wave -noupdate -group MGR{0} -group MRC{1} -group SDP -group SDPS -group RESPONSE_ID -radix hexadecimal {{/top/system_inst/manager_array_inst/mgr_inst[{0}]/manager/mrc_cntl_strm_inst[{1}]/mrc_cntl/sdp_cntl/sdp_stream_cntl/response_id_fifo[0]/pipe_cntl}}'.format(mgr,strm,lane)
      pLine = pLine + '\nadd wave -noupdate -group MGR{0} -group MRC{1} -group SDP -group SDPS -group RESPONSE_ID -radix hexadecimal {{/top/system_inst/manager_array_inst/mgr_inst[{0}]/manager/mrc_cntl_strm_inst[{1}]/mrc_cntl/sdp_cntl/sdp_stream_cntl/response_id_fifo[0]/pipe_bank}}'.format(mgr,strm,lane)
      pLine = pLine + '\nadd wave -noupdate -group MGR{0} -group MRC{1} -group SDP -group SDPS -group RESPONSE_ID -radix hexadecimal {{/top/system_inst/manager_array_inst/mgr_inst[{0}]/manager/mrc_cntl_strm_inst[{1}]/mrc_cntl/sdp_cntl/sdp_stream_cntl/response_id_fifo[0]/pipe_page}}'.format(mgr,strm,lane)
      pLine = pLine + '\nadd wave -noupdate -group MGR{0} -group MRC{1} -group SDP -group SDPS -group RESPONSE_ID -radix hexadecimal {{/top/system_inst/manager_array_inst/mgr_inst[{0}]/manager/mrc_cntl_strm_inst[{1}]/mrc_cntl/sdp_cntl/sdp_stream_cntl/response_id_fifo[0]/pipe_line}}'.format(mgr,strm,lane)
      pLine = pLine + '\nadd wave -noupdate -group MGR{0} -group MRC{1} -group SDP -group SDPS -group RESPONSE_ID -radix hexadecimal {{/top/system_inst/manager_array_inst/mgr_inst[{0}]/manager/mrc_cntl_strm_inst[{1}]/mrc_cntl/sdp_cntl/sdp_stream_cntl/response_id_fifo[0]/pipe_som}}'.format(mgr,strm,lane)
      pLine = pLine + '\nadd wave -noupdate -group MGR{0} -group MRC{1} -group SDP -group SDPS -group RESPONSE_ID -radix hexadecimal {{/top/system_inst/manager_array_inst/mgr_inst[{0}]/manager/mrc_cntl_strm_inst[{1}]/mrc_cntl/sdp_cntl/sdp_stream_cntl/response_id_fifo[0]/pipe_mom}}'.format(mgr,strm,lane)
      pLine = pLine + '\nadd wave -noupdate -group MGR{0} -group MRC{1} -group SDP -group SDPS -group RESPONSE_ID -radix hexadecimal {{/top/system_inst/manager_array_inst/mgr_inst[{0}]/manager/mrc_cntl_strm_inst[{1}]/mrc_cntl/sdp_cntl/sdp_stream_cntl/response_id_fifo[0]/pipe_eom}}'.format(mgr,strm,lane)
      pLine = pLine + '\nadd wave -noupdate -group MGR{0} -group MRC{1} -group SDP -group SDPS -group RESPONSE_ID -radix hexadecimal {{/top/system_inst/manager_array_inst/mgr_inst[{0}]/manager/mrc_cntl_strm_inst[{1}]/mrc_cntl/sdp_cntl/sdp_stream_cntl/response_id_fifo[0]/response_id_in_progress}}'.format(mgr,strm,lane)
      pLine = pLine + '\nadd wave -noupdate -group MGR{0} -group MRC{1} -group SDP -group SDPS -group RESPONSE_ID -radix hexadecimal {{/top/system_inst/manager_array_inst/mgr_inst[{0}]/manager/mrc_cntl_strm_inst[{1}]/mrc_cntl/sdp_cntl/sdp_stream_cntl/response_id_fifo[0]/pipe_read}}'.format(mgr,strm,lane)
      pLine = pLine + '\nadd wave -noupdate -group MGR{0} -group MRC{1} -group SDP -group SDPS -group RESPONSE_ID -radix hexadecimal {{/top/system_inst/manager_array_inst/mgr_inst[{0}]/manager/mrc_cntl_strm_inst[{1}]/mrc_cntl/sdp_cntl/sdp_stream_cntl/response_id_fifo[1]/write}}'.format(mgr,strm,lane)
      pLine = pLine + '\nadd wave -noupdate -group MGR{0} -group MRC{1} -group SDP -group SDPS -group RESPONSE_ID -radix hexadecimal {{/top/system_inst/manager_array_inst/mgr_inst[{0}]/manager/mrc_cntl_strm_inst[{1}]/mrc_cntl/sdp_cntl/sdp_stream_cntl/response_id_fifo[1]/pipe_valid}}'.format(mgr,strm,lane)
      pLine = pLine + '\nadd wave -noupdate -group MGR{0} -group MRC{1} -group SDP -group SDPS -group RESPONSE_ID -radix hexadecimal {{/top/system_inst/manager_array_inst/mgr_inst[{0}]/manager/mrc_cntl_strm_inst[{1}]/mrc_cntl/sdp_cntl/sdp_stream_cntl/response_id_fifo[1]/pipe_cntl}}'.format(mgr,strm,lane)
      pLine = pLine + '\nadd wave -noupdate -group MGR{0} -group MRC{1} -group SDP -group SDPS -group RESPONSE_ID -radix hexadecimal {{/top/system_inst/manager_array_inst/mgr_inst[{0}]/manager/mrc_cntl_strm_inst[{1}]/mrc_cntl/sdp_cntl/sdp_stream_cntl/response_id_fifo[1]/pipe_bank}}'.format(mgr,strm,lane)
      pLine = pLine + '\nadd wave -noupdate -group MGR{0} -group MRC{1} -group SDP -group SDPS -group RESPONSE_ID -radix hexadecimal {{/top/system_inst/manager_array_inst/mgr_inst[{0}]/manager/mrc_cntl_strm_inst[{1}]/mrc_cntl/sdp_cntl/sdp_stream_cntl/response_id_fifo[1]/pipe_page}}'.format(mgr,strm,lane)
      pLine = pLine + '\nadd wave -noupdate -group MGR{0} -group MRC{1} -group SDP -group SDPS -group RESPONSE_ID -radix hexadecimal {{/top/system_inst/manager_array_inst/mgr_inst[{0}]/manager/mrc_cntl_strm_inst[{1}]/mrc_cntl/sdp_cntl/sdp_stream_cntl/response_id_fifo[1]/pipe_line}}'.format(mgr,strm,lane)
      pLine = pLine + '\nadd wave -noupdate -group MGR{0} -group MRC{1} -group SDP -group SDPS -group RESPONSE_ID -radix hexadecimal {{/top/system_inst/manager_array_inst/mgr_inst[{0}]/manager/mrc_cntl_strm_inst[{1}]/mrc_cntl/sdp_cntl/sdp_stream_cntl/response_id_fifo[1]/pipe_som}}'.format(mgr,strm,lane)
      pLine = pLine + '\nadd wave -noupdate -group MGR{0} -group MRC{1} -group SDP -group SDPS -group RESPONSE_ID -radix hexadecimal {{/top/system_inst/manager_array_inst/mgr_inst[{0}]/manager/mrc_cntl_strm_inst[{1}]/mrc_cntl/sdp_cntl/sdp_stream_cntl/response_id_fifo[1]/pipe_mom}}'.format(mgr,strm,lane)
      pLine = pLine + '\nadd wave -noupdate -group MGR{0} -group MRC{1} -group SDP -group SDPS -group RESPONSE_ID -radix hexadecimal {{/top/system_inst/manager_array_inst/mgr_inst[{0}]/manager/mrc_cntl_strm_inst[{1}]/mrc_cntl/sdp_cntl/sdp_stream_cntl/response_id_fifo[1]/pipe_eom}}'.format(mgr,strm,lane)
      pLine = pLine + '\nadd wave -noupdate -group MGR{0} -group MRC{1} -group SDP -group SDPS -group RESPONSE_ID -radix hexadecimal {{/top/system_inst/manager_array_inst/mgr_inst[{0}]/manager/mrc_cntl_strm_inst[{1}]/mrc_cntl/sdp_cntl/sdp_stream_cntl/response_id_fifo[1]/response_id_in_progress}}'.format(mgr,strm,lane)
      pLine = pLine + '\nadd wave -noupdate -group MGR{0} -group MRC{1} -group SDP -group SDPS -group RESPONSE_ID -radix hexadecimal {{/top/system_inst/manager_array_inst/mgr_inst[{0}]/manager/mrc_cntl_strm_inst[{1}]/mrc_cntl/sdp_cntl/sdp_stream_cntl/response_id_fifo[1]/pipe_read}}'.format(mgr,strm,lane)
      pLine = pLine + '\nadd wave -noupdate -group MGR{0} -group MRC{1} -group SDP -group SDPS -radix hexadecimal {{/top/system_inst/manager_array_inst/mgr_inst[{0}]/manager/mrc_cntl_strm_inst[{1}]/mrc_cntl/sdp_cntl/sdp_stream_cntl/block_request[0]}}'.format(mgr,strm,lane)
      pLine = pLine + '\nadd wave -noupdate -group MGR{0} -group MRC{1} -group SDP -group SDPS -radix hexadecimal {{/top/system_inst/manager_array_inst/mgr_inst[{0}]/manager/mrc_cntl_strm_inst[{1}]/mrc_cntl/sdp_cntl/sdp_stream_cntl/block_request[1]}}'.format(mgr,strm,lane)
      #                                                                                  
      pLine = pLine + '\nadd wave -noupdate -group MGR{0} -group MRC{1} -group SDP -group SDPS -radix hexadecimal {{/top/system_inst/manager_array_inst/mgr_inst[{0}]/manager/mrc_cntl_strm_inst[{1}]/mrc_cntl/sdp_cntl/sdp_stream_cntl/get_next_line[0]}}'.format(mgr,strm,lane)
      pLine = pLine + '\nadd wave -noupdate -group MGR{0} -group MRC{1} -group SDP -group SDPS -radix hexadecimal {{/top/system_inst/manager_array_inst/mgr_inst[{0}]/manager/mrc_cntl_strm_inst[{1}]/mrc_cntl/sdp_cntl/sdp_stream_cntl/get_next_line[1]}}'.format(mgr,strm,lane)
      #                                                                                  
      pLine = pLine + '\nadd wave -noupdate -group MGR{0} -group MRC{1} -group SDP -group SDPS -radix hexadecimal {{/top/system_inst/manager_array_inst/mgr_inst[{0}]/manager/mrc_cntl_strm_inst[{1}]/mrc_cntl/sdp_cntl/sdp_stream_cntl/sdp__xxx__get_next_line[0]}} '.format(mgr,strm,lane)
      pLine = pLine + '\nadd wave -noupdate -group MGR{0} -group MRC{1} -group SDP -group SDPS -radix hexadecimal {{/top/system_inst/manager_array_inst/mgr_inst[{0}]/manager/mrc_cntl_strm_inst[{1}]/mrc_cntl/sdp_cntl/sdp_stream_cntl/all_lanes_complete}}'.format(mgr,strm,lane)
      #                                                                                  
      pLine = pLine + '\nadd wave -noupdate -group MGR{0} -group MRC{1} -group SDP -group SDPS -radix hexadecimal {{/top/system_inst/manager_array_inst/mgr_inst[{0}]/manager/mrc_cntl_strm_inst[{1}]/mrc_cntl/sdp_cntl/sdp_stream_cntl/lanes_req_next_line[0][{2}]}}'.format(mgr,strm,lane)
      pLine = pLine + '\nadd wave -noupdate -group MGR{0} -group MRC{1} -group SDP -group SDPS -radix hexadecimal {{/top/system_inst/manager_array_inst/mgr_inst[{0}]/manager/mrc_cntl_strm_inst[{1}]/mrc_cntl/sdp_cntl/sdp_stream_cntl/lanes_req_next_line[1][{2}]}}'.format(mgr,strm,lane)
      pLine = pLine + '\nadd wave -noupdate -group MGR{0} -group MRC{1} -group SDP -group SDPS -radix hexadecimal {{/top/system_inst/manager_array_inst/mgr_inst[{0}]/manager/mrc_cntl_strm_inst[{1}]/mrc_cntl/sdp_cntl/sdp_stream_cntl/lanes_force_req_next_line[0][{2}]}}'.format(mgr,strm,lane)
      pLine = pLine + '\nadd wave -noupdate -group MGR{0} -group MRC{1} -group SDP -group SDPS -radix hexadecimal {{/top/system_inst/manager_array_inst/mgr_inst[{0}]/manager/mrc_cntl_strm_inst[{1}]/mrc_cntl/sdp_cntl/sdp_stream_cntl/lanes_force_req_next_line[1][{2}]}}'.format(mgr,strm,lane)
      pLine = pLine + '\nadd wave -noupdate -group MGR{0} -group MRC{1} -group SDP -group SDPS -radix hexadecimal {{/top/system_inst/manager_array_inst/mgr_inst[{0}]/manager/mrc_cntl_strm_inst[{1}]/mrc_cntl/sdp_cntl/sdp_stream_cntl/lanes_force_req_next_line}}'.format(mgr,strm,lane)
      pLine = pLine + '\nadd wave -noupdate -group MGR{0} -group MRC{1} -group SDP -group SDPS -radix hexadecimal {{/top/system_inst/manager_array_inst/mgr_inst[{0}]/manager/mrc_cntl_strm_inst[{1}]/mrc_cntl/sdp_cntl/sdp_stream_cntl/neither_match[0][{2}]}}'.format(mgr,strm,lane)
      pLine = pLine + '\nadd wave -noupdate -group MGR{0} -group MRC{1} -group SDP -group SDPS -radix hexadecimal {{/top/system_inst/manager_array_inst/mgr_inst[{0}]/manager/mrc_cntl_strm_inst[{1}]/mrc_cntl/sdp_cntl/sdp_stream_cntl/neither_match[1][{2}]}}'.format(mgr,strm,lane)
      pLine = pLine + '\nadd wave -noupdate -group MGR{0} -group MRC{1} -group SDP -group SDPS -radix hexadecimal {{/top/system_inst/manager_array_inst/mgr_inst[{0}]/manager/mrc_cntl_strm_inst[{1}]/mrc_cntl/sdp_cntl/sdp_stream_cntl/sdp__xxx__get_next_line[0]}} '.format(mgr,strm,lane)
      pLine = pLine + '\nadd wave -noupdate -group MGR{0} -group MRC{1} -group SDP -group SDPS -radix hexadecimal {{/top/system_inst/manager_array_inst/mgr_inst[{0}]/manager/mrc_cntl_strm_inst[{1}]/mrc_cntl/sdp_cntl/sdp_stream_cntl/sdp__xxx__get_next_line[1]}} '.format(mgr,strm,lane)
      #                                                                                  
      pLine = pLine + '\nadd wave -noupdate -group MGR{0} -group MRC{1} -group SDP -group SDPS -radix hexadecimal {{/top/system_inst/manager_array_inst/mgr_inst[{0}]/manager/mrc_cntl_strm_inst[{1}]/mrc_cntl/sdp_cntl/sdp_stream_cntl/consJump_to_strm_fsm_fifo[0]/pipe_consJumpCntl}}'.format(mgr,strm,lane)
      pLine = pLine + '\nadd wave -noupdate -group MGR{0} -group MRC{1} -group SDP -group SDPS -radix hexadecimal {{/top/system_inst/manager_array_inst/mgr_inst[{0}]/manager/mrc_cntl_strm_inst[{1}]/mrc_cntl/sdp_cntl/sdp_stream_cntl/consJump_to_strm_fsm_fifo[0]/pipe_consJumpValue}}'.format(mgr,strm,lane)
      #                                                                                  
      pLine = pLine + '\nadd wave -noupdate -group MGR{0} -group MRC{1} -group SDP -group SDPS -radix hexadecimal {{/top/system_inst/manager_array_inst/mgr_inst[{0}]/manager/mrc_cntl_strm_inst[{1}]/mrc_cntl/sdp_cntl/sdp_stream_cntl/all_lanes_loaded_consequtive}}'.format(mgr,strm,lane)
      pLine = pLine + '\nadd wave -noupdate -group MGR{0} -group MRC{1} -group SDP -group SDPS -radix hexadecimal {{/top/system_inst/manager_array_inst/mgr_inst[{0}]/manager/mrc_cntl_strm_inst[{1}]/mrc_cntl/sdp_cntl/sdp_stream_cntl/all_lanes_loaded_jump}}'.format(mgr,strm,lane)
      #                                                                                  
      pLine = pLine + '\nadd wave -noupdate -group MGR{0} -group MRC{1} -group SDP -group SDPS -radix hexadecimal {{/top/system_inst/manager_array_inst/mgr_inst[{0}]/manager/mrc_cntl_strm_inst[{1}]/mrc_cntl/sdp_cntl/sdp_stream_cntl/lanes_loaded_consequtive}}'.format(mgr,strm,lane)
      pLine = pLine + '\nadd wave -noupdate -group MGR{0} -group MRC{1} -group SDP -group SDPS -radix hexadecimal {{/top/system_inst/manager_array_inst/mgr_inst[{0}]/manager/mrc_cntl_strm_inst[{1}]/mrc_cntl/sdp_cntl/sdp_stream_cntl/lanes_loaded_jump}}'.format(mgr,strm,lane)
      pLine = pLine + '\nadd wave -noupdate -group MGR{0} -group MRC{1} -group SDP -group SDPS -radix hexadecimal {{/top/system_inst/manager_array_inst/mgr_inst[{0}]/manager/mrc_cntl_strm_inst[{1}]/mrc_cntl/sdp_cntl/sdp_stream_cntl/lanes_loading_consequtive}}'.format(mgr,strm,lane)
      pLine = pLine + '\nadd wave -noupdate -group MGR{0} -group MRC{1} -group SDP -group SDPS -radix hexadecimal {{/top/system_inst/manager_array_inst/mgr_inst[{0}]/manager/mrc_cntl_strm_inst[{1}]/mrc_cntl/sdp_cntl/sdp_stream_cntl/lanes_loading_jump}}'.format(mgr,strm,lane)
      #                                                                                  
      #                                                                                  
      pLine = pLine + '\nadd wave -noupdate -group MGR{0} -group MRC{1} -group SDP -group SDPS -radix hexadecimal {{/top/system_inst/manager_array_inst/mgr_inst[{0}]/manager/mrc_cntl_strm_inst[{1}]/mrc_cntl/sdp_cntl/sdp_stream_cntl/addr_to_strm_fsm_fifo[0]/write}}'.format(mgr,strm,lane)
      pLine = pLine + '\nadd wave -noupdate -group MGR{0} -group MRC{1} -group SDP -group SDPS -radix hexadecimal {{/top/system_inst/manager_array_inst/mgr_inst[{0}]/manager/mrc_cntl_strm_inst[{1}]/mrc_cntl/sdp_cntl/sdp_stream_cntl/addr_to_strm_fsm_fifo[0]/pipe_addr}}'.format(mgr,strm,lane)
      pLine = pLine + '\nadd wave -noupdate -group MGR{0} -group MRC{1} -group SDP -group SDPS -radix hexadecimal {{/top/system_inst/manager_array_inst/mgr_inst[{0}]/manager/mrc_cntl_strm_inst[{1}]/mrc_cntl/sdp_cntl/sdp_stream_cntl/addr_to_strm_fsm_fifo[0]/pipe_num_lanes}}'.format(mgr,strm,lane)
      pLine = pLine + '\nadd wave -noupdate -group MGR{0} -group MRC{1} -group SDP -group SDPS -radix hexadecimal {{/top/system_inst/manager_array_inst/mgr_inst[{0}]/manager/mrc_cntl_strm_inst[{1}]/mrc_cntl/sdp_cntl/sdp_stream_cntl/addr_to_strm_fsm_fifo[0]/pipe_num_lanes_m1}}'.format(mgr,strm,lane)
      pLine = pLine + '\nadd wave -noupdate -group MGR{0} -group MRC{1} -group SDP -group SDPS -radix hexadecimal {{/top/system_inst/manager_array_inst/mgr_inst[{0}]/manager/mrc_cntl_strm_inst[{1}]/mrc_cntl/sdp_cntl/sdp_stream_cntl/addr_to_strm_fsm_fifo[0]/pipe_lane_enable}}'.format(mgr,strm,lane)
      pLine = pLine + '\nadd wave -noupdate -group MGR{0} -group MRC{1} -group SDP -group SDPS -radix hexadecimal {{/top/system_inst/manager_array_inst/mgr_inst[{0}]/manager/mrc_cntl_strm_inst[{1}]/mrc_cntl/sdp_cntl/sdp_stream_cntl/addr_to_strm_fsm_fifo[0]/pipe_order}}'.format(mgr,strm,lane)
      pLine = pLine + '\nadd wave -noupdate -group MGR{0} -group MRC{1} -group SDP -group SDPS -radix hexadecimal {{/top/system_inst/manager_array_inst/mgr_inst[{0}]/manager/mrc_cntl_strm_inst[{1}]/mrc_cntl/sdp_cntl/sdp_stream_cntl/addr_to_strm_fsm_fifo[0]/pipe_read}}'.format(mgr,strm,lane)
      pLine = pLine + '\nadd wave -noupdate -group MGR{0} -group MRC{1} -group SDP -group SDPS -radix hexadecimal {{/top/system_inst/manager_array_inst/mgr_inst[{0}]/manager/mrc_cntl_strm_inst[{1}]/mrc_cntl/sdp_cntl/sdp_stream_cntl/addr_to_strm_fsm_fifo[0]/pipe_tgt}}'.format(mgr,strm,lane)
      pLine = pLine + '\nadd wave -noupdate -group MGR{0} -group MRC{1} -group SDP -group SDPS -radix hexadecimal {{/top/system_inst/manager_array_inst/mgr_inst[{0}]/manager/mrc_cntl_strm_inst[{1}]/mrc_cntl/sdp_cntl/sdp_stream_cntl/addr_to_strm_fsm_fifo[0]/pipe_transfer_type}}'.format(mgr,strm,lane)
      pLine = pLine + '\nadd wave -noupdate -group MGR{0} -group MRC{1} -group SDP -group SDPS -radix hexadecimal {{/top/system_inst/manager_array_inst/mgr_inst[{0}]/manager/mrc_cntl_strm_inst[{1}]/mrc_cntl/sdp_cntl/sdp_stream_cntl/addr_to_strm_fsm_fifo[0]/pipe_valid}}'.format(mgr,strm,lane)
      pLine = pLine + '\nadd wave -noupdate -group MGR{0} -group MRC{1} -group SDP -group SDPS -radix hexadecimal {{/top/system_inst/manager_array_inst/mgr_inst[{0}]/manager/mrc_cntl_strm_inst[{1}]/mrc_cntl/sdp_cntl/sdp_stream_cntl/consJump_to_strm_fsm_fifo[0]/pipe_consJumpCntl}}'.format(mgr,strm,lane)
      pLine = pLine + '\nadd wave -noupdate -group MGR{0} -group MRC{1} -group SDP -group SDPS -radix hexadecimal {{/top/system_inst/manager_array_inst/mgr_inst[{0}]/manager/mrc_cntl_strm_inst[{1}]/mrc_cntl/sdp_cntl/sdp_stream_cntl/consJump_to_strm_fsm_fifo[0]/pipe_consJumpValue}}'.format(mgr,strm,lane)
      pLine = pLine + '\nadd wave -noupdate -group MGR{0} -group MRC{1} -group SDP -group SDPS -radix hexadecimal {{/top/system_inst/manager_array_inst/mgr_inst[{0}]/manager/mrc_cntl_strm_inst[{1}]/mrc_cntl/sdp_cntl/sdp_stream_cntl/consJump_to_strm_fsm_fifo[0]/pipe_eom}}'.format(mgr,strm,lane)
      pLine = pLine + '\nadd wave -noupdate -group MGR{0} -group MRC{1} -group SDP -group SDPS -radix hexadecimal {{/top/system_inst/manager_array_inst/mgr_inst[{0}]/manager/mrc_cntl_strm_inst[{1}]/mrc_cntl/sdp_cntl/sdp_stream_cntl/consJump_to_strm_fsm_fifo[0]/pipe_read}}'.format(mgr,strm,lane)
      pLine = pLine + '\nadd wave -noupdate -group MGR{0} -group MRC{1} -group SDP -group SDPS -radix hexadecimal {{/top/system_inst/manager_array_inst/mgr_inst[{0}]/manager/mrc_cntl_strm_inst[{1}]/mrc_cntl/sdp_cntl/sdp_stream_cntl/consJump_to_strm_fsm_fifo[0]/pipe_som}}'.format(mgr,strm,lane)
      pLine = pLine + '\nadd wave -noupdate -group MGR{0} -group MRC{1} -group SDP -group SDPS -radix hexadecimal {{/top/system_inst/manager_array_inst/mgr_inst[{0}]/manager/mrc_cntl_strm_inst[{1}]/mrc_cntl/sdp_cntl/sdp_stream_cntl/consJump_to_strm_fsm_fifo[0]/pipe_valid}}'.format(mgr,strm,lane)
      pLine = pLine + '\nadd wave -noupdate -group MGR{0} -group MRC{1} -group SDP -group SDPS -radix hexadecimal {{/top/system_inst/manager_array_inst/mgr_inst[{0}]/manager/mrc_cntl_strm_inst[{1}]/mrc_cntl/sdp_cntl/sdp_stream_cntl/consJump_to_strm_fsm_fifo[0]/write}}'.format(mgr,strm,lane)
      #
      #
      for lane in [0,7,15,23,31] :
        #
        pLine = pLine + '\nadd wave -noupdate -group MGR{0} -group MRC{1} -group SDP -group SDPS -group LANE{2} -radix hexadecimal {{/top/system_inst/manager_array_inst/mgr_inst[{0}]/manager/mrc_cntl_strm_inst[{1}]/mrc_cntl/sdp_cntl/sdp_stream_cntl/lane_fsm[{2}]/sdp_cntl_stream_data_state}}'.format(mgr,strm,lane)
        pLine = pLine + '\nadd wave -noupdate -group MGR{0} -group MRC{1} -group SDP -group SDPS -group LANE{2} -radix hexadecimal {{/top/system_inst/manager_array_inst/mgr_inst[{0}]/manager/mrc_cntl_strm_inst[{1}]/mrc_cntl/sdp_cntl/sdp_stream_cntl/lane_fsm[{2}]/req_next_line[0]}} '.format(mgr,strm,lane)
        pLine = pLine + '\nadd wave -noupdate -group MGR{0} -group MRC{1} -group SDP -group SDPS -group LANE{2} -radix hexadecimal {{/top/system_inst/manager_array_inst/mgr_inst[{0}]/manager/mrc_cntl_strm_inst[{1}]/mrc_cntl/sdp_cntl/sdp_stream_cntl/lane_fsm[{2}]/force_req_next_line[0]}} '.format(mgr,strm,lane)
        pLine = pLine + '\nadd wave -noupdate -group MGR{0} -group MRC{1} -group SDP -group SDPS -group LANE{2} -radix hexadecimal {{/top/system_inst/manager_array_inst/mgr_inst[{0}]/manager/mrc_cntl_strm_inst[{1}]/mrc_cntl/sdp_cntl/sdp_stream_cntl/lane_fsm[{2}]/lane_address_match[0]}} '.format(mgr,strm,lane)
        pLine = pLine + '\nadd wave -noupdate -group MGR{0} -group MRC{1} -group SDP -group SDPS -group LANE{2} -radix hexadecimal {{/top/system_inst/manager_array_inst/mgr_inst[{0}]/manager/mrc_cntl_strm_inst[{1}]/mrc_cntl/sdp_cntl/sdp_stream_cntl/lane_fsm[{2}]/lane_address_next_match[0]}} '.format(mgr,strm,lane)
        pLine = pLine + '\nadd wave -noupdate -group MGR{0} -group MRC{1} -group SDP -group SDPS -group LANE{2} -radix hexadecimal {{/top/system_inst/manager_array_inst/mgr_inst[{0}]/manager/mrc_cntl_strm_inst[{1}]/mrc_cntl/sdp_cntl/sdp_stream_cntl/lane_fsm[{2}]/req_next_line[1]}} '.format(mgr,strm,lane)
        pLine = pLine + '\nadd wave -noupdate -group MGR{0} -group MRC{1} -group SDP -group SDPS -group LANE{2} -radix hexadecimal {{/top/system_inst/manager_array_inst/mgr_inst[{0}]/manager/mrc_cntl_strm_inst[{1}]/mrc_cntl/sdp_cntl/sdp_stream_cntl/lane_fsm[{2}]/force_req_next_line[1]}} '.format(mgr,strm,lane)
        pLine = pLine + '\nadd wave -noupdate -group MGR{0} -group MRC{1} -group SDP -group SDPS -group LANE{2} -radix hexadecimal {{/top/system_inst/manager_array_inst/mgr_inst[{0}]/manager/mrc_cntl_strm_inst[{1}]/mrc_cntl/sdp_cntl/sdp_stream_cntl/lane_fsm[{2}]/lane_address_match[1]}} '.format(mgr,strm,lane)
        pLine = pLine + '\nadd wave -noupdate -group MGR{0} -group MRC{1} -group SDP -group SDPS -group LANE{2} -radix hexadecimal {{/top/system_inst/manager_array_inst/mgr_inst[{0}]/manager/mrc_cntl_strm_inst[{1}]/mrc_cntl/sdp_cntl/sdp_stream_cntl/lane_fsm[{2}]/lane_address_next_match[1]}} '.format(mgr,strm,lane)
        #                                                                                  
        pLine = pLine + '\nadd wave -noupdate -group MGR{0} -group MRC{1} -group SDP -group SDPS -group LANE{2} -radix hexadecimal {{/top/system_inst/manager_array_inst/mgr_inst[{0}]/manager/mrc_cntl_strm_inst[{1}]/mrc_cntl/sdp_cntl/sdp_stream_cntl/lane_fsm[{2}]/sdp_cntl_stream_data_state}}'.format(mgr,strm,lane)
        pLine = pLine + '\nadd wave -noupdate -group MGR{0} -group MRC{1} -group SDP -group SDPS -group LANE{2} -radix hexadecimal {{/top/system_inst/manager_array_inst/mgr_inst[{0}]/manager/mrc_cntl_strm_inst[{1}]/mrc_cntl/sdp_cntl/sdp_stream_cntl/lane_fsm[{2}]/complete}}'.format(mgr,strm,lane)
        pLine = pLine + '\nadd wave -noupdate -group MGR{0} -group MRC{1} -group SDP -group SDPS -group LANE{2} -radix hexadecimal {{/top/system_inst/manager_array_inst/mgr_inst[{0}]/manager/mrc_cntl_strm_inst[{1}]/mrc_cntl/sdp_cntl/sdp_stream_cntl/lane_fsm[{2}]/lane_channel_ptr}}'.format(mgr,strm,lane)
        pLine = pLine + '\nadd wave -noupdate -group MGR{0} -group MRC{1} -group SDP -group SDPS -group LANE{2} -radix hexadecimal {{/top/system_inst/manager_array_inst/mgr_inst[{0}]/manager/mrc_cntl_strm_inst[{1}]/mrc_cntl/sdp_cntl/sdp_stream_cntl/lane_fsm[{2}]/lane_bank_ptr}}'.format(mgr,strm,lane)
        pLine = pLine + '\nadd wave -noupdate -group MGR{0} -group MRC{1} -group SDP -group SDPS -group LANE{2} -radix hexadecimal {{/top/system_inst/manager_array_inst/mgr_inst[{0}]/manager/mrc_cntl_strm_inst[{1}]/mrc_cntl/sdp_cntl/sdp_stream_cntl/lane_fsm[{2}]/lane_line_ptr}}'.format(mgr,strm,lane)
        pLine = pLine + '\nadd wave -noupdate -group MGR{0} -group MRC{1} -group SDP -group SDPS -group LANE{2} -radix hexadecimal {{/top/system_inst/manager_array_inst/mgr_inst[{0}]/manager/mrc_cntl_strm_inst[{1}]/mrc_cntl/sdp_cntl/sdp_stream_cntl/lane_fsm[{2}]/lane_word_ptr}}'.format(mgr,strm,lane)
        pLine = pLine + '\nadd wave -noupdate -group MGR{0} -group MRC{1} -group SDP -group SDPS -group LANE{2} -radix hexadecimal {{/top/system_inst/manager_array_inst/mgr_inst[{0}]/manager/mrc_cntl_strm_inst[{1}]/mrc_cntl/sdp_cntl/sdp_stream_cntl/lane_fsm[{2}]/lane_channel_ptr_e1}}'.format(mgr,strm,lane)
        pLine = pLine + '\nadd wave -noupdate -group MGR{0} -group MRC{1} -group SDP -group SDPS -group LANE{2} -radix hexadecimal {{/top/system_inst/manager_array_inst/mgr_inst[{0}]/manager/mrc_cntl_strm_inst[{1}]/mrc_cntl/sdp_cntl/sdp_stream_cntl/lane_fsm[{2}]/lane_bank_ptr_e1}}'.format(mgr,strm,lane)
        pLine = pLine + '\nadd wave -noupdate -group MGR{0} -group MRC{1} -group SDP -group SDPS -group LANE{2} -radix hexadecimal {{/top/system_inst/manager_array_inst/mgr_inst[{0}]/manager/mrc_cntl_strm_inst[{1}]/mrc_cntl/sdp_cntl/sdp_stream_cntl/lane_fsm[{2}]/lane_line_ptr_e1}}'.format(mgr,strm,lane)
        pLine = pLine + '\nadd wave -noupdate -group MGR{0} -group MRC{1} -group SDP -group SDPS -group LANE{2} -radix hexadecimal {{/top/system_inst/manager_array_inst/mgr_inst[{0}]/manager/mrc_cntl_strm_inst[{1}]/mrc_cntl/sdp_cntl/sdp_stream_cntl/lane_fsm[{2}]/lane_word_ptr_e1}}'.format(mgr,strm,lane)
        pLine = pLine + '\nadd wave -noupdate -group MGR{0} -group MRC{1} -group SDP -group SDPS -group LANE{2} -radix hexadecimal {{/top/system_inst/manager_array_inst/mgr_inst[{0}]/manager/mrc_cntl_strm_inst[{1}]/mrc_cntl/sdp_cntl/sdp_stream_cntl/lane_fsm[{2}]/consequtive_counter_le0}}'.format(mgr,strm,lane)
        pLine = pLine + '\nadd wave -noupdate -group MGR{0} -group MRC{1} -group SDP -group SDPS -group LANE{2} -radix hexadecimal {{/top/system_inst/manager_array_inst/mgr_inst[{0}]/manager/mrc_cntl_strm_inst[{1}]/mrc_cntl/sdp_cntl/sdp_stream_cntl/lane_fsm[{2}]/lane_data_available}}'.format(mgr,strm,lane)
        pLine = pLine + '\nadd wave -noupdate -group MGR{0} -group MRC{1} -group SDP -group SDPS -group LANE{2} -radix hexadecimal {{/top/system_inst/manager_array_inst/mgr_inst[{0}]/manager/mrc_cntl_strm_inst[{1}]/mrc_cntl/sdp_cntl/sdp_stream_cntl/lane_fsm[{2}]/sent_data_without_increment}}'.format(mgr,strm,lane)
        pLine = pLine + '\nadd wave -noupdate -group MGR{0} -group MRC{1} -group SDP -group SDPS -group LANE{2} -radix hexadecimal {{/top/system_inst/manager_array_inst/mgr_inst[{0}]/manager/mrc_cntl_strm_inst[{1}]/mrc_cntl/sdp_cntl/sdp_stream_cntl/lane_fsm[{2}]/destination_ready}}'.format(mgr,strm,lane)
        pLine = pLine + '\nadd wave -noupdate -group MGR{0} -group MRC{1} -group SDP -group SDPS -group LANE{2} -radix hexadecimal {{/top/system_inst/manager_array_inst/mgr_inst[{0}]/manager/mrc_cntl_strm_inst[{1}]/mrc_cntl/sdp_cntl/sdp_stream_cntl/lane_fsm[{2}]/consequtive_counter}}'.format(mgr,strm,lane)
        pLine = pLine + '\nadd wave -noupdate -group MGR{0} -group MRC{1} -group SDP -group SDPS -group LANE{2} -radix hexadecimal {{/top/system_inst/manager_array_inst/mgr_inst[{0}]/manager/mrc_cntl_strm_inst[{1}]/mrc_cntl/sdp_cntl/sdp_stream_cntl/lane_fsm[{2}]/lane_next_inc_cons_start_address}}'.format(mgr,strm,lane)
        pLine = pLine + '\nadd wave -noupdate -group MGR{0} -group MRC{1} -group SDP -group SDPS -group LANE{2} -radix hexadecimal {{/top/system_inst/manager_array_inst/mgr_inst[{0}]/manager/mrc_cntl_strm_inst[{1}]/mrc_cntl/sdp_cntl/sdp_stream_cntl/lane_fsm[{2}]/last_consequtive}}'.format(mgr,strm,lane)
        pLine = pLine + '\nadd wave -noupdate -group MGR{0} -group MRC{1} -group SDP -group SDPS -group LANE{2} -radix hexadecimal {{/top/system_inst/manager_array_inst/mgr_inst[{0}]/manager/mrc_cntl_strm_inst[{1}]/mrc_cntl/sdp_cntl/sdp_stream_cntl/lane_fsm[{2}]/sdp_cntl_stream_data_state}}'.format(mgr,strm,lane)
        pLine = pLine + '\nadd wave -noupdate -group MGR{0} -group MRC{1} -group SDP -group SDPS -group LANE{2} -radix hexadecimal {{/top/system_inst/manager_array_inst/mgr_inst[{0}]/manager/mrc_cntl_strm_inst[{1}]/mrc_cntl/sdp_cntl/sdp_stream_cntl/lane_fsm[{2}]/lane_address_match[0]}}'.format(mgr,strm,lane) 
        pLine = pLine + '\nadd wave -noupdate -group MGR{0} -group MRC{1} -group SDP -group SDPS -group LANE{2} -radix hexadecimal {{/top/system_inst/manager_array_inst/mgr_inst[{0}]/manager/mrc_cntl_strm_inst[{1}]/mrc_cntl/sdp_cntl/sdp_stream_cntl/lane_fsm[{2}]/lane_address_match[1]}}'.format(mgr,strm,lane) 
        #                                                                                  
        pLine = pLine + '\nadd wave -noupdate -group MGR{0} -group MRC{1} -group SDP -group SDPS -group LANE{2} -radix hexadecimal {{/top/system_inst/manager_array_inst/mgr_inst[{0}]/manager/mrc_cntl_strm_inst[{1}]/mrc_cntl/sdp_cntl/sdp_stream_cntl/lanes_req_next_line[0][{2}]}}'.format(mgr,strm,lane)
        pLine = pLine + '\nadd wave -noupdate -group MGR{0} -group MRC{1} -group SDP -group SDPS -group LANE{2} -radix hexadecimal {{/top/system_inst/manager_array_inst/mgr_inst[{0}]/manager/mrc_cntl_strm_inst[{1}]/mrc_cntl/sdp_cntl/sdp_stream_cntl/lanes_req_next_line[1][{2}]}}'.format(mgr,strm,lane)
        pLine = pLine + '\nadd wave -noupdate -group MGR{0} -group MRC{1} -group SDP -group SDPS -group LANE{2} -radix hexadecimal {{/top/system_inst/manager_array_inst/mgr_inst[{0}]/manager/mrc_cntl_strm_inst[{1}]/mrc_cntl/sdp_cntl/sdp_stream_cntl/lane_fsm[{2}]/req_next_line_but_not_accepted}}'.format(mgr,strm,lane)
        pLine = pLine + '\nadd wave -noupdate -group MGR{0} -group MRC{1} -group SDP -group SDPS -group LANE{2} -radix hexadecimal {{/top/system_inst/manager_array_inst/mgr_inst[{0}]/manager/mrc_cntl_strm_inst[{1}]/mrc_cntl/sdp_cntl/sdp_stream_cntl/lane_fsm[{2}]/send_data}}'.format(mgr,strm,lane)
        pLine = pLine + '\nadd wave -noupdate -group MGR{0} -group MRC{1} -group SDP -group SDPS -group LANE{2} -radix hexadecimal {{/top/system_inst/manager_array_inst/mgr_inst[{0}]/manager/mrc_cntl_strm_inst[{1}]/mrc_cntl/sdp_cntl/sdp_stream_cntl/lane_fsm[{2}]/lane_running}}'.format(mgr,strm,lane)
        pLine = pLine + '\nadd wave -noupdate -group MGR{0} -group MRC{1} -group SDP -group SDPS -group LANE{2} -radix hexadecimal {{/top/system_inst/manager_array_inst/mgr_inst[{0}]/manager/mrc_cntl_strm_inst[{1}]/mrc_cntl/sdp_cntl/sdp_stream_cntl/lane_fsm[{2}]/lane_data_available}}'.format(mgr,strm,lane)
        pLine = pLine + '\nadd wave -noupdate -group MGR{0} -group MRC{1} -group SDP -group SDPS -group LANE{2} -radix hexadecimal {{/top/system_inst/manager_array_inst/mgr_inst[{0}]/manager/mrc_cntl_strm_inst[{1}]/mrc_cntl/sdp_cntl/sdp_stream_cntl/lane_fsm[{2}]/destination_ready}}'.format(mgr,strm,lane)
        pLine = pLine + '\nadd wave -noupdate -group MGR{0} -group MRC{1} -group SDP -group SDPS -group LANE{2} -radix hexadecimal {{/top/system_inst/manager_array_inst/mgr_inst[{0}]/manager/mrc_cntl_strm_inst[{1}]/mrc_cntl/sdp_cntl/sdp_stream_cntl/lane_fsm[{2}]/sdp_cntl_stream_data_state}}'.format(mgr,strm,lane)
        pLine = pLine + '\nadd wave -noupdate -group MGR{0} -group MRC{1} -group SDP -group SDPS -group LANE{2} -radix hexadecimal {{/top/system_inst/manager_array_inst/mgr_inst[{0}]/manager/mrc_cntl_strm_inst[{1}]/mrc_cntl/sdp_cntl/sdp_stream_cntl/lane_fsm[{2}]/loaded_consequtive}}'.format(mgr,strm,lane)
        pLine = pLine + '\nadd wave -noupdate -group MGR{0} -group MRC{1} -group SDP -group SDPS -group LANE{2} -radix hexadecimal {{/top/system_inst/manager_array_inst/mgr_inst[{0}]/manager/mrc_cntl_strm_inst[{1}]/mrc_cntl/sdp_cntl/sdp_stream_cntl/lane_fsm[{2}]/loaded_jump}}'.format(mgr,strm,lane)
        pLine = pLine + '\nadd wave -noupdate -group MGR{0} -group MRC{1} -group SDP -group SDPS -group LANE{2} -radix hexadecimal {{/top/system_inst/manager_array_inst/mgr_inst[{0}]/manager/mrc_cntl_strm_inst[{1}]/mrc_cntl/sdp_cntl/sdp_stream_cntl/lane_fsm[{2}]/loading_consequtive}}'.format(mgr,strm,lane)
        pLine = pLine + '\nadd wave -noupdate -group MGR{0} -group MRC{1} -group SDP -group SDPS -group LANE{2} -radix hexadecimal {{/top/system_inst/manager_array_inst/mgr_inst[{0}]/manager/mrc_cntl_strm_inst[{1}]/mrc_cntl/sdp_cntl/sdp_stream_cntl/lane_fsm[{2}]/loading_jump}}'.format(mgr,strm,lane)

  for mgr in range (0, numOfMgr):
      for strm in range (0, numOfStrms):
        pLine = pLine + '\nadd wave -noupdate -group MGR{0} -group MRC{1} -group FROM_WUD -radix hexadecimal {{/top/system_inst/manager_array_inst/mgr_inst[{0}]/manager/mrc_cntl_strm_inst[{1}]/mrc_cntl/wud__mrc__valid}}'.format(mgr,strm)
        pLine = pLine + '\nadd wave -noupdate -group MGR{0} -group MRC{1} -group FROM_WUD -radix hexadecimal {{/top/system_inst/manager_array_inst/mgr_inst[{0}]/manager/mrc_cntl_strm_inst[{1}]/mrc_cntl/wud__mrc__cntl}}'.format(mgr,strm)
        pLine = pLine + '\nadd wave -noupdate -group MGR{0} -group MRC{1} -group FROM_WUD -radix hexadecimal {{/top/system_inst/manager_array_inst/mgr_inst[{0}]/manager/mrc_cntl_strm_inst[{1}]/mrc_cntl/wud__mrc__option_type}}'.format(mgr,strm)
        pLine = pLine + '\nadd wave -noupdate -group MGR{0} -group MRC{1} -group FROM_WUD -radix hexadecimal {{/top/system_inst/manager_array_inst/mgr_inst[{0}]/manager/mrc_cntl_strm_inst[{1}]/mrc_cntl/wud__mrc__option_value}}'.format(mgr,strm)
        pLine = pLine + '\nadd wave -noupdate -group MGR{0} -group MRC{1} -group FROM_WUD -radix hexadecimal {{/top/system_inst/manager_array_inst/mgr_inst[{0}]/manager/mrc_cntl_strm_inst[{1}]/mrc_cntl/wud__mrc__tag}}'.format(mgr,strm)
        pLine = pLine + '\nadd wave -noupdate -group MGR{0} -group MRC{1} -group FROM_WUD -radix hexadecimal {{/top/system_inst/manager_array_inst/mgr_inst[{0}]/manager/mrc_cntl_strm_inst[{1}]/mrc_cntl/mrc__wud__ready}}'.format(mgr,strm)
        #
        pLine = pLine + '\nadd wave -noupdate -group MGR{0} -group MRC{1} -group FROM_WUD -group FROM_WUD_FIFO -group WRITE -radix hexadecimal {{/top/system_inst/manager_array_inst/mgr_inst[{0}]/manager/mrc_cntl_strm_inst[{1}]/mrc_cntl/from_Wud_Fifo[0]/write}}'.format(mgr,strm)
        pLine = pLine + '\nadd wave -noupdate -group MGR{0} -group MRC{1} -group FROM_WUD -group FROM_WUD_FIFO -group WRITE -radix hexadecimal {{/top/system_inst/manager_array_inst/mgr_inst[{0}]/manager/mrc_cntl_strm_inst[{1}]/mrc_cntl/from_Wud_Fifo[0]/write_cntl}}'.format(mgr,strm)
        pLine = pLine + '\nadd wave -noupdate -group MGR{0} -group MRC{1} -group FROM_WUD -group FROM_WUD_FIFO -group WRITE -radix hexadecimal {{/top/system_inst/manager_array_inst/mgr_inst[{0}]/manager/mrc_cntl_strm_inst[{1}]/mrc_cntl/from_Wud_Fifo[0]/write_tag}}'.format(mgr,strm)
        pLine = pLine + '\nadd wave -noupdate -group MGR{0} -group MRC{1} -group FROM_WUD -group FROM_WUD_FIFO -group WRITE -radix hexadecimal {{/top/system_inst/manager_array_inst/mgr_inst[{0}]/manager/mrc_cntl_strm_inst[{1}]/mrc_cntl/from_Wud_Fifo[0]/write_option_type}}'.format(mgr,strm)
        pLine = pLine + '\nadd wave -noupdate -group MGR{0} -group MRC{1} -group FROM_WUD -group FROM_WUD_FIFO -group WRITE -radix hexadecimal {{/top/system_inst/manager_array_inst/mgr_inst[{0}]/manager/mrc_cntl_strm_inst[{1}]/mrc_cntl/from_Wud_Fifo[0]/write_option_value}}'.format(mgr,strm)
        #
        pLine = pLine + '\nadd wave -noupdate -group MGR{0} -group MRC{1} -group FROM_WUD -group FROM_WUD_FIFO -group READ -radix hexadecimal {{/top/system_inst/manager_array_inst/mgr_inst[{0}]/manager/mrc_cntl_strm_inst[{1}]/mrc_cntl/from_Wud_Fifo[0]/read}}'.format(mgr,strm)
        pLine = pLine + '\nadd wave -noupdate -group MGR{0} -group MRC{1} -group FROM_WUD -group FROM_WUD_FIFO -group READ -radix hexadecimal {{/top/system_inst/manager_array_inst/mgr_inst[{0}]/manager/mrc_cntl_strm_inst[{1}]/mrc_cntl/from_Wud_Fifo[0]/read_cntl}}'.format(mgr,strm)
        pLine = pLine + '\nadd wave -noupdate -group MGR{0} -group MRC{1} -group FROM_WUD -group FROM_WUD_FIFO -group READ -radix hexadecimal {{/top/system_inst/manager_array_inst/mgr_inst[{0}]/manager/mrc_cntl_strm_inst[{1}]/mrc_cntl/from_Wud_Fifo[0]/read_tag}}'.format(mgr,strm)
        pLine = pLine + '\nadd wave -noupdate -group MGR{0} -group MRC{1} -group FROM_WUD -group FROM_WUD_FIFO -group READ -radix hexadecimal {{/top/system_inst/manager_array_inst/mgr_inst[{0}]/manager/mrc_cntl_strm_inst[{1}]/mrc_cntl/from_Wud_Fifo[0]/read_option_type}}'.format(mgr,strm)
        pLine = pLine + '\nadd wave -noupdate -group MGR{0} -group MRC{1} -group FROM_WUD -group FROM_WUD_FIFO -group READ -radix hexadecimal {{/top/system_inst/manager_array_inst/mgr_inst[{0}]/manager/mrc_cntl_strm_inst[{1}]/mrc_cntl/from_Wud_Fifo[0]/read_option_value}}'.format(mgr,strm)
        pLine = pLine + '\nadd wave -noupdate -group MGR{0} -group MRC{1} -group FROM_WUD -group FROM_WUD_FIFO -group READ -radix hexadecimal {{/top/system_inst/manager_array_inst/mgr_inst[{0}]/manager/mrc_cntl_strm_inst[{1}]/mrc_cntl/from_Wud_Fifo[0]/clear}}'.format(mgr,strm)
        pLine = pLine + '\nadd wave -noupdate -group MGR{0} -group MRC{1} -group FROM_WUD -group FROM_WUD_FIFO -group READ -radix hexadecimal {{/top/system_inst/manager_array_inst/mgr_inst[{0}]/manager/mrc_cntl_strm_inst[{1}]/mrc_cntl/from_Wud_Fifo[0]/empty}}'.format(mgr,strm)
        pLine = pLine + '\nadd wave -noupdate -group MGR{0} -group MRC{1} -group FROM_WUD -group FROM_WUD_FIFO -group READ -radix hexadecimal {{/top/system_inst/manager_array_inst/mgr_inst[{0}]/manager/mrc_cntl_strm_inst[{1}]/mrc_cntl/from_Wud_Fifo[0]/almost_full}}'.format(mgr,strm)
        pLine = pLine + '\nadd wave -noupdate -group MGR{0} -group MRC{1} -group FROM_WUD -group FROM_WUD_FIFO -group READ -radix hexadecimal {{/top/system_inst/manager_array_inst/mgr_inst[{0}]/manager/mrc_cntl_strm_inst[{1}]/mrc_cntl/from_Wud_Fifo[0]/fifo_pipe_valid}}'.format(mgr,strm)
        pLine = pLine + '\nadd wave -noupdate -group MGR{0} -group MRC{1} -group FROM_WUD -group FROM_WUD_FIFO -group READ -radix hexadecimal {{/top/system_inst/manager_array_inst/mgr_inst[{0}]/manager/mrc_cntl_strm_inst[{1}]/mrc_cntl/from_Wud_Fifo[0]/fifo_pipe_read}}'.format(mgr,strm)
        pLine = pLine + '\nadd wave -noupdate -group MGR{0} -group MRC{1} -group FROM_WUD -group FROM_WUD_FIFO -group READ -radix hexadecimal {{/top/system_inst/manager_array_inst/mgr_inst[{0}]/manager/mrc_cntl_strm_inst[{1}]/mrc_cntl/from_Wud_Fifo[0]/pipe_read}}'.format(mgr,strm)
        pLine = pLine + '\nadd wave -noupdate -group MGR{0} -group MRC{1} -group FROM_WUD -group FROM_WUD_FIFO -group READ -radix hexadecimal {{/top/system_inst/manager_array_inst/mgr_inst[{0}]/manager/mrc_cntl_strm_inst[{1}]/mrc_cntl/from_Wud_Fifo[0]/pipe_valid}}'.format(mgr,strm)
        pLine = pLine + '\nadd wave -noupdate -group MGR{0} -group MRC{1} -group FROM_WUD -group FROM_WUD_FIFO -group READ -radix hexadecimal {{/top/system_inst/manager_array_inst/mgr_inst[{0}]/manager/mrc_cntl_strm_inst[{1}]/mrc_cntl/from_Wud_Fifo[0]/pipe_cntl}}'.format(mgr,strm)
        pLine = pLine + '\nadd wave -noupdate -group MGR{0} -group MRC{1} -group FROM_WUD -group FROM_WUD_FIFO -group READ -radix hexadecimal {{/top/system_inst/manager_array_inst/mgr_inst[{0}]/manager/mrc_cntl_strm_inst[{1}]/mrc_cntl/from_Wud_Fifo[0]/pipe_tag}}'.format(mgr,strm)
        pLine = pLine + '\nadd wave -noupdate -group MGR{0} -group MRC{1} -group FROM_WUD -group FROM_WUD_FIFO -group READ -radix hexadecimal {{/top/system_inst/manager_array_inst/mgr_inst[{0}]/manager/mrc_cntl_strm_inst[{1}]/mrc_cntl/from_Wud_Fifo[0]/pipe_option_type}}'.format(mgr,strm)
        pLine = pLine + '\nadd wave -noupdate -group MGR{0} -group MRC{1} -group FROM_WUD -group FROM_WUD_FIFO -group READ -radix hexadecimal {{/top/system_inst/manager_array_inst/mgr_inst[{0}]/manager/mrc_cntl_strm_inst[{1}]/mrc_cntl/from_Wud_Fifo[0]/pipe_option_value}}'.format(mgr,strm)
        pLine = pLine + '\nadd wave -noupdate -group MGR{0} -group MRC{1} -group FROM_WUD -group FROM_WUD_FIFO -group READ -radix hexadecimal {{/top/system_inst/manager_array_inst/mgr_inst[{0}]/manager/mrc_cntl_strm_inst[{1}]/mrc_cntl/from_Wud_Fifo[0]/pipe_som}}'.format(mgr,strm)
        pLine = pLine + '\nadd wave -noupdate -group MGR{0} -group MRC{1} -group FROM_WUD -group FROM_WUD_FIFO -group READ -radix hexadecimal {{/top/system_inst/manager_array_inst/mgr_inst[{0}]/manager/mrc_cntl_strm_inst[{1}]/mrc_cntl/from_Wud_Fifo[0]/pipe_eom}}'.format(mgr,strm)
        #
        pLine = pLine + '\nadd wave -noupdate -group MGR{0} -group MRC{1} -group GENERAL -radix hexadecimal {{/top/system_inst/manager_array_inst/mgr_inst[{0}]/manager/mrc_cntl_strm_inst[{1}]/mrc_cntl/sys__mgr__mgrId}}'.format(mgr,strm)
        pLine = pLine + '\nadd wave -noupdate -group MGR{0} -group MRC{1} -group GENERAL -radix hexadecimal {{/top/system_inst/manager_array_inst/mgr_inst[{0}]/manager/mrc_cntl_strm_inst[{1}]/mrc_cntl/clk}}'.format(mgr,strm)
        pLine = pLine + '\nadd wave -noupdate -group MGR{0} -group MRC{1} -group GENERAL -radix hexadecimal {{/top/system_inst/manager_array_inst/mgr_inst[{0}]/manager/mrc_cntl_strm_inst[{1}]/mrc_cntl/reset_poweron}}'.format(mgr,strm)
        pLine = pLine + '\nadd wave -noupdate -group MGR{0} -group MRC{1} -group GENERAL -radix hexadecimal {{/top/system_inst/manager_array_inst/mgr_inst[{0}]/manager/mrc_cntl_strm_inst[{1}]/mrc_cntl/tag}}'.format(mgr,strm)
        pLine = pLine + '\nadd wave -noupdate -group MGR{0} -group MRC{1} -group GENERAL -radix hexadecimal {{/top/system_inst/manager_array_inst/mgr_inst[{0}]/manager/mrc_cntl_strm_inst[{1}]/mrc_cntl/num_lanes}}'.format(mgr,strm)
        pLine = pLine + '\nadd wave -noupdate -group MGR{0} -group MRC{1} -group GENERAL -radix hexadecimal {{/top/system_inst/manager_array_inst/mgr_inst[{0}]/manager/mrc_cntl_strm_inst[{1}]/mrc_cntl/num_lanes_m1}}'.format(mgr,strm)
        pLine = pLine + '\nadd wave -noupdate -group MGR{0} -group MRC{1} -group GENERAL -radix hexadecimal {{/top/system_inst/manager_array_inst/mgr_inst[{0}]/manager/mrc_cntl_strm_inst[{1}]/mrc_cntl/storage_desc_ptr}}'.format(mgr,strm)
        pLine = pLine + '\nadd wave -noupdate -group MGR{0} -group MRC{1} -group GENERAL -radix hexadecimal {{/top/system_inst/manager_array_inst/mgr_inst[{0}]/manager/mrc_cntl_strm_inst[{1}]/mrc_cntl/txfer_type}}'.format(mgr,strm)
        pLine = pLine + '\nadd wave -noupdate -group MGR{0} -group MRC{1} -group GENERAL -radix hexadecimal {{/top/system_inst/manager_array_inst/mgr_inst[{0}]/manager/mrc_cntl_strm_inst[{1}]/mrc_cntl/target}}'.format(mgr,strm)
        pLine = pLine + '\nadd wave -noupdate -group MGR{0} -group MRC{1} -group GENERAL -radix hexadecimal {{/top/system_inst/manager_array_inst/mgr_inst[{0}]/manager/mrc_cntl_strm_inst[{1}]/mrc_cntl/extracting_descriptor_state}}'.format(mgr,strm)
        pLine = pLine + '\nadd wave -noupdate -group MGR{0} -group MRC{1} -group GENERAL -radix hexadecimal {{/top/system_inst/manager_array_inst/mgr_inst[{0}]/manager/mrc_cntl_strm_inst[{1}]/mrc_cntl/descriptor_fsm_complete}}'.format(mgr,strm)
        pLine = pLine + '\nadd wave -noupdate -group MGR{0} -group MRC{1} -group GENERAL -radix hexadecimal {{/top/system_inst/manager_array_inst/mgr_inst[{0}]/manager/mrc_cntl_strm_inst[{1}]/mrc_cntl/storage_desc_processing_enable}}'.format(mgr,strm)
        pLine = pLine + '\nadd wave -noupdate -group MGR{0} -group MRC{1} -group GENERAL -radix hexadecimal {{/top/system_inst/manager_array_inst/mgr_inst[{0}]/manager/mrc_cntl_strm_inst[{1}]/mrc_cntl/storage_desc_processing_complete}}'.format(mgr,strm)
        pLine = pLine + '\nadd wave -noupdate -group MGR{0} -group MRC{1} -group GENERAL -radix hexadecimal {{/top/system_inst/manager_array_inst/mgr_inst[{0}]/manager/mrc_cntl_strm_inst[{1}]/mrc_cntl/mrc_cntl_extract_desc_state}}'.format(mgr,strm)
        pLine = pLine + '\nadd wave -noupdate -group MGR{0} -group MRC{1} -group GENERAL -radix hexadecimal {{/top/system_inst/manager_array_inst/mgr_inst[{0}]/manager/mrc_cntl_strm_inst[{1}]/mrc_cntl/mrc_cntl_extract_desc_state_next}}'.format(mgr,strm)
        pLine = pLine + '\nadd wave -noupdate -group MGR{0} -group MRC{1} -group GENERAL -radix hexadecimal {{/top/system_inst/manager_array_inst/mgr_inst[{0}]/manager/mrc_cntl_strm_inst[{1}]/mrc_cntl/sdp__xxx__lane_valid}}'.format(mgr,strm)
        pLine = pLine + '\nadd wave -noupdate -group MGR{0} -group MRC{1} -group GENERAL -radix hexadecimal {{/top/system_inst/manager_array_inst/mgr_inst[{0}]/manager/mrc_cntl_strm_inst[{1}]/mrc_cntl/sdp__xxx__lane_cntl}}'.format(mgr,strm)
        pLine = pLine + '\nadd wave -noupdate -group MGR{0} -group MRC{1} -group GENERAL -radix hexadecimal {{/top/system_inst/manager_array_inst/mgr_inst[{0}]/manager/mrc_cntl_strm_inst[{1}]/mrc_cntl/sdp__xxx__lane_enable}}'.format(mgr,strm)
        pLine = pLine + '\nadd wave -noupdate -group MGR{0} -group MRC{1} -group GENERAL -radix hexadecimal {{/top/system_inst/manager_array_inst/mgr_inst[{0}]/manager/mrc_cntl_strm_inst[{1}]/mrc_cntl/sdp__xxx__lane_channel_ptr}}'.format(mgr,strm)
        pLine = pLine + '\nadd wave -noupdate -group MGR{0} -group MRC{1} -group GENERAL -radix hexadecimal {{/top/system_inst/manager_array_inst/mgr_inst[{0}]/manager/mrc_cntl_strm_inst[{1}]/mrc_cntl/sdp__xxx__lane_word_ptr}}'.format(mgr,strm)
        pLine = pLine + '\nadd wave -noupdate -group MGR{0} -group MRC{1} -group GENERAL -radix hexadecimal {{/top/system_inst/manager_array_inst/mgr_inst[{0}]/manager/mrc_cntl_strm_inst[{1}]/mrc_cntl/sdp__xxx__lane_target}}'.format(mgr,strm)
        pLine = pLine + '\nadd wave -noupdate -group MGR{0} -group MRC{1} -group GENERAL -radix hexadecimal {{/top/system_inst/manager_array_inst/mgr_inst[{0}]/manager/mrc_cntl_strm_inst[{1}]/mrc_cntl/mem_request_channel_data_valid}}'.format(mgr,strm)
        pLine = pLine + '\nadd wave -noupdate -group MGR{0} -group MRC{1} -group GENERAL -radix hexadecimal {{/top/system_inst/manager_array_inst/mgr_inst[{0}]/manager/mrc_cntl_strm_inst[{1}]/mrc_cntl/sdp__xxx__get_next_line}}'.format(mgr,strm)
        pLine = pLine + '\nadd wave -noupdate -group MGR{0} -group MRC{1} -group GENERAL -radix hexadecimal {{/top/system_inst/manager_array_inst/mgr_inst[{0}]/manager/mrc_cntl_strm_inst[{1}]/mrc_cntl/lane_valid}}'.format(mgr,strm)
        pLine = pLine + '\nadd wave -noupdate -group MGR{0} -group MRC{1} -group GENERAL -radix hexadecimal {{/top/system_inst/manager_array_inst/mgr_inst[{0}]/manager/mrc_cntl_strm_inst[{1}]/mrc_cntl/lane_enable}}'.format(mgr,strm)
        pLine = pLine + '\nadd wave -noupdate -group MGR{0} -group MRC{1} -group GENERAL -radix hexadecimal {{/top/system_inst/manager_array_inst/mgr_inst[{0}]/manager/mrc_cntl_strm_inst[{1}]/mrc_cntl/lane_word}}'.format(mgr,strm)
        pLine = pLine + '\nadd wave -noupdate -group MGR{0} -group MRC{1} -group GENERAL -radix hexadecimal {{/top/system_inst/manager_array_inst/mgr_inst[{0}]/manager/mrc_cntl_strm_inst[{1}]/mrc_cntl/lane_cntl}}'.format(mgr,strm)
        pLine = pLine + '\nadd wave -noupdate -group MGR{0} -group MRC{1} -group GENERAL -radix hexadecimal {{/top/system_inst/manager_array_inst/mgr_inst[{0}]/manager/mrc_cntl_strm_inst[{1}]/mrc_cntl/lane_target}}'.format(mgr,strm)
        pLine = pLine + '\nadd wave -noupdate -group MGR{0} -group MRC{1} -group GENERAL -radix hexadecimal {{/top/system_inst/manager_array_inst/mgr_inst[{0}]/manager/mrc_cntl_strm_inst[{1}]/mrc_cntl/xxx__sdp__lane_ready}}'.format(mgr,strm)
        #
        pLine = pLine + '\nadd wave -noupdate -group MGR{0} -group MRC{1} -group INTF_REGS -radix hexadecimal {{/top/system_inst/manager_array_inst/mgr_inst[{0}]/manager/mrc_cntl_strm_inst[{1}]/mrc_cntl/mrc__std__lane_cntl_e1}}'.format(mgr,strm)
        pLine = pLine + '\nadd wave -noupdate -group MGR{0} -group MRC{1} -group INTF_REGS -radix hexadecimal {{/top/system_inst/manager_array_inst/mgr_inst[{0}]/manager/mrc_cntl_strm_inst[{1}]/mrc_cntl/mrc__std__lane_data_e1}}'.format(mgr,strm)
        pLine = pLine + '\nadd wave -noupdate -group MGR{0} -group MRC{1} -group INTF_REGS -radix hexadecimal {{/top/system_inst/manager_array_inst/mgr_inst[{0}]/manager/mrc_cntl_strm_inst[{1}]/mrc_cntl/mrc__std__lane_valid_e1}}'.format(mgr,strm)
        pLine = pLine + '\nadd wave -noupdate -group MGR{0} -group MRC{1} -group INTF_REGS -radix hexadecimal {{/top/system_inst/manager_array_inst/mgr_inst[{0}]/manager/mrc_cntl_strm_inst[{1}]/mrc_cntl/std__mrc__lane_ready_d1}}'.format(mgr,strm)
        pLine = pLine + '\nadd wave -noupdate -group MGR{0} -group MRC{1} -group INTF_REGS -radix hexadecimal {{/top/system_inst/manager_array_inst/mgr_inst[{0}]/manager/mrc_cntl_strm_inst[{1}]/mrc_cntl/wud__mrc__valid_d1}}'.format(mgr,strm)
        pLine = pLine + '\nadd wave -noupdate -group MGR{0} -group MRC{1} -group INTF_REGS -radix hexadecimal {{/top/system_inst/manager_array_inst/mgr_inst[{0}]/manager/mrc_cntl_strm_inst[{1}]/mrc_cntl/wud__mrc__cntl_d1}}'.format(mgr,strm)
        pLine = pLine + '\nadd wave -noupdate -group MGR{0} -group MRC{1} -group INTF_REGS -radix hexadecimal {{/top/system_inst/manager_array_inst/mgr_inst[{0}]/manager/mrc_cntl_strm_inst[{1}]/mrc_cntl/wud__mrc__tag_d1}}'.format(mgr,strm)
        pLine = pLine + '\nadd wave -noupdate -group MGR{0} -group MRC{1} -group INTF_REGS -radix hexadecimal {{/top/system_inst/manager_array_inst/mgr_inst[{0}]/manager/mrc_cntl_strm_inst[{1}]/mrc_cntl/wud__mrc__option_type_d1}}'.format(mgr,strm)
        pLine = pLine + '\nadd wave -noupdate -group MGR{0} -group MRC{1} -group INTF_REGS -radix hexadecimal {{/top/system_inst/manager_array_inst/mgr_inst[{0}]/manager/mrc_cntl_strm_inst[{1}]/mrc_cntl/wud__mrc__option_value_d1}}'.format(mgr,strm)
        pLine = pLine + '\nadd wave -noupdate -group MGR{0} -group MRC{1} -group INTF_REGS -radix hexadecimal {{/top/system_inst/manager_array_inst/mgr_inst[{0}]/manager/mrc_cntl_strm_inst[{1}]/mrc_cntl/mrc__wud__ready_e1}}'.format(mgr,strm)
        pLine = pLine + '\nadd wave -noupdate -group MGR{0} -group MRC{1} -group INTF_REGS -radix hexadecimal {{/top/system_inst/manager_array_inst/mgr_inst[{0}]/manager/mrc_cntl_strm_inst[{1}]/mrc_cntl/mmc__mrc__valid_d1}}'.format(mgr,strm)
        pLine = pLine + '\nadd wave -noupdate -group MGR{0} -group MRC{1} -group INTF_REGS -radix hexadecimal {{/top/system_inst/manager_array_inst/mgr_inst[{0}]/manager/mrc_cntl_strm_inst[{1}]/mrc_cntl/mmc__mrc__cntl_d1}}'.format(mgr,strm)
        pLine = pLine + '\nadd wave -noupdate -group MGR{0} -group MRC{1} -group INTF_REGS -radix hexadecimal {{/top/system_inst/manager_array_inst/mgr_inst[{0}]/manager/mrc_cntl_strm_inst[{1}]/mrc_cntl/mmc__mrc__data_d1}}'.format(mgr,strm)
        pLine = pLine + '\nadd wave -noupdate -group MGR{0} -group MRC{1} -group INTF_REGS -radix hexadecimal {{/top/system_inst/manager_array_inst/mgr_inst[{0}]/manager/mrc_cntl_strm_inst[{1}]/mrc_cntl/mrc__mmc__ready_e1}}'.format(mgr,strm)
        pLine = pLine + '\nadd wave -noupdate -group MGR{0} -group MRC{1} -group INTF_REGS -radix hexadecimal {{/top/system_inst/manager_array_inst/mgr_inst[{0}]/manager/mrc_cntl_strm_inst[{1}]/mrc_cntl/mrc__mmc__valid_e1}}'.format(mgr,strm)
        pLine = pLine + '\nadd wave -noupdate -group MGR{0} -group MRC{1} -group INTF_REGS -radix hexadecimal {{/top/system_inst/manager_array_inst/mgr_inst[{0}]/manager/mrc_cntl_strm_inst[{1}]/mrc_cntl/mrc__mmc__cntl_e1}}'.format(mgr,strm)
        pLine = pLine + '\nadd wave -noupdate -group MGR{0} -group MRC{1} -group INTF_REGS -radix hexadecimal {{/top/system_inst/manager_array_inst/mgr_inst[{0}]/manager/mrc_cntl_strm_inst[{1}]/mrc_cntl/mrc__mmc__tag_e1}}'.format(mgr,strm)
        pLine = pLine + '\nadd wave -noupdate -group MGR{0} -group MRC{1} -group INTF_REGS -radix hexadecimal {{/top/system_inst/manager_array_inst/mgr_inst[{0}]/manager/mrc_cntl_strm_inst[{1}]/mrc_cntl/mrc__mmc__channel_e1}}'.format(mgr,strm)
        pLine = pLine + '\nadd wave -noupdate -group MGR{0} -group MRC{1} -group INTF_REGS -radix hexadecimal {{/top/system_inst/manager_array_inst/mgr_inst[{0}]/manager/mrc_cntl_strm_inst[{1}]/mrc_cntl/mrc__mmc__bank_e1}}'.format(mgr,strm)
        pLine = pLine + '\nadd wave -noupdate -group MGR{0} -group MRC{1} -group INTF_REGS -radix hexadecimal {{/top/system_inst/manager_array_inst/mgr_inst[{0}]/manager/mrc_cntl_strm_inst[{1}]/mrc_cntl/mrc__mmc__page_e1}}'.format(mgr,strm)
        pLine = pLine + '\nadd wave -noupdate -group MGR{0} -group MRC{1} -group INTF_REGS -radix hexadecimal {{/top/system_inst/manager_array_inst/mgr_inst[{0}]/manager/mrc_cntl_strm_inst[{1}]/mrc_cntl/mrc__mmc__word_e1}}'.format(mgr,strm)
        pLine = pLine + '\nadd wave -noupdate -group MGR{0} -group MRC{1} -group INTF_REGS -radix hexadecimal {{/top/system_inst/manager_array_inst/mgr_inst[{0}]/manager/mrc_cntl_strm_inst[{1}]/mrc_cntl/mmc__mrc__ready_d1}}'.format(mgr,strm)
        #
        pLine = pLine + '\nadd wave -noupdate -group MGR{0} -group MRC{1} -group TO_MMC -radix hexadecimal {{/top/system_inst/manager_array_inst/mgr_inst[{0}]/manager/mrc_cntl_strm_inst[{1}]/mrc_cntl/mrc__mmc__valid}}'.format(mgr,strm)
        pLine = pLine + '\nadd wave -noupdate -group MGR{0} -group MRC{1} -group TO_MMC -radix hexadecimal {{/top/system_inst/manager_array_inst/mgr_inst[{0}]/manager/mrc_cntl_strm_inst[{1}]/mrc_cntl/mrc__mmc__cntl}}'.format(mgr,strm)
        pLine = pLine + '\nadd wave -noupdate -group MGR{0} -group MRC{1} -group TO_MMC -radix hexadecimal {{/top/system_inst/manager_array_inst/mgr_inst[{0}]/manager/mrc_cntl_strm_inst[{1}]/mrc_cntl/mrc__mmc__tag}}'.format(mgr,strm)
        pLine = pLine + '\nadd wave -noupdate -group MGR{0} -group MRC{1} -group TO_MMC -radix hexadecimal {{/top/system_inst/manager_array_inst/mgr_inst[{0}]/manager/mrc_cntl_strm_inst[{1}]/mrc_cntl/mrc__mmc__channel}}'.format(mgr,strm)
        pLine = pLine + '\nadd wave -noupdate -group MGR{0} -group MRC{1} -group TO_MMC -radix hexadecimal {{/top/system_inst/manager_array_inst/mgr_inst[{0}]/manager/mrc_cntl_strm_inst[{1}]/mrc_cntl/mrc__mmc__bank}}'.format(mgr,strm)
        pLine = pLine + '\nadd wave -noupdate -group MGR{0} -group MRC{1} -group TO_MMC -radix hexadecimal {{/top/system_inst/manager_array_inst/mgr_inst[{0}]/manager/mrc_cntl_strm_inst[{1}]/mrc_cntl/mrc__mmc__page}}'.format(mgr,strm)
        pLine = pLine + '\nadd wave -noupdate -group MGR{0} -group MRC{1} -group TO_MMC -radix hexadecimal {{/top/system_inst/manager_array_inst/mgr_inst[{0}]/manager/mrc_cntl_strm_inst[{1}]/mrc_cntl/mrc__mmc__word}}'.format(mgr,strm)
        pLine = pLine + '\nadd wave -noupdate -group MGR{0} -group MRC{1} -group TO_MMC -radix hexadecimal {{/top/system_inst/manager_array_inst/mgr_inst[{0}]/manager/mrc_cntl_strm_inst[{1}]/mrc_cntl/mmc__mrc__ready}}'.format(mgr,strm)
        #
        pLine = pLine + '\nadd wave -noupdate -group MGR{0} -group MRC{1} -group FROM_MMC -radix hexadecimal {{/top/system_inst/manager_array_inst/mgr_inst[{0}]/manager/mrc_cntl_strm_inst[{1}]/mrc_cntl/mmc__mrc__valid}}'.format(mgr,strm)
        pLine = pLine + '\nadd wave -noupdate -group MGR{0} -group MRC{1} -group FROM_MMC -radix hexadecimal {{/top/system_inst/manager_array_inst/mgr_inst[{0}]/manager/mrc_cntl_strm_inst[{1}]/mrc_cntl/mmc__mrc__cntl}}'.format(mgr,strm)
        pLine = pLine + '\nadd wave -noupdate -group MGR{0} -group MRC{1} -group FROM_MMC -radix hexadecimal {{/top/system_inst/manager_array_inst/mgr_inst[{0}]/manager/mrc_cntl_strm_inst[{1}]/mrc_cntl/mmc__mrc__data}}'.format(mgr,strm)
        pLine = pLine + '\nadd wave -noupdate -group MGR{0} -group MRC{1} -group FROM_MMC -radix hexadecimal {{/top/system_inst/manager_array_inst/mgr_inst[{0}]/manager/mrc_cntl_strm_inst[{1}]/mrc_cntl/mrc__mmc__ready}}'.format(mgr,strm)
        #
        for chan in range (0, numOfChannels):
          pLine = pLine + '\nadd wave -noupdate -group MGR{0} -group MRC{1} -group FROM_MMC_FIFO_CHAN{2} -radix hexadecimal  {{/top/system_inst/manager_array_inst/mgr_inst[{0}]/manager/mrc_cntl_strm_inst[{1}]/mrc_cntl/from_mmc_fifo[{2}]/almost_full}}'.format(mgr,strm,chan)
          pLine = pLine + '\nadd wave -noupdate -group MGR{0} -group MRC{1} -group FROM_MMC_FIFO_CHAN{2} -radix hexadecimal  {{/top/system_inst/manager_array_inst/mgr_inst[{0}]/manager/mrc_cntl_strm_inst[{1}]/mrc_cntl/from_mmc_fifo[{2}]/empty}}'.format(mgr,strm,chan)
          pLine = pLine + '\nadd wave -noupdate -group MGR{0} -group MRC{1} -group FROM_MMC_FIFO_CHAN{2} -radix hexadecimal  {{/top/system_inst/manager_array_inst/mgr_inst[{0}]/manager/mrc_cntl_strm_inst[{1}]/mrc_cntl/from_mmc_fifo[{2}]/write}}'.format(mgr,strm,chan)
          pLine = pLine + '\nadd wave -noupdate -group MGR{0} -group MRC{1} -group FROM_MMC_FIFO_CHAN{2} -radix hexadecimal  {{/top/system_inst/manager_array_inst/mgr_inst[{0}]/manager/mrc_cntl_strm_inst[{1}]/mrc_cntl/from_mmc_fifo[{2}]/write_data}}'.format(mgr,strm,chan)
          pLine = pLine + '\nadd wave -noupdate -group MGR{0} -group MRC{1} -group FROM_MMC_FIFO_CHAN{2} -radix hexadecimal  {{/top/system_inst/manager_array_inst/mgr_inst[{0}]/manager/mrc_cntl_strm_inst[{1}]/mrc_cntl/from_mmc_fifo[{2}]/read}}'.format(mgr,strm,chan)
          pLine = pLine + '\nadd wave -noupdate -group MGR{0} -group MRC{1} -group FROM_MMC_FIFO_CHAN{2} -radix hexadecimal  {{/top/system_inst/manager_array_inst/mgr_inst[{0}]/manager/mrc_cntl_strm_inst[{1}]/mrc_cntl/from_mmc_fifo[{2}]/read_data}}'.format(mgr,strm,chan)
          pLine = pLine + '\nadd wave -noupdate -group MGR{0} -group MRC{1} -group FROM_MMC_FIFO_CHAN{2} -radix hexadecimal  {{/top/system_inst/manager_array_inst/mgr_inst[{0}]/manager/mrc_cntl_strm_inst[{1}]/mrc_cntl/from_mmc_fifo[{2}]/fifo_pipe_valid}}'.format(mgr,strm,chan)
          pLine = pLine + '\nadd wave -noupdate -group MGR{0} -group MRC{1} -group FROM_MMC_FIFO_CHAN{2} -radix hexadecimal  {{/top/system_inst/manager_array_inst/mgr_inst[{0}]/manager/mrc_cntl_strm_inst[{1}]/mrc_cntl/from_mmc_fifo[{2}]/fifo_pipe_read}}'.format(mgr,strm,chan)
          pLine = pLine + '\nadd wave -noupdate -group MGR{0} -group MRC{1} -group FROM_MMC_FIFO_CHAN{2} -radix hexadecimal  {{/top/system_inst/manager_array_inst/mgr_inst[{0}]/manager/mrc_cntl_strm_inst[{1}]/mrc_cntl/from_mmc_fifo[{2}]/pipe_valid}}'.format(mgr,strm,chan)
          pLine = pLine + '\nadd wave -noupdate -group MGR{0} -group MRC{1} -group FROM_MMC_FIFO_CHAN{2} -radix hexadecimal  {{/top/system_inst/manager_array_inst/mgr_inst[{0}]/manager/mrc_cntl_strm_inst[{1}]/mrc_cntl/from_mmc_fifo[{2}]/pipe_read}}'.format(mgr,strm,chan)
          pLine = pLine + '\nadd wave -noupdate -group MGR{0} -group MRC{1} -group FROM_MMC_FIFO_CHAN{2} -radix hexadecimal  {{/top/system_inst/manager_array_inst/mgr_inst[{0}]/manager/mrc_cntl_strm_inst[{1}]/mrc_cntl/from_mmc_fifo[{2}]/pipe_data}}'.format(mgr,strm,chan)
        #
        pLine = pLine + '\nadd wave -noupdate -group MGR{0} -group MRC{1} -group TO_STD -radix hexadecimal {{/top/system_inst/manager_array_inst/mgr_inst[{0}]/manager/mrc_cntl_strm_inst[{1}]/mrc_cntl/mrc__std__lane_valid}}'.format(mgr,strm)
        pLine = pLine + '\nadd wave -noupdate -group MGR{0} -group MRC{1} -group TO_STD -radix hexadecimal {{/top/system_inst/manager_array_inst/mgr_inst[{0}]/manager/mrc_cntl_strm_inst[{1}]/mrc_cntl/mrc__std__lane_cntl}}'.format(mgr,strm)
        pLine = pLine + '\nadd wave -noupdate -group MGR{0} -group MRC{1} -group TO_STD -radix hexadecimal {{/top/system_inst/manager_array_inst/mgr_inst[{0}]/manager/mrc_cntl_strm_inst[{1}]/mrc_cntl/mrc__std__lane_data}}'.format(mgr,strm)
        pLine = pLine + '\nadd wave -noupdate -group MGR{0} -group MRC{1} -group TO_STD -radix hexadecimal {{/top/system_inst/manager_array_inst/mgr_inst[{0}]/manager/mrc_cntl_strm_inst[{1}]/mrc_cntl/std__mrc__lane_ready}}'.format(mgr,strm)
        #
        pLine = pLine + '\nadd wave -noupdate -group MGR{0} -group MRC{1} -group TO_MCNTL -radix hexadecimal {{/top/system_inst/manager_array_inst/mgr_inst[{0}]/manager/mrc_cntl_strm_inst[{1}]/mrc_cntl/mrc__mcntl__lane_valid}}'.format(mgr,strm)
        pLine = pLine + '\nadd wave -noupdate -group MGR{0} -group MRC{1} -group TO_MCNTL -radix hexadecimal {{/top/system_inst/manager_array_inst/mgr_inst[{0}]/manager/mrc_cntl_strm_inst[{1}]/mrc_cntl/mrc__mcntl__lane_cntl}}'.format(mgr,strm)
        pLine = pLine + '\nadd wave -noupdate -group MGR{0} -group MRC{1} -group TO_MCNTL -radix hexadecimal {{/top/system_inst/manager_array_inst/mgr_inst[{0}]/manager/mrc_cntl_strm_inst[{1}]/mrc_cntl/mrc__mcntl__lane_data}}'.format(mgr,strm)
        pLine = pLine + '\nadd wave -noupdate -group MGR{0} -group MRC{1} -group TO_MCNTL -radix hexadecimal {{/top/system_inst/manager_array_inst/mgr_inst[{0}]/manager/mrc_cntl_strm_inst[{1}]/mrc_cntl/mcntl__mrc__lane_ready}}'.format(mgr,strm)
        #
  ...
  for mgr in range (0, numOfMgr):
    ...
    pLine = pLine + '\nadd wave -noupdate -group MGR{0} -group WU_DECODE -group FROM_WUM -group FROM_WUM_FIFO -radix hexadecimal {{/top/system_inst/manager_array_inst/mgr_inst[{0}]/manager/wu_decode/pipe_option_extd_type}}'.format(mgr,strm)
    pLine = pLine + '\nadd wave -noupdate -group MGR{0} -group WU_DECODE -group FROM_WUM -group FROM_WUM_FIFO -radix hexadecimal {{/top/system_inst/manager_array_inst/mgr_inst[{0}]/manager/wu_decode/pipe_option_extd_value}}'.format(mgr,strm)
    pLine = pLine + '\nadd wave -noupdate -group MGR{0} -group WU_DECODE -group FROM_WUM -group FROM_WUM_FIFO -radix hexadecimal {{/top/system_inst/manager_array_inst/mgr_inst[{0}]/manager/wu_decode/pipe_option_extd_valid}}'.format(mgr,strm)
    pLine = pLine + '\nadd wave -noupdate -group MGR{0} -group WU_DECODE -group FROM_WUM -group FROM_WUM_FIFO -radix hexadecimal {{/top/system_inst/manager_array_inst/mgr_inst[{0}]/manager/wu_decode/mode_reg_valid}}'.format(mgr)
    pLine = pLine + '\nadd wave -noupdate -group MGR{0} -group WU_DECODE -group FROM_WUM -group FROM_WUM_FIFO -radix hexadecimal {{/top/system_inst/manager_array_inst/mgr_inst[{0}]/manager/wu_decode/mode_reg_id}}'.format(mgr)
    pLine = pLine + '\nadd wave -noupdate -group MGR{0} -group WU_DECODE -group FROM_WUM -group FROM_WUM_FIFO -radix hexadecimal {{/top/system_inst/manager_array_inst/mgr_inst[{0}]/manager/wu_decode/mode_reg_value}}'.format(mgr)
    #                                                              
    ...
    pLine = pLine + '\nadd wave -noupdate -group MGR{0} -group WU_DECODE -group TO_OOB -radix hexadecimal {{/top/system_inst/manager_array_inst/mgr_inst[{0}]/manager/wu_decode/wud__odc__tag}}'.format(mgr,strm)
    ...
    pLine = pLine + '\nadd wave -noupdate -group MGR{0} -group WU_DECODE -group GEN -radix hexadecimal {{/top/system_inst/manager_array_inst/mgr_inst[{0}]/manager/wu_decode/send_info_to_noc_mem_cntl}}'.format(mgr)
    pLine = pLine + '\nadd wave -noupdate -group MGR{0} -group WU_DECODE -group GEN -radix hexadecimal {{/top/system_inst/manager_array_inst/mgr_inst[{0}]/manager/wu_decode/sending_to_arg0_mem_cntl}}'.format(mgr)
    pLine = pLine + '\nadd wave -noupdate -group MGR{0} -group WU_DECODE -group GEN -radix hexadecimal {{/top/system_inst/manager_array_inst/mgr_inst[{0}]/manager/wu_decode/sending_to_arg1_mem_cntl}}'.format(mgr)
    pLine = pLine + '\nadd wave -noupdate -group MGR{0} -group WU_DECODE -group GEN -radix hexadecimal {{/top/system_inst/manager_array_inst/mgr_inst[{0}]/manager/wu_decode/sending_to_oob_downstream}}'.format(mgr)
    pLine = pLine + '\nadd wave -noupdate -group MGR{0} -group WU_DECODE -group GEN -radix hexadecimal {{/top/system_inst/manager_array_inst/mgr_inst[{0}]/manager/wu_decode/sending_to_return_proc}}'.format(mgr)
    pLine = pLine + '\nadd wave -noupdate -group MGR{0} -group WU_DECODE -group GEN -radix hexadecimal {{/top/system_inst/manager_array_inst/mgr_inst[{0}]/manager/wu_decode/sending_to_main_cntl}}'.format(mgr)
    pLine = pLine + '\nadd wave -noupdate -group MGR{0} -group WU_DECODE -group GEN -radix hexadecimal {{/top/system_inst/manager_array_inst/mgr_inst[{0}]/manager/wu_decode/sending_to_noc_mem_cntl}}'.format(mgr)
    pLine = pLine + '\nadd wave -noupdate -group MGR{0} -group WU_DECODE -group GEN -radix hexadecimal {{/top/system_inst/manager_array_inst/mgr_inst[{0}]/manager/wu_decode/pipe_option_extd_type}}'.format(mgr,strm)
    pLine = pLine + '\nadd wave -noupdate -group MGR{0} -group WU_DECODE -group GEN -radix hexadecimal {{/top/system_inst/manager_array_inst/mgr_inst[{0}]/manager/wu_decode/pipe_option_extd_value}}'.format(mgr,strm)
    pLine = pLine + '\nadd wave -noupdate -group MGR{0} -group WU_DECODE -group GEN -radix hexadecimal {{/top/system_inst/manager_array_inst/mgr_inst[{0}]/manager/wu_decode/pipe_option_extd_valid}}'.format(mgr,strm)
    ...
    for ot in range (0, numOfOptTuples):
      ...
      pLine = pLine + '\nadd wave -noupdate -group MGR{0} -group WU_DECODE -group INSTR_DEC{1} -radix hexadecimal {{/top/system_inst/manager_array_inst/mgr_inst[{0}]/manager/wu_decode/instr_decode[{1}]/send_info_to_noc_mem_cntl}}'.format(mgr,ot)
  ...
  for mgr in range (0, numOfMgr):
    for port in range (0, numOfPorts):
      pLine = pLine + '\nadd wave -noupdate -group MGR{0} -group NOC -group TO_NOC -radix hexadecimal  {{/top/system_inst/manager_array_inst/mgr_inst[{0}]/mgr__noc__port_cntl [{1}]}}'.format(mgr,port)
      pLine = pLine + '\nadd wave -noupdate -group MGR{0} -group NOC -group TO_NOC -radix hexadecimal  {{/top/system_inst/manager_array_inst/mgr_inst[{0}]/mgr__noc__port_data [{1}]}}'.format(mgr,port)
      pLine = pLine + '\nadd wave -noupdate -group MGR{0} -group NOC -group TO_NOC -radix hexadecimal  {{/top/system_inst/manager_array_inst/mgr_inst[{0}]/mgr__noc__port_fc   [{1}]}}'.format(mgr,port)
      pLine = pLine + '\nadd wave -noupdate -group MGR{0} -group NOC -group TO_NOC -radix hexadecimal  {{/top/system_inst/manager_array_inst/mgr_inst[{0}]/mgr__noc__port_valid[{1}]}}'.format(mgr,port)
 
      pLine = pLine + '\nadd wave -noupdate -group MGR{0} -group NOC -group FROM_NOC -radix hexadecimal  {{/top/system_inst/manager_array_inst/mgr_inst[{0}]/noc__mgr__port_cntl [{1}]}}'.format(mgr,port)
      pLine = pLine + '\nadd wave -noupdate -group MGR{0} -group NOC -group FROM_NOC -radix hexadecimal  {{/top/system_inst/manager_array_inst/mgr_inst[{0}]/noc__mgr__port_data [{1}]}}'.format(mgr,port)
      pLine = pLine + '\nadd wave -noupdate -group MGR{0} -group NOC -group FROM_NOC -radix hexadecimal  {{/top/system_inst/manager_array_inst/mgr_inst[{0}]/noc__mgr__port_fc   [{1}]}}'.format(mgr,port)
      pLine = pLine + '\nadd wave -noupdate -group MGR{0} -group NOC -group FROM_NOC -radix hexadecimal  {{/top/system_inst/manager_array_inst/mgr_inst[{0}]/noc__mgr__port_valid[{1}]}}'.format(mgr,port)
 
    pLine = pLine + '\nadd wave -noupdate -group MGR{0} -group NOC -group LOCAL_TO_NOC -group DP -radix hexadecimal  {{/top/system_inst/manager_array_inst/mgr_inst[{0}]/manager/mgr_noc_cntl/locl__noc__dp_valid}}'.format(mgr,port)
    pLine = pLine + '\nadd wave -noupdate -group MGR{0} -group NOC -group LOCAL_TO_NOC -group DP -radix hexadecimal  {{/top/system_inst/manager_array_inst/mgr_inst[{0}]/manager/mgr_noc_cntl/locl__noc__dp_cntl}}'.format(mgr,port)
    pLine = pLine + '\nadd wave -noupdate -group MGR{0} -group NOC -group LOCAL_TO_NOC -group DP -radix hexadecimal  {{/top/system_inst/manager_array_inst/mgr_inst[{0}]/manager/mgr_noc_cntl/locl__noc__dp_type}}'.format(mgr,port)
    pLine = pLine + '\nadd wave -noupdate -group MGR{0} -group NOC -group LOCAL_TO_NOC -group DP -radix hexadecimal  {{/top/system_inst/manager_array_inst/mgr_inst[{0}]/manager/mgr_noc_cntl/locl__noc__dp_ptype}}'.format(mgr,port)
    pLine = pLine + '\nadd wave -noupdate -group MGR{0} -group NOC -group LOCAL_TO_NOC -group DP -radix hexadecimal  {{/top/system_inst/manager_array_inst/mgr_inst[{0}]/manager/mgr_noc_cntl/locl__noc__dp_desttype}}'.format(mgr,port)
    pLine = pLine + '\nadd wave -noupdate -group MGR{0} -group NOC -group LOCAL_TO_NOC -group DP -radix hexadecimal  {{/top/system_inst/manager_array_inst/mgr_inst[{0}]/manager/mgr_noc_cntl/locl__noc__dp_pvalid}}'.format(mgr,port)
    pLine = pLine + '\nadd wave -noupdate -group MGR{0} -group NOC -group LOCAL_TO_NOC -group DP -radix hexadecimal  {{/top/system_inst/manager_array_inst/mgr_inst[{0}]/manager/mgr_noc_cntl/locl__noc__dp_data}}'.format(mgr,port)
    pLine = pLine + '\nadd wave -noupdate -group MGR{0} -group NOC -group LOCAL_TO_NOC -group DP -radix hexadecimal  {{/top/system_inst/manager_array_inst/mgr_inst[{0}]/manager/mgr_noc_cntl/noc__locl__dp_ready}}'.format(mgr,port)
    
    pLine = pLine + '\nadd wave -noupdate -group MGR{0} -group NOC -group LOCAL_FROM_NOC -group DP -radix hexadecimal  {{/top/system_inst/manager_array_inst/mgr_inst[{0}]/manager/mgr_noc_cntl/noc__locl__dp_valid}}'.format(mgr,port)
    pLine = pLine + '\nadd wave -noupdate -group MGR{0} -group NOC -group LOCAL_FROM_NOC -group DP -radix hexadecimal  {{/top/system_inst/manager_array_inst/mgr_inst[{0}]/manager/mgr_noc_cntl/noc__locl__dp_cntl}}'.format(mgr,port)
    pLine = pLine + '\nadd wave -noupdate -group MGR{0} -group NOC -group LOCAL_FROM_NOC -group DP -radix hexadecimal  {{/top/system_inst/manager_array_inst/mgr_inst[{0}]/manager/mgr_noc_cntl/noc__locl__dp_mgrId}}'.format(mgr,port)
    pLine = pLine + '\nadd wave -noupdate -group MGR{0} -group NOC -group LOCAL_FROM_NOC -group DP -radix hexadecimal  {{/top/system_inst/manager_array_inst/mgr_inst[{0}]/manager/mgr_noc_cntl/noc__locl__dp_type}}'.format(mgr,port)
    pLine = pLine + '\nadd wave -noupdate -group MGR{0} -group NOC -group LOCAL_FROM_NOC -group DP -radix hexadecimal  {{/top/system_inst/manager_array_inst/mgr_inst[{0}]/manager/mgr_noc_cntl/noc__locl__dp_ptype}}'.format(mgr,port)
    pLine = pLine + '\nadd wave -noupdate -group MGR{0} -group NOC -group LOCAL_FROM_NOC -group DP -radix hexadecimal  {{/top/system_inst/manager_array_inst/mgr_inst[{0}]/manager/mgr_noc_cntl/noc__locl__dp_pvalid}}'.format(mgr,port)
    pLine = pLine + '\nadd wave -noupdate -group MGR{0} -group NOC -group LOCAL_FROM_NOC -group DP -radix hexadecimal  {{/top/system_inst/manager_array_inst/mgr_inst[{0}]/manager/mgr_noc_cntl/noc__locl__dp_data}}'.format(mgr,port)
    pLine = pLine + '\nadd wave -noupdate -group MGR{0} -group NOC -group LOCAL_FROM_NOC -group DP -radix hexadecimal  {{/top/system_inst/manager_array_inst/mgr_inst[{0}]/manager/mgr_noc_cntl/locl__noc__dp_ready}}'.format(mgr,port)

    pLine = pLine + '\nadd wave -noupdate -group MGR{0} -group NOC -group LOCAL_TO_NOC -group CP -radix hexadecimal  {{/top/system_inst/manager_array_inst/mgr_inst[{0}]/manager/mgr_noc_cntl/locl__noc__cp_valid}}'.format(mgr,port)
    pLine = pLine + '\nadd wave -noupdate -group MGR{0} -group NOC -group LOCAL_TO_NOC -group CP -radix hexadecimal  {{/top/system_inst/manager_array_inst/mgr_inst[{0}]/manager/mgr_noc_cntl/locl__noc__cp_cntl}}'.format(mgr,port)
    pLine = pLine + '\nadd wave -noupdate -group MGR{0} -group NOC -group LOCAL_TO_NOC -group CP -radix hexadecimal  {{/top/system_inst/manager_array_inst/mgr_inst[{0}]/manager/mgr_noc_cntl/locl__noc__cp_type}}'.format(mgr,port)
    pLine = pLine + '\nadd wave -noupdate -group MGR{0} -group NOC -group LOCAL_TO_NOC -group CP -radix hexadecimal  {{/top/system_inst/manager_array_inst/mgr_inst[{0}]/manager/mgr_noc_cntl/locl__noc__cp_ptype}}'.format(mgr,port)
    pLine = pLine + '\nadd wave -noupdate -group MGR{0} -group NOC -group LOCAL_TO_NOC -group CP -radix hexadecimal  {{/top/system_inst/manager_array_inst/mgr_inst[{0}]/manager/mgr_noc_cntl/locl__noc__cp_desttype}}'.format(mgr,port)
    pLine = pLine + '\nadd wave -noupdate -group MGR{0} -group NOC -group LOCAL_TO_NOC -group CP -radix hexadecimal  {{/top/system_inst/manager_array_inst/mgr_inst[{0}]/manager/mgr_noc_cntl/locl__noc__cp_pvalid}}'.format(mgr,port)
    pLine = pLine + '\nadd wave -noupdate -group MGR{0} -group NOC -group LOCAL_TO_NOC -group CP -radix hexadecimal  {{/top/system_inst/manager_array_inst/mgr_inst[{0}]/manager/mgr_noc_cntl/locl__noc__cp_data}}'.format(mgr,port)
    pLine = pLine + '\nadd wave -noupdate -group MGR{0} -group NOC -group LOCAL_TO_NOC -group CP -radix hexadecimal  {{/top/system_inst/manager_array_inst/mgr_inst[{0}]/manager/mgr_noc_cntl/noc__locl__cp_ready}}'.format(mgr,port)
    
    pLine = pLine + '\nadd wave -noupdate -group MGR{0} -group NOC -group LOCAL_FROM_NOC -group CP -radix hexadecimal  {{/top/system_inst/manager_array_inst/mgr_inst[{0}]/manager/mgr_noc_cntl/noc__locl__cp_valid}}'.format(mgr,port)
    pLine = pLine + '\nadd wave -noupdate -group MGR{0} -group NOC -group LOCAL_FROM_NOC -group CP -radix hexadecimal  {{/top/system_inst/manager_array_inst/mgr_inst[{0}]/manager/mgr_noc_cntl/noc__locl__cp_cntl}}'.format(mgr,port)
    pLine = pLine + '\nadd wave -noupdate -group MGR{0} -group NOC -group LOCAL_FROM_NOC -group CP -radix hexadecimal  {{/top/system_inst/manager_array_inst/mgr_inst[{0}]/manager/mgr_noc_cntl/noc__locl__cp_mgrId}}'.format(mgr,port)
    pLine = pLine + '\nadd wave -noupdate -group MGR{0} -group NOC -group LOCAL_FROM_NOC -group CP -radix hexadecimal  {{/top/system_inst/manager_array_inst/mgr_inst[{0}]/manager/mgr_noc_cntl/noc__locl__cp_type}}'.format(mgr,port)
    pLine = pLine + '\nadd wave -noupdate -group MGR{0} -group NOC -group LOCAL_FROM_NOC -group CP -radix hexadecimal  {{/top/system_inst/manager_array_inst/mgr_inst[{0}]/manager/mgr_noc_cntl/noc__locl__cp_ptype}}'.format(mgr,port)
    pLine = pLine + '\nadd wave -noupdate -group MGR{0} -group NOC -group LOCAL_FROM_NOC -group CP -radix hexadecimal  {{/top/system_inst/manager_array_inst/mgr_inst[{0}]/manager/mgr_noc_cntl/noc__locl__cp_pvalid}}'.format(mgr,port)
    pLine = pLine + '\nadd wave -noupdate -group MGR{0} -group NOC -group LOCAL_FROM_NOC -group CP -radix hexadecimal  {{/top/system_inst/manager_array_inst/mgr_inst[{0}]/manager/mgr_noc_cntl/noc__locl__cp_data}}'.format(mgr,port)
    pLine = pLine + '\nadd wave -noupdate -group MGR{0} -group NOC -group LOCAL_FROM_NOC -group CP -radix hexadecimal  {{/top/system_inst/manager_array_inst/mgr_inst[{0}]/manager/mgr_noc_cntl/locl__noc__cp_ready}}'.format(mgr,port)
  ...
  for mgr in range (0, numOfMgr):
    ...
    #
    pLine = pLine + '\nadd wave -noupdate -group MGR{0} -group MWC -group STORAGE_DESC_MEM -radix hexadecimal  {{/top/system_inst/manager_array_inst/mgr_inst[{0}]/manager/mwc_cntl/storageDesc_mem[0]/gmemory/reset_poweron}}'.format(mgr)
    pLine = pLine + '\nadd wave -noupdate -group MGR{0} -group MWC -group STORAGE_DESC_MEM -radix hexadecimal  {{/top/system_inst/manager_array_inst/mgr_inst[{0}]/manager/mwc_cntl/storageDesc_mem[0]/gmemory/portA_enable}}'.format(mgr)
    pLine = pLine + '\nadd wave -noupdate -group MGR{0} -group MWC -group STORAGE_DESC_MEM -radix hexadecimal  {{/top/system_inst/manager_array_inst/mgr_inst[{0}]/manager/mwc_cntl/storageDesc_mem[0]/gmemory/portA_address}}'.format(mgr)
    pLine = pLine + '\nadd wave -noupdate -group MGR{0} -group MWC -group STORAGE_DESC_MEM -radix hexadecimal  {{/top/system_inst/manager_array_inst/mgr_inst[{0}]/manager/mwc_cntl/storageDesc_mem[0]/gmemory/portA_write}}'.format(mgr)
    pLine = pLine + '\nadd wave -noupdate -group MGR{0} -group MWC -group STORAGE_DESC_MEM -radix hexadecimal  {{/top/system_inst/manager_array_inst/mgr_inst[{0}]/manager/mwc_cntl/storageDesc_mem[0]/gmemory/portA_write_data}}'.format(mgr)
    pLine = pLine + '\nadd wave -noupdate -group MGR{0} -group MWC -group STORAGE_DESC_MEM -radix hexadecimal  {{/top/system_inst/manager_array_inst/mgr_inst[{0}]/manager/mwc_cntl/storageDesc_mem[0]/gmemory/portA_read}}'.format(mgr)
    pLine = pLine + '\nadd wave -noupdate -group MGR{0} -group MWC -group STORAGE_DESC_MEM -radix hexadecimal  {{/top/system_inst/manager_array_inst/mgr_inst[{0}]/manager/mwc_cntl/storageDesc_mem[0]/gmemory/portA_read_data}}'.format(mgr)
    pLine = pLine + '\nadd wave -noupdate -group MGR{0} -group MWC -group STORAGE_DESC_MEM -radix hexadecimal  {{/top/system_inst/manager_array_inst/mgr_inst[{0}]/manager/mwc_cntl/storageDesc_mem[0]/gmemory/reg_portA_read_data}}'.format(mgr)
    pLine = pLine + '\nadd wave -noupdate -group MGR{0} -group MWC -group STORAGE_DESC_MEM -radix hexadecimal  {{/top/system_inst/manager_array_inst/mgr_inst[{0}]/manager/mwc_cntl/storageDesc_mem[0]/gmemory/entry}}'.format(mgr)
    pLine = pLine + '\nadd wave -noupdate -group MGR{0} -group MWC -group STORAGE_DESC_MEM -radix hexadecimal  {{/top/system_inst/manager_array_inst/mgr_inst[{0}]/manager/mwc_cntl/storageDesc_mem[0]/gmemory/fileDesc}}'.format(mgr)
    pLine = pLine + '\nadd wave -noupdate -group MGR{0} -group MWC -group STORAGE_DESC_MEM -radix hexadecimal  {{/top/system_inst/manager_array_inst/mgr_inst[{0}]/manager/mwc_cntl/storageDesc_mem[0]/gmemory/loadMemory}}'.format(mgr)
    pLine = pLine + '\nadd wave -noupdate -group MGR{0} -group MWC -group STORAGE_DESC_MEM -radix hexadecimal  {{/top/system_inst/manager_array_inst/mgr_inst[{0}]/manager/mwc_cntl/storageDesc_mem[0]/gmemory/memory_address}}'.format(mgr)
    pLine = pLine + '\nadd wave -noupdate -group MGR{0} -group MWC -group STORAGE_DESC_MEM -radix hexadecimal  {{/top/system_inst/manager_array_inst/mgr_inst[{0}]/manager/mwc_cntl/storageDesc_mem[0]/gmemory/memory_data}}'.format(mgr)
    pLine = pLine + '\nadd wave -noupdate -group MGR{0} -group MWC -group STORAGE_DESC_MEM -radix hexadecimal  {{/top/system_inst/manager_array_inst/mgr_inst[{0}]/manager/mwc_cntl/storageDesc_mem[0]/gmemory/GENERIC_MEM_ADDR_WIDTH}}'.format(mgr)
    pLine = pLine + '\nadd wave -noupdate -group MGR{0} -group MWC -group STORAGE_DESC_MEM -radix hexadecimal  {{/top/system_inst/manager_array_inst/mgr_inst[{0}]/manager/mwc_cntl/storageDesc_mem[0]/gmemory/GENERIC_MEM_DATA_WIDTH}}'.format(mgr)
    pLine = pLine + '\nadd wave -noupdate -group MGR{0} -group MWC -group STORAGE_DESC_MEM -radix hexadecimal  {{/top/system_inst/manager_array_inst/mgr_inst[{0}]/manager/mwc_cntl/storageDesc_mem[0]/gmemory/GENERIC_MEM_DEPTH}}'.format(mgr)
    pLine = pLine + '\nadd wave -noupdate -group MGR{0} -group MWC -group STORAGE_DESC_MEM -radix hexadecimal  {{/top/system_inst/manager_array_inst/mgr_inst[{0}]/manager/mwc_cntl/storageDesc_mem[0]/gmemory/GENERIC_MEM_INIT_FILE}}'.format(mgr)
    pLine = pLine + '\nadd wave -noupdate -group MGR{0} -group MWC -group STORAGE_DESC_MEM -radix hexadecimal  {{/top/system_inst/manager_array_inst/mgr_inst[{0}]/manager/mwc_cntl/storageDesc_mem[0]/gmemory/GENERIC_MEM_REGISTERED_OUT}}'.format(mgr)
    pLine = pLine + '\nadd wave -noupdate -group MGR{0} -group MWC -group STORAGE_DESC_MEM -radix hexadecimal  {{/top/system_inst/manager_array_inst/mgr_inst[{0}]/manager/mwc_cntl/storageDesc_mem[0]/gmemory/GENERIC_NUM_OF_PORTS}}'.format(mgr)
    #
    ...
    for intf in range (2):
        ...
        pLine = pLine + '\nadd wave -noupdate -group MGR{0} -group MWC -group {2} -radix hexadecimal  {{/top/system_inst/manager_array_inst/mgr_inst[{0}]/manager/mwc_cntl/intf_fsm[{1}]/performing_dma}}'.format(mgr,intf,src)
        ...
        pLine = pLine + '\nadd wave -noupdate -group MGR{0} -group MWC -group {2} -radix hexadecimal  {{/top/system_inst/manager_array_inst/mgr_inst[{0}]/manager/mwc_cntl/intf_fsm[{1}]/pipe_type}}'.format(mgr,intf,src)
        ...
        pLine = pLine + '\nadd wave -noupdate -group MGR{0} -group MWC -group {2} -radix hexadecimal  {{/top/system_inst/manager_array_inst/mgr_inst[{0}]/manager/mwc_cntl/intf_fsm[{1}]/pipe_som}}'.format(mgr,intf,src)
    ...
    for intf in range (2):
        if intf == 0:
          ...
          src = "MCNTL"
        pLine = pLine + '\nadd wave -noupdate -group MGR{0} -group MWC -group {2} -group FROM_{2}_FIFO -radix hexadecimal  {{/top/system_inst/manager_array_inst/mgr_inst[{0}]/manager/mwc_cntl/input_intf_fifo[{1}]/pipe_cntl}}'.format(mgr,intf,src)
        pLine = pLine + '\nadd wave -noupdate -group MGR{0} -group MWC -group {2} -group FROM_{2}_FIFO -radix hexadecimal  {{/top/system_inst/manager_array_inst/mgr_inst[{0}]/manager/mwc_cntl/input_intf_fifo[{1}]/pipe_data}}'.format(mgr,intf,src)
        pLine = pLine + '\nadd wave -noupdate -group MGR{0} -group MWC -group {2} -group FROM_{2}_FIFO -radix hexadecimal  {{/top/system_inst/manager_array_inst/mgr_inst[{0}]/manager/mwc_cntl/input_intf_fifo[{1}]/pipe_som}}'.format(mgr,intf,src)
        pLine = pLine + '\nadd wave -noupdate -group MGR{0} -group MWC -group {2} -group FROM_{2}_FIFO -radix hexadecimal  {{/top/system_inst/manager_array_inst/mgr_inst[{0}]/manager/mwc_cntl/input_intf_fifo[{1}]/pipe_eom}}'.format(mgr,intf,src)
        pLine = pLine + '\nadd wave -noupdate -group MGR{0} -group MWC -group {2} -group FROM_{2}_FIFO -radix hexadecimal  {{/top/system_inst/manager_array_inst/mgr_inst[{0}]/manager/mwc_cntl/input_intf_fifo[{1}]/pipe_mem_data}}'.format(mgr,intf,src)
        pLine = pLine + '\nadd wave -noupdate -group MGR{0} -group MWC -group {2} -group FROM_{2}_FIFO -radix hexadecimal  {{/top/system_inst/manager_array_inst/mgr_inst[{0}]/manager/mwc_cntl/input_intf_fifo[{1}]/pipe_type}}'.format(mgr,intf,src)
        pLine = pLine + '\nadd wave -noupdate -group MGR{0} -group MWC -group {2} -group FROM_{2}_FIFO -radix hexadecimal  {{/top/system_inst/manager_array_inst/mgr_inst[{0}]/manager/mwc_cntl/input_intf_fifo[{1}]/pipe_ptype}}'.format(mgr,intf,src)
        pLine = pLine + '\nadd wave -noupdate -group MGR{0} -group MWC -group {2} -group FROM_{2}_FIFO -radix hexadecimal  {{/top/system_inst/manager_array_inst/mgr_inst[{0}]/manager/mwc_cntl/input_intf_fifo[{1}]/pipe_pvalid}}'.format(mgr,intf,src)
        pLine = pLine + '\nadd wave -noupdate -group MGR{0} -group MWC -group {2} -group FROM_{2}_FIFO -radix hexadecimal  {{/top/system_inst/manager_array_inst/mgr_inst[{0}]/manager/mwc_cntl/input_intf_fifo[{1}]/pipe_read}}'.format(mgr,intf,src)
        pLine = pLine + '\nadd wave -noupdate -group MGR{0} -group MWC -group {2} -group FROM_{2}_FIFO -radix hexadecimal  {{/top/system_inst/manager_array_inst/mgr_inst[{0}]/manager/mwc_cntl/input_intf_fifo[{1}]/pipe_som}}'.format(mgr,intf,src)
        pLine = pLine + '\nadd wave -noupdate -group MGR{0} -group MWC -group {2} -group FROM_{2}_FIFO -radix hexadecimal  {{/top/system_inst/manager_array_inst/mgr_inst[{0}]/manager/mwc_cntl/input_intf_fifo[{1}]/pipe_valid}}'.format(mgr,intf,src)
        pLine = pLine + '\nadd wave -noupdate -group MGR{0} -group MWC -group {2} -group FROM_{2}_FIFO -radix hexadecimal  {{/top/system_inst/manager_array_inst/mgr_inst[{0}]/manager/mwc_cntl/input_intf_fifo[{1}]/write}}'.format(mgr,intf,src)
        pLine = pLine + '\nadd wave -noupdate -group MGR{0} -group MWC -group {2} -group FROM_{2}_FIFO -radix hexadecimal  {{/top/system_inst/manager_array_inst/mgr_inst[{0}]/manager/mwc_cntl/input_intf_fifo[{1}]/write_data}}'.format(mgr,intf,src)
  ...
  for mgr in range (0, numOfMgr):
    ...
    pLine = pLine + '\nadd wave -noupdate -group MGR{0} -group MGR_CNTL -group GENERAL -radix hexadecimal  {{/top/system_inst/manager_array_inst/mgr_inst[{0}]/manager/mgr_cntl/mode_reg_valid}}'.format(mgr)
    pLine = pLine + '\nadd wave -noupdate -group MGR{0} -group MGR_CNTL -group GENERAL -radix hexadecimal  {{/top/system_inst/manager_array_inst/mgr_inst[{0}]/manager/mgr_cntl/mode_reg_type}}'.format(mgr)
    ...
    pLine = pLine + '\nadd wave -noupdate -group MGR{0} -group MGR_CNTL -group GENERAL -radix hexadecimal  {{/top/system_inst/manager_array_inst/mgr_inst[{0}]/manager/mgr_cntl/pipe_option_extd_type}}'.format(mgr)
    pLine = pLine + '\nadd wave -noupdate -group MGR{0} -group MGR_CNTL -group GENERAL -radix hexadecimal  {{/top/system_inst/manager_array_inst/mgr_inst[{0}]/manager/mgr_cntl/pipe_option_extd_value}}'.format(mgr)
    pLine = pLine + '\nadd wave -noupdate -group MGR{0} -group MGR_CNTL -group GENERAL -radix hexadecimal  {{/top/system_inst/manager_array_inst/mgr_inst[{0}]/manager/mgr_cntl/pipe_option_extd_valid}}'.format(mgr)
    pLine = pLine + '\nadd wave -noupdate -group MGR{0} -group MGR_CNTL -group GENERAL -radix hexadecimal  {{/top/system_inst/manager_array_inst/mgr_inst[{0}]/manager/mgr_cntl/cfg_tag}}'.format(mgr)
    pLine = pLine + '\nadd wave -noupdate -group MGR{0} -group MGR_CNTL -group GENERAL -radix hexadecimal  {{/top/system_inst/manager_array_inst/mgr_inst[{0}]/manager/mgr_cntl/cfg_data_mode_reg_valid}}'.format(mgr)
    pLine = pLine + '\nadd wave -noupdate -group MGR{0} -group MGR_CNTL -group GENERAL -radix hexadecimal  {{/top/system_inst/manager_array_inst/mgr_inst[{0}]/manager/mgr_cntl/cfg_data_mode_reg_id}}'.format(mgr)
    pLine = pLine + '\nadd wave -noupdate -group MGR{0} -group MGR_CNTL -group GENERAL -radix hexadecimal  {{/top/system_inst/manager_array_inst/mgr_inst[{0}]/manager/mgr_cntl/cfg_data_mode_reg_value}}'.format(mgr)
    pLine = pLine + '\nadd wave -noupdate -group MGR{0} -group MGR_CNTL -group GENERAL -radix hexadecimal  {{/top/system_inst/manager_array_inst/mgr_inst[{0}]/manager/mgr_cntl/cfg_sync_mode_reg_valid}}'.format(mgr)
    pLine = pLine + '\nadd wave -noupdate -group MGR{0} -group MGR_CNTL -group GENERAL -radix hexadecimal  {{/top/system_inst/manager_array_inst/mgr_inst[{0}]/manager/mgr_cntl/cfg_sync_mode_reg_id}}'.format(mgr)
    pLine = pLine + '\nadd wave -noupdate -group MGR{0} -group MGR_CNTL -group GENERAL -radix hexadecimal  {{/top/system_inst/manager_array_inst/mgr_inst[{0}]/manager/mgr_cntl/cfg_sync_mode_reg_value}}'.format(mgr)
    pLine = pLine + '\nadd wave -noupdate -group MGR{0} -group MGR_CNTL -group GENERAL -radix hexadecimal  {{/top/system_inst/manager_array_inst/mgr_inst[{0}]/manager/mgr_cntl/cfg_storage_desc_ptr_valid}}'.format(mgr)
    pLine = pLine + '\nadd wave -noupdate -group MGR{0} -group MGR_CNTL -group GENERAL -radix hexadecimal  {{/top/system_inst/manager_array_inst/mgr_inst[{0}]/manager/mgr_cntl/cfg_storage_desc_ptr_type}}'.format(mgr)
    pLine = pLine + '\nadd wave -noupdate -group MGR{0} -group MGR_CNTL -group GENERAL -radix hexadecimal  {{/top/system_inst/manager_array_inst/mgr_inst[{0}]/manager/mgr_cntl/cfg_storage_desc_ptr_value}}'.format(mgr)
    #
    pLine = pLine + '\nadd wave -noupdate -group MGR{0} -group MGR_CNTL -group GENERAL -radix hexadecimal  {{/top/system_inst/manager_array_inst/mgr_inst[{0}]/manager/mgr_cntl/config_to_noc_cntl}}'.format(mgr)
    pLine = pLine + '\nadd wave -noupdate -group MGR{0} -group MGR_CNTL -group GENERAL -radix hexadecimal  {{/top/system_inst/manager_array_inst/mgr_inst[{0}]/manager/mgr_cntl/config_to_noc_type}}'.format(mgr)
    pLine = pLine + '\nadd wave -noupdate -group MGR{0} -group MGR_CNTL -group GENERAL -radix hexadecimal  {{/top/system_inst/manager_array_inst/mgr_inst[{0}]/manager/mgr_cntl/config_to_noc_ptype}}'.format(mgr)
    pLine = pLine + '\nadd wave -noupdate -group MGR{0} -group MGR_CNTL -group GENERAL -radix hexadecimal  {{/top/system_inst/manager_array_inst/mgr_inst[{0}]/manager/mgr_cntl/config_to_noc_desttype}}'.format(mgr)
    pLine = pLine + '\nadd wave -noupdate -group MGR{0} -group MGR_CNTL -group GENERAL -radix hexadecimal  {{/top/system_inst/manager_array_inst/mgr_inst[{0}]/manager/mgr_cntl/config_to_noc_pvalid}}'.format(mgr)
    pLine = pLine + '\nadd wave -noupdate -group MGR{0} -group MGR_CNTL -group GENERAL -radix hexadecimal  {{/top/system_inst/manager_array_inst/mgr_inst[{0}]/manager/mgr_cntl/config_to_noc_data}}'.format(mgr)
    pLine = pLine + '\nadd wave -noupdate -group MGR{0} -group MGR_CNTL -group GENERAL -radix hexadecimal  {{/top/system_inst/manager_array_inst/mgr_inst[{0}]/manager/mgr_cntl/config_upld_fifo_write}}'.format(mgr)
    pLine = pLine + '\nadd wave -noupdate -group MGR{0} -group MGR_CNTL -group GENERAL -radix hexadecimal  {{/top/system_inst/manager_array_inst/mgr_inst[{0}]/manager/mgr_cntl/to_noc_almost_full}}'.format(mgr)
    pLine = pLine + '\nadd wave -noupdate -group MGR{0} -group MGR_CNTL -group GENERAL -radix hexadecimal  {{/top/system_inst/manager_array_inst/mgr_inst[{0}]/manager/mgr_cntl/upld_noc_data_first_pkt}}'.format(mgr)
    pLine = pLine + '\nadd wave -noupdate -group MGR{0} -group MGR_CNTL -group GENERAL -radix hexadecimal  {{/top/system_inst/manager_array_inst/mgr_inst[{0}]/manager/mgr_cntl/upld_noc_data_last_pkt}}'.format(mgr)
    pLine = pLine + '\nadd wave -noupdate -group MGR{0} -group MGR_CNTL -group GENERAL -radix hexadecimal  {{/top/system_inst/manager_array_inst/mgr_inst[{0}]/manager/mgr_cntl/noc_unsolicited_dma}}'.format(mgr)
    pLine = pLine + '\nadd wave -noupdate -group MGR{0} -group MGR_CNTL -group GENERAL -radix hexadecimal  {{/top/system_inst/manager_array_inst/mgr_inst[{0}]/manager/mgr_cntl/noc_dnld_complete  }}'.format(mgr)
    pLine = pLine + '\nadd wave -noupdate -group MGR{0} -group MGR_CNTL -group GENERAL -radix hexadecimal  {{/top/system_inst/manager_array_inst/mgr_inst[{0}]/manager/mgr_cntl/is_peek_cfg_dma      }}'.format(mgr)
    pLine = pLine + '\nadd wave -noupdate -group MGR{0} -group MGR_CNTL -group GENERAL -radix hexadecimal  {{/top/system_inst/manager_array_inst/mgr_inst[{0}]/manager/mgr_cntl/is_peek_cfg_dma_start}}'.format(mgr)
    pLine = pLine + '\nadd wave -noupdate -group MGR{0} -group MGR_CNTL -group GENERAL -radix hexadecimal  {{/top/system_inst/manager_array_inst/mgr_inst[{0}]/manager/mgr_cntl/is_peek_desc_wr_type }}'.format(mgr)
    pLine = pLine + '\nadd wave -noupdate -group MGR{0} -group MGR_CNTL -group GENERAL -radix hexadecimal  {{/top/system_inst/manager_array_inst/mgr_inst[{0}]/manager/mgr_cntl/is_peek_desc_wr_data }}'.format(mgr)
    pLine = pLine + '\nadd wave -noupdate -group MGR{0} -group MGR_CNTL -group GENERAL -radix hexadecimal  {{/top/system_inst/manager_array_inst/mgr_inst[{0}]/manager/mgr_cntl/is_cfg_dma      }}'.format(mgr)
    pLine = pLine + '\nadd wave -noupdate -group MGR{0} -group MGR_CNTL -group GENERAL -radix hexadecimal  {{/top/system_inst/manager_array_inst/mgr_inst[{0}]/manager/mgr_cntl/is_cfg_dma_start}}'.format(mgr)
    pLine = pLine + '\nadd wave -noupdate -group MGR{0} -group MGR_CNTL -group GENERAL -radix hexadecimal  {{/top/system_inst/manager_array_inst/mgr_inst[{0}]/manager/mgr_cntl/is_desc_wr_type }}'.format(mgr)
    pLine = pLine + '\nadd wave -noupdate -group MGR{0} -group MGR_CNTL -group GENERAL -radix hexadecimal  {{/top/system_inst/manager_array_inst/mgr_inst[{0}]/manager/mgr_cntl/is_desc_wr_data }}'.format(mgr)
    pLine = pLine + '\nadd wave -noupdate -group MGR{0} -group MGR_CNTL -group GENERAL -radix hexadecimal  {{/top/system_inst/manager_array_inst/mgr_inst[{0}]/manager/mgr_cntl/processing_config_upld    }}'.format(mgr)
    pLine = pLine + '\nadd wave -noupdate -group MGR{0} -group MGR_CNTL -group GENERAL -radix hexadecimal  {{/top/system_inst/manager_array_inst/mgr_inst[{0}]/manager/mgr_cntl/processing_config_upld_d1 }}'.format(mgr)
    pLine = pLine + '\nadd wave -noupdate -group MGR{0} -group MGR_CNTL -group GENERAL -radix hexadecimal  {{/top/system_inst/manager_array_inst/mgr_inst[{0}]/manager/mgr_cntl/processing_config_dnld    }}'.format(mgr)
    pLine = pLine + '\nadd wave -noupdate -group MGR{0} -group MGR_CNTL -group GENERAL -radix hexadecimal  {{/top/system_inst/manager_array_inst/mgr_inst[{0}]/manager/mgr_cntl/processing_sync_to_host   }}'.format(mgr)
    pLine = pLine + '\nadd wave -noupdate -group MGR{0} -group MGR_CNTL -group GENERAL -radix hexadecimal  {{/top/system_inst/manager_array_inst/mgr_inst[{0}]/manager/mgr_cntl/processing_sync_to_ssc    }}'.format(mgr)
    pLine = pLine + '\nadd wave -noupdate -group MGR{0} -group MGR_CNTL -group GENERAL -radix hexadecimal  {{/top/system_inst/manager_array_inst/mgr_inst[{0}]/manager/mgr_cntl/processing_sync_to_host_d1}}'.format(mgr)
    pLine = pLine + '\nadd wave -noupdate -group MGR{0} -group MGR_CNTL -group GENERAL -radix hexadecimal  {{/top/system_inst/manager_array_inst/mgr_inst[{0}]/manager/mgr_cntl/processing_sync_to_ssc_d1 }}'.format(mgr)
    #
    ...
    #
    pLine = pLine + '\nadd wave -noupdate -group MGR{0} -group MGR_CNTL -group FSM_MAIN -radix hexadecimal  {{/top/system_inst/manager_array_inst/mgr_inst[{0}]/manager/mgr_cntl/mgr_cntl_main_state}}'.format(mgr)
    pLine = pLine + '\nadd wave -noupdate -group MGR{0} -group MGR_CNTL -group FSM_MAIN -radix hexadecimal  {{/top/system_inst/manager_array_inst/mgr_inst[{0}]/manager/mgr_cntl/mgr_cntl_main_state_next}}'.format(mgr)
    pLine = pLine + '\nadd wave -noupdate -group MGR{0} -group MGR_CNTL -group FSM_MAIN -radix hexadecimal  {{/top/system_inst/manager_array_inst/mgr_inst[{0}]/manager/mgr_cntl/process_wud}}'.format(mgr)
    pLine = pLine + '\nadd wave -noupdate -group MGR{0} -group MGR_CNTL -group FSM_MAIN -radix hexadecimal  {{/top/system_inst/manager_array_inst/mgr_inst[{0}]/manager/mgr_cntl/from_wud_valid}}'.format(mgr)
    pLine = pLine + '\nadd wave -noupdate -group MGR{0} -group MGR_CNTL -group FSM_MAIN -radix hexadecimal  {{/top/system_inst/manager_array_inst/mgr_inst[{0}]/manager/mgr_cntl/from_wud_eod}}'.format(mgr)
    pLine = pLine + '\nadd wave -noupdate -group MGR{0} -group MGR_CNTL -group FSM_MAIN -radix hexadecimal  {{/top/system_inst/manager_array_inst/mgr_inst[{0}]/manager/mgr_cntl/from_wud_sod}}'.format(mgr)
    pLine = pLine + '\nadd wave -noupdate -group MGR{0} -group MGR_CNTL -group FSM_MAIN -radix hexadecimal  {{/top/system_inst/manager_array_inst/mgr_inst[{0}]/manager/mgr_cntl/from_wud_dcntl}}'.format(mgr)
    pLine = pLine + '\nadd wave -noupdate -group MGR{0} -group MGR_CNTL -group FSM_MAIN -radix hexadecimal  {{/top/system_inst/manager_array_inst/mgr_inst[{0}]/manager/mgr_cntl/from_wud_tag}}'.format(mgr)
    pLine = pLine + '\nadd wave -noupdate -group MGR{0} -group MGR_CNTL -group FSM_MAIN -radix hexadecimal  {{/top/system_inst/manager_array_inst/mgr_inst[{0}]/manager/mgr_cntl/from_wud_option_type}}'.format(mgr)
    pLine = pLine + '\nadd wave -noupdate -group MGR{0} -group MGR_CNTL -group FSM_MAIN -radix hexadecimal  {{/top/system_inst/manager_array_inst/mgr_inst[{0}]/manager/mgr_cntl/from_wud_option_value}}'.format(mgr)
    pLine = pLine + '\nadd wave -noupdate -group MGR{0} -group MGR_CNTL -group FSM_MAIN -radix hexadecimal  {{/top/system_inst/manager_array_inst/mgr_inst[{0}]/manager/mgr_cntl/from_wud_read}}'.format(mgr)
    pLine = pLine + '\nadd wave -noupdate -group MGR{0} -group MGR_CNTL -group FSM_MAIN -radix hexadecimal  {{/top/system_inst/manager_array_inst/mgr_inst[{0}]/manager/mgr_cntl/cfg_tag}}'.format(mgr)
    pLine = pLine + '\nadd wave -noupdate -group MGR{0} -group MGR_CNTL -group FSM_MAIN -radix hexadecimal  {{/top/system_inst/manager_array_inst/mgr_inst[{0}]/manager/mgr_cntl/cfg_data_mode_reg_valid}}'.format(mgr)
    pLine = pLine + '\nadd wave -noupdate -group MGR{0} -group MGR_CNTL -group FSM_MAIN -radix hexadecimal  {{/top/system_inst/manager_array_inst/mgr_inst[{0}]/manager/mgr_cntl/cfg_data_mode_reg_id}}'.format(mgr)
    pLine = pLine + '\nadd wave -noupdate -group MGR{0} -group MGR_CNTL -group FSM_MAIN -radix hexadecimal  {{/top/system_inst/manager_array_inst/mgr_inst[{0}]/manager/mgr_cntl/cfg_data_mode_reg_value}}'.format(mgr)
    pLine = pLine + '\nadd wave -noupdate -group MGR{0} -group MGR_CNTL -group FSM_MAIN -radix hexadecimal  {{/top/system_inst/manager_array_inst/mgr_inst[{0}]/manager/mgr_cntl/cfg_sync_mode_reg_valid}}'.format(mgr)
    pLine = pLine + '\nadd wave -noupdate -group MGR{0} -group MGR_CNTL -group FSM_MAIN -radix hexadecimal  {{/top/system_inst/manager_array_inst/mgr_inst[{0}]/manager/mgr_cntl/cfg_sync_mode_reg_id}}'.format(mgr)
    pLine = pLine + '\nadd wave -noupdate -group MGR{0} -group MGR_CNTL -group FSM_MAIN -radix hexadecimal  {{/top/system_inst/manager_array_inst/mgr_inst[{0}]/manager/mgr_cntl/cfg_sync_mode_reg_value}}'.format(mgr)
    pLine = pLine + '\nadd wave -noupdate -group MGR{0} -group MGR_CNTL -group FSM_MAIN -radix hexadecimal  {{/top/system_inst/manager_array_inst/mgr_inst[{0}]/manager/mgr_cntl/cfg_storage_desc_ptr_valid}}'.format(mgr)
    pLine = pLine + '\nadd wave -noupdate -group MGR{0} -group MGR_CNTL -group FSM_MAIN -radix hexadecimal  {{/top/system_inst/manager_array_inst/mgr_inst[{0}]/manager/mgr_cntl/cfg_storage_desc_ptr_type}}'.format(mgr)
    pLine = pLine + '\nadd wave -noupdate -group MGR{0} -group MGR_CNTL -group FSM_MAIN -radix hexadecimal  {{/top/system_inst/manager_array_inst/mgr_inst[{0}]/manager/mgr_cntl/cfg_storage_desc_ptr_value}}'.format(mgr)
    pLine = pLine + '\nadd wave -noupdate -group MGR{0} -group MGR_CNTL -group FSM_MAIN -radix hexadecimal  {{/top/system_inst/manager_array_inst/mgr_inst[{0}]/manager/mgr_cntl/noc_data_cycle_count}}'.format(mgr)
    pLine = pLine + '\nadd wave -noupdate -group MGR{0} -group MGR_CNTL -group FSM_MAIN -radix hexadecimal  {{/top/system_inst/manager_array_inst/mgr_inst[{0}]/manager/mgr_cntl/upld_word_count}}'.format(mgr)
    pLine = pLine + '\nadd wave -noupdate -group MGR{0} -group MGR_CNTL -group FSM_MAIN -radix hexadecimal  {{/top/system_inst/manager_array_inst/mgr_inst[{0}]/manager/mgr_cntl/noc_data_mtu_cycle}}'.format(mgr)
    pLine = pLine + '\nadd wave -noupdate -group MGR{0} -group MGR_CNTL -group FSM_MAIN -radix hexadecimal  {{/top/system_inst/manager_array_inst/mgr_inst[{0}]/manager/mgr_cntl/to_noc_almost_full}}'.format(mgr)
    pLine = pLine + '\nadd wave -noupdate -group MGR{0} -group MGR_CNTL -group FSM_MAIN -radix hexadecimal  {{/top/system_inst/manager_array_inst/mgr_inst[{0}]/manager/mgr_cntl/to_noc_almost_full}}'.format(mgr)
    pLine = pLine + '\nadd wave -noupdate -group MGR{0} -group MGR_CNTL -group FSM_MAIN -radix hexadecimal  {{/top/system_inst/manager_array_inst/mgr_inst[{0}]/manager/mgr_cntl/from_mrc_lanes_valid}}'.format(mgr)
    pLine = pLine + '\nadd wave -noupdate -group MGR{0} -group MGR_CNTL -group FSM_MAIN -radix hexadecimal  {{/top/system_inst/manager_array_inst/mgr_inst[{0}]/manager/mgr_cntl/upld_transfer_mrc_to_noc}}'.format(mgr)
    pLine = pLine + '\nadd wave -noupdate -group MGR{0} -group MGR_CNTL -group FSM_MAIN -radix hexadecimal  {{/top/system_inst/manager_array_inst/mgr_inst[{0}]/manager/mgr_cntl/to_noc_almost_full}}'.format(mgr)
    pLine = pLine + '\nadd wave -noupdate -group MGR{0} -group MGR_CNTL -group FSM_MAIN -radix hexadecimal  {{/top/system_inst/manager_array_inst/mgr_inst[{0}]/manager/mgr_cntl/upld_noc_data_first_pkt}}'.format(mgr)
    pLine = pLine + '\nadd wave -noupdate -group MGR{0} -group MGR_CNTL -group FSM_MAIN -radix hexadecimal  {{/top/system_inst/manager_array_inst/mgr_inst[{0}]/manager/mgr_cntl/upld_noc_data_last_pkt}}'.format(mgr)
    #
    pLine = pLine + '\nadd wave -noupdate -group MGR{0} -group MGR_CNTL -group FSM_NOC -radix hexadecimal  {{/top/system_inst/manager_array_inst/mgr_inst[{0}]/manager/mgr_cntl/mgr_cntl_noc_cntl_state}}'.format(mgr)
    pLine = pLine + '\nadd wave -noupdate -group MGR{0} -group MGR_CNTL -group FSM_NOC -radix hexadecimal  {{/top/system_inst/manager_array_inst/mgr_inst[{0}]/manager/mgr_cntl/mgr_cntl_noc_cntl_state_next}}'.format(mgr)
    pLine = pLine + '\nadd wave -noupdate -group MGR{0} -group MGR_CNTL -group FSM_NOC -radix hexadecimal  {{/top/system_inst/manager_array_inst/mgr_inst[{0}]/manager/mgr_cntl/from_noc_valid}}'.format(mgr)
    pLine = pLine + '\nadd wave -noupdate -group MGR{0} -group MGR_CNTL -group FSM_NOC -radix hexadecimal  {{/top/system_inst/manager_array_inst/mgr_inst[{0}]/manager/mgr_cntl/from_noc_cntl}}'.format(mgr)
    pLine = pLine + '\nadd wave -noupdate -group MGR{0} -group MGR_CNTL -group FSM_NOC -radix hexadecimal  {{/top/system_inst/manager_array_inst/mgr_inst[{0}]/manager/mgr_cntl/from_noc_type}}'.format(mgr)
    pLine = pLine + '\nadd wave -noupdate -group MGR{0} -group MGR_CNTL -group FSM_NOC -radix hexadecimal  {{/top/system_inst/manager_array_inst/mgr_inst[{0}]/manager/mgr_cntl/from_noc_ptype}}'.format(mgr)
    pLine = pLine + '\nadd wave -noupdate -group MGR{0} -group MGR_CNTL -group FSM_NOC -radix hexadecimal  {{/top/system_inst/manager_array_inst/mgr_inst[{0}]/manager/mgr_cntl/from_noc_data}}'.format(mgr)
    pLine = pLine + '\nadd wave -noupdate -group MGR{0} -group MGR_CNTL -group FSM_NOC -radix hexadecimal  {{/top/system_inst/manager_array_inst/mgr_inst[{0}]/manager/mgr_cntl/from_noc_pvalid}}'.format(mgr)
    pLine = pLine + '\nadd wave -noupdate -group MGR{0} -group MGR_CNTL -group FSM_NOC -radix hexadecimal  {{/top/system_inst/manager_array_inst/mgr_inst[{0}]/manager/mgr_cntl/from_noc_srcId}}'.format(mgr)
    pLine = pLine + '\nadd wave -noupdate -group MGR{0} -group MGR_CNTL -group FSM_NOC -radix hexadecimal  {{/top/system_inst/manager_array_inst/mgr_inst[{0}]/manager/mgr_cntl/noc_to_mwc}}'.format(mgr)
    pLine = pLine + '\nadd wave -noupdate -group MGR{0} -group MGR_CNTL -group FSM_NOC -radix hexadecimal  {{/top/system_inst/manager_array_inst/mgr_inst[{0}]/manager/mgr_cntl/add_desc_to_mwc}}'.format(mgr)
    pLine = pLine + '\nadd wave -noupdate -group MGR{0} -group MGR_CNTL -group FSM_NOC -radix hexadecimal  {{/top/system_inst/manager_array_inst/mgr_inst[{0}]/manager/mgr_cntl/noc_to_wum}}'.format(mgr)
    #
    ...
    #
    pLine = pLine + '\nadd wave -noupdate -group MGR{0} -group MGR_CNTL -group FROM_NOC -group FROM_NOC_FIFO -radix hexadecimal  {{/top/system_inst/manager_array_inst/mgr_inst[{0}]/manager/mgr_cntl/from_noc_fifo[0]/almost_full}}'.format(mgr)
    pLine = pLine + '\nadd wave -noupdate -group MGR{0} -group MGR_CNTL -group FROM_NOC -group FROM_NOC_FIFO -radix hexadecimal  {{/top/system_inst/manager_array_inst/mgr_inst[{0}]/manager/mgr_cntl/from_noc_fifo[0]/clear}}'.format(mgr)
    pLine = pLine + '\nadd wave -noupdate -group MGR{0} -group MGR_CNTL -group FROM_NOC -group FROM_NOC_FIFO -radix hexadecimal  {{/top/system_inst/manager_array_inst/mgr_inst[{0}]/manager/mgr_cntl/from_noc_fifo[0]/intf}}'.format(mgr)
    pLine = pLine + '\nadd wave -noupdate -group MGR{0} -group MGR_CNTL -group FROM_NOC -group FROM_NOC_FIFO -radix hexadecimal  {{/top/system_inst/manager_array_inst/mgr_inst[{0}]/manager/mgr_cntl/from_noc_fifo[0]/pipe_cntl}}'.format(mgr)
    pLine = pLine + '\nadd wave -noupdate -group MGR{0} -group MGR_CNTL -group FROM_NOC -group FROM_NOC_FIFO -radix hexadecimal  {{/top/system_inst/manager_array_inst/mgr_inst[{0}]/manager/mgr_cntl/from_noc_fifo[0]/pipe_som}}'.format(mgr)
    pLine = pLine + '\nadd wave -noupdate -group MGR{0} -group MGR_CNTL -group FROM_NOC -group FROM_NOC_FIFO -radix hexadecimal  {{/top/system_inst/manager_array_inst/mgr_inst[{0}]/manager/mgr_cntl/from_noc_fifo[0]/pipe_eom}}'.format(mgr)
    pLine = pLine + '\nadd wave -noupdate -group MGR{0} -group MGR_CNTL -group FROM_NOC -group FROM_NOC_FIFO -radix hexadecimal  {{/top/system_inst/manager_array_inst/mgr_inst[{0}]/manager/mgr_cntl/from_noc_fifo[0]/pipe_read}}'.format(mgr)
    #
    pLine = pLine + '\nadd wave -noupdate -group MGR{0} -group MGR_CNTL -group FROM_NOC -group FROM_NOC_FIFO -radix hexadecimal  {{/top/system_inst/manager_array_inst/mgr_inst[{0}]/manager/mgr_cntl/from_noc_fifo[0]/pipe_valid}}'.format(mgr)
    pLine = pLine + '\nadd wave -noupdate -group MGR{0} -group MGR_CNTL -group FROM_NOC -group FROM_NOC_FIFO -radix hexadecimal  {{/top/system_inst/manager_array_inst/mgr_inst[{0}]/manager/mgr_cntl/from_noc_fifo[0]/pipe_data}}'.format(mgr)
    pLine = pLine + '\nadd wave -noupdate -group MGR{0} -group MGR_CNTL -group FROM_NOC -group FROM_NOC_FIFO -radix hexadecimal  {{/top/system_inst/manager_array_inst/mgr_inst[{0}]/manager/mgr_cntl/from_noc_fifo[0]/pipe_mem_data}}'.format(mgr)
    pLine = pLine + '\nadd wave -noupdate -group MGR{0} -group MGR_CNTL -group FROM_NOC -group FROM_NOC_FIFO -radix hexadecimal  {{/top/system_inst/manager_array_inst/mgr_inst[{0}]/manager/mgr_cntl/from_noc_fifo[0]/pipe_ptype}}'.format(mgr)
    pLine = pLine + '\nadd wave -noupdate -group MGR{0} -group MGR_CNTL -group FROM_NOC -group FROM_NOC_FIFO -radix hexadecimal  {{/top/system_inst/manager_array_inst/mgr_inst[{0}]/manager/mgr_cntl/from_noc_fifo[0]/pipe_pvalid}}'.format(mgr)
    pLine = pLine + '\nadd wave -noupdate -group MGR{0} -group MGR_CNTL -group FROM_NOC -group FROM_NOC_FIFO -radix hexadecimal  {{/top/system_inst/manager_array_inst/mgr_inst[{0}]/manager/mgr_cntl/from_noc_fifo[0]/pipe_srcId}}'.format(mgr)
    pLine = pLine + '\nadd wave -noupdate -group MGR{0} -group MGR_CNTL -group FROM_NOC -group FROM_NOC_FIFO -radix hexadecimal  {{/top/system_inst/manager_array_inst/mgr_inst[{0}]/manager/mgr_cntl/from_noc_fifo[0]/pipe_type}}'.format(mgr)
    #
    pLine = pLine + '\nadd wave -noupdate -group MGR{0} -group MGR_CNTL -group FROM_NOC -group FROM_NOC_FIFO -radix hexadecimal  {{/top/system_inst/manager_array_inst/mgr_inst[{0}]/manager/mgr_cntl/from_noc_fifo[0]/pipe_peek_valid}}'.format(mgr)
    pLine = pLine + '\nadd wave -noupdate -group MGR{0} -group MGR_CNTL -group FROM_NOC -group FROM_NOC_FIFO -radix hexadecimal  {{/top/system_inst/manager_array_inst/mgr_inst[{0}]/manager/mgr_cntl/from_noc_fifo[0]/pipe_peek_cntl}}'.format(mgr)
    pLine = pLine + '\nadd wave -noupdate -group MGR{0} -group MGR_CNTL -group FROM_NOC -group FROM_NOC_FIFO -radix hexadecimal  {{/top/system_inst/manager_array_inst/mgr_inst[{0}]/manager/mgr_cntl/from_noc_fifo[0]/pipe_peek_data}}'.format(mgr)
    pLine = pLine + '\nadd wave -noupdate -group MGR{0} -group MGR_CNTL -group FROM_NOC -group FROM_NOC_FIFO -radix hexadecimal  {{/top/system_inst/manager_array_inst/mgr_inst[{0}]/manager/mgr_cntl/from_noc_fifo[0]/pipe_peek_mem_data}}'.format(mgr)
    pLine = pLine + '\nadd wave -noupdate -group MGR{0} -group MGR_CNTL -group FROM_NOC -group FROM_NOC_FIFO -radix hexadecimal  {{/top/system_inst/manager_array_inst/mgr_inst[{0}]/manager/mgr_cntl/from_noc_fifo[0]/pipe_peek_ptype}}'.format(mgr)
    pLine = pLine + '\nadd wave -noupdate -group MGR{0} -group MGR_CNTL -group FROM_NOC -group FROM_NOC_FIFO -radix hexadecimal  {{/top/system_inst/manager_array_inst/mgr_inst[{0}]/manager/mgr_cntl/from_noc_fifo[0]/pipe_peek_pvalid}}'.format(mgr)
    pLine = pLine + '\nadd wave -noupdate -group MGR{0} -group MGR_CNTL -group FROM_NOC -group FROM_NOC_FIFO -radix hexadecimal  {{/top/system_inst/manager_array_inst/mgr_inst[{0}]/manager/mgr_cntl/from_noc_fifo[0]/pipe_peek_srcId}}'.format(mgr)
    pLine = pLine + '\nadd wave -noupdate -group MGR{0} -group MGR_CNTL -group FROM_NOC -group FROM_NOC_FIFO -radix hexadecimal  {{/top/system_inst/manager_array_inst/mgr_inst[{0}]/manager/mgr_cntl/from_noc_fifo[0]/pipe_peek_type}}'.format(mgr)
    #
    pLine = pLine + '\nadd wave -noupdate -group MGR{0} -group MGR_CNTL -group FROM_NOC -group FROM_NOC_FIFO -radix hexadecimal  {{/top/system_inst/manager_array_inst/mgr_inst[{0}]/manager/mgr_cntl/from_noc_fifo[0]/pipe_peek_twoIn_valid}}'.format(mgr)
    pLine = pLine + '\nadd wave -noupdate -group MGR{0} -group MGR_CNTL -group FROM_NOC -group FROM_NOC_FIFO -radix hexadecimal  {{/top/system_inst/manager_array_inst/mgr_inst[{0}]/manager/mgr_cntl/from_noc_fifo[0]/pipe_peek_twoIn_cntl}}'.format(mgr)
    pLine = pLine + '\nadd wave -noupdate -group MGR{0} -group MGR_CNTL -group FROM_NOC -group FROM_NOC_FIFO -radix hexadecimal  {{/top/system_inst/manager_array_inst/mgr_inst[{0}]/manager/mgr_cntl/from_noc_fifo[0]/pipe_peek_twoIn_data}}'.format(mgr)
    pLine = pLine + '\nadd wave -noupdate -group MGR{0} -group MGR_CNTL -group FROM_NOC -group FROM_NOC_FIFO -radix hexadecimal  {{/top/system_inst/manager_array_inst/mgr_inst[{0}]/manager/mgr_cntl/from_noc_fifo[0]/pipe_peek_twoIn_mem_data}}'.format(mgr)
    pLine = pLine + '\nadd wave -noupdate -group MGR{0} -group MGR_CNTL -group FROM_NOC -group FROM_NOC_FIFO -radix hexadecimal  {{/top/system_inst/manager_array_inst/mgr_inst[{0}]/manager/mgr_cntl/from_noc_fifo[0]/pipe_peek_twoIn_ptype}}'.format(mgr)
    pLine = pLine + '\nadd wave -noupdate -group MGR{0} -group MGR_CNTL -group FROM_NOC -group FROM_NOC_FIFO -radix hexadecimal  {{/top/system_inst/manager_array_inst/mgr_inst[{0}]/manager/mgr_cntl/from_noc_fifo[0]/pipe_peek_twoIn_pvalid}}'.format(mgr)
    pLine = pLine + '\nadd wave -noupdate -group MGR{0} -group MGR_CNTL -group FROM_NOC -group FROM_NOC_FIFO -radix hexadecimal  {{/top/system_inst/manager_array_inst/mgr_inst[{0}]/manager/mgr_cntl/from_noc_fifo[0]/pipe_peek_twoIn_srcId}}'.format(mgr)
    pLine = pLine + '\nadd wave -noupdate -group MGR{0} -group MGR_CNTL -group FROM_NOC -group FROM_NOC_FIFO -radix hexadecimal  {{/top/system_inst/manager_array_inst/mgr_inst[{0}]/manager/mgr_cntl/from_noc_fifo[0]/pipe_peek_twoIn_type}}'.format(mgr)
    #
    pLine = pLine + '\nadd wave -noupdate -group MGR{0} -group MGR_CNTL -group FROM_NOC -group FROM_NOC_FIFO -radix hexadecimal  {{/top/system_inst/manager_array_inst/mgr_inst[{0}]/manager/mgr_cntl/from_noc_fifo[0]/write}}'.format(mgr)
    pLine = pLine + '\nadd wave -noupdate -group MGR{0} -group MGR_CNTL -group FROM_NOC -group FROM_NOC_FIFO -radix hexadecimal  {{/top/system_inst/manager_array_inst/mgr_inst[{0}]/manager/mgr_cntl/from_noc_fifo[0]/write_data}}'.format(mgr)
    #
    pLine = pLine + '\nadd wave -noupdate -group MGR{0} -group MGR_CNTL -group TO_NOC -radix hexadecimal  {{/top/system_inst/manager_array_inst/mgr_inst[{0}]/manager/mgr_cntl/mcntl__noc__cp_valid}}'.format(mgr)
    pLine = pLine + '\nadd wave -noupdate -group MGR{0} -group MGR_CNTL -group TO_NOC -radix hexadecimal  {{/top/system_inst/manager_array_inst/mgr_inst[{0}]/manager/mgr_cntl/mcntl__noc__cp_cntl}}'.format(mgr)
    pLine = pLine + '\nadd wave -noupdate -group MGR{0} -group MGR_CNTL -group TO_NOC -radix hexadecimal  {{/top/system_inst/manager_array_inst/mgr_inst[{0}]/manager/mgr_cntl/noc__mcntl__cp_ready}}'.format(mgr)
    pLine = pLine + '\nadd wave -noupdate -group MGR{0} -group MGR_CNTL -group TO_NOC -radix hexadecimal  {{/top/system_inst/manager_array_inst/mgr_inst[{0}]/manager/mgr_cntl/mcntl__noc__cp_data}}'.format(mgr)
    pLine = pLine + '\nadd wave -noupdate -group MGR{0} -group MGR_CNTL -group TO_NOC -radix hexadecimal  {{/top/system_inst/manager_array_inst/mgr_inst[{0}]/manager/mgr_cntl/mcntl__noc__cp_desttype}}'.format(mgr)
    pLine = pLine + '\nadd wave -noupdate -group MGR{0} -group MGR_CNTL -group TO_NOC -radix hexadecimal  {{/top/system_inst/manager_array_inst/mgr_inst[{0}]/manager/mgr_cntl/mcntl__noc__cp_ptype}}'.format(mgr)
    pLine = pLine + '\nadd wave -noupdate -group MGR{0} -group MGR_CNTL -group TO_NOC -radix hexadecimal  {{/top/system_inst/manager_array_inst/mgr_inst[{0}]/manager/mgr_cntl/mcntl__noc__cp_pvalid}}'.format(mgr)
    pLine = pLine + '\nadd wave -noupdate -group MGR{0} -group MGR_CNTL -group TO_NOC -radix hexadecimal  {{/top/system_inst/manager_array_inst/mgr_inst[{0}]/manager/mgr_cntl/mcntl__noc__cp_type}}'.format(mgr)
    pLine = pLine + '\nadd wave -noupdate -group MGR{0} -group MGR_CNTL -group TO_NOC -radix hexadecimal  {{/top/system_inst/manager_array_inst/mgr_inst[{0}]/manager/mgr_cntl/mcntl__noc__dp_valid}}'.format(mgr)
    pLine = pLine + '\nadd wave -noupdate -group MGR{0} -group MGR_CNTL -group TO_NOC -radix hexadecimal  {{/top/system_inst/manager_array_inst/mgr_inst[{0}]/manager/mgr_cntl/mcntl__noc__dp_cntl}}'.format(mgr)
    pLine = pLine + '\nadd wave -noupdate -group MGR{0} -group MGR_CNTL -group TO_NOC -radix hexadecimal  {{/top/system_inst/manager_array_inst/mgr_inst[{0}]/manager/mgr_cntl/noc__mcntl__dp_ready}}'.format(mgr)
    pLine = pLine + '\nadd wave -noupdate -group MGR{0} -group MGR_CNTL -group TO_NOC -radix hexadecimal  {{/top/system_inst/manager_array_inst/mgr_inst[{0}]/manager/mgr_cntl/mcntl__noc__dp_data}}'.format(mgr)
    pLine = pLine + '\nadd wave -noupdate -group MGR{0} -group MGR_CNTL -group TO_NOC -radix hexadecimal  {{/top/system_inst/manager_array_inst/mgr_inst[{0}]/manager/mgr_cntl/mcntl__noc__dp_desttype}}'.format(mgr)
    pLine = pLine + '\nadd wave -noupdate -group MGR{0} -group MGR_CNTL -group TO_NOC -radix hexadecimal  {{/top/system_inst/manager_array_inst/mgr_inst[{0}]/manager/mgr_cntl/mcntl__noc__dp_ptype}}'.format(mgr)
    pLine = pLine + '\nadd wave -noupdate -group MGR{0} -group MGR_CNTL -group TO_NOC -radix hexadecimal  {{/top/system_inst/manager_array_inst/mgr_inst[{0}]/manager/mgr_cntl/mcntl__noc__dp_pvalid}}'.format(mgr)
    pLine = pLine + '\nadd wave -noupdate -group MGR{0} -group MGR_CNTL -group TO_NOC -radix hexadecimal  {{/top/system_inst/manager_array_inst/mgr_inst[{0}]/manager/mgr_cntl/mcntl__noc__dp_type}}'.format(mgr)
    #
    pLine = pLine + '\nadd wave -noupdate -group MGR{0} -group MGR_CNTL -group TO_NOC -group TO_NOC_FIFO -radix hexadecimal  {{/top/system_inst/manager_array_inst/mgr_inst[{0}]/manager/mgr_cntl/to_noc_fifo[0]/almost_full}}'.format(mgr)
    pLine = pLine + '\nadd wave -noupdate -group MGR{0} -group MGR_CNTL -group TO_NOC -group TO_NOC_FIFO -radix hexadecimal  {{/top/system_inst/manager_array_inst/mgr_inst[{0}]/manager/mgr_cntl/to_noc_fifo[0]/pipe_cntl}}'.format(mgr)
    pLine = pLine + '\nadd wave -noupdate -group MGR{0} -group MGR_CNTL -group TO_NOC -group TO_NOC_FIFO -radix hexadecimal  {{/top/system_inst/manager_array_inst/mgr_inst[{0}]/manager/mgr_cntl/to_noc_fifo[0]/pipe_data}}'.format(mgr)
    pLine = pLine + '\nadd wave -noupdate -group MGR{0} -group MGR_CNTL -group TO_NOC -group TO_NOC_FIFO -radix hexadecimal  {{/top/system_inst/manager_array_inst/mgr_inst[{0}]/manager/mgr_cntl/to_noc_fifo[0]/pipe_desttype}}'.format(mgr)
    pLine = pLine + '\nadd wave -noupdate -group MGR{0} -group MGR_CNTL -group TO_NOC -group TO_NOC_FIFO -radix hexadecimal  {{/top/system_inst/manager_array_inst/mgr_inst[{0}]/manager/mgr_cntl/to_noc_fifo[0]/pipe_ptype}}'.format(mgr)
    pLine = pLine + '\nadd wave -noupdate -group MGR{0} -group MGR_CNTL -group TO_NOC -group TO_NOC_FIFO -radix hexadecimal  {{/top/system_inst/manager_array_inst/mgr_inst[{0}]/manager/mgr_cntl/to_noc_fifo[0]/pipe_pvalid}}'.format(mgr)
    pLine = pLine + '\nadd wave -noupdate -group MGR{0} -group MGR_CNTL -group TO_NOC -group TO_NOC_FIFO -radix hexadecimal  {{/top/system_inst/manager_array_inst/mgr_inst[{0}]/manager/mgr_cntl/to_noc_fifo[0]/pipe_read}}'.format(mgr)
    pLine = pLine + '\nadd wave -noupdate -group MGR{0} -group MGR_CNTL -group TO_NOC -group TO_NOC_FIFO -radix hexadecimal  {{/top/system_inst/manager_array_inst/mgr_inst[{0}]/manager/mgr_cntl/to_noc_fifo[0]/pipe_type}}'.format(mgr)
    pLine = pLine + '\nadd wave -noupdate -group MGR{0} -group MGR_CNTL -group TO_NOC -group TO_NOC_FIFO -radix hexadecimal  {{/top/system_inst/manager_array_inst/mgr_inst[{0}]/manager/mgr_cntl/to_noc_fifo[0]/pipe_valid}}'.format(mgr)
    pLine = pLine + '\nadd wave -noupdate -group MGR{0} -group MGR_CNTL -group TO_NOC -group TO_NOC_FIFO -radix hexadecimal  {{/top/system_inst/manager_array_inst/mgr_inst[{0}]/manager/mgr_cntl/to_noc_fifo[0]/write}}'.format(mgr)
    pLine = pLine + '\nadd wave -noupdate -group MGR{0} -group MGR_CNTL -group TO_NOC -group TO_NOC_FIFO -radix hexadecimal  {{/top/system_inst/manager_array_inst/mgr_inst[{0}]/manager/mgr_cntl/to_noc_fifo[0]/write_cntl}}'.format(mgr)
    pLine = pLine + '\nadd wave -noupdate -group MGR{0} -group MGR_CNTL -group TO_NOC -group TO_NOC_FIFO -radix hexadecimal  {{/top/system_inst/manager_array_inst/mgr_inst[{0}]/manager/mgr_cntl/to_noc_fifo[0]/write_data}}'.format(mgr)
    pLine = pLine + '\nadd wave -noupdate -group MGR{0} -group MGR_CNTL -group TO_NOC -group TO_NOC_FIFO -radix hexadecimal  {{/top/system_inst/manager_array_inst/mgr_inst[{0}]/manager/mgr_cntl/to_noc_fifo[0]/write_desttype}}'.format(mgr)
    pLine = pLine + '\nadd wave -noupdate -group MGR{0} -group MGR_CNTL -group TO_NOC -group TO_NOC_FIFO -radix hexadecimal  {{/top/system_inst/manager_array_inst/mgr_inst[{0}]/manager/mgr_cntl/to_noc_fifo[0]/write_ptype}}'.format(mgr)
    pLine = pLine + '\nadd wave -noupdate -group MGR{0} -group MGR_CNTL -group TO_NOC -group TO_NOC_FIFO -radix hexadecimal  {{/top/system_inst/manager_array_inst/mgr_inst[{0}]/manager/mgr_cntl/to_noc_fifo[0]/write_pvalid}}'.format(mgr)
    pLine = pLine + '\nadd wave -noupdate -group MGR{0} -group MGR_CNTL -group TO_NOC -group TO_NOC_FIFO -radix hexadecimal  {{/top/system_inst/manager_array_inst/mgr_inst[{0}]/manager/mgr_cntl/to_noc_fifo[0]/write_type}}'.format(mgr)
    #
    pLine = pLine + '\nadd wave -noupdate -group MGR{0} -group MGR_CNTL -group FROM_WUD -radix hexadecimal  {{/top/system_inst/manager_array_inst/mgr_inst[{0}]/manager/mgr_cntl/wud__mcntl__valid}}'.format(mgr)
    pLine = pLine + '\nadd wave -noupdate -group MGR{0} -group MGR_CNTL -group FROM_WUD -radix hexadecimal  {{/top/system_inst/manager_array_inst/mgr_inst[{0}]/manager/mgr_cntl/wud__mcntl__dcntl}}'.format(mgr)
    pLine = pLine + '\nadd wave -noupdate -group MGR{0} -group MGR_CNTL -group FROM_WUD -radix hexadecimal  {{/top/system_inst/manager_array_inst/mgr_inst[{0}]/manager/mgr_cntl/wud__mcntl__option_type}}'.format(mgr)
    pLine = pLine + '\nadd wave -noupdate -group MGR{0} -group MGR_CNTL -group FROM_WUD -radix hexadecimal  {{/top/system_inst/manager_array_inst/mgr_inst[{0}]/manager/mgr_cntl/wud__mcntl__option_value}}'.format(mgr)
    pLine = pLine + '\nadd wave -noupdate -group MGR{0} -group MGR_CNTL -group FROM_WUD -radix hexadecimal  {{/top/system_inst/manager_array_inst/mgr_inst[{0}]/manager/mgr_cntl/wud__mcntl__tag}}'.format(mgr)
    pLine = pLine + '\nadd wave -noupdate -group MGR{0} -group MGR_CNTL -group FROM_WUD -radix hexadecimal  {{/top/system_inst/manager_array_inst/mgr_inst[{0}]/manager/mgr_cntl/mcntl__wud__ready}}'.format(mgr)
    #
    pLine = pLine + '\nadd wave -noupdate -group MGR{0} -group MGR_CNTL -group FROM_WUD -group FROM_WUD_FIFO -radix hexadecimal  {{/top/system_inst/manager_array_inst/mgr_inst[{0}]/manager/mgr_cntl/from_WuDecode_Fifo[0]/almost_full}}'.format(mgr)
    pLine = pLine + '\nadd wave -noupdate -group MGR{0} -group MGR_CNTL -group FROM_WUD -group FROM_WUD_FIFO -radix hexadecimal  {{/top/system_inst/manager_array_inst/mgr_inst[{0}]/manager/mgr_cntl/from_WuDecode_Fifo[0]/clear}}'.format(mgr)
    pLine = pLine + '\nadd wave -noupdate -group MGR{0} -group MGR_CNTL -group FROM_WUD -group FROM_WUD_FIFO -radix hexadecimal  {{/top/system_inst/manager_array_inst/mgr_inst[{0}]/manager/mgr_cntl/from_WuDecode_Fifo[0]/empty}}'.format(mgr)
    pLine = pLine + '\nadd wave -noupdate -group MGR{0} -group MGR_CNTL -group FROM_WUD -group FROM_WUD_FIFO -radix hexadecimal  {{/top/system_inst/manager_array_inst/mgr_inst[{0}]/manager/mgr_cntl/from_WuDecode_Fifo[0]/fifo_pipe_read}}'.format(mgr)
    pLine = pLine + '\nadd wave -noupdate -group MGR{0} -group MGR_CNTL -group FROM_WUD -group FROM_WUD_FIFO -radix hexadecimal  {{/top/system_inst/manager_array_inst/mgr_inst[{0}]/manager/mgr_cntl/from_WuDecode_Fifo[0]/fifo_pipe_valid}}'.format(mgr)
    pLine = pLine + '\nadd wave -noupdate -group MGR{0} -group MGR_CNTL -group FROM_WUD -group FROM_WUD_FIFO -radix hexadecimal  {{/top/system_inst/manager_array_inst/mgr_inst[{0}]/manager/mgr_cntl/from_WuDecode_Fifo[0]/gvi}}'.format(mgr)
    pLine = pLine + '\nadd wave -noupdate -group MGR{0} -group MGR_CNTL -group FROM_WUD -group FROM_WUD_FIFO -radix hexadecimal  {{/top/system_inst/manager_array_inst/mgr_inst[{0}]/manager/mgr_cntl/from_WuDecode_Fifo[0]/pipe_dcntl}}'.format(mgr)
    pLine = pLine + '\nadd wave -noupdate -group MGR{0} -group MGR_CNTL -group FROM_WUD -group FROM_WUD_FIFO -radix hexadecimal  {{/top/system_inst/manager_array_inst/mgr_inst[{0}]/manager/mgr_cntl/from_WuDecode_Fifo[0]/pipe_option_type}}'.format(mgr)
    pLine = pLine + '\nadd wave -noupdate -group MGR{0} -group MGR_CNTL -group FROM_WUD -group FROM_WUD_FIFO -radix hexadecimal  {{/top/system_inst/manager_array_inst/mgr_inst[{0}]/manager/mgr_cntl/from_WuDecode_Fifo[0]/pipe_option_value}}'.format(mgr)
    pLine = pLine + '\nadd wave -noupdate -group MGR{0} -group MGR_CNTL -group FROM_WUD -group FROM_WUD_FIFO -radix hexadecimal  {{/top/system_inst/manager_array_inst/mgr_inst[{0}]/manager/mgr_cntl/from_WuDecode_Fifo[0]/pipe_sod}}'.format(mgr)
    pLine = pLine + '\nadd wave -noupdate -group MGR{0} -group MGR_CNTL -group FROM_WUD -group FROM_WUD_FIFO -radix hexadecimal  {{/top/system_inst/manager_array_inst/mgr_inst[{0}]/manager/mgr_cntl/from_WuDecode_Fifo[0]/pipe_eod}}'.format(mgr)
    pLine = pLine + '\nadd wave -noupdate -group MGR{0} -group MGR_CNTL -group FROM_WUD -group FROM_WUD_FIFO -radix hexadecimal  {{/top/system_inst/manager_array_inst/mgr_inst[{0}]/manager/mgr_cntl/mode_reg_valid}}'.format(mgr)
    pLine = pLine + '\nadd wave -noupdate -group MGR{0} -group MGR_CNTL -group FROM_WUD -group FROM_WUD_FIFO -radix hexadecimal  {{/top/system_inst/manager_array_inst/mgr_inst[{0}]/manager/mgr_cntl/mode_reg_type}}'.format(mgr)
    pLine = pLine + '\nadd wave -noupdate -group MGR{0} -group MGR_CNTL -group FROM_WUD -group FROM_WUD_FIFO -radix hexadecimal  {{/top/system_inst/manager_array_inst/mgr_inst[{0}]/manager/mgr_cntl/mode_reg_id}}'.format(mgr)
    pLine = pLine + '\nadd wave -noupdate -group MGR{0} -group MGR_CNTL -group FROM_WUD -group FROM_WUD_FIFO -radix hexadecimal  {{/top/system_inst/manager_array_inst/mgr_inst[{0}]/manager/mgr_cntl/mode_reg_value}}'.format(mgr)
    pLine = pLine + '\nadd wave -noupdate -group MGR{0} -group MGR_CNTL -group FROM_WUD -group FROM_WUD_FIFO -radix hexadecimal  {{/top/system_inst/manager_array_inst/mgr_inst[{0}]/manager/mgr_cntl/pipe_option_extd_type}}'.format(mgr)
    pLine = pLine + '\nadd wave -noupdate -group MGR{0} -group MGR_CNTL -group FROM_WUD -group FROM_WUD_FIFO -radix hexadecimal  {{/top/system_inst/manager_array_inst/mgr_inst[{0}]/manager/mgr_cntl/pipe_option_extd_value}}'.format(mgr)
    pLine = pLine + '\nadd wave -noupdate -group MGR{0} -group MGR_CNTL -group FROM_WUD -group FROM_WUD_FIFO -radix hexadecimal  {{/top/system_inst/manager_array_inst/mgr_inst[{0}]/manager/mgr_cntl/pipe_option_extd_valid}}'.format(mgr)
    pLine = pLine + '\nadd wave -noupdate -group MGR{0} -group MGR_CNTL -group FROM_WUD -group FROM_WUD_FIFO -radix hexadecimal  {{/top/system_inst/manager_array_inst/mgr_inst[{0}]/manager/mgr_cntl/cfg_tag}}'.format(mgr)
    pLine = pLine + '\nadd wave -noupdate -group MGR{0} -group MGR_CNTL -group FROM_WUD -group FROM_WUD_FIFO -radix hexadecimal  {{/top/system_inst/manager_array_inst/mgr_inst[{0}]/manager/mgr_cntl/cfg_data_mode_reg_valid}}'.format(mgr)
    pLine = pLine + '\nadd wave -noupdate -group MGR{0} -group MGR_CNTL -group FROM_WUD -group FROM_WUD_FIFO -radix hexadecimal  {{/top/system_inst/manager_array_inst/mgr_inst[{0}]/manager/mgr_cntl/cfg_data_mode_reg_id}}'.format(mgr)
    pLine = pLine + '\nadd wave -noupdate -group MGR{0} -group MGR_CNTL -group FROM_WUD -group FROM_WUD_FIFO -radix hexadecimal  {{/top/system_inst/manager_array_inst/mgr_inst[{0}]/manager/mgr_cntl/cfg_data_mode_reg_value}}'.format(mgr)
    pLine = pLine + '\nadd wave -noupdate -group MGR{0} -group MGR_CNTL -group FROM_WUD -group FROM_WUD_FIFO -radix hexadecimal  {{/top/system_inst/manager_array_inst/mgr_inst[{0}]/manager/mgr_cntl/cfg_sync_mode_reg_valid}}'.format(mgr)
    pLine = pLine + '\nadd wave -noupdate -group MGR{0} -group MGR_CNTL -group FROM_WUD -group FROM_WUD_FIFO -radix hexadecimal  {{/top/system_inst/manager_array_inst/mgr_inst[{0}]/manager/mgr_cntl/cfg_sync_mode_reg_id}}'.format(mgr)
    pLine = pLine + '\nadd wave -noupdate -group MGR{0} -group MGR_CNTL -group FROM_WUD -group FROM_WUD_FIFO -radix hexadecimal  {{/top/system_inst/manager_array_inst/mgr_inst[{0}]/manager/mgr_cntl/cfg_sync_mode_reg_value}}'.format(mgr)
    pLine = pLine + '\nadd wave -noupdate -group MGR{0} -group MGR_CNTL -group FROM_WUD -group FROM_WUD_FIFO -radix hexadecimal  {{/top/system_inst/manager_array_inst/mgr_inst[{0}]/manager/mgr_cntl/cfg_storage_desc_ptr_valid}}'.format(mgr)
    pLine = pLine + '\nadd wave -noupdate -group MGR{0} -group MGR_CNTL -group FROM_WUD -group FROM_WUD_FIFO -radix hexadecimal  {{/top/system_inst/manager_array_inst/mgr_inst[{0}]/manager/mgr_cntl/cfg_storage_desc_ptr_type}}'.format(mgr)
    pLine = pLine + '\nadd wave -noupdate -group MGR{0} -group MGR_CNTL -group FROM_WUD -group FROM_WUD_FIFO -radix hexadecimal  {{/top/system_inst/manager_array_inst/mgr_inst[{0}]/manager/mgr_cntl/cfg_storage_desc_ptr_value}}'.format(mgr)
    pLine = pLine + '\nadd wave -noupdate -group MGR{0} -group MGR_CNTL -group FROM_WUD -group FROM_WUD_FIFO -radix hexadecimal  {{/top/system_inst/manager_array_inst/mgr_inst[{0}]/manager/mgr_cntl/from_WuDecode_Fifo[0]/pipe_read}}'.format(mgr)
    pLine = pLine + '\nadd wave -noupdate -group MGR{0} -group MGR_CNTL -group FROM_WUD -group FROM_WUD_FIFO -radix hexadecimal  {{/top/system_inst/manager_array_inst/mgr_inst[{0}]/manager/mgr_cntl/from_WuDecode_Fifo[0]/pipe_tag}}'.format(mgr)
    pLine = pLine + '\nadd wave -noupdate -group MGR{0} -group MGR_CNTL -group FROM_WUD -group FROM_WUD_FIFO -radix hexadecimal  {{/top/system_inst/manager_array_inst/mgr_inst[{0}]/manager/mgr_cntl/from_WuDecode_Fifo[0]/pipe_valid}}'.format(mgr)
    pLine = pLine + '\nadd wave -noupdate -group MGR{0} -group MGR_CNTL -group FROM_WUD -group FROM_WUD_FIFO -radix hexadecimal  {{/top/system_inst/manager_array_inst/mgr_inst[{0}]/manager/mgr_cntl/from_WuDecode_Fifo[0]/read}}'.format(mgr)
    pLine = pLine + '\nadd wave -noupdate -group MGR{0} -group MGR_CNTL -group FROM_WUD -group FROM_WUD_FIFO -radix hexadecimal  {{/top/system_inst/manager_array_inst/mgr_inst[{0}]/manager/mgr_cntl/from_WuDecode_Fifo[0]/read_dcntl}}'.format(mgr)
    pLine = pLine + '\nadd wave -noupdate -group MGR{0} -group MGR_CNTL -group FROM_WUD -group FROM_WUD_FIFO -radix hexadecimal  {{/top/system_inst/manager_array_inst/mgr_inst[{0}]/manager/mgr_cntl/from_WuDecode_Fifo[0]/read_option_type}}'.format(mgr)
    pLine = pLine + '\nadd wave -noupdate -group MGR{0} -group MGR_CNTL -group FROM_WUD -group FROM_WUD_FIFO -radix hexadecimal  {{/top/system_inst/manager_array_inst/mgr_inst[{0}]/manager/mgr_cntl/from_WuDecode_Fifo[0]/read_option_value}}'.format(mgr)
    pLine = pLine + '\nadd wave -noupdate -group MGR{0} -group MGR_CNTL -group FROM_WUD -group FROM_WUD_FIFO -radix hexadecimal  {{/top/system_inst/manager_array_inst/mgr_inst[{0}]/manager/mgr_cntl/from_WuDecode_Fifo[0]/read_tag}}'.format(mgr)
    pLine = pLine + '\nadd wave -noupdate -group MGR{0} -group MGR_CNTL -group FROM_WUD -group FROM_WUD_FIFO -radix hexadecimal  {{/top/system_inst/manager_array_inst/mgr_inst[{0}]/manager/mgr_cntl/from_WuDecode_Fifo[0]/write}}'.format(mgr)
    pLine = pLine + '\nadd wave -noupdate -group MGR{0} -group MGR_CNTL -group FROM_WUD -group FROM_WUD_FIFO -radix hexadecimal  {{/top/system_inst/manager_array_inst/mgr_inst[{0}]/manager/mgr_cntl/from_WuDecode_Fifo[0]/write_dcntl}}'.format(mgr)
    pLine = pLine + '\nadd wave -noupdate -group MGR{0} -group MGR_CNTL -group FROM_WUD -group FROM_WUD_FIFO -radix hexadecimal  {{/top/system_inst/manager_array_inst/mgr_inst[{0}]/manager/mgr_cntl/from_WuDecode_Fifo[0]/write_option_type}}'.format(mgr)
    pLine = pLine + '\nadd wave -noupdate -group MGR{0} -group MGR_CNTL -group FROM_WUD -group FROM_WUD_FIFO -radix hexadecimal  {{/top/system_inst/manager_array_inst/mgr_inst[{0}]/manager/mgr_cntl/from_WuDecode_Fifo[0]/write_option_value}}'.format(mgr)
    pLine = pLine + '\nadd wave -noupdate -group MGR{0} -group MGR_CNTL -group FROM_WUD -group FROM_WUD_FIFO -radix hexadecimal  {{/top/system_inst/manager_array_inst/mgr_inst[{0}]/manager/mgr_cntl/from_WuDecode_Fifo[0]/write_tag}}'.format(mgr)
    #
    pLine = pLine + '\nadd wave -noupdate -group MGR{0} -group MGR_CNTL -group TO_WUM -radix hexadecimal  {{/top/system_inst/manager_array_inst/mgr_inst[{0}]/manager/mgr_cntl/wum__mcntl__inst_count}}'.format(mgr)
    #
    pLine = pLine + '\nadd wave -noupdate -group MGR{0} -group MGR_CNTL -group TO_WUM -radix hexadecimal  {{/top/system_inst/manager_array_inst/mgr_inst[{0}]/manager/mgr_cntl/mcntl__wum__enable_inst_dnld}}'.format(mgr)
    pLine = pLine + '\nadd wave -noupdate -group MGR{0} -group MGR_CNTL -group TO_WUM -radix hexadecimal  {{/top/system_inst/manager_array_inst/mgr_inst[{0}]/manager/mgr_cntl/mcntl__wum__valid}}'.format(mgr)
    pLine = pLine + '\nadd wave -noupdate -group MGR{0} -group MGR_CNTL -group TO_WUM -radix hexadecimal  {{/top/system_inst/manager_array_inst/mgr_inst[{0}]/manager/mgr_cntl/mcntl__wum__address}}'.format(mgr)
    pLine = pLine + '\nadd wave -noupdate -group MGR{0} -group MGR_CNTL -group TO_WUM -radix hexadecimal  {{/top/system_inst/manager_array_inst/mgr_inst[{0}]/manager/mgr_cntl/wum__mcntl__ready}}'.format(mgr)
    pLine = pLine + '\nadd wave -noupdate -group MGR{0} -group MGR_CNTL -group TO_WUM -radix hexadecimal  {{/top/system_inst/manager_array_inst/mgr_inst[{0}]/manager/mgr_cntl/mcntl__wum__icntl}}'.format(mgr)
    pLine = pLine + '\nadd wave -noupdate -group MGR{0} -group MGR_CNTL -group TO_WUM -radix hexadecimal  {{/top/system_inst/manager_array_inst/mgr_inst[{0}]/manager/mgr_cntl/mcntl__wum__dcntl}}'.format(mgr)
    pLine = pLine + '\nadd wave -noupdate -group MGR{0} -group MGR_CNTL -group TO_WUM -radix hexadecimal  {{/top/system_inst/manager_array_inst/mgr_inst[{0}]/manager/mgr_cntl/mcntl__wum__op}}'.format(mgr)
    pLine = pLine + '\nadd wave -noupdate -group MGR{0} -group MGR_CNTL -group TO_WUM -radix hexadecimal  {{/top/system_inst/manager_array_inst/mgr_inst[{0}]/manager/mgr_cntl/mcntl__wum__option_type}}'.format(mgr)
    pLine = pLine + '\nadd wave -noupdate -group MGR{0} -group MGR_CNTL -group TO_WUM -radix hexadecimal  {{/top/system_inst/manager_array_inst/mgr_inst[{0}]/manager/mgr_cntl/mcntl__wum__option_value}}'.format(mgr)
    #
    pLine = pLine + '\nadd wave -noupdate -group MGR{0} -group MGR_CNTL -group TO_MWC -radix hexadecimal  {{/top/system_inst/manager_array_inst/mgr_inst[{0}]/manager/mgr_cntl/mcntl__mwc__valid}}'.format(mgr)
    pLine = pLine + '\nadd wave -noupdate -group MGR{0} -group MGR_CNTL -group TO_MWC -radix hexadecimal  {{/top/system_inst/manager_array_inst/mgr_inst[{0}]/manager/mgr_cntl/mcntl__mwc__cntl}}'.format(mgr)
    pLine = pLine + '\nadd wave -noupdate -group MGR{0} -group MGR_CNTL -group TO_MWC -radix hexadecimal  {{/top/system_inst/manager_array_inst/mgr_inst[{0}]/manager/mgr_cntl/mcntl__mwc__data}}'.format(mgr)
    pLine = pLine + '\nadd wave -noupdate -group MGR{0} -group MGR_CNTL -group TO_MWC -radix hexadecimal  {{/top/system_inst/manager_array_inst/mgr_inst[{0}]/manager/mgr_cntl/mcntl__mwc__flush}}'.format(mgr)
    pLine = pLine + '\nadd wave -noupdate -group MGR{0} -group MGR_CNTL -group TO_MWC -radix hexadecimal  {{/top/system_inst/manager_array_inst/mgr_inst[{0}]/manager/mgr_cntl/mcntl__mwc__mgrId}}'.format(mgr)
    pLine = pLine + '\nadd wave -noupdate -group MGR{0} -group MGR_CNTL -group TO_MWC -radix hexadecimal  {{/top/system_inst/manager_array_inst/mgr_inst[{0}]/manager/mgr_cntl/mcntl__mwc__ptype}}'.format(mgr)
    pLine = pLine + '\nadd wave -noupdate -group MGR{0} -group MGR_CNTL -group TO_MWC -radix hexadecimal  {{/top/system_inst/manager_array_inst/mgr_inst[{0}]/manager/mgr_cntl/mcntl__mwc__pvalid}}'.format(mgr)
    pLine = pLine + '\nadd wave -noupdate -group MGR{0} -group MGR_CNTL -group TO_MWC -radix hexadecimal  {{/top/system_inst/manager_array_inst/mgr_inst[{0}]/manager/mgr_cntl/mcntl__mwc__type}}'.format(mgr)
    pLine = pLine + '\nadd wave -noupdate -group MGR{0} -group MGR_CNTL -group TO_MWC -radix hexadecimal  {{/top/system_inst/manager_array_inst/mgr_inst[{0}]/manager/mgr_cntl/mwc__mcntl__ready}}'.format(mgr)
    #
    #
    #
    pLine = pLine + '\nadd wave -noupdate -group MGR{0} -group MGR_CNTL -group TO_WUF -radix hexadecimal  {{/top/system_inst/manager_array_inst/mgr_inst[{0}]/manager/mgr_cntl/mcntl__wuf__enable}}'.format(mgr)
    pLine = pLine + '\nadd wave -noupdate -group MGR{0} -group MGR_CNTL -group TO_WUF -radix hexadecimal  {{/top/system_inst/manager_array_inst/mgr_inst[{0}]/manager/mgr_cntl/mcntl__wuf__start_addr}}'.format(mgr)
    #
    pLine = pLine + '\nadd wave -noupdate -group MGR{0} -group MGR_CNTL -group TO_WUF -radix hexadecimal  {{/top/system_inst/manager_array_inst/mgr_inst[{0}]/manager/mgr_cntl/mcntl__wuf__stall}}'.format(mgr)
    #
    pLine = pLine + '\nadd wave -noupdate -group MGR{0} -group MGR_CNTL -group FROM_MRC -radix hexadecimal  {{/top/system_inst/manager_array_inst/mgr_inst[{0}]/manager/mgr_cntl/mrc__mcntl__lane_valid}}'.format(mgr)
    pLine = pLine + '\nadd wave -noupdate -group MGR{0} -group MGR_CNTL -group FROM_MRC -radix hexadecimal  {{/top/system_inst/manager_array_inst/mgr_inst[{0}]/manager/mgr_cntl/mrc__mcntl__lane_cntl}}'.format(mgr)
    pLine = pLine + '\nadd wave -noupdate -group MGR{0} -group MGR_CNTL -group FROM_MRC -radix hexadecimal  {{/top/system_inst/manager_array_inst/mgr_inst[{0}]/manager/mgr_cntl/mrc__mcntl__lane_data}}'.format(mgr)
    pLine = pLine + '\nadd wave -noupdate -group MGR{0} -group MGR_CNTL -group FROM_MRC -radix hexadecimal  {{/top/system_inst/manager_array_inst/mgr_inst[{0}]/manager/mgr_cntl/mcntl__mrc__lane_ready}}'.format(mgr)
    pLine = pLine + '\nadd wave -noupdate -group MGR{0} -group MGR_CNTL -group FROM_MRC -group FROM_MRC_FIFO -radix hexadecimal  {{/top/system_inst/manager_array_inst/mgr_inst[{0}]/manager/mgr_cntl/from_mrc_fifo[0]/write_cntl}}'.format(mgr)
    pLine = pLine + '\nadd wave -noupdate -group MGR{0} -group MGR_CNTL -group FROM_MRC -group FROM_MRC_FIFO -radix hexadecimal  {{/top/system_inst/manager_array_inst/mgr_inst[{0}]/manager/mgr_cntl/from_mrc_fifo[0]/write_data}}'.format(mgr)
    pLine = pLine + '\nadd wave -noupdate -group MGR{0} -group MGR_CNTL -group FROM_MRC -group FROM_MRC_FIFO -radix hexadecimal  {{/top/system_inst/manager_array_inst/mgr_inst[{0}]/manager/mgr_cntl/from_mrc_fifo[0]/write}}'.format(mgr)
    pLine = pLine + '\nadd wave -noupdate -group MGR{0} -group MGR_CNTL -group FROM_MRC -group FROM_MRC_FIFO -radix hexadecimal  {{/top/system_inst/manager_array_inst/mgr_inst[{0}]/manager/mgr_cntl/from_mrc_fifo[0]/almost_full}}'.format(mgr)
    pLine = pLine + '\nadd wave -noupdate -group MGR{0} -group MGR_CNTL -group FROM_MRC -group FROM_MRC_FIFO -radix hexadecimal  {{/top/system_inst/manager_array_inst/mgr_inst[{0}]/manager/mgr_cntl/from_mrc_fifo[0]/pipe_valid}}'.format(mgr)
    pLine = pLine + '\nadd wave -noupdate -group MGR{0} -group MGR_CNTL -group FROM_MRC -group FROM_MRC_FIFO -radix hexadecimal  {{/top/system_inst/manager_array_inst/mgr_inst[{0}]/manager/mgr_cntl/from_mrc_fifo[0]/pipe_read}}'.format(mgr)
    pLine = pLine + '\nadd wave -noupdate -group MGR{0} -group MGR_CNTL -group FROM_MRC -group FROM_MRC_FIFO -radix hexadecimal  {{/top/system_inst/manager_array_inst/mgr_inst[{0}]/manager/mgr_cntl/from_mrc_fifo[0]/pipe_cntl}}'.format(mgr)
    pLine = pLine + '\nadd wave -noupdate -group MGR{0} -group MGR_CNTL -group FROM_MRC -group FROM_MRC_FIFO -radix hexadecimal  {{/top/system_inst/manager_array_inst/mgr_inst[{0}]/manager/mgr_cntl/from_mrc_fifo[0]/pipe_data}}'.format(mgr)
    pLine = pLine + '\nadd wave -noupdate -group MGR{0} -group MGR_CNTL -group FROM_MRC -group FROM_MRC_FIFO -radix hexadecimal  {{/top/system_inst/manager_array_inst/mgr_inst[{0}]/manager/mgr_cntl/from_mrc_fifo[0]/pipe_som}}'.format(mgr)
    pLine = pLine + '\nadd wave -noupdate -group MGR{0} -group MGR_CNTL -group FROM_MRC -group FROM_MRC_FIFO -radix hexadecimal  {{/top/system_inst/manager_array_inst/mgr_inst[{0}]/manager/mgr_cntl/from_mrc_fifo[0]/pipe_mom}}'.format(mgr)
    pLine = pLine + '\nadd wave -noupdate -group MGR{0} -group MGR_CNTL -group FROM_MRC -group FROM_MRC_FIFO -radix hexadecimal  {{/top/system_inst/manager_array_inst/mgr_inst[{0}]/manager/mgr_cntl/from_mrc_fifo[0]/pipe_eom}}'.format(mgr)
    #
    pLine = pLine + '\nadd wave -noupdate -group MGR{0} -group MGR_CNTL -group FROM_RDP -radix hexadecimal  {{/top/system_inst/manager_array_inst/mgr_inst[{0}]/manager/mgr_cntl/rdp__mcntl__noc_valid}}'.format(mgr)
    pLine = pLine + '\nadd wave -noupdate -group MGR{0} -group MGR_CNTL -group FROM_RDP -radix hexadecimal  {{/top/system_inst/manager_array_inst/mgr_inst[{0}]/manager/mgr_cntl/rdp__mcntl__noc_cntl}}'.format(mgr)
    pLine = pLine + '\nadd wave -noupdate -group MGR{0} -group MGR_CNTL -group FROM_RDP -radix hexadecimal  {{/top/system_inst/manager_array_inst/mgr_inst[{0}]/manager/mgr_cntl/mcntl__rdp__noc_ready}}'.format(mgr)
    pLine = pLine + '\nadd wave -noupdate -group MGR{0} -group MGR_CNTL -group FROM_RDP -radix hexadecimal  {{/top/system_inst/manager_array_inst/mgr_inst[{0}]/manager/mgr_cntl/rdp__mcntl__noc_data}}'.format(mgr)
    pLine = pLine + '\nadd wave -noupdate -group MGR{0} -group MGR_CNTL -group FROM_RDP -radix hexadecimal  {{/top/system_inst/manager_array_inst/mgr_inst[{0}]/manager/mgr_cntl/rdp__mcntl__noc_desttype}}'.format(mgr)
    pLine = pLine + '\nadd wave -noupdate -group MGR{0} -group MGR_CNTL -group FROM_RDP -radix hexadecimal  {{/top/system_inst/manager_array_inst/mgr_inst[{0}]/manager/mgr_cntl/rdp__mcntl__noc_ptype}}'.format(mgr)
    pLine = pLine + '\nadd wave -noupdate -group MGR{0} -group MGR_CNTL -group FROM_RDP -radix hexadecimal  {{/top/system_inst/manager_array_inst/mgr_inst[{0}]/manager/mgr_cntl/rdp__mcntl__noc_pvalid}}'.format(mgr)
    pLine = pLine + '\nadd wave -noupdate -group MGR{0} -group MGR_CNTL -group FROM_RDP -radix hexadecimal  {{/top/system_inst/manager_array_inst/mgr_inst[{0}]/manager/mgr_cntl/rdp__mcntl__noc_type}}'.format(mgr)
    #
    pLine = pLine + '\nadd wave -noupdate -group MGR{0} -group MGR_CNTL -group FROM_RDP -group FROM_RDP_FIFO -radix hexadecimal  {{/top/system_inst/manager_array_inst/mgr_inst[{0}]/manager/mgr_cntl/from_rdp_fifo[0]/almost_full}}'.format(mgr)
    pLine = pLine + '\nadd wave -noupdate -group MGR{0} -group MGR_CNTL -group FROM_RDP -group FROM_RDP_FIFO -radix hexadecimal  {{/top/system_inst/manager_array_inst/mgr_inst[{0}]/manager/mgr_cntl/from_rdp_fifo[0]/pipe_cntl}}'.format(mgr)
    pLine = pLine + '\nadd wave -noupdate -group MGR{0} -group MGR_CNTL -group FROM_RDP -group FROM_RDP_FIFO -radix hexadecimal  {{/top/system_inst/manager_array_inst/mgr_inst[{0}]/manager/mgr_cntl/from_rdp_fifo[0]/pipe_data}}'.format(mgr)
    pLine = pLine + '\nadd wave -noupdate -group MGR{0} -group MGR_CNTL -group FROM_RDP -group FROM_RDP_FIFO -radix hexadecimal  {{/top/system_inst/manager_array_inst/mgr_inst[{0}]/manager/mgr_cntl/from_rdp_fifo[0]/pipe_desttype}}'.format(mgr)
    pLine = pLine + '\nadd wave -noupdate -group MGR{0} -group MGR_CNTL -group FROM_RDP -group FROM_RDP_FIFO -radix hexadecimal  {{/top/system_inst/manager_array_inst/mgr_inst[{0}]/manager/mgr_cntl/from_rdp_fifo[0]/pipe_ptype}}'.format(mgr)
    pLine = pLine + '\nadd wave -noupdate -group MGR{0} -group MGR_CNTL -group FROM_RDP -group FROM_RDP_FIFO -radix hexadecimal  {{/top/system_inst/manager_array_inst/mgr_inst[{0}]/manager/mgr_cntl/from_rdp_fifo[0]/pipe_pvalid}}'.format(mgr)
    pLine = pLine + '\nadd wave -noupdate -group MGR{0} -group MGR_CNTL -group FROM_RDP -group FROM_RDP_FIFO -radix hexadecimal  {{/top/system_inst/manager_array_inst/mgr_inst[{0}]/manager/mgr_cntl/from_rdp_fifo[0]/pipe_read}}'.format(mgr)
    pLine = pLine + '\nadd wave -noupdate -group MGR{0} -group MGR_CNTL -group FROM_RDP -group FROM_RDP_FIFO -radix hexadecimal  {{/top/system_inst/manager_array_inst/mgr_inst[{0}]/manager/mgr_cntl/from_rdp_fifo[0]/pipe_type}}'.format(mgr)
    pLine = pLine + '\nadd wave -noupdate -group MGR{0} -group MGR_CNTL -group FROM_RDP -group FROM_RDP_FIFO -radix hexadecimal  {{/top/system_inst/manager_array_inst/mgr_inst[{0}]/manager/mgr_cntl/from_rdp_fifo[0]/pipe_valid}}'.format(mgr)
    pLine = pLine + '\nadd wave -noupdate -group MGR{0} -group MGR_CNTL -group FROM_RDP -group FROM_RDP_FIFO -radix hexadecimal  {{/top/system_inst/manager_array_inst/mgr_inst[{0}]/manager/mgr_cntl/from_rdp_fifo[0]/write}}'.format(mgr)
    pLine = pLine + '\nadd wave -noupdate -group MGR{0} -group MGR_CNTL -group FROM_RDP -group FROM_RDP_FIFO -radix hexadecimal  {{/top/system_inst/manager_array_inst/mgr_inst[{0}]/manager/mgr_cntl/from_rdp_fifo[0]/write_cntl}}'.format(mgr)
    pLine = pLine + '\nadd wave -noupdate -group MGR{0} -group MGR_CNTL -group FROM_RDP -group FROM_RDP_FIFO -radix hexadecimal  {{/top/system_inst/manager_array_inst/mgr_inst[{0}]/manager/mgr_cntl/from_rdp_fifo[0]/write_data}}'.format(mgr)
    pLine = pLine + '\nadd wave -noupdate -group MGR{0} -group MGR_CNTL -group FROM_RDP -group FROM_RDP_FIFO -radix hexadecimal  {{/top/system_inst/manager_array_inst/mgr_inst[{0}]/manager/mgr_cntl/from_rdp_fifo[0]/write_desttype}}'.format(mgr)
    pLine = pLine + '\nadd wave -noupdate -group MGR{0} -group MGR_CNTL -group FROM_RDP -group FROM_RDP_FIFO -radix hexadecimal  {{/top/system_inst/manager_array_inst/mgr_inst[{0}]/manager/mgr_cntl/from_rdp_fifo[0]/write_ptype}}'.format(mgr)
    pLine = pLine + '\nadd wave -noupdate -group MGR{0} -group MGR_CNTL -group FROM_RDP -group FROM_RDP_FIFO -radix hexadecimal  {{/top/system_inst/manager_array_inst/mgr_inst[{0}]/manager/mgr_cntl/from_rdp_fifo[0]/write_pvalid}}'.format(mgr)
    pLine = pLine + '\nadd wave -noupdate -group MGR{0} -group MGR_CNTL -group FROM_RDP -group FROM_RDP_FIFO -radix hexadecimal  {{/top/system_inst/manager_array_inst/mgr_inst[{0}]/manager/mgr_cntl/from_rdp_fifo[0]/write_type}}'.format(mgr)
    #
    ...
    #
    pLine = pLine + '\nadd wave -noupdate -group MGR{0} -group MGR_CNTL -group INTF_REGS -radix hexadecimal  {{/top/system_inst/manager_array_inst/mgr_inst[{0}]/manager/mgr_cntl/mcntl__noc__cp_valid_e1}}'.format(mgr)
    pLine = pLine + '\nadd wave -noupdate -group MGR{0} -group MGR_CNTL -group INTF_REGS -radix hexadecimal  {{/top/system_inst/manager_array_inst/mgr_inst[{0}]/manager/mgr_cntl/mcntl__noc__cp_cntl_e1}}'.format(mgr)
    pLine = pLine + '\nadd wave -noupdate -group MGR{0} -group MGR_CNTL -group INTF_REGS -radix hexadecimal  {{/top/system_inst/manager_array_inst/mgr_inst[{0}]/manager/mgr_cntl/noc__mcntl__cp_ready_d1}}'.format(mgr)
    pLine = pLine + '\nadd wave -noupdate -group MGR{0} -group MGR_CNTL -group INTF_REGS -radix hexadecimal  {{/top/system_inst/manager_array_inst/mgr_inst[{0}]/manager/mgr_cntl/mcntl__noc__cp_data_e1}}'.format(mgr)
    pLine = pLine + '\nadd wave -noupdate -group MGR{0} -group MGR_CNTL -group INTF_REGS -radix hexadecimal  {{/top/system_inst/manager_array_inst/mgr_inst[{0}]/manager/mgr_cntl/mcntl__noc__cp_desttype_e1}}'.format(mgr)
    pLine = pLine + '\nadd wave -noupdate -group MGR{0} -group MGR_CNTL -group INTF_REGS -radix hexadecimal  {{/top/system_inst/manager_array_inst/mgr_inst[{0}]/manager/mgr_cntl/mcntl__noc__cp_ptype_e1}}'.format(mgr)
    pLine = pLine + '\nadd wave -noupdate -group MGR{0} -group MGR_CNTL -group INTF_REGS -radix hexadecimal  {{/top/system_inst/manager_array_inst/mgr_inst[{0}]/manager/mgr_cntl/mcntl__noc__cp_pvalid_e1}}'.format(mgr)
    pLine = pLine + '\nadd wave -noupdate -group MGR{0} -group MGR_CNTL -group INTF_REGS -radix hexadecimal  {{/top/system_inst/manager_array_inst/mgr_inst[{0}]/manager/mgr_cntl/mcntl__noc__cp_ready_e1}}'.format(mgr)
    pLine = pLine + '\nadd wave -noupdate -group MGR{0} -group MGR_CNTL -group INTF_REGS -radix hexadecimal  {{/top/system_inst/manager_array_inst/mgr_inst[{0}]/manager/mgr_cntl/mcntl__noc__cp_type_e1}}'.format(mgr)
    pLine = pLine + '\nadd wave -noupdate -group MGR{0} -group MGR_CNTL -group INTF_REGS -radix hexadecimal  {{/top/system_inst/manager_array_inst/mgr_inst[{0}]/manager/mgr_cntl/mcntl__noc__dp_valid_e1}}'.format(mgr)
    pLine = pLine + '\nadd wave -noupdate -group MGR{0} -group MGR_CNTL -group INTF_REGS -radix hexadecimal  {{/top/system_inst/manager_array_inst/mgr_inst[{0}]/manager/mgr_cntl/mcntl__noc__dp_cntl_e1}}'.format(mgr)
    pLine = pLine + '\nadd wave -noupdate -group MGR{0} -group MGR_CNTL -group INTF_REGS -radix hexadecimal  {{/top/system_inst/manager_array_inst/mgr_inst[{0}]/manager/mgr_cntl/noc__mcntl__dp_ready_d1}}'.format(mgr)
    pLine = pLine + '\nadd wave -noupdate -group MGR{0} -group MGR_CNTL -group INTF_REGS -radix hexadecimal  {{/top/system_inst/manager_array_inst/mgr_inst[{0}]/manager/mgr_cntl/mcntl__noc__dp_data_e1}}'.format(mgr)
    pLine = pLine + '\nadd wave -noupdate -group MGR{0} -group MGR_CNTL -group INTF_REGS -radix hexadecimal  {{/top/system_inst/manager_array_inst/mgr_inst[{0}]/manager/mgr_cntl/mcntl__noc__dp_desttype_e1}}'.format(mgr)
    pLine = pLine + '\nadd wave -noupdate -group MGR{0} -group MGR_CNTL -group INTF_REGS -radix hexadecimal  {{/top/system_inst/manager_array_inst/mgr_inst[{0}]/manager/mgr_cntl/mcntl__noc__dp_ptype_e1}}'.format(mgr)
    pLine = pLine + '\nadd wave -noupdate -group MGR{0} -group MGR_CNTL -group INTF_REGS -radix hexadecimal  {{/top/system_inst/manager_array_inst/mgr_inst[{0}]/manager/mgr_cntl/mcntl__noc__dp_pvalid_e1}}'.format(mgr)
    pLine = pLine + '\nadd wave -noupdate -group MGR{0} -group MGR_CNTL -group INTF_REGS -radix hexadecimal  {{/top/system_inst/manager_array_inst/mgr_inst[{0}]/manager/mgr_cntl/mcntl__noc__dp_type_e1}}'.format(mgr)
    #
    pLine = pLine + '\nadd wave -noupdate -group MGR{0} -group MGR_CNTL -group INTF_REGS -radix hexadecimal  {{/top/system_inst/manager_array_inst/mgr_inst[{0}]/manager/mgr_cntl/mcntl__rdp__noc_ready_p1}}'.format(mgr)
    pLine = pLine + '\nadd wave -noupdate -group MGR{0} -group MGR_CNTL -group INTF_REGS -radix hexadecimal  {{/top/system_inst/manager_array_inst/mgr_inst[{0}]/manager/mgr_cntl/rdp__mcntl__noc_cntl_d1}}'.format(mgr)
    pLine = pLine + '\nadd wave -noupdate -group MGR{0} -group MGR_CNTL -group INTF_REGS -radix hexadecimal  {{/top/system_inst/manager_array_inst/mgr_inst[{0}]/manager/mgr_cntl/rdp__mcntl__noc_data_d1}}'.format(mgr)
    pLine = pLine + '\nadd wave -noupdate -group MGR{0} -group MGR_CNTL -group INTF_REGS -radix hexadecimal  {{/top/system_inst/manager_array_inst/mgr_inst[{0}]/manager/mgr_cntl/rdp__mcntl__noc_desttype_d1}}'.format(mgr)
    pLine = pLine + '\nadd wave -noupdate -group MGR{0} -group MGR_CNTL -group INTF_REGS -radix hexadecimal  {{/top/system_inst/manager_array_inst/mgr_inst[{0}]/manager/mgr_cntl/rdp__mcntl__noc_ptype_d1}}'.format(mgr)
    pLine = pLine + '\nadd wave -noupdate -group MGR{0} -group MGR_CNTL -group INTF_REGS -radix hexadecimal  {{/top/system_inst/manager_array_inst/mgr_inst[{0}]/manager/mgr_cntl/rdp__mcntl__noc_pvalid_d1}}'.format(mgr)
    pLine = pLine + '\nadd wave -noupdate -group MGR{0} -group MGR_CNTL -group INTF_REGS -radix hexadecimal  {{/top/system_inst/manager_array_inst/mgr_inst[{0}]/manager/mgr_cntl/rdp__mcntl__noc_type_d1}}'.format(mgr)
    pLine = pLine + '\nadd wave -noupdate -group MGR{0} -group MGR_CNTL -group INTF_REGS -radix hexadecimal  {{/top/system_inst/manager_array_inst/mgr_inst[{0}]/manager/mgr_cntl/rdp__mcntl__noc_valid_d1}}'.format(mgr)
    #
    ...
    #
    pLine = pLine + '\nadd wave -noupdate -group MGR{0} -group MGR_CNTL -group INTF_REGS -radix hexadecimal  {{/top/system_inst/manager_array_inst/mgr_inst[{0}]/manager/mgr_cntl/mrc__mcntl__lane_valid_d1}}'.format(mgr)
    pLine = pLine + '\nadd wave -noupdate -group MGR{0} -group MGR_CNTL -group INTF_REGS -radix hexadecimal  {{/top/system_inst/manager_array_inst/mgr_inst[{0}]/manager/mgr_cntl/mrc__mcntl__lane_cntl_d1}}'.format(mgr)
    pLine = pLine + '\nadd wave -noupdate -group MGR{0} -group MGR_CNTL -group INTF_REGS -radix hexadecimal  {{/top/system_inst/manager_array_inst/mgr_inst[{0}]/manager/mgr_cntl/mrc__mcntl__lane_data_d1}}'.format(mgr)
    pLine = pLine + '\nadd wave -noupdate -group MGR{0} -group MGR_CNTL -group INTF_REGS -radix hexadecimal  {{/top/system_inst/manager_array_inst/mgr_inst[{0}]/manager/mgr_cntl/mcntl__mrc__lane_ready_e1}}'.format(mgr)
    #
