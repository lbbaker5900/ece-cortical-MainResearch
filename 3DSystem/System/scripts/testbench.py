...
if __name__ == "__main__":
  ...
  for mgr in range (0, numOfMgr):
    for port in range (0, numOfPorts):
      pLine = pLine + '\nadd wave -noupdate -group MGR{0} -group NOC -group TO_NOC -radix hexadecimal  {{/top/system_inst/manager_array_inst/mgr_inst[{0}]/mgr__noc__port{1}_cntl}}'.format(mgr,port)
      pLine = pLine + '\nadd wave -noupdate -group MGR{0} -group NOC -group TO_NOC -radix hexadecimal  {{/top/system_inst/manager_array_inst/mgr_inst[{0}]/mgr__noc__port{1}_data}}'.format(mgr,port)
      pLine = pLine + '\nadd wave -noupdate -group MGR{0} -group NOC -group TO_NOC -radix hexadecimal  {{/top/system_inst/manager_array_inst/mgr_inst[{0}]/mgr__noc__port{1}_fc}}'.format(mgr,port)
      pLine = pLine + '\nadd wave -noupdate -group MGR{0} -group NOC -group TO_NOC -radix hexadecimal  {{/top/system_inst/manager_array_inst/mgr_inst[{0}]/mgr__noc__port{1}_valid}}'.format(mgr,port)
 
      pLine = pLine + '\nadd wave -noupdate -group MGR{0} -group NOC -group FROM_NOC -radix hexadecimal  {{/top/system_inst/manager_array_inst/mgr_inst[{0}]/noc__mgr__port{1}_cntl}}'.format(mgr,port)
      pLine = pLine + '\nadd wave -noupdate -group MGR{0} -group NOC -group FROM_NOC -radix hexadecimal  {{/top/system_inst/manager_array_inst/mgr_inst[{0}]/noc__mgr__port{1}_data}}'.format(mgr,port)
      pLine = pLine + '\nadd wave -noupdate -group MGR{0} -group NOC -group FROM_NOC -radix hexadecimal  {{/top/system_inst/manager_array_inst/mgr_inst[{0}]/noc__mgr__port{1}_fc}}'.format(mgr,port)
      pLine = pLine + '\nadd wave -noupdate -group MGR{0} -group NOC -group FROM_NOC -radix hexadecimal  {{/top/system_inst/manager_array_inst/mgr_inst[{0}]/noc__mgr__port{1}_valid}}'.format(mgr,port)
