...
if __name__ == "__main__":
  ...
  for mgr in range (0, numOfMgr):
    ...
    #
    pLine = pLine + '\nadd wave -noupdate -group MGR{0} -group MGR_CNTL -group FROM_RDP_FIFO -radix hexadecimal  {{/top/system_inst/manager_array_inst/mgr_inst[{0}]/manager/mgr_cntl/from_rdp_fifo[0]/almost_full}}'.format(mgr)
    pLine = pLine + '\nadd wave -noupdate -group MGR{0} -group MGR_CNTL -group FROM_RDP_FIFO -radix hexadecimal  {{/top/system_inst/manager_array_inst/mgr_inst[{0}]/manager/mgr_cntl/from_rdp_fifo[0]/pipe_cntl}}'.format(mgr)
    pLine = pLine + '\nadd wave -noupdate -group MGR{0} -group MGR_CNTL -group FROM_RDP_FIFO -radix hexadecimal  {{/top/system_inst/manager_array_inst/mgr_inst[{0}]/manager/mgr_cntl/from_rdp_fifo[0]/pipe_data}}'.format(mgr)
    pLine = pLine + '\nadd wave -noupdate -group MGR{0} -group MGR_CNTL -group FROM_RDP_FIFO -radix hexadecimal  {{/top/system_inst/manager_array_inst/mgr_inst[{0}]/manager/mgr_cntl/from_rdp_fifo[0]/pipe_desttype}}'.format(mgr)
    pLine = pLine + '\nadd wave -noupdate -group MGR{0} -group MGR_CNTL -group FROM_RDP_FIFO -radix hexadecimal  {{/top/system_inst/manager_array_inst/mgr_inst[{0}]/manager/mgr_cntl/from_rdp_fifo[0]/pipe_ptype}}'.format(mgr)
    pLine = pLine + '\nadd wave -noupdate -group MGR{0} -group MGR_CNTL -group FROM_RDP_FIFO -radix hexadecimal  {{/top/system_inst/manager_array_inst/mgr_inst[{0}]/manager/mgr_cntl/from_rdp_fifo[0]/pipe_pvalid}}'.format(mgr)
    pLine = pLine + '\nadd wave -noupdate -group MGR{0} -group MGR_CNTL -group FROM_RDP_FIFO -radix hexadecimal  {{/top/system_inst/manager_array_inst/mgr_inst[{0}]/manager/mgr_cntl/from_rdp_fifo[0]/pipe_read}}'.format(mgr)
    pLine = pLine + '\nadd wave -noupdate -group MGR{0} -group MGR_CNTL -group FROM_RDP_FIFO -radix hexadecimal  {{/top/system_inst/manager_array_inst/mgr_inst[{0}]/manager/mgr_cntl/from_rdp_fifo[0]/pipe_type}}'.format(mgr)
    pLine = pLine + '\nadd wave -noupdate -group MGR{0} -group MGR_CNTL -group FROM_RDP_FIFO -radix hexadecimal  {{/top/system_inst/manager_array_inst/mgr_inst[{0}]/manager/mgr_cntl/from_rdp_fifo[0]/pipe_valid}}'.format(mgr)
    pLine = pLine + '\nadd wave -noupdate -group MGR{0} -group MGR_CNTL -group FROM_RDP_FIFO -radix hexadecimal  {{/top/system_inst/manager_array_inst/mgr_inst[{0}]/manager/mgr_cntl/from_rdp_fifo[0]/write}}'.format(mgr)
    pLine = pLine + '\nadd wave -noupdate -group MGR{0} -group MGR_CNTL -group FROM_RDP_FIFO -radix hexadecimal  {{/top/system_inst/manager_array_inst/mgr_inst[{0}]/manager/mgr_cntl/from_rdp_fifo[0]/write_cntl}}'.format(mgr)
    pLine = pLine + '\nadd wave -noupdate -group MGR{0} -group MGR_CNTL -group FROM_RDP_FIFO -radix hexadecimal  {{/top/system_inst/manager_array_inst/mgr_inst[{0}]/manager/mgr_cntl/from_rdp_fifo[0]/write_data}}'.format(mgr)
    pLine = pLine + '\nadd wave -noupdate -group MGR{0} -group MGR_CNTL -group FROM_RDP_FIFO -radix hexadecimal  {{/top/system_inst/manager_array_inst/mgr_inst[{0}]/manager/mgr_cntl/from_rdp_fifo[0]/write_desttype}}'.format(mgr)
    pLine = pLine + '\nadd wave -noupdate -group MGR{0} -group MGR_CNTL -group FROM_RDP_FIFO -radix hexadecimal  {{/top/system_inst/manager_array_inst/mgr_inst[{0}]/manager/mgr_cntl/from_rdp_fifo[0]/write_ptype}}'.format(mgr)
    pLine = pLine + '\nadd wave -noupdate -group MGR{0} -group MGR_CNTL -group FROM_RDP_FIFO -radix hexadecimal  {{/top/system_inst/manager_array_inst/mgr_inst[{0}]/manager/mgr_cntl/from_rdp_fifo[0]/write_pvalid}}'.format(mgr)
    pLine = pLine + '\nadd wave -noupdate -group MGR{0} -group MGR_CNTL -group FROM_RDP_FIFO -radix hexadecimal  {{/top/system_inst/manager_array_inst/mgr_inst[{0}]/manager/mgr_cntl/from_rdp_fifo[0]/write_type}}'.format(mgr)
    #
    pLine = pLine + '\nadd wave -noupdate -group MGR{0} -group MGR_CNTL -group TO_NOC_FIFO -radix hexadecimal  {{/top/system_inst/manager_array_inst/mgr_inst[{0}]/manager/mgr_cntl/to_noc_fifo[0]/almost_full}}'.format(mgr)
    pLine = pLine + '\nadd wave -noupdate -group MGR{0} -group MGR_CNTL -group TO_NOC_FIFO -radix hexadecimal  {{/top/system_inst/manager_array_inst/mgr_inst[{0}]/manager/mgr_cntl/to_noc_fifo[0]/pipe_cntl}}'.format(mgr)
    pLine = pLine + '\nadd wave -noupdate -group MGR{0} -group MGR_CNTL -group TO_NOC_FIFO -radix hexadecimal  {{/top/system_inst/manager_array_inst/mgr_inst[{0}]/manager/mgr_cntl/to_noc_fifo[0]/pipe_data}}'.format(mgr)
    pLine = pLine + '\nadd wave -noupdate -group MGR{0} -group MGR_CNTL -group TO_NOC_FIFO -radix hexadecimal  {{/top/system_inst/manager_array_inst/mgr_inst[{0}]/manager/mgr_cntl/to_noc_fifo[0]/pipe_desttype}}'.format(mgr)
    pLine = pLine + '\nadd wave -noupdate -group MGR{0} -group MGR_CNTL -group TO_NOC_FIFO -radix hexadecimal  {{/top/system_inst/manager_array_inst/mgr_inst[{0}]/manager/mgr_cntl/to_noc_fifo[0]/pipe_ptype}}'.format(mgr)
    pLine = pLine + '\nadd wave -noupdate -group MGR{0} -group MGR_CNTL -group TO_NOC_FIFO -radix hexadecimal  {{/top/system_inst/manager_array_inst/mgr_inst[{0}]/manager/mgr_cntl/to_noc_fifo[0]/pipe_pvalid}}'.format(mgr)
    pLine = pLine + '\nadd wave -noupdate -group MGR{0} -group MGR_CNTL -group TO_NOC_FIFO -radix hexadecimal  {{/top/system_inst/manager_array_inst/mgr_inst[{0}]/manager/mgr_cntl/to_noc_fifo[0]/pipe_read}}'.format(mgr)
    pLine = pLine + '\nadd wave -noupdate -group MGR{0} -group MGR_CNTL -group TO_NOC_FIFO -radix hexadecimal  {{/top/system_inst/manager_array_inst/mgr_inst[{0}]/manager/mgr_cntl/to_noc_fifo[0]/pipe_type}}'.format(mgr)
    pLine = pLine + '\nadd wave -noupdate -group MGR{0} -group MGR_CNTL -group TO_NOC_FIFO -radix hexadecimal  {{/top/system_inst/manager_array_inst/mgr_inst[{0}]/manager/mgr_cntl/to_noc_fifo[0]/pipe_valid}}'.format(mgr)
    pLine = pLine + '\nadd wave -noupdate -group MGR{0} -group MGR_CNTL -group TO_NOC_FIFO -radix hexadecimal  {{/top/system_inst/manager_array_inst/mgr_inst[{0}]/manager/mgr_cntl/to_noc_fifo[0]/write}}'.format(mgr)
    pLine = pLine + '\nadd wave -noupdate -group MGR{0} -group MGR_CNTL -group TO_NOC_FIFO -radix hexadecimal  {{/top/system_inst/manager_array_inst/mgr_inst[{0}]/manager/mgr_cntl/to_noc_fifo[0]/write_cntl}}'.format(mgr)
    pLine = pLine + '\nadd wave -noupdate -group MGR{0} -group MGR_CNTL -group TO_NOC_FIFO -radix hexadecimal  {{/top/system_inst/manager_array_inst/mgr_inst[{0}]/manager/mgr_cntl/to_noc_fifo[0]/write_data}}'.format(mgr)
    pLine = pLine + '\nadd wave -noupdate -group MGR{0} -group MGR_CNTL -group TO_NOC_FIFO -radix hexadecimal  {{/top/system_inst/manager_array_inst/mgr_inst[{0}]/manager/mgr_cntl/to_noc_fifo[0]/write_desttype}}'.format(mgr)
    pLine = pLine + '\nadd wave -noupdate -group MGR{0} -group MGR_CNTL -group TO_NOC_FIFO -radix hexadecimal  {{/top/system_inst/manager_array_inst/mgr_inst[{0}]/manager/mgr_cntl/to_noc_fifo[0]/write_ptype}}'.format(mgr)
    pLine = pLine + '\nadd wave -noupdate -group MGR{0} -group MGR_CNTL -group TO_NOC_FIFO -radix hexadecimal  {{/top/system_inst/manager_array_inst/mgr_inst[{0}]/manager/mgr_cntl/to_noc_fifo[0]/write_pvalid}}'.format(mgr)
    pLine = pLine + '\nadd wave -noupdate -group MGR{0} -group MGR_CNTL -group TO_NOC_FIFO -radix hexadecimal  {{/top/system_inst/manager_array_inst/mgr_inst[{0}]/manager/mgr_cntl/to_noc_fifo[0]/write_type}}'.format(mgr)
    #
