...
if __name__ == "__main__":
  ...
  for mgr in range (0, numOfMgr):
    ...
    pLine = pLine + '\nadd wave -noupdate -group MGR{0} -group WU_DECODE -group FROM_WUM -group FROM_WUM_FIFO -radix hexadecimal {{/top/system_inst/manager_array_inst/mgr_inst[{0}]/manager/wu_decode/mode_reg_valid_e1}}'.format(mgr)
    pLine = pLine + '\nadd wave -noupdate -group MGR{0} -group WU_DECODE -group FROM_WUM -group FROM_WUM_FIFO -radix hexadecimal {{/top/system_inst/manager_array_inst/mgr_inst[{0}]/manager/wu_decode/mode_reg_id_e1}}'.format(mgr)
    pLine = pLine + '\nadd wave -noupdate -group MGR{0} -group WU_DECODE -group FROM_WUM -group FROM_WUM_FIFO -radix hexadecimal {{/top/system_inst/manager_array_inst/mgr_inst[{0}]/manager/wu_decode/mode_reg_value_e1}}'.format(mgr)
    #                                                              
    ...
    pLine = pLine + '\nadd wave -noupdate -group MGR{0} -group WU_DECODE -group GEN -radix hexadecimal {{/top/system_inst/manager_array_inst/mgr_inst[{0}]/manager/wu_decode/mode_reg_valid_e1}}'.format(mgr)
    pLine = pLine + '\nadd wave -noupdate -group MGR{0} -group WU_DECODE -group GEN -radix hexadecimal {{/top/system_inst/manager_array_inst/mgr_inst[{0}]/manager/wu_decode/mode_reg_id_e1}}'.format(mgr)
    pLine = pLine + '\nadd wave -noupdate -group MGR{0} -group WU_DECODE -group GEN -radix hexadecimal {{/top/system_inst/manager_array_inst/mgr_inst[{0}]/manager/wu_decode/mode_reg_value_e1}}'.format(mgr)
  ...
  for mgr in range (0, numOfMgr):
    ...
    pLine = pLine + '\nadd wave -noupdate -group MGR{0} -group NOC -group LOCAL_TO_NOC -radix hexadecimal  {{/top/system_inst/manager_array_inst/mgr_inst[{0}]/manager/mgr_noc_cntl/locl__noc__dp_valid}}'.format(mgr,port)
    pLine = pLine + '\nadd wave -noupdate -group MGR{0} -group NOC -group LOCAL_TO_NOC -radix hexadecimal  {{/top/system_inst/manager_array_inst/mgr_inst[{0}]/manager/mgr_noc_cntl/locl__noc__dp_cntl}}'.format(mgr,port)
    pLine = pLine + '\nadd wave -noupdate -group MGR{0} -group NOC -group LOCAL_TO_NOC -radix hexadecimal  {{/top/system_inst/manager_array_inst/mgr_inst[{0}]/manager/mgr_noc_cntl/locl__noc__dp_type}}'.format(mgr,port)
    pLine = pLine + '\nadd wave -noupdate -group MGR{0} -group NOC -group LOCAL_TO_NOC -radix hexadecimal  {{/top/system_inst/manager_array_inst/mgr_inst[{0}]/manager/mgr_noc_cntl/locl__noc__dp_ptype}}'.format(mgr,port)
    pLine = pLine + '\nadd wave -noupdate -group MGR{0} -group NOC -group LOCAL_TO_NOC -radix hexadecimal  {{/top/system_inst/manager_array_inst/mgr_inst[{0}]/manager/mgr_noc_cntl/locl__noc__dp_desttype}}'.format(mgr,port)
    pLine = pLine + '\nadd wave -noupdate -group MGR{0} -group NOC -group LOCAL_TO_NOC -radix hexadecimal  {{/top/system_inst/manager_array_inst/mgr_inst[{0}]/manager/mgr_noc_cntl/locl__noc__dp_pvalid}}'.format(mgr,port)
    pLine = pLine + '\nadd wave -noupdate -group MGR{0} -group NOC -group LOCAL_TO_NOC -radix hexadecimal  {{/top/system_inst/manager_array_inst/mgr_inst[{0}]/manager/mgr_noc_cntl/locl__noc__dp_data}}'.format(mgr,port)
    pLine = pLine + '\nadd wave -noupdate -group MGR{0} -group NOC -group LOCAL_TO_NOC -radix hexadecimal  {{/top/system_inst/manager_array_inst/mgr_inst[{0}]/manager/mgr_noc_cntl/noc__locl__dp_ready}}'.format(mgr,port)
    
    pLine = pLine + '\nadd wave -noupdate -group MGR{0} -group NOC -group LOCAL_FROM_NOC -radix hexadecimal  {{/top/system_inst/manager_array_inst/mgr_inst[{0}]/manager/mgr_noc_cntl/noc__locl__dp_valid}}'.format(mgr,port)
    pLine = pLine + '\nadd wave -noupdate -group MGR{0} -group NOC -group LOCAL_FROM_NOC -radix hexadecimal  {{/top/system_inst/manager_array_inst/mgr_inst[{0}]/manager/mgr_noc_cntl/noc__locl__dp_cntl}}'.format(mgr,port)
    pLine = pLine + '\nadd wave -noupdate -group MGR{0} -group NOC -group LOCAL_FROM_NOC -radix hexadecimal  {{/top/system_inst/manager_array_inst/mgr_inst[{0}]/manager/mgr_noc_cntl/noc__locl__dp_mgrId}}'.format(mgr,port)
    pLine = pLine + '\nadd wave -noupdate -group MGR{0} -group NOC -group LOCAL_FROM_NOC -radix hexadecimal  {{/top/system_inst/manager_array_inst/mgr_inst[{0}]/manager/mgr_noc_cntl/noc__locl__dp_type}}'.format(mgr,port)
    pLine = pLine + '\nadd wave -noupdate -group MGR{0} -group NOC -group LOCAL_FROM_NOC -radix hexadecimal  {{/top/system_inst/manager_array_inst/mgr_inst[{0}]/manager/mgr_noc_cntl/noc__locl__dp_ptype}}'.format(mgr,port)
    pLine = pLine + '\nadd wave -noupdate -group MGR{0} -group NOC -group LOCAL_FROM_NOC -radix hexadecimal  {{/top/system_inst/manager_array_inst/mgr_inst[{0}]/manager/mgr_noc_cntl/noc__locl__dp_pvalid}}'.format(mgr,port)
    pLine = pLine + '\nadd wave -noupdate -group MGR{0} -group NOC -group LOCAL_FROM_NOC -radix hexadecimal  {{/top/system_inst/manager_array_inst/mgr_inst[{0}]/manager/mgr_noc_cntl/noc__locl__dp_data}}'.format(mgr,port)
    pLine = pLine + '\nadd wave -noupdate -group MGR{0} -group NOC -group LOCAL_FROM_NOC -radix hexadecimal  {{/top/system_inst/manager_array_inst/mgr_inst[{0}]/manager/mgr_noc_cntl/locl__noc__dp_ready}}'.format(mgr,port)
  ...
  for mgr in range (0, numOfMgr):
    ...
    pLine = pLine + '\nadd wave -noupdate -group MGR{0} -group MGR_CNTL -group FSM_MAIN -radix hexadecimal  {{/top/system_inst/manager_array_inst/mgr_inst[{0}]/manager/mgr_cntl/upld_noc_data_cycle_count}}'.format(mgr)
    ...
    pLine = pLine + '\nadd wave -noupdate -group MGR{0} -group MGR_CNTL -group FSM_MAIN -radix hexadecimal  {{/top/system_inst/manager_array_inst/mgr_inst[{0}]/manager/mgr_cntl/upld_noc_data_mtu_cycle}}'.format(mgr)
