...
This work assumes any useful \ac{ann} will be of a similar size to \cite{krizhevsky2012imagenet}.
...
\begin{figure}
\centering
\includegraphics[width=0.4\textwidth]{SmallStackDiagram.jpg}
...
\end{outline}
% ----------------------------------------------------------------------------------------------------
A detailed block diagram of the SSCcan be seen in Figure \ref{fig:DetailedFlowDiagram}.
...
Timing closure was at a frequency of \SI{500}{\mega\hertz} and a place and route for the Manager and PE are shown in Figure \ref{fig:Manager and PE Die layouts}. 
The parasitics were extracted from these layouts and simulated against a group of operation based on the expected lower and upper limits of pre-synaptic fanin. 
