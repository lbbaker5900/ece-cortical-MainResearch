    ...
    \begin{adjustbox}{width=0.7\textwidth}
      \begin{tabular}{cc}
        \toprule
                            % \multicolumn{4}{c}{3D-DRAM Simulation-based estimates}   \\
                                                      &                                          \\  %\cline{1-1}
                                                      & Downstream Stack                         \\  %\cline{1-1}
                   Test \cite{krizhevsky2012imagenet} & Bus Efficiency                           \\  %\cline{1-1}
        \hline  % instead of \midrule %midrule doesnt overlap with column lines
                   CONV2                              &\SI[per-mode=symbol]{\sim 70}{\percent}   \\ %\cline{2-2}
                   FC-7                               &\SI[per-mode=symbol]{\sim 94}{\percent}   \\ %\cline{2-2}
        \bottomrule
      \end{tabular}
    \end{adjustbox}
    \vspace{3pt}
