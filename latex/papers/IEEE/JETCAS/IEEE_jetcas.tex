    ...
    \begin{adjustbox}{width=0.7\textwidth}
      \begin{tabular}{cccc}
        \toprule
                         ...
                         &                       &          &                                       \\  %\cline{1-1}
                         &                       & Expected &                                       \\  %\cline{1-1}
                   Tech  & Freq                  &  Power   &  Test \cite{krizhevsky2012imagenet}   \\  %\cline{1-1}
        \hline  % instead of \midrule %midrule doesnt overlap with column lines
                   28    & \SI{500}{\mega\hertz} &   53W    &  CONV2                                \\ %\cline{2-2}
                   28    & \SI{700}{\mega\hertz} &   73W    &  CONV2                                \\ %\cline{2-2}
        \bottomrule
      \end{tabular}
    \end{adjustbox}
    \vspace{3pt}
  ...
  \begin{subtable}{0.5\textwidth}
    ...
    \begin{adjustbox}{width=0.9\textwidth}
      \begin{tabular}{cccc}
        \toprule
                            % \multicolumn{4}{c}{3D-DRAM Simulation-based estimates}   \\
                                                      & Downstream                              &                                                           &                                                        \\  %\cline{1-1}
                                                      & Stack                                   &                                        \multicolumn{2}{c}{At Frequency}                                            \\  %\cline{1-1}
                   Test \cite{krizhevsky2012imagenet} & Bus Efficiency                          &       \SI{500}{\mega\hertz}                               & \SI{700}{\mega\hertz}                                  \\  %\cline{1-1}
        \hline  % instead of \midrule %midrule doesnt overlap with column lines                                       
                   CONV2                              &\SI[per-mode=symbol]{\sim 70}{\percent}  & \SI[per-mode=symbol]{\approx 46}{\tera\bit\per\second}    & \SI[per-mode=symbol]{\approx 64}{\tera\bit\per\second} \\ %\cline{2-2}
                   FC-7                               &\SI[per-mode=symbol]{\sim 94}{\percent}  & \SI[per-mode=symbol]{\approx 62}{\tera\bit\per\second}    & \SI[per-mode=symbol]{\approx 86}{\tera\bit\per\second} \\ %\cline{2-2}
        \bottomrule
      \end{tabular}
    \end{adjustbox}
    \vspace{3pt}
