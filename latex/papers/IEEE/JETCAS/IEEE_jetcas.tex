...
were extracted from these layouts and simulated against a group of operations.
The primetime-PX power and bandwidth estimates for \SI{500}{\mega\hertz} and \SI{700}{\mega\hertz} are shown in table \ref{tab:Simulation-based estimates}.
...
%  \begin{center}
    ...
    \begin{tabular}{ccccc}
          ...
          \hline  % instead of \midrule %midrule doesnt overlap with column lines
                   28    & \SI{500}{\mega\hertz} &       \SI[per-mode=symbol]{\sim 46}{\tera\bit\per\second}   &  53W   &  \\ %\cline{2-2}
                   28    & \SI{700}{\mega\hertz} &       \SI[per-mode=symbol]{\sim 64}{\tera\bit\per\second}   &  73W   &  \\ %\cline{2-2}
          \bottomrule
    \end{tabular}
%  \end{center}
\end{table}
