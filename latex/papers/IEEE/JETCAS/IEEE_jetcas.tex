      ...
      \begin{tabular}{cccc}
        \toprule
            ...
            Technology   & Clock                 & Expected &                                       \\  %\cline{1-1}
                Node     & Frequency             &  Power   &  Test \cite{krizhevsky2012imagenet}   \\  %\cline{1-1}
        \hline  % instead of \midrule %midrule doesnt overlap with column lines
                   28nm  & \SI{500}{\mega\hertz} &   53W    &  CONV2                                \\ %\cline{2-2}
                   28nm  & \SI{700}{\mega\hertz} &   73W    &  CONV2                                \\ %\cline{2-2}
        \bottomrule
      \end{tabular}
    \end{adjustbox}
    \vspace{3pt}
  ...
  \begin{subtable}{0.5\textwidth}
    ...
    \begin{adjustbox}{width=0.95\textwidth}
      \begin{tabular}{cccc}
        ...
        \hline  % instead of \midrule %midrule doesnt overlap with column lines                                       
                   CONV2                              &\SI[per-mode=symbol]{\sim 70}{\percent}  & \SI[per-mode=symbol]{\sim 46}{\tera\bit\per\second}    & \SI[per-mode=symbol]{\sim 64}{\tera\bit\per\second} \\ %\cline{2-2}
                   FC-7                               &\SI[per-mode=symbol]{\sim 94}{\percent}  & \SI[per-mode=symbol]{\sim 62}{\tera\bit\per\second}    & \SI[per-mode=symbol]{\sim 86}{\tera\bit\per\second} \\ %\cline{2-2}
        \bottomrule
      \end{tabular}
    \end{adjustbox}
    \vspace{3pt}
