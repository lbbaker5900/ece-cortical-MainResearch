...
This work demonstrates the required average bandwidth exceeding  10's of \SI[per-mode=symbol]{}{\tera \bit \per \second} when run against various ANN fully and locally connected ANN layers.
