...
Accessing a "typical" DRAM involveopening a page in a bank, reading or writing a portion of the contents of the page then closing the page.
...
Figure \ref{fig:dramBlockDiagram} is a block diagram of a typical DRAM.
...
We achieve the increase in bandwidth by proposing that the DRAM expose more of its currently open page.

Without the limitations of having to transfer data beyond the chip stack, we expose a larger portion of the page and by staying within the 3D footprint we can transfer data over a very wide through-silicon-via interface
