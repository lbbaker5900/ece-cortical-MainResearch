...
\section{Results}
\label{sec:Results}
The objectives of this work was to design a system able to accelerate ANNs in customer facing systems implementted at the edge. This means systems that are not designed
...
To demonstrate such a system, this work targeted 3DIC technology including 3D-DRAM. This work proposes that if a system can be purely 3DIC, thethe system can take advantage of the benefits
...
The design was synthesized using an available 65nm technology node and then scaled to 28nm.
