...
The minimum pre-synaptic fanin is of the order of two hundred that means the \ac{noc} must transport the result packets in approximately two hundred clocks.
