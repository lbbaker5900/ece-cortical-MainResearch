...
The baseline \ac{ann} described in table \ref{tab:Baseline Layer Configuration} was used to define a collection of presynaptic fanin tests and the average bandwidth achieved from those tests were used to ensure the average bandwidth is maintained.
