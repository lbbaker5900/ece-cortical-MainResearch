...
\begin{figure}[!t]
  ...
  %\begin{subfigure}{1\textwidth}
    ...
    \begin{bytefield}[bitwidth=0.49em, endianness=big]{76}
      \bitheader{0,8,16,24,32,40,48,56,64,67,73,75} \\
      ...
      \begin{rightwordgroup}{\scriptsize Data Cycle}
        \bitbox{2}{\rotatebox{90}{\tiny MOM}} & \bitbox{5}{} & \bitbox{3}{\tiny pyld\\ \vspace{-0em} type} & \bitbox{1}{} & \bitbox{1}{\tiny P\\ V} & \bitbox{32}{\tiny Data} & \bitbox{32}{\tiny Data}
      \end{rightwordgroup}  \\
      \bitbox[]{76}{$\vdots$} \\[1ex]
      \begin{rightwordgroup}{\scriptsize Data Cycle}
        \bitbox{2}{\rotatebox{90}{\tiny EOM}} & \bitbox{5}{} & \bitbox{3}{\tiny pyld\\ \vspace{-0em} type} & \bitbox{1}{} & \bitbox{1}{\tiny P\\ V} & \bitbox{32}{\tiny Data} & \bitbox{32}{\tiny Data}
      \end{rightwordgroup}  \\
    \end{bytefield}
