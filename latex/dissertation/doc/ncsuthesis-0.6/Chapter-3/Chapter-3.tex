...
One way to avoid this limitation is to employ \ac{3dic} (see figure \ref{fig:Die Stack}. The advantages of \ac{3dic} are well understood. reducing the amount of off-chip communication increases bandwidth and reduces power. The power reduction comes from not having to drive the relatively
...
\begin{subfigure}{.9\textwidth}
  ...
  \caption{Different Die types stacked with an interposer}
  \label{fig:Die Stack}
\end{subfigure}%
...
\centerline{
\mbox{\includegraphics[width=6.0in]{TSVs.pdf}}
}
