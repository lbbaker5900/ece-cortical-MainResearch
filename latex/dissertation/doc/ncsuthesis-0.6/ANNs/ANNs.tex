...
\caption{Artists impression of a Mammalian Neuron \cite{wikipedia_neuron}}
\label{fig:neuron}
\end{figure}
  ...
  %\setlength{\leftmargin}{0pt}
        ...
        \1 The accumulated inputs drives an activation function
          ...
          \2 many models have been proposed with varying levels of complexity
              \3 Leaky integrate and fire \cite{Brunel2007} to Izhikevich \cite{Iz2005} (see \fref{fig:Izhikevich Model})
...
Another popular \ac{ann} known as Deep Neural Networks (\ac{dnn}) \cite{aizenberg2013multi}\cite{doi:10.1162/neco.2006.18.7.1527} have gained traction over the last few years. They get good press in applications such as image recognition and speech recognition. 
...
Considering the various functions a complex customer facing or embedded application system performs, it is likely that many real-world applications will employ multiple disparate instances of these useful sized \ac{ann}s.
