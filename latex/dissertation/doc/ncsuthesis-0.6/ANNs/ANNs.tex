...
%\newgeometry{letterpaper,left=1in,right=1in,bottom=1in,top=1.25in,footskip=\chapterfootskip, includefoot}
...
\begin{landscape}
  ...
  \begin{figure}[!htbp]
    %\begin{adjustbox}{angle=0, width=1.0\linewidth}
      \centering
      \captionsetup{justification=centering}
      ...
      %\begin{adjustbox}{width=1.0\linewidth}
        \begin{minipage}{0.95\linewidth}
          \centering
          \includegraphics[width=1.0\linewidth]{fullDNN}
          \captionsetup{justification=centering, skip=15pt}
