    ...
    \begin{minipage}{0.85\textwidth}
        ...
        \begin{adjustbox}{width=1\textwidth}
            ...
            \begin{tabular}{ |c|c|c|c|  }
              ...
              config sync                      &   10   &  N&  Synchronization \\
              config data                      &   11   &  N&  Data transfers\\
...
It is also responsible for downloading configuration data including \ac{ssc} instruction, \ac{pe} \ac{simd} instructions and configuration tables such as storage pointer tables and \ac{pe} \ac{stop} and \ac{simd} operation tables.
The host transfer logic has not been implemented and will be covered in future work but the anicipated process is described below.
...
\begin{figure}[!t]
  ...
  %\begin{subfigure}{1\textwidth}
    ...
    \captionsetup{justification=centering, skip=9pt}
    \vspace{-0.5cm}
    \captionof{figure}{Host transfer \ac{noc} data packet}
