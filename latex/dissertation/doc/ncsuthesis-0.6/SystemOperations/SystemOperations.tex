...
The data to be transferred is included in further \ac{noc} packets and in the case of larger transfers will be fragmented into individual packets to match the 32 data word \ac{mtu} of the \ac{noc}.
...
In the case of a data upload, the main controller will check the status of the instruction decode and if it has not been halted by a sync instruction, will halt the the instruction decoder.
