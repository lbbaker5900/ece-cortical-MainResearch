...
An instruction can contain one or more descriptors and each of these descriptors contains the information to control specific operations within the \ac{ssc} to perform the high level task.
