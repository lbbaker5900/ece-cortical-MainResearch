...
\definecolor{desc}{rgb}{0.406,0.734,0.211}
...
\usepackage{placeins}
%Deï¿œfines a \FloatBarï¿œrier comï¿œmand, beï¿œyond which floats may not pass; useï¿œful, for exï¿œamï¿œple, to enï¿œsure all floats for a secï¿œtion apï¿œpear beï¿œfore the next \secï¿œtion comï¿œmand.
...
\student{Lee Brian}{Baker} % a full middle name
...
\thesistitle{Design of a 3DIC System to Aid in the Acceleration of Embedded Systems that Employ Multiple Instances of Disparate Artificial Neural Networks}
...
\newlength{\leelscapepagenumber}
\setlength{\leelscapepagenumber}{18mm}

\fancypagestyle{lscapedlee}{%
  \fancyhf{}
  \fancyfoot{%
    \tikz[remember picture,overlay]
      \node[outer sep=\leelscapepagenumber,above,rotate=90] at (current page.east) {\thepage};}
\renewcommand{\headrulewidth}{0pt} 
\renewcommand{\footrulewidth}{0pt}
}
...
%\titlespacing*{\chapter}{0pt}{-0.15in-9pt}{22pt}
\titlespacing*{\chapter}{0pt}{-0.12in-9pt}{22pt}
