...
This work demonstrates how a customized \ac{3dic} \ac{dram} with a very wide data-bus can be combined with application-specific layers to produce a system meeting the requirements of embedded systems employing multiple instances of disparate \acp{ann}.
