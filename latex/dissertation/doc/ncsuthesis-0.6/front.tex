...
This work demonstrates how a customized \ac{3dic} \ac{dram} with a very wide data-bus can be combined with application-specific layers to produce a system meeting the required level of performance in embedded systems with multiple instances of disparate \acp{ann}.
...
This work demonstrates that relatively high utilization of the very wide \ac{dram} data-bus can be maintained when combined with instructions and data structures that facilitate operating directly out of the \ac{3ddram}.
