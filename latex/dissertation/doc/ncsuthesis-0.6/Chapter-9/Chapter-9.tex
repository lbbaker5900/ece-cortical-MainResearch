...
\begin{outline}
    ...
    \1 Inform the manager to access the states of the pre-synaptic neurons
    \1 Inform the manager to access the weights of the connections from the pre-synaptic ANs
...
An instruction will typically have up to four descriptors, although variable lengths are supported and will typically communicate:
...
In figure \ref{fig:instructionTuple} we see the format of a 4-tuple instruction which is used to perform an activation calculation for a group of \acp{an}.
